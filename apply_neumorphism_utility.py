...
directories = [
    r"c:\Users\JV\Documents\GitHub\iReside\src\app\landlord\utility-billing",
    r"c:\Users\JV\Documents\GitHub\iReside\src\components\landlord\utility",
]
...
def process_file(file_path):
    ...
    # Page wrappers
    content = re.sub(r'\bmin-h-screen bg-background text-foreground\b', 'min-h-screen text-foreground', content) # often the body has the bg anyway, but let's keep it clean
...
print("Applied Neumorphism to utility-billing successfully!")
