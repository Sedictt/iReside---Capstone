    ...
    () => import("@/components/SearchMap"),
    {
        ...
        loading: () => (
            <div className="h-full w-full bg-[#0a0a0a] flex flex-col items-center justify-center gap-4">
                ...
                <p className="text-xs font-semibold text-neutral-500 tracking-widest uppercase animate-pulse">Initializing Map</p>
            </div>
        )
    }
);
...
export default function SearchPage() {
    ...
    return (
        <div className="flex flex-col h-screen w-full bg-background overflow-hidden font-sans text-neutral-200">
            <TenantNavbar />
