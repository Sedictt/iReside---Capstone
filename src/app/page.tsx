    ...
    return (
        <div className="min-h-screen bg-background text-foreground selection:bg-primary/20 font-sans overflow-x-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 md:px-12 h-20 md:h-24 flex items-center justify-between">
                    ...
                    >
                        ...
                        <div className="flex flex-col border-l border-border/50 pl-4">
                            <span className="text-[9px] md:text-[10px] font-semibold uppercase tracking-[0.25em] text-primary leading-tight">Landlord Access</span>
                        </div>
                    </div>
            ...
            <main id="main-content">
                ...
                <section className="relative min-h-[100svh] flex flex-col items-center justify-center px-6 pt-24 pb-20 z-10" aria-labelledby="hero-title">
                    <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1], delay: 0.1 }} className="max-w-[70rem] mx-auto text-center w-full">
                        <h1 id="hero-title" className="text-[3.5rem] sm:text-6xl md:text-[6.5rem] lg:text-[8rem] font-semibold tracking-tighter leading-[0.85] mb-6 flex flex-col items-center">
                    ...
                    <TransitionLink href="/signup" className="group relative inline-flex items-center justify-center h-16 px-10 rounded-full bg-primary text-primary-foreground font-semibold text-lg transition-all hover:scale-105 shadow-[0_0_40px_rgba(109,152,56,0.3)]">
                        Request Access <ArrowRight className="ml-2 size-5 group-hover:translate-x-1.5 transition-transform" />
                    </TransitionLink>
                </motion.div>
                <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2">
                    <span className="text-[10px] font-semibold uppercase tracking-[0.3em] text-muted-foreground">Scroll to Explore</span>
            ...
            <section className="relative py-24 px-6 bg-muted/30 border-y border-border/50 text-center z-20">
                <p className="text-2xl md:text-4xl font-semibold text-foreground/80">Built for landlords who value <span className="text-primary italic">control</span> and consistency.</p>
            </section>
            ...
            <section id="how-it-works" ref={containerRef} className="relative h-screen z-20 overflow-hidden bg-background">
                <div ref={scrollWrapperRef} className="flex h-screen items-center w-max px-[5vw]">
                    <div className="howit-panel w-[90vw] md:w-[60vw] shrink-0 flex flex-col justify-center px-12 md:px-20">
                        <h2 className="text-5xl md:text-8xl font-semibold mb-8">How It<br/>Works</h2>
                            ...
                            <div className="relative w-full h-full rounded-[3rem] border border-border bg-card p-10 flex flex-col justify-between overflow-hidden group shadow-lg">
                                ...
                                <div>
                                    <div className="flex justify-between mb-8">
                                        ...
                                        <span className="text-muted-foreground font-semibold text-6xl opacity-10">0{i + 1}</span>
                                    </div>
                                    <h3 className="text-4xl md:text-5xl font-semibold mb-4">{feature.title}</h3>
                                ...
                                <div className="mt-8 pt-8 border-t border-border/50 grid grid-cols-1 md:grid-cols-2 gap-6 items-end">
                                    ...
                                    <div className="rounded-2xl border border-primary/30 bg-primary/10 p-4 text-center">
                                        <p className="text-3xl font-semibold text-primary">{feature.metric}</p>
            ...
            <section id="features" ref={showcaseContainerRef} className="relative h-screen bg-background z-20 overflow-hidden">
                <div className="absolute top-24 left-0 right-0 z-30 text-center pointer-events-none">
                    <p className="text-sm font-semibold uppercase tracking-widest text-primary mb-2">Featured Modules</p>
                    ...
                    <div key={mod.id} className="showcase-card absolute inset-0 flex items-center justify-center p-6 bg-background border-t border-border shadow-2xl" style={{ zIndex: i + 1 }}>
                        <div className="max-w-7xl w-full flex flex-col items-center text-center mt-12">
                            <div className="module-body flex flex-col items-center">
                                ...
                                <h2 className="text-4xl md:text-6xl font-semibold mb-6 tracking-tight">{mod.title}</h2>
                                <p className="text-xl md:text-2xl text-muted-foreground font-medium mb-8 leading-relaxed max-w-2xl">
                                    {mod.desc}
                                </p>
                                <TransitionLink href={mod.href} className="module-cta inline-flex items-center gap-2 rounded-full border border-primary bg-primary/10 px-8 py-4 font-semibold text-primary uppercase text-sm hover:bg-primary/20 transition-all">
                ...
                <div className="relative max-w-7xl mx-auto w-full">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        <div className="relative z-10">
                            <h2 className="iris-header-anim text-5xl md:text-7xl lg:text-[6rem] font-semibold tracking-[-0.04em] mb-6">Meet <span className="text-primary">iRis.</span></h2>
            ...
            <section id="outcomes" ref={outcomesSectionRef} className="relative py-32 px-6 z-20 overflow-hidden bg-background border-t border-border/40">
                ...
                <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-20">
                    <div className="outcomes-left lg:w-1/2 lg:sticky lg:top-40">
                        <p className="outcomes-reveal text-sm font-semibold uppercase text-primary mb-5">Operational Outcomes</p>
                        <h2 className="outcomes-reveal text-5xl md:text-7xl font-semibold leading-tight">Calm operations,<br/>measurable gains.</h2>
                    </div>
                        ...
                        <div className="grid gap-12 outcomes-right-track lg:absolute lg:inset-x-0 lg:top-0">
                            {OUTCOMES.map(o => (
                                <article key={o.label} className="outcome-item p-8 border-l-4 border-primary/30 bg-muted/20 rounded-r-3xl">
                                    <div className="flex items-center gap-4 mb-4"><span className="outcome-metric-value text-6xl font-semibold">{o.metric}</span><CheckCircle2 className="size-8 text-primary" /></div>
            ...
            <section ref={ctaSectionRef} className="relative py-32 px-6 border-t border-border z-20 bg-background text-center">
                ...
                <div className="max-w-4xl mx-auto">
                    <p className="cta-reveal text-sm font-semibold uppercase text-primary mb-6 tracking-widest">Your Pipeline Awaits</p>
                    <h2 className="cta-reveal text-5xl md:text-8xl font-semibold leading-[0.9]">Build your next<span className="block text-primary mt-4">growth cycle.</span></h2>
                    <div className="cta-reveal mt-20 cta-panel-wrapper border border-border bg-card p-12 rounded-[3rem] shadow-2xl relative overflow-hidden">
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 justify-center">
                            <TransitionLink href="/signup" className="h-20 px-12 rounded-full bg-primary text-white font-semibold text-xl flex items-center justify-center hover:scale-105 transition-transform">Request Access <ArrowRight className="ml-3 size-6" /></TransitionLink>
                        </div>
                    </div>
                </div>
            </section>
            ...
            >
                ...
                <div className="relative z-10 flex flex-col items-center">
                    ...
                    <div className="absolute -bottom-8 opacity-0 group-hover:opacity-100 transition-all duration-300">
                        <span className="text-[10px] font-semibold uppercase tracking-widest text-primary">Top</span>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-32">
                        <div className="flex flex-col gap-10 col-span-1 lg:col-span-1">
                            <div className="flex flex-col gap-5">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-[10px] font-semibold uppercase tracking-[0.2em] text-emerald-500/80">Systems Operational</span>
                                </div>
                            </div>
                        ...
                        <div className="grid grid-cols-2 gap-12 lg:col-span-3">
                            <div className="flex flex-col gap-8">
                                <h4 className="text-[11px] font-semibold uppercase tracking-[0.3em] text-foreground/40">Platform Modules</h4>
                            ...
                            <div className="flex flex-col gap-8">
                                <h4 className="text-[11px] font-semibold uppercase tracking-[0.3em] text-foreground/40">Company</h4>
                                <ul className="flex flex-col gap-6">
                                    {[
                    ...
                    <div className="pt-12 border-t border-border/50 flex flex-col md:flex-row items-center justify-between gap-10">
                        ...
                        <div className="flex items-center gap-4 px-6 py-3 rounded-2xl border border-primary/20 bg-primary/5 backdrop-blur-sm group cursor-default shadow-sm hover:border-primary/40 transition-colors">
                            ...
                            <div className="flex flex-col">
                                <span className="text-[11px] font-semibold uppercase tracking-[0.2em] text-primary">Powered by iRis AI</span>
                                <span className="text-[9px] font-semibold text-primary/50 uppercase tracking-[0.1em]">Intelligence Engine v2.4</span>
                            </div>
                        </div>
                    </div>
                </div>
