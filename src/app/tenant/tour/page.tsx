        ...
        <div className="mx-auto max-w-3xl py-10 space-y-6">
            <section className="rounded-2xl border border-border bg-card p-6 space-y-4">
                ...
                <div className="rounded-xl border border-border bg-background/50 px-4 py-3 text-sm">
                    Progress: <span className="font-semibold">{progressLabel}</span>
                </div>
            ...
            <section className="rounded-2xl border border-border bg-card p-6 flex flex-wrap gap-3">
                ...
                <Link href="/tenant/dashboard" className="inline-flex items-center rounded-lg border border-border px-4 py-2 text-sm font-semibold">
                    Back to Dashboard
                </Link>
            </section>
        </div>
