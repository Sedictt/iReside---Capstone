    ...
    <div className="space-y-12">
      ...
      <section className="space-y-6">
        ...
        <div className="flex flex-wrap gap-4 pt-2">
          <Button className="bg-primary hover:bg-primary-dark text-white h-12 px-8 text-lg font-black rounded-xl" asChild>
            <Link href="/docs/getting-started/quick-start">
              Get Started <Rocket className="ml-2 size-5" />
            </Link>
          </Button>
          <Button variant="outline" className="h-12 px-8 text-lg font-black rounded-xl border-divider hover:bg-surface-2" asChild>
      ...
      <section className="space-y-6">
        <div className="space-y-3">
          <h2 id="what-is-ireside" className="text-3xl font-black text-text-high">What is iReside?</h2>
      ...
      <section className="space-y-6">
        <h2 id="who-is-this-for" className="text-3xl font-black text-text-high">Who is This For?</h2>
          ...
          {categories.map((category) => (
            ...
            >
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-black text-text-high group-hover:text-primary transition-colors">
                  {category.title}
                </h3>
              ...
              <div className="mt-auto flex items-center text-sm font-black text-primary">
      ...
      <section className="rounded-3xl bg-surface-2/50 border border-divider p-8 lg:p-12 text-center md:text-left">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
          <div className="space-y-4 max-w-2xl">
            <h2 id="features" className="text-3xl font-black text-text-high">Platform Capabilities</h2>
      ...
      <section className="space-y-6">
        <div className="space-y-3">
          <h2 id="how-it-works" className="text-3xl font-black text-text-high">How iReside Works</h2>
        ...
        <div className="grid gap-6 sm:grid-cols-3">
          {[
            ...
            <div key={item.step} className="rounded-2xl border border-divider bg-surface-1 p-6">
              ...
              <h4 className="mb-2 font-black text-text-high">{item.title}</h4>
      ...
      <section className="space-y-6">
        <h2 id="why-choose" className="text-3xl font-black text-text-high">Why Choose iReside</h2>
        <div className="rounded-2xl border border-divider bg-surface-1 p-8">
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="mb-1 font-black text-text-high">Your Information is Protected</h4>
                <p className="text-sm text-text-medium leading-relaxed">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="mb-1 font-black text-text-high">Built for Simplicity</h4>
                <p className="text-sm text-text-medium leading-relaxed">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="mb-1 font-black text-text-high">Direct Relationships</h4>
                <p className="text-sm text-text-medium leading-relaxed">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="mb-1 font-black text-text-high">Clear Communication</h4>
                <p className="text-sm text-text-medium leading-relaxed">
      ...
      <section className="space-y-6">
        <h2 id="get-started" className="text-3xl font-black text-text-high">Ready to Get Started?</h2>
          ...
          <div className="space-y-4">
            <Link href="/docs/getting-started/quick-start" className="flex items-center gap-3 rounded-lg border border-divider bg-surface-1 p-4 transition-all hover:border-primary/50 hover:bg-surface-2">
              ...
              <div className="flex-1">
                <h4 className="font-black text-text-high">Quick Start Guide</h4>
            ...
            <Link href="/docs/tenant/applications" className="flex items-center gap-3 rounded-lg border border-divider bg-surface-1 p-4 transition-all hover:border-primary/50 hover:bg-surface-2">
              ...
              <div className="flex-1">
                <h4 className="font-black text-text-high">Tenant Guide</h4>
            ...
            <Link href="/docs/landlord/screening" className="flex items-center gap-3 rounded-lg border border-divider bg-surface-1 p-4 transition-all hover:border-primary/50 hover:bg-surface-2">
              ...
              <div className="flex-1">
                <h4 className="font-black text-text-high">Landlord Guide</h4>
      ...
      <section className="flex flex-col items-center justify-between gap-6 rounded-2xl border border-divider bg-primary p-8 text-white sm:flex-row">
        ...
        <Button className="bg-white text-primary hover:bg-white/90 h-12 px-8 rounded-xl font-black whitespace-nowrap" asChild>
