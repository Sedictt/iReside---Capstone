 ...
 * Legacy multi-tenant admin chat moderation page.
    ...
    return (
        <div className="mx-auto max-w-7xl space-y-8 px-4 pb-12 sm:px-6 lg:px-8">
            ...
            <header className="relative overflow-hidden rounded-[2.5rem] border border-border/50 bg-card p-10 shadow-2xl dark:border-white/5 dark:bg-neutral-900/40">
                ...
                <div className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-8">
                    ...
                    <div className="flex items-center gap-3">
                        <button
                            ...
                            className="group flex items-center gap-2 rounded-2xl bg-muted/50 px-6 py-3.5 text-sm font-black text-foreground transition-all hover:bg-muted hover:scale-105 active:scale-95 dark:bg-white/5 dark:text-white dark:hover:bg-white/10"
                        >
                ...
                {error && (
                    <div className="mt-6 flex items-center gap-3 rounded-2xl border border-red-500/20 bg-red-500/10 p-4 text-sm font-black text-red-500 animate-in slide-in-from-top-2">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-4 rounded-[2rem] border border-border/50 bg-card/50 p-6 backdrop-blur-sm dark:border-white/5 dark:bg-white/[0.02]">
                        ...
                        <div className="flex flex-wrap items-center gap-3">
                            ...
                            <div className="relative group/status">
                                <button className="flex items-center gap-3 px-4 py-2.5 rounded-xl border border-border bg-background/50 hover:bg-background hover:border-primary/50 transition-all text-xs font-black text-foreground min-w-[140px] justify-between">
                                    <div className="flex items-center gap-2">
                                        <div className={cn(
                                ...
                                <div className="absolute top-full left-0 mt-2 w-full min-w-[160px] rounded-2xl border border-border/50 bg-card/95 p-1.5 shadow-2xl backdrop-blur-2xl opacity-0 invisible group-hover/status:opacity-100 group-hover/status:visible transition-all z-50 transform origin-top translate-y-2 group-hover/status:translate-y-0">
                                    <button
                                        ...
                                        className={cn(
                                            "w-full text-left px-3 py-2 text-[11px] font-black uppercase tracking-wider rounded-lg transition-colors",
                            ...
                            <div className="relative group/cat">
                                <button className="flex items-center gap-3 px-4 py-2.5 rounded-xl border border-border bg-background/50 hover:bg-background hover:border-primary/50 transition-all text-xs font-black text-foreground min-w-[160px] justify-between">
                                    <div className="flex items-center gap-2">
                ...
                <aside className="lg:col-span-4 space-y-6">
                    <div className="rounded-[2.5rem] border border-border/50 bg-card p-8 shadow-xl dark:border-white/5 dark:bg-neutral-900/40">
                        <div className="mb-6 space-y-2">
                            <h2 className="text-lg font-black text-foreground dark:text-white uppercase tracking-wider">Vocabulary</h2>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex flex-col gap-3">
                                    <input
                                        ...
                                        className="w-full rounded-2xl border border-border bg-background/50 px-5 py-4 text-sm font-black text-foreground focus:border-primary/50 focus:ring-4 focus:ring-primary/10 outline-none dark:border-white/10 dark:bg-black/40"
                                    />
                                    <button
                            ...
                            <div className="pt-6 border-t border-border/50 dark:border-white/5">
                                <div className="relative mb-4">
                                    ...
                                    <input
                                        ...
                                        placeholder="Search..."
                                        className="w-full rounded-2xl border border-border bg-background/50 pl-12 pr-5 py-3 text-sm font-black text-foreground focus:border-primary/50 outline-none dark:border-white/10 dark:bg-black/40"
                                    />
                                </div>
                                ...
                                <div className="custom-scrollbar max-h-[450px] space-y-2 overflow-y-auto pr-2">
                                    {filteredTerms.length === 0 ? (
                                        <div className="py-12 text-center">
                                            <p className="text-xs font-black text-muted-foreground/40 italic">No matches found.</p>
                                        </div>
                                    ) : (
                                        filteredTerms.map((term) => (
                                            ...
                                            >
                                                <div className="flex flex-col gap-0.5">
                                                    <span className="text-sm font-black text-foreground dark:text-white">{term.term}</span>
                                                    <span className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">{term.source}</span>
                                                </div>
                                                {term.reportId && (
                ...
                <div className="pointer-events-none absolute left-1/2 -top-14 z-[100] -translate-x-1/2 opacity-0 invisible translate-y-2 scale-95 transition-all duration-200 ease-out group-hover:opacity-100 group-hover:visible group-hover:-translate-y-1 group-hover:scale-100">
                    <div className="relative rounded-2xl border border-primary/30 bg-card px-6 py-4 shadow-[0_20px_50px_rgba(0,0,0,0.3)] backdrop-blur-2xl min-w-[320px] max-w-md">
                        <div className="flex flex-col gap-1.5">
                            <span className="text-[9px] font-black uppercase tracking-widest text-primary">Incident Insight</span>
                ...
                <div className="flex flex-1 items-center min-w-0">
                    ...
                    <div className="flex items-center gap-3 min-w-0 flex-1 lg:flex-none lg:w-80">
                        ...
                        <div className="flex flex-col min-w-0">
                            ...
                            <span className="text-[10px] font-black text-muted-foreground uppercase tracking-widest truncate">{report.category}</span>
                        </div>
                    </div>
                                ...
                                <div className="grid lg:grid-cols-2 border-b border-border/50">
                                    ...
                                    <div className="flex flex-col p-8 border-r border-border/50 bg-muted/10 dark:bg-white/[0.01]">
                                        ...
                                        <div className="flex items-center gap-3 mt-12">
                                            ...
                                            <div className="flex flex-col">
                                                <span className="text-xs font-black text-muted-foreground">Reported by {report.reporter?.name || "Anon"}</span>
                                    ...
                                    <div className="flex flex-col p-8 bg-red-500/[0.02]">
                                        ...
                                        {report.target && (
                                                <>
                                                    <div className="flex flex-col">
                                                        <span className="text-xs font-black text-primary">Target: {report.target.name}</span>
