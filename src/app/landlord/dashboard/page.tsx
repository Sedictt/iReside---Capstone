                    ...
                    <div className="group relative overflow-hidden rounded-[2rem] border border-amber-500/25 bg-amber-500/10 p-6 backdrop-blur-sm animate-in zoom-in-95 duration-500">
                        <div className="relative z-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                            <div className="flex items-center gap-5">
                                ...
                                <div>
                                    <h3 className="text-lg font-semibold text-amber-300">{systemAdvisory.title}</h3>
                                    <p className="text-sm font-medium text-muted-foreground/80">{systemAdvisory.message}</p>
                                </div>
                            </div>
                            <div className="rounded-xl border border-amber-500/25 bg-amber-500/12 px-4 py-2 text-xs font-semibold uppercase tracking-widest text-amber-300">
                                Global Alert
                            </div>
                        </div>
                ...
                <section className="relative z-0 h-auto w-full rounded-[2.5rem] border border-white/10 bg-card/60 p-8 shadow-2xl shadow-black/30 backdrop-blur-xl">
                    <div className="mb-10 flex flex-wrap items-center justify-between gap-4 px-2">
                        <div className="flex min-w-0 items-center gap-4">
                            ...
                            <div>
                                <h2 className="text-2xl font-semibold tracking-tight text-foreground">Cash Flow Ledger</h2>
                                <p className="text-sm font-medium text-muted-foreground/80">Track what is overdue, due this week, and already paid.</p>
                            </div>
                        </div>
                        <Link href="/landlord/invoices" className="group shrink-0 flex items-center gap-2 rounded-xl border border-white/10 bg-card/70 px-4 py-2 text-xs font-semibold uppercase tracking-widest transition-all hover:bg-card">
                            View Invoices
                    ...
                    <div className="relative z-0 h-auto w-full rounded-[2.5rem] border border-white/10 bg-card/60 p-8 shadow-2xl shadow-black/30 backdrop-blur-xl mb-8">
                        <div className="flex flex-wrap items-center justify-between gap-4 px-2">
                            <div className="flex min-w-0 items-center gap-4">
                                ...
                                <div>
                                    <h2 className="text-2xl font-semibold tracking-tight text-foreground">Lease Renewals</h2>
                                    <p className="text-sm font-medium text-muted-foreground/80">Review and manage tenant renewal requests.</p>
                                </div>
                            </div>
                            <Link href="/landlord/tenants?tab=renewals" className="group shrink-0 flex items-center gap-2 rounded-xl border border-white/10 bg-card/70 px-4 py-2 text-xs font-semibold uppercase tracking-widest transition-all hover:bg-card">
                                View All
                                <ArrowUpRight className="size-3.5 transition-transform group-hover:-translate-y-0.5 group-hover:translate-x-0.5" />
                            </Link>
                        </div>
                                    ...
                                    <div className="flex items-center justify-between px-4">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="space-y-1">
                                                <h3 className={cn("text-[10px] font-semibold uppercase tracking-[0.2em]", tone)}>{label}</h3>
                                                <p className="text-[10px] font-semibold text-muted-foreground/60">{hint}</p>
                                            </div>
                                        </div>
                                        <button 
                                            onClick={() => setOpenPaymentModal(key)} 
                                            className="text-[10px] font-semibold text-muted-foreground/60 transition-colors hover:text-primary uppercase tracking-tighter"
                                        >
                                            See more
                                        </button>
                                    </div>
                                    ...
                                    <div className="flex min-h-[140px] flex-1 flex-col justify-center rounded-[1.75rem] border border-white/10 bg-card/70 p-4 transition-all hover:bg-card">
                                        {paymentsLoading ? (
                                            ...
                                            <div className="flex flex-col items-center justify-center py-6 text-muted-foreground/40">
                                                ...
                                                <p className="text-[9px] font-semibold uppercase tracking-widest">{emptyState}</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
                    ...
                    <div className="relative z-10 max-h-[90vh] w-full max-w-6xl overflow-hidden rounded-[2.5rem] border border-white/10 bg-card shadow-[0_30px_60px_rgba(0,0,0,0.5)] animate-in zoom-in-95 duration-300">
                        <div className="sticky top-0 z-10 flex items-center justify-between border-b border-white/10 bg-card/95 px-8 py-6 backdrop-blur-xl">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h2 className="text-xl font-semibold text-foreground">Private Referral Link</h2>
                        ...
                        >
                            {!isConfirmingAction ? (
                                <>
                                    ...
                                    <div className="px-8 pb-4 space-y-3">
                                        <div className="rounded-2xl bg-muted/30 p-4 border border-border/50">
                                            ...
                                            <h4 className="text-3xl font-semibold text-foreground">PHP {selectedActionPayment.amount.toLocaleString()}</h4>
                                        </div>

                                        <div className="grid grid-cols-2 gap-3">
                                            <div className="rounded-2xl bg-muted/20 p-4 border border-border/30">
                                                <p className="text-[10px] font-semibold uppercase tracking-[0.2em] text-muted-foreground mb-1">Lease Ends</p>
                                                <p className="text-xs font-bold text-foreground">Oct 2026</p>
                                            </div>
                                            <div className="rounded-2xl bg-muted/20 p-4 border border-border/30">
                                                <p className="text-[10px] font-semibold uppercase tracking-[0.2em] text-muted-foreground mb-1">Tenant Status</p>
                                ...
                                <div className="p-8 text-center animate-in slide-in-from-right-4 duration-300">
                                    ...
                                    <h3 className="text-xl font-semibold text-foreground">Confirm Settlement</h3>
                                    ...
                                    <div className="mt-8 flex flex-col gap-3">
                                        <button 
                                            ...
                                            className="w-full rounded-2xl bg-primary py-4 text-sm font-semibold uppercase tracking-widest text-primary-foreground shadow-lg shadow-primary/20 transition-all hover:scale-[1.02] active:scale-95"
                                        >
                                            Complete Settlement
                                        </button>
                                        <button 
                                            onClick={() => setIsConfirmingAction(false)}
                                            className="w-full rounded-2xl border border-white/10 bg-card/70 py-4 text-[10px] font-semibold uppercase tracking-widest text-muted-foreground/70 transition-all hover:bg-card hover:text-foreground"
                                        >
                                            Go Back
                                        </button>
                                    </div>
        ...
        >
            <div className="flex items-center gap-4 relative z-10">
                ...
                <div className="min-w-0 max-w-[120px] sm:max-w-[160px]">
                    <h4 className="truncate text-sm font-semibold text-foreground group-hover:text-primary transition-colors">{tenant}</h4>
                    <p className="text-[11px] font-bold text-muted-foreground uppercase tracking-tight">{unit}</p>
                </div>
            </div>

            <div className="text-right relative z-10 flex flex-col items-end">
                <h4 className="mb-0.5 text-sm font-semibold text-foreground">PHP {amount.toLocaleString()}</h4>
                <div className="flex items-center justify-end gap-1.5 mt-1">
                    <span className="text-[9px] font-semibold uppercase tracking-widest text-muted-foreground/60">{date}</span>
                </div>
            </div>
