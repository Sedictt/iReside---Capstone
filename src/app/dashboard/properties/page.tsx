            ...
            {view === "grid" ? (
                <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    {mockProperties.map((property) => (
                        <div
                            key={property.id}
                            className="group relative overflow-hidden rounded-xl border border-zinc-800 bg-zinc-900/50 transition-all hover:border-zinc-700 hover:bg-zinc-800/50"
                        >
                            ...
                            <div className="p-6">
                                ...
                                <div className="mt-6 flex items-center justify-between border-t border-zinc-800 pt-4">
                                    <div>
                                        ...
                                        <p className="font-medium text-zinc-200">{property.units}</p>
                                    </div>
                ...
                <div className="h-[600px] w-full overflow-hidden rounded-xl border border-zinc-800">
                    {isClient && (
