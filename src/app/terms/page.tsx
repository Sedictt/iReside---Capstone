        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:ireside.official.mail@gmail.com" className="text-primary hover:underline">
