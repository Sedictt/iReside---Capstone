            ...
            >
                    ...
                    <div className="relative flex items-start justify-between">
                        <div className="space-y-2">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-[10px] font-bold uppercase tracking-[0.25em] text-primary">Financial Ledger</span>
                            </div>
                            <h2 className="text-3xl font-bold tracking-tight text-foreground">Record Expense</h2>
                ...
                <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-8 custom-scrollbar space-y-6">
                    <div className="space-y-3">
                        <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground">Expense Category</label>
                    ...
                    <div className="grid gap-6 sm:grid-cols-2">
                        <div className="space-y-3">
                            <label htmlFor="expense-amount" className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground">Amount (PHP)</label>
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full rounded-2xl border border-border bg-background py-4 pl-12 pr-4 text-sm font-bold text-foreground outline-none transition-all placeholder:text-muted-foreground/50 focus:border-primary focus:ring-4 focus:ring-primary/10"
                                    placeholder="0.00"
                                />
                            </div>
                        </div>
                        ...
                        <div className="space-y-3">
                            <label htmlFor="expense-date" className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground">Date Incurred</label>
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full rounded-2xl border border-border bg-background py-4 pl-12 pr-4 text-sm font-bold text-foreground outline-none transition-all focus:border-primary focus:ring-4 focus:ring-primary/10"
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-3">
                        <label htmlFor="expense-description" className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground">Description</label>
                        <div className="relative group">
                    ...
                    <div className="pt-4">
                        <button
                            ...
                            className="group flex w-full items-center justify-center gap-2 rounded-2xl bg-primary px-6 py-4 text-sm font-bold uppercase tracking-widest text-primary-foreground shadow-lg shadow-primary/20 transition-all hover:scale-[1.01] hover:bg-primary/90 active:scale-95 disabled:pointer-events-none disabled:opacity-50"
                        >
                            {loading ? (
                                "Saving..."
                            ) : (
