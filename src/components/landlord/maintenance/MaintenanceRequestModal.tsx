...
export function MaintenanceRequestModal({
 ...
 />
 <div
 className="relative z-10 w-full max-w-2xl max-h-[95vh] bg-card text-card-foreground rounded-[2rem] /50 flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-300"
 ...
 <button
 onClick={onClose}
 className="p-3 hover:neumorphic-inset rounded-full transition-colors shrink-0"
 aria-label="Close"
 >
 ...
 className="px-6 py-3 rounded-xl text-sm font-black text-muted-foreground hover:text-foreground hover:neumorphic-inset transition-all"
 >
 Cancel
 </button>
 <button
 ...
 disabled={isSubmitting}
 className="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-black neumorphic-primary hover:bg-primary/90 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
 >
 {isSubmitting ? (
 <>
 ...
 <div
 className="relative z-10 w-full max-w-5xl max-h-[95vh] bg-card text-card-foreground rounded-[2rem] /50 flex flex-col md:flex-row overflow-hidden animate-in fade-in zoom-in-95 duration-300"
 onClick={(event) => event.stopPropagation()}
 >
 {/* Left Panel: Images */}
 <div className="w-full md:w-[45%] relative neumorphic-inset shrink-0 basis-[250px] md:basis-auto md:min-h-full overflow-hidden group">
 ...
 <button
 onClick={() => setIsImageLightboxOpen(true)}
 className="absolute top-6 right-6 z-20 inline-flex items-center gap-1.5 rounded-full bg-black/40 backdrop-blur-md px-3.5 py-2 text-xs font-black text-white hover:bg-black/60 transition-colors "
 >
 ...
 className="absolute left-4 top-1/2 -translate-y-1/2 p-2.5 bg-black/40 text-white rounded-full backdrop-blur-md opacity-0 group-hover:opacity-100 disabled:opacity-0 transition-opacity hover:bg-white hover:text-black "
 >
 ...
 className="absolute right-4 top-1/2 -translate-y-1/2 p-2.5 bg-black/40 text-white rounded-full backdrop-blur-md opacity-0 group-hover:opacity-100 disabled:opacity-0 transition-opacity hover:bg-white hover:text-black "
 >
 <ChevronRight className="size-5" />
 </button>

 <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex items-center gap-2 bg-black/40 backdrop-blur-md px-4 py-2.5 rounded-full ">
 ...
 <div className="absolute inset-0 flex items-center justify-center neumorphic-inset/80">
 ...
 <span className={cn(
 "px-3 py-1.5 rounded-xl border text-[10px] font-black uppercase tracking-widest backdrop-blur-md",
 request.status === "Pending" ? "bg-amber-500/90 text-black border-amber-400" :
 request.status === "In Progress" ? "neumorphic-primary/90 border-primary/50" :
 ...
 {/* HUD: Property & Unit */}
 <div className="mt-2 bg-black/40 backdrop-blur-md rounded-2xl p-3 flex flex-col gap-2.5 w-full">
 ...
 <button
 onClick={onClose}
 className="absolute top-6 right-6 p-2.5 neumorphic-inset hover:neumorphic-inset-foreground/10 text-muted-foreground hover:text-foreground rounded-full transition-all z-20 active:scale-90"
 aria-label="Close"
 >
 <X className="size-5" />
 </button>
 ...
 <div className="flex items-center neumorphic-inset rounded-lg px-3 py-1.5 text-foreground/70">
 ID: {request.id.split('-')[0]}
 </div>
 <div className="flex items-center gap-1.5 neumorphic-inset px-3 py-1.5 rounded-lg text-foreground/70">
 ...
 {selfRepairRequested && (
 <div className="rounded-3xl border border-emerald-500/20 bg-emerald-500/5 p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-6 ">
 ...
 className={cn("px-5 py-2.5 rounded-xl text-sm font-black transition-all border", selfRepairDecision === "allow" ? "bg-emerald-500 text-white border-emerald-500 " : "bg-background text-emerald-600 border-emerald-500/20 hover:bg-emerald-500/10")}
 >
 Approve
 </button>
 <button 
 onClick={() => setSelfRepairDecision("reject")}
 className={cn("px-5 py-2.5 rounded-xl text-sm font-black transition-all border", selfRepairDecision === "reject" ? "bg-red-500 text-white border-red-500 " : "bg-background text-red-600 border-red-500/20 hover:bg-red-500/10")}
 >
 Deny
 </button>
 </div>
 ...
 <div className="flex items-center gap-4 neumorphic-inset p-5 rounded-3xl ">
 <div
 className="size-14 rounded-2xl overflow-hidden shrink-0 flex items-center justify-center text-lg font-black text-white relative"
 ...
 <button className="p-3 rounded-2xl neumorphic-primary hover:bg-primary/90 transition-all active:scale-90 shrink-0">
 ...
 <div className={cn(
 "rounded-2xl border px-5 py-4 flex flex-col gap-3 animate-in fade-in slide-in-from-top-2",
 ...
 className="relative size-20 rounded-xl overflow-hidden hover:border-primary/50 transition-all group"
 >
 ...
 <div className={cn("neumorphic-inset /50 rounded-3xl p-5 sm:p-6 space-y-5 transition-all duration-300", selfRepairDecision === "allow" ? "opacity-50 pointer-events-none" : "")}>
 <div className="flex items-center gap-2 mb-2">
 <div className={cn("size-2 rounded-full", selfRepairDecision === "allow" ? "neumorphic-inset-foreground" : "bg-amber-500 animate-pulse")} />
 ...
 className="w-full rounded-xl neumorphic-panel/50 py-3.5 pl-[3.25rem] pr-4 text-sm font-black text-foreground outline-none focus:border-primary/50 focus:ring-4 focus:ring-primary/10 transition-all placeholder:text-muted-foreground/40 hover:border-border"
 />
 </div>
 </div>
 )}
 ...
 className={cn(
 "w-full sm:flex-1 px-6 py-4 rounded-2xl font-black uppercase tracking-wider text-sm transition-all flex items-center justify-center gap-2 group/btn relative overflow-hidden",
 processStep === "pending" 
 ? "neumorphic-primary hover:bg-primary/90 shadow-[0_0_20px_rgba(var(--primary),0.2)] active:scale-[0.98]" 
 ...
 disabled={isSaving}
 className="w-full sm:w-auto px-6 py-4 rounded-2xl neumorphic-inset hover:neumorphic-inset/80 disabled:opacity-50 text-foreground transition-all /50 flex items-center justify-center gap-2 whitespace-nowrap text-sm font-black animate-in fade-in slide-in-from-bottom-2"
 >
 ...
 src={request.images[currentImageIndex]}
 alt="Enlarged view"
 className="max-w-[90vw] max-h-[90vh] object-contain rounded-xl animate-in zoom-in-95 duration-300"
 />
 ...
 disabled={currentImageIndex === 0}
 className="absolute left-6 top-1/2 -translate-y-1/2 p-4 bg-white/10 hover:bg-white/20 text-white rounded-full transition-colors disabled:opacity-0 "
 >
 ...
 disabled={currentImageIndex === request.images.length - 1}
 className="absolute right-6 top-1/2 -translate-y-1/2 p-4 bg-white/10 hover:bg-white/20 text-white rounded-full transition-colors disabled:opacity-0 "
 >
 <ChevronRight className="size-8" />
 </button>
 
 <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex items-center gap-3 bg-black/50 px-5 py-3 rounded-full backdrop-blur-md ">
 {request.images.map((_, idx) => (
 <button
