...
export function TenantDetailModal({ isOpen, onClose, tenantId, initialTab = 'profile' }: TenantDetailModalProps) {
 ...
 {/* Tabs */}
 <div className="flex gap-1 border-b border-white/5 neumorphic-inset px-8 py-4">
 {[
 ...
 <div className="space-y-4 rounded-3xl neumorphic-inset p-6">
 ...
 <div key={activity.id} className="flex items-center justify-between rounded-2xl neumorphic-inset p-4">
 ...
 {documents.map(doc => (
 <div key={doc.id} className="group flex items-center justify-between rounded-3xl neumorphic-panel p-5 transition-all hover:border-primary/20 hover:">
 <div className="flex items-center gap-4">
 <div className="size-12 rounded-2xl neumorphic-inset flex items-center justify-center text-muted-foreground group-hover:bg-primary/10 group-hover:text-primary transition-colors">
 ...
 className="size-10 rounded-xl neumorphic-inset flex items-center justify-center text-muted-foreground hover:neumorphic-primary hover: transition-all"
 >
 ...
 idx === 0 ? "neumorphic-primary shadow-primary/20" : "neumorphic-inset text-muted-foreground"
 )}>
 {getIcon(activity.icon)}
 </div>
 ...
 {/* Footer */}
 <div className="border-t border-border neumorphic-inset p-8 flex justify-end">
 <button
 onClick={onClose}
