        ...
        return (
            <div className="flex min-h-screen items-center justify-center bg-[#0a0a0a]">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-muted-foreground animate-pulse">Syncing Portfolio</p>
                </div>
            </div>
        );
    }
    ...
    if (properties.length === 0) {
        return (
            <div className="flex min-h-screen flex-col items-center justify-center bg-[#0a0a0a] px-6 text-center">
                ...
                <h1 className="mb-4 text-3xl font-bold tracking-tight text-foreground md:text-5xl">No properties detected</h1>
                ...
                <Link 
                    ...
                    className="group flex items-center gap-3 rounded-2xl bg-primary px-8 py-4 text-sm font-bold uppercase tracking-widest text-primary-foreground transition-all hover:scale-[1.02] active:scale-95"
                >
        ...
        <div ref={containerRef} className="relative flex h-screen w-full flex-col overflow-hidden bg-[#0a0a0a] text-foreground md:flex-row">
            ...
            <aside className="relative z-20 flex w-full flex-col border-b border-white/5 bg-card/40 backdrop-blur-2xl md:w-[420px] md:border-b-0 md:border-r">
                ...
                <div className="border-t border-white/5 p-6">
                    <Link href="/landlord/dashboard" className="flex items-center justify-center gap-2 text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground/60 transition-colors hover:text-foreground">
                        Exit Selection
                    </Link>
                </div>
            </aside>
                                ...
                                <div className="grid lg:grid-cols-[1fr_360px]">
                                        ...
                                        <div className="absolute bottom-8 left-8 right-8">
                                            <div className="flex items-center gap-4 text-white">
                                                ...
                                                <div className="flex flex-col">
                                                    <span className="text-[10px] font-bold uppercase tracking-widest opacity-60">Verified Location</span>
                                    ...
                                    <div className="flex flex-col p-10">
                                        <div className="mb-auto">
                                            <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.2em] text-primary">
                                                <MessageSquare className="size-3" />
                                                {badgeText}
                                            </div>
                                            <h1 className="property-stage-content text-4xl font-bold tracking-tight text-foreground">
                                                {activeProperty.name}
                                            </h1>
                                            ...
                                            <div className="mt-8 grid grid-cols-2 gap-4">
                                                <div className="property-stage-content flex flex-col gap-1 rounded-2xl border border-white/5 bg-white/5 p-4 transition-all hover:bg-white/10">
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span className="text-lg font-bold">{activeProperty.units?.length || 0}</span>
                                                    </div>
                                                </div>
                                                <div className="property-stage-content flex flex-col gap-1 rounded-2xl border border-white/5 bg-white/5 p-4 transition-all hover:bg-white/10">
                                        ...
                                        <div className="property-stage-content mt-12">
                                            <button 
                                                ...
                                                className="group flex w-full items-center justify-between rounded-2xl bg-primary p-5 text-sm font-bold uppercase tracking-widest text-primary-foreground shadow-xl shadow-primary/20 transition-all hover:scale-[1.02] active:scale-95"
                                            >
                                                {buttonText}
