                        ...
                        <div className="flex h-full flex-col">
                            ...
                            <div className="flex items-center justify-between border-b border-white/5 p-8">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h2 className="text-xl font-semibold tracking-tight text-foreground">Mission Control</h2>
                                        <p className="text-[10px] font-semibold uppercase tracking-[0.2em] text-muted-foreground/60">Operational Roadmap</p>
                                    </div>
                                </div>
                                <button
                                    onClick={onClose}
                                            ...
                                            >
                                                <div className="flex items-start justify-between mb-4">
                                                    ...
                                                    {isDone ? (
                                                        ...
                                                        <span className="text-[10px] font-semibold tracking-widest text-primary bg-primary/10 px-2 py-1 rounded-lg">
                                                            {progress}%
                                                        </span>
                                                    )}
                                                </div>
                                                ...
                                                <div className="space-y-2 mb-6">
                                                    <h3 className="text-sm font-semibold tracking-tight text-foreground">{quest.title}</h3>
                                                ...
                                                <div className="space-y-4">
                                                    ...
                                                    <button
                                                        ...
                                                        className={cn(
                                                            "flex w-full items-center justify-center gap-2 rounded-xl py-2.5 text-[10px] font-semibold uppercase tracking-widest transition-all",
                                                            isDone
