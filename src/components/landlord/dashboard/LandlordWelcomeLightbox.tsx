...
import { LandlordMobileWelcomeModal } from "./LandlordMobileWelcomeModal";
...
export function LandlordWelcomeLightbox() {
    ...
    return (
        <>
            {/* Separate Mobile Welcome Modal */}
            <LandlordMobileWelcomeModal />

            {/* Desktop-specific Welcome Lightbox (Preserved full code, hidden on mobile) */}
            {isVisible && (
                <div className="fixed inset-0 z-[110] hidden md:block pointer-events-auto">
                    {/* Dimmed Background */}
