                        ...
                        <div className="flex-1 overflow-y-auto p-8 space-y-4 custom-scrollbar-premium bg-gradient-to-b from-transparent to-black/20">
                            {payments.length === 0 ? (
                                <div className="rounded-[2.5rem] border border-dashed border-white/10 bg-white/5 p-16 text-center backdrop-blur-sm">
                                    <p className="text-sm font-bold uppercase tracking-widest text-muted-foreground/40">{categoryCopy.emptyState}</p>
                                </div>
                            ) : (
                                    ...
                                    >
                                        <div className="flex items-center gap-5 relative z-10">
                                            ...
                                            <div className="min-w-0">
                                                <h4 className="text-base font-bold text-white transition-colors group-hover:text-primary truncate">{payment.tenant}</h4>
                                                <p className="text-[11px] font-bold text-muted-foreground uppercase tracking-wider">{payment.unit}</p>
                                            </div>
                                        </div>
                                        
                                        <div className="text-right flex flex-col items-end relative z-10">
                                            <h4 className="mb-1 text-base font-bold text-white tracking-tight">PHP {payment.amount.toLocaleString()}</h4>
                                    ...
                                    {!isConfirmingAction ? (
                                        <>
                                            <div className="p-8 text-center pt-10">
                                                ...
                                                <h3 className="text-2xl font-bold text-white">{selectedActionPayment.tenant}</h3>
                                                <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-[0.3em] mt-1">{selectedActionPayment.unit}</p>
                                                ...
                                                <div className="mt-8 flex flex-col gap-2 rounded-3xl bg-white/[0.02] p-6 border border-white/5">
                                                    ...
                                                    <h4 className="text-4xl font-bold text-white tracking-tighter">PHP {selectedActionPayment.amount.toLocaleString()}</h4>
                                                </div>
                                            </div>
                                            ...
                                            <div className="grid gap-3 p-8 pt-0">
                                                ...
                                                >
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <span className="text-sm font-bold uppercase tracking-tight text-white">Record Settlement</span>
                                                    </div>
                                                ...
                                                <button 
                                                    ...
                                                    className="flex items-center justify-center rounded-2xl border border-white/5 bg-white/5 py-4 text-[11px] font-bold uppercase tracking-[0.4em] text-muted-foreground/60 transition-all hover:bg-white/10 hover:text-white"
                                                >
                                                    Dismiss
                                                </button>
                                            </div>
                                        ...
                                        <div className="p-8 text-center pt-10 animate-in slide-in-from-right-4 duration-300">
                                            ...
                                            <h3 className="text-2xl font-bold text-white tracking-tight">Double Check</h3>
                                            ...
                                            <div className="mt-10 flex flex-col gap-3">
                                                <button 
                                                    ...
                                                    className="w-full rounded-2xl bg-primary py-5 text-sm font-bold uppercase tracking-widest text-white shadow-[0_15px_30px_rgba(var(--primary-rgb),0.3)] transition-all hover:scale-[1.02] active:scale-95"
                                                >
                                                    Confirm Record
                                                </button>
                                                <button 
                                                    onClick={() => setIsConfirmingAction(false)}
                                                    className="w-full rounded-2xl border border-white/5 bg-white/5 py-4 text-[10px] font-bold uppercase tracking-widest text-muted-foreground/60 transition-all hover:bg-white/10 hover:text-white"
                                                >
                                                    Go Back
                                                </button>
                                            </div>
