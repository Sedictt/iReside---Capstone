                ...
                <div className="relative z-10 flex flex-col gap-8">
                    <div className="flex items-start justify-between gap-6">
                        <div className="space-y-4">
                            <div className={cn(
                                "inline-flex items-center gap-2 rounded-full border px-4 py-1.5 text-[10px] font-semibold uppercase tracking-[0.2em] shadow-sm", 
                                statusStyles[status]
                            )}>
                                <div className={cn(
                                    "size-2 rounded-full",
                            ...
                            <div>
                                ...
                                <h3 className="mt-3 text-3xl font-semibold tracking-tight text-foreground leading-tight">{headline}</h3>
                            </div>
                        </div>
                            ...
                            return (
                                ...
                                >
                                    <div className="relative z-10 flex items-start justify-between gap-3">
                                        <div>
                                            <p className="text-[10px] font-semibold uppercase tracking-[0.15em] opacity-70">{metric.label}</p>
