    ...
    return (
        <div className={cn(
            ...
            <div className="flex justify-between items-start z-20 relative">
                <div>
                    < p className="text-sm font-bold tracking-wider text-white/90 mb-1 uppercase drop-shadow-md">Best Performing Property</p>
            ...
            <div className="relative z-20 mt-auto">
                <div className="flex gap-8 backdrop-blur-sm bg-black/20 p-4 rounded-2xl border border-white/10 inline-flex">
                    <div>
                        <p className="text-xs font-semibold text-white/70 uppercase tracking-wide">Total Revenue</p>
                        <p className="text-2xl font-bold tracking-tight mt-0.5">{totalSales}</p>
                    </div>
                    <div>
                        <p className="text-xs font-semibold text-white/70 uppercase tracking-wide">Total Views</p>
