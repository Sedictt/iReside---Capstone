            ...
            <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-8">
                <div className="flex items-center gap-10">
                    <button
                        ...
                        className={cn(
                            "text-[10px] font-semibold uppercase tracking-[0.25em] transition-all flex items-center gap-3 pb-3 relative",
                ...
                <div className="relative group/select">
                    <select
                        ...
                        className="cursor-pointer appearance-none rounded-2xl border border-white/10 bg-card/80 py-2.5 pl-6 pr-8 text-[10px] font-semibold uppercase tracking-[0.15em] text-foreground transition-all hover:bg-card hover:ring-1 hover:ring-primary/20 focus:outline-none min-w-[150px]"
                    >
