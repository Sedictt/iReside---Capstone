                                        ...
                                        >
                                            ...
                                            <div className="grid flex-1 grid-cols-1 items-center gap-6 px-6 lg:grid-cols-[1fr_120px_180px] xl:grid-cols-[1fr_120px_120px_180px]">
                                                <div className="flex items-center gap-4 min-w-0">
                                                    <div className="relative size-12 shrink-0 rounded-full border-2 border-border bg-muted flex items-center justify-center font-black text-muted-foreground" style={{ backgroundColor: app.applicant.avatarBgColor || "" }}>
                                                ...
                                                <div className="rounded-2xl border border-amber-500/20 bg-amber-500/5 p-5 flex items-start gap-4">
                                                    ...
                                                    <div className="space-y-3">
                                                        ...
                                                        <ul className="space-y-1.5">
                                                            {missing.map((item) => (
                                                                <li key={item} className="flex items-center gap-2 text-[11px] font-black text-muted-foreground/80">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="rounded-[2.5rem] border border-border bg-background/50 p-8 space-y-8">
                                        <div className="flex items-center gap-6">
                                            <div className="relative size-20 rounded-full border-4 border-border shadow-xl flex items-center justify-center text-3xl font-black text-white" style={{ backgroundColor: selectedApp.applicant.avatarBgColor || "#171717" }}>
