...
export const UNIT_MAP_TOUR_STEPS: UnitMapTourStep[] = [
    {
        id: 1,
        title: "Step 1: Assign Units to Floors",
        description: "Organize your units across building levels. Drag units between floor lanes, or use 'Distribute Evenly' and 'Bulk Distribute' to allocate them automatically.",
        targetElementLabel: "Floor Lanes & Distribution Actions",
        tip: "Pro-tip: If you have unassigned units, drag them into the target floor lane or click Distribute Evenly.",
    },
    {
        id: 2,
        title: "Step 2: Add & Manage Floor Levels",
        description: "Need additional levels or basements? Click '+ Add Floor' to create more stories. You can also renumber units or rename floors to match your property.",
    ...
    {
        id: 3,
        title: "Step 3: Generate Interactive Unit Map",
