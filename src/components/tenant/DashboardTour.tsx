...
import { TENANT_DASHBOARD_TOUR_STEPS as TOUR_STEPS } from "@/lib/product-tour";
...
export function DashboardTour() {
    ...
    useEffect(() => {
        ...
        const hasSeenTour = localStorage.getItem("ireside_dashboard_tour_completed");
        if (!hasSeenTour) {
    ...
    const completeTour = () => {
        setIsVisible(false);
        localStorage.setItem("ireside_dashboard_tour_completed", "true");
    };
