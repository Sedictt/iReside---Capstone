                            ...
                            <div className="mt-auto flex items-center justify-between pt-6 border-t border-border/50">
                                <div className="flex items-center gap-5">
                                    ...
                                    <div className="flex flex-col gap-0.5">
                                        ...
                                        <div className="flex items-center gap-2 text-[11px] font-black text-emerald-500">
                                ...
                                <div className="flex flex-col items-end gap-0.5">
                                    ...
                                    <div className="flex items-baseline gap-1">
                                        ...
                                        {amenity.price_per_unit > 0 && <span className="text-[10px] font-black text-muted-foreground lowercase tracking-normal">/{amenity.unit_type}</span>}
                                    </div>
                                </div>
                            </div>
                        </div>
