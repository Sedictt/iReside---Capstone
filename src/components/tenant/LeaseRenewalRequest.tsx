        ...
        <>
            {variant === "sidebar" ? (
                ...
                <div className={cn(
                    ...
                    <div className="relative z-10">
                        ...
                        <button
                            ...
                            disabled={!isEligible}
                            className={cn(
                                "w-full py-4 rounded-2xl font-bold uppercase tracking-widest text-[10px] transition-all border shadow-sm",
                                isEligible 
                ...
                >
                    ...
                    <span className="text-[10px] font-bold text-center group-hover:text-primary transition-colors uppercase tracking-widest">Renew Lease</span>
                </button>
                            ...
                            {submitted ? (
                                <div className="text-center space-y-6 animate-in zoom-in-95 duration-500">
                                    ...
                                    <div className="space-y-2">
                                        <h4 className="text-2xl font-bold text-foreground">Request Sent</h4>
                                        <p className="text-sm text-muted-foreground max-w-[280px] mx-auto leading-relaxed">
                                            Your request to renew for **{selectedTerm} months** has been sent to your landlord for review.
                                        </p>
                                    </div>
                                    <div className="inline-flex items-center gap-2 text-[10px] font-bold text-primary uppercase tracking-widest bg-primary/5 px-4 py-2 rounded-full border border-primary/10">
                                ...
                                <div className="w-full animate-in slide-in-from-right-4 duration-500 space-y-6">
                                    <div className="bg-primary/5 rounded-[2rem] p-6 border border-primary/10 relative overflow-hidden">
                                        ...
                                        <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-primary mb-4">Official Property Memo</p>
                                    ...
                                    <div className="space-y-4">
                                        <h4 className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground border-b border-border pb-2">Updated Terms</h4>
                                        <div className="grid grid-cols-1 gap-3">
                                            <div className="flex items-center justify-between p-4 bg-muted/30 rounded-2xl border border-border">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <span className="text-xs font-bold text-foreground uppercase tracking-widest">Expected Rent Adjustment</span>
                                                </div>
                                            ...
                                            {renewalSettings?.new_rules && renewalSettings.new_rules.length > 0 && (
                                                <div className="space-y-3 pt-2">
                                                    <p className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">New Rules & Clauses</p>
                                ...
                                <div className="w-full animate-in slide-in-from-right-4 duration-500 space-y-6">
                                    <div className="text-center space-y-2 mb-8">
                                        <h4 className="text-2xl font-bold text-foreground">Select Your Term</h4>
                                        ...
                                        {(renewalSettings?.renewal_terms?.length ? renewalSettings.renewal_terms : DEFAULT_RENEWAL_TERMS).map((opt) => (
                                            ...
                                            >
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        <p className="text-sm font-bold text-foreground">{opt.months} Months</p>
                                                ...
                                                <div className="text-right">
                                                    ...
                                                    {opt.is_popular && <span className="text-[8px] font-bold text-white bg-primary px-2 py-0.5 rounded-full uppercase tracking-tighter">Popular</span>}
                                                </div>
                                            </button>
                                        ))}
                                    </div>
                            ...
                            <div className="p-6 border-t border-border bg-background/50 flex gap-3">
                                {step === "disclosure" ? (
                                    <button
                                        ...
                                        className="w-full py-4 rounded-2xl bg-primary text-white font-bold uppercase tracking-widest text-[10px] hover:bg-primary-dark transition-all flex items-center justify-center gap-2 shadow-lg shadow-primary/20 disabled:opacity-50"
                                    >
                                    ...
                                    <>
                                        <button
                                            ...
                                            className="px-6 py-4 rounded-2xl border border-border text-muted-foreground font-bold uppercase tracking-widest text-[10px] hover:bg-muted transition-all flex-1"
                                        >
                                            Back
                                        </button>
                                        <button
                                            ...
                                            disabled={submitting}
                                            className="px-6 py-4 rounded-2xl bg-primary text-white font-bold uppercase tracking-widest text-[10px] hover:bg-primary-dark transition-all flex-[2] items-center justify-center gap-2 shadow-lg shadow-primary/20 disabled:opacity-50"
                                        >
