    ...
    if (activeChat) {
        ...
        return (
            <div className="fixed inset-0 z-[120] bg-background flex flex-col max-w-md mx-auto">
                {/* Chat Top Bar */}
                <div className="px-4 py-3 border-b border-white/10 flex items-center justify-between bg-card/90 backdrop-blur-md">
                    <div className="flex items-center gap-3">
                        <button
                            onClick={() => setActiveChat(null)}
                            className="p-1.5 -ml-1.5 rounded-full hover:bg-white/10 text-muted-foreground hover:text-foreground"
                            aria-label="Back to conversations"
                        >
                            <ArrowLeft className="size-5" />
                        </button>
                        <div className="relative size-9 rounded-full overflow-hidden border border-white/10 bg-muted">
                                    ...
                                    <div
                                        className={cn(
                                            ...
                                            isMine
                                                ...
                                                : 'bg-card border border-white/10 text-foreground rounded-bl-xs'
                                        )}
                                    >
                                        <p>{msg.content}</p>
                                    </div>
                ...
                <form
                    ...
                    className="p-3 border-t border-white/10 bg-card/90 backdrop-blur-md flex items-center gap-2"
                >
                    <input
                        type="text"
                        ...
                        className="flex-1 bg-background/80 border border-white/10 rounded-xl px-3.5 py-2.5 text-xs text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary"
                    />
                    <button
                        type="submit"
        ...
        <div className="flex flex-col gap-3.5 pb-6">
                            ...
                            filteredConversations.map((conv) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className="w-full p-3 rounded-2xl border border-white/10 bg-card/80 hover:bg-card active:scale-[0.98] transition-all flex items-center gap-3 text-left"
                                    >
                                        <div className="relative size-11 rounded-full overflow-hidden border border-white/10 bg-muted shrink-0">
            ...
            {isBroadcastModalOpen && (
                <div className="fixed inset-0 z-[125] bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in duration-200">
                    <div className="w-full max-w-sm rounded-[1.75rem] border border-white/10 bg-card/95 backdrop-blur-xl p-5 shadow-2xl">
                            ...
                            <form onSubmit={handlePublishBroadcast} className="flex flex-col gap-3">
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full bg-background border border-white/10 rounded-xl px-3 py-2 text-xs text-foreground focus:outline-none focus:ring-1 focus:ring-primary"
                                    >
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                        className="w-full bg-background border border-white/10 rounded-xl px-3 py-2 text-xs text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary"
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        required
                                        className="w-full bg-background border border-white/10 rounded-xl px-3 py-2 text-xs text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary resize-none"
                                    />
                                </div>
