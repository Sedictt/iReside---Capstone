                ...
                {loading ? (
                    ...
                    filteredInvoices.map((invoice) => {
                        ...
                        return (
                            <div 
                                key={invoice.id} 
                                className="rounded-2xl border border-slate-300 dark:border-white/15 bg-white dark:bg-card/80 p-3.5 shadow-xs flex flex-col gap-2.5"
                            >
                                ...
                                {hasProof && invoice.paymentProofUrl && (
                                    <div className="mt-1 p-2 rounded-xl bg-slate-50 dark:bg-background/60 border border-slate-200 dark:border-white/10 flex items-center justify-between gap-3">
                                        <div className="flex items-center gap-2 min-w-0">
                                            <div className="relative size-12 rounded-lg overflow-hidden border border-slate-300 dark:border-white/15 bg-black/40 shrink-0">
                                                <Image 
