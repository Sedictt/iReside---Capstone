            ...
            >
                ...
                <div className="shrink-0 border-b border-white/5 bg-surface-1/50 px-8 py-6">
                    <div className="flex items-center justify-between">
                        <div className="space-y-1">
                            <h2 className="text-xl font-bold text-text-high tracking-tight">Resolve Payment Issue</h2>
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar-premium p-8 space-y-8">
                    ...
                    <div className={cn(
                        ...
                        <div className="space-y-1">
                            <h3 className="text-lg font-bold text-text-high">
                        ...
                        {issueType === "insufficient_amount" && (
                            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                <div className="rounded-2xl border border-white/10 bg-surface-1 p-6 space-y-4">
                                    <div className="flex items-center justify-between">
                                        <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-text-disabled">Remaining Balance</p>
                                        <p className="text-xl font-bold text-amber-400">{formatPhpCurrency(shortfall)}</p>
                                    </div>
                                ...
                                <button 
                                    ...
                                    className="w-full h-16 rounded-[1.5rem] bg-primary text-primary-foreground font-bold uppercase tracking-widest text-xs flex items-center justify-center gap-3 shadow-2xl shadow-primary/20 hover:-translate-y-1 transition-all active:scale-95"
                                >
                        ...
                        {issueType === "excessive_amount" && (
                            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                <div className="rounded-2xl border border-emerald-500/10 bg-emerald-500/5 p-6 space-y-4">
                                    <div className="flex items-center justify-between">
                                        <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-emerald-500">Excess Amount</p>
                                        <p className="text-xl font-bold text-emerald-500">{formatPhpCurrency(Math.abs(shortfall))}</p>
                                    </div>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    >
                                        ...
                                        <span className="text-[10px] font-bold uppercase tracking-widest text-center">Credit to Next Bill</span>
                                    </button>
                                    <button 
                                    ...
                                    >
                                        ...
                                        <span className="text-[10px] font-bold uppercase tracking-widest text-center">Request Refund</span>
                                    </button>
                                </div>
                                ...
                                {excessAction === "refund" && (
                                    <div className="space-y-4 p-6 rounded-2xl border border-white/5 bg-surface-1 animate-in zoom-in-95 duration-300">
                                        <div className="space-y-2">
                                            <p className="text-[10px] font-bold uppercase tracking-widest text-text-disabled">GCash Number</p>
                                            <input 
                                                type="text"
                                                value={gcashNumber}
                                                onChange={(e) => setGcashNumber(e.target.value)}
                                                placeholder="09XX XXX XXXX"
                                                className="w-full rounded-xl border border-white/10 bg-surface-2 px-4 py-3 text-sm font-bold text-text-high outline-none focus:border-primary/50 transition-all"
                                            />
                                        </div>
                                        <div className="space-y-2">
                                            <p className="text-[10px] font-bold uppercase tracking-widest text-text-disabled">Or Upload QR Code</p>
                                ...
                                <button 
                                    ...
                                    className="w-full h-16 rounded-[1.5rem] bg-primary text-primary-foreground font-bold uppercase tracking-widest text-xs flex items-center justify-center gap-3 shadow-2xl shadow-primary/20 hover:-translate-y-1 transition-all active:scale-95 disabled:opacity-50 disabled:translate-y-0"
                                >
                ...
                <div className="shrink-0 border-t border-white/5 bg-surface-1/50 px-8 py-6 flex items-center justify-center">
                    <button className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-text-disabled hover:text-primary transition-colors group">
