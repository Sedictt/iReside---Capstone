...
directories = [
    r"c:\Users\JV\Documents\GitHub\iReside\src\app\landlord\move-out",
    r"c:\Users\JV\Documents\GitHub\iReside\src\components\landlord\move-out",
]
...
print("Applied Neumorphism to move-out successfully!")
