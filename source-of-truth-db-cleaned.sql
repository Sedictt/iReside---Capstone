...
CREATE OR REPLACE FUNCTION "public"."check_renewal_windows"() RETURNS "void"
...
ALTER FUNCTION "public"."check_renewal_windows"() OWNER TO "postgres";
...
ALTER TABLE "public"."consultation_documents" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."expenses" (
    ...
    CONSTRAINT "expenses_category_check" CHECK (("category" = ANY (ARRAY['maintenance'::"text", 'utilities'::"text", 'taxes'::"text", 'other'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."landlord_applications" (
    ...
    "onboarding_token_expires_at" timestamp without time zone,
    "onboarding_completed_at" timestamp without time zone,
    "business_permit_url" "text",
    "business_permit_card_url" "text",
...
CREATE TABLE IF NOT EXISTS "public"."landlord_product_tour_events" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "landlord_id" "uuid" NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "landlord_product_tour_events_event_type_check" CHECK (("event_type" = ANY (ARRAY['tour_started'::"text", 'tour_step_completed'::"text", 'tour_skipped'::"text", 'tour_completed'::"text", 'tour_replayed'::"text", 'tour_failed'::"text"]))),
    CONSTRAINT "landlord_product_tour_events_trigger_source_check" CHECK (("trigger_source" = ANY (ARRAY['onboarding_handoff'::"text", 'auto_portal_entry'::"text", 'manual'::"text", 'resume'::"text", 'replay'::"text", 'step_progression'::"text", 'fallback'::"text", 'system'::"text"])))
);


ALTER TABLE "public"."landlord_product_tour_events" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."landlord_product_tour_states" (
    "landlord_id" "uuid" NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "landlord_product_tour_states_current_step_index_check" CHECK (("current_step_index" >= 0)),
    CONSTRAINT "landlord_product_tour_states_replay_count_check" CHECK (("replay_count" >= 0)),
    CONSTRAINT "landlord_product_tour_states_status_check" CHECK (("status" = ANY (ARRAY['not_started'::"text", 'in_progress'::"text", 'skipped'::"text", 'completed'::"text"])))
);


ALTER TABLE "public"."landlord_product_tour_states" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."profiles" (
    ...
    "avatar_bg_color" "text" DEFAULT '#171717'::"text",
    "bio" "text",
    "website" "text",
    "address" "text",
    "cover_url" "text",
...
CREATE TABLE IF NOT EXISTS "public"."properties" (
    ...
    "map_decorations" "jsonb" DEFAULT '{}'::"jsonb",
    "total_units" integer DEFAULT 1,
    "total_floors" integer DEFAULT 1,
    "base_rent_amount" numeric(10,2) DEFAULT 0,
    "renewal_window_days" integer DEFAULT 90 NOT NULL,
    "renewal_settings" "jsonb" DEFAULT '{"new_rules": [], "is_enabled": true, "landlord_memo": "", "adjustment_type": "percentage", "base_rent_adjustment": 0}'::"jsonb"
);
...
CREATE TABLE IF NOT EXISTS "public"."property_floor_configs" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "property_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."property_floor_configs" OWNER TO "postgres";
...
ALTER TABLE "public"."renewal_requests" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."tenant_intake_invites" (
    ...
    CONSTRAINT "tenant_intake_invites_application_type_check" CHECK (("application_type" = ANY (ARRAY['online'::"text", 'face_to_face'::"text", 'existing_tenant'::"text"]))),
...
CREATE TABLE IF NOT EXISTS "public"."unit_map_positions" (
    "unit_id" "uuid" NOT NULL,
    "floor_key" "text" NOT NULL,
    "x" integer DEFAULT 0 NOT NULL,
    "y" integer DEFAULT 0 NOT NULL,
    "w" integer DEFAULT 200 NOT NULL,
    "h" integer DEFAULT 140 NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL
);


ALTER TABLE "public"."unit_map_positions" OWNER TO "postgres";
...
ALTER VIEW "public"."user_sessions" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."consultation_documents"
    ADD CONSTRAINT "consultation_documents_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."landlord_product_tour_events"
    ADD CONSTRAINT "landlord_product_tour_events_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."landlord_product_tour_states"
    ADD CONSTRAINT "landlord_product_tour_states_pkey" PRIMARY KEY ("landlord_id");
...
ALTER TABLE ONLY "public"."property_floor_configs"
    ADD CONSTRAINT "property_floor_configs_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."renewal_requests"
    ADD CONSTRAINT "renewal_requests_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."unit_map_positions"
    ADD CONSTRAINT "unit_map_positions_pkey" PRIMARY KEY ("unit_id");
...
ALTER TABLE ONLY "public"."property_floor_configs"
    ADD CONSTRAINT "uq_property_floor" UNIQUE ("property_id", "floor_number");



ALTER TABLE ONLY "public"."property_floor_configs"
    ADD CONSTRAINT "uq_property_floor_key" UNIQUE ("property_id", "floor_key");
...
CREATE INDEX "idx_floor_configs_property" ON "public"."property_floor_configs" USING "btree" ("property_id");
...
CREATE INDEX "idx_landlord_product_tour_events_landlord_created" ON "public"."landlord_product_tour_events" USING "btree" ("landlord_id", "created_at" DESC);



CREATE INDEX "idx_landlord_product_tour_states_last_event" ON "public"."landlord_product_tour_states" USING "btree" ("last_event_at" DESC) WHERE ("last_event_at" IS NOT NULL);



CREATE INDEX "idx_landlord_product_tour_states_status" ON "public"."landlord_product_tour_states" USING "btree" ("status", "updated_at" DESC);
...
CREATE INDEX "idx_renewal_requests_created_at" ON "public"."renewal_requests" USING "btree" ("created_at" DESC);



CREATE INDEX "idx_renewal_requests_landlord_id" ON "public"."renewal_requests" USING "btree" ("landlord_id");



CREATE INDEX "idx_renewal_requests_lease_id" ON "public"."renewal_requests" USING "btree" ("current_lease_id");



CREATE INDEX "idx_renewal_requests_status" ON "public"."renewal_requests" USING "btree" ("status");



CREATE INDEX "idx_renewal_requests_tenant_id" ON "public"."renewal_requests" USING "btree" ("tenant_id");
...
CREATE INDEX "idx_unit_map_positions_floor" ON "public"."unit_map_positions" USING "btree" ("floor_key");
...
CREATE UNIQUE INDEX "unique_pending_renewal" ON "public"."renewal_requests" USING "btree" ("current_lease_id") WHERE ("status" = 'pending'::"public"."renewal_status");
...
CREATE OR REPLACE TRIGGER "trg_floor_configs_updated_at" BEFORE UPDATE ON "public"."property_floor_configs" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at"();



CREATE OR REPLACE TRIGGER "trg_landlord_product_tour_states_updated_at" BEFORE UPDATE ON "public"."landlord_product_tour_states" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at"();
...
CREATE OR REPLACE TRIGGER "trg_unit_map_positions_updated_at" BEFORE UPDATE ON "public"."unit_map_positions" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at"();
...
ALTER TABLE ONLY "public"."amenities"
    ADD CONSTRAINT "amenities_landlord_id_fkey" FOREIGN KEY ("landlord_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."amenity_bookings"
    ADD CONSTRAINT "amenity_bookings_amenity_id_fkey" FOREIGN KEY ("amenity_id") REFERENCES "public"."amenities"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."amenity_bookings"
    ADD CONSTRAINT "amenity_bookings_landlord_id_fkey" FOREIGN KEY ("landlord_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."amenity_bookings"
    ADD CONSTRAINT "amenity_bookings_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."expenses"
    ADD CONSTRAINT "expenses_landlord_id_fkey" FOREIGN KEY ("landlord_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."landlord_product_tour_events"
    ADD CONSTRAINT "landlord_product_tour_events_landlord_id_fkey" FOREIGN KEY ("landlord_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."landlord_product_tour_states"
    ADD CONSTRAINT "landlord_product_tour_states_landlord_id_fkey" FOREIGN KEY ("landlord_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."property_floor_configs"
    ADD CONSTRAINT "property_floor_configs_property_id_fkey" FOREIGN KEY ("property_id") REFERENCES "public"."properties"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."renewal_requests"
    ADD CONSTRAINT "renewal_requests_current_lease_id_fkey" FOREIGN KEY ("current_lease_id") REFERENCES "public"."leases"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."renewal_requests"
    ADD CONSTRAINT "renewal_requests_landlord_id_fkey" FOREIGN KEY ("landlord_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."renewal_requests"
    ADD CONSTRAINT "renewal_requests_new_lease_id_fkey" FOREIGN KEY ("new_lease_id") REFERENCES "public"."leases"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."renewal_requests"
    ADD CONSTRAINT "renewal_requests_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."unit_map_positions"
    ADD CONSTRAINT "unit_map_positions_unit_id_fkey" FOREIGN KEY ("unit_id") REFERENCES "public"."units"("id") ON DELETE CASCADE;
...
CREATE POLICY "Admins have full access to consultation_documents" ON "public"."consultation_documents" USING ((("auth"."jwt"() ->> 'email'::"text") IN ( SELECT "profiles"."email"
   FROM "public"."profiles"
...
CREATE POLICY "Floor configs viewable by everyone" ON "public"."property_floor_configs" FOR SELECT USING (true);
...
CREATE POLICY "Landlords can create own product tour state" ON "public"."landlord_product_tour_states" FOR INSERT WITH CHECK (("auth"."uid"() = "landlord_id"));
...
CREATE POLICY "Landlords can insert own product tour events" ON "public"."landlord_product_tour_events" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "landlord_id"));
...
CREATE POLICY "Landlords can manage bookings for their amenities" ON "public"."amenity_bookings" USING (("auth"."uid"() = "landlord_id"));
...
CREATE POLICY "Landlords can manage own floor configs" ON "public"."property_floor_configs" USING ((EXISTS ( SELECT 1
   FROM "public"."properties"
  WHERE (("properties"."id" = "property_floor_configs"."property_id") AND ("properties"."landlord_id" = "auth"."uid"()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."properties"
  WHERE (("properties"."id" = "property_floor_configs"."property_id") AND ("properties"."landlord_id" = "auth"."uid"())))));
...
CREATE POLICY "Landlords can manage their own amenities" ON "public"."amenities" USING (("auth"."uid"() = "landlord_id"));



CREATE POLICY "Landlords can manage their own expenses" ON "public"."expenses" USING (("auth"."uid"() = "landlord_id"));



CREATE POLICY "Landlords can manage unit map positions" ON "public"."unit_map_positions" USING ((EXISTS ( SELECT 1
   FROM ("public"."units" "u"
     JOIN "public"."properties" "p" ON (("p"."id" = "u"."property_id")))
  WHERE (("u"."id" = "unit_map_positions"."unit_id") AND ("p"."landlord_id" = "auth"."uid"()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM ("public"."units" "u"
     JOIN "public"."properties" "p" ON (("p"."id" = "u"."property_id")))
  WHERE (("u"."id" = "unit_map_positions"."unit_id") AND ("p"."landlord_id" = "auth"."uid"())))));
...
CREATE POLICY "Landlords can update own product tour state" ON "public"."landlord_product_tour_states" FOR UPDATE USING (("auth"."uid"() = "landlord_id")) WITH CHECK (("auth"."uid"() = "landlord_id"));
...
CREATE POLICY "Landlords can view own product tour events" ON "public"."landlord_product_tour_events" FOR SELECT USING (("auth"."uid"() = "landlord_id"));



CREATE POLICY "Landlords can view own product tour state" ON "public"."landlord_product_tour_states" FOR SELECT USING (("auth"."uid"() = "landlord_id"));
...
CREATE POLICY "Public can read documents for signing" ON "public"."consultation_documents" FOR SELECT USING ((("status" = 'pending'::"text") OR ("status" = 'signed'::"text")));



CREATE POLICY "Public can update documents to sign them" ON "public"."consultation_documents" FOR UPDATE USING (("status" = 'pending'::"text"));
...
CREATE POLICY "Tenants can create bookings" ON "public"."amenity_bookings" FOR INSERT WITH CHECK (("auth"."uid"() = "tenant_id"));
...
CREATE POLICY "Tenants can update own move-out requests" ON "public"."move_out_requests" FOR UPDATE USING (("tenant_id" = "auth"."uid"())) WITH CHECK (("tenant_id" = "auth"."uid"()));
...
CREATE POLICY "Tenants can view their own bookings" ON "public"."amenity_bookings" FOR SELECT USING (("auth"."uid"() = "tenant_id"));
...
CREATE POLICY "Unit map positions viewable by everyone" ON "public"."unit_map_positions" FOR SELECT USING (true);
...
ALTER TABLE "public"."landlord_product_tour_events" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."landlord_product_tour_states" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."property_floor_configs" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."unit_map_positions" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON FUNCTION "public"."check_renewal_windows"() TO "anon";
GRANT ALL ON FUNCTION "public"."check_renewal_windows"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."check_renewal_windows"() TO "service_role";
...
GRANT ALL ON TABLE "public"."consultation_documents" TO "anon";
GRANT ALL ON TABLE "public"."consultation_documents" TO "authenticated";
...
GRANT ALL ON TABLE "public"."landlord_product_tour_events" TO "anon";
GRANT ALL ON TABLE "public"."landlord_product_tour_events" TO "authenticated";
GRANT ALL ON TABLE "public"."landlord_product_tour_events" TO "service_role";



GRANT ALL ON TABLE "public"."landlord_product_tour_states" TO "anon";
GRANT ALL ON TABLE "public"."landlord_product_tour_states" TO "authenticated";
GRANT ALL ON TABLE "public"."landlord_product_tour_states" TO "service_role";
...
GRANT ALL ON TABLE "public"."property_floor_configs" TO "anon";
GRANT ALL ON TABLE "public"."property_floor_configs" TO "authenticated";
GRANT ALL ON TABLE "public"."property_floor_configs" TO "service_role";



GRANT ALL ON TABLE "public"."renewal_requests" TO "anon";
GRANT ALL ON TABLE "public"."renewal_requests" TO "authenticated";
GRANT ALL ON TABLE "public"."renewal_requests" TO "service_role";
...
GRANT ALL ON TABLE "public"."unit_map_positions" TO "anon";
GRANT ALL ON TABLE "public"."unit_map_positions" TO "authenticated";
GRANT ALL ON TABLE "public"."unit_map_positions" TO "service_role";
