...
## Corpus Check
- 926 files · ~6,903,359 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7663 nodes · 19124 edges · 568 communities (378 shown, 190 thin omitted)
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 4453 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `165ff815`
...
Cohesion: 0.03
Nodes (151): _3DBase, InlineFont, PhoneticProperties, PhoneticText, Font for inline text because, yes what you need are different objects with the s, RichText, Text, _3DBase (+143 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (112): Chartsheet, ChartsheetProperties, ChartsheetProtection, WebPublishItem, WebPublishItems, DrawingHF, SheetBackgroundPicture, ChartsheetView (+104 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (98): Alias, HexBinary, Relation, MultiSequence, MultiSequencePart, NestedSequence, Allow a multisequence to be built up from parts      Excluded from the instance, Wrap a sequence in an containing object (+90 more)
...
Cohesion: 0.06
Nodes (78): Bool, title_maker(), ColorChoice, Convertible, EmptyTag, NestedValue, Boolean if a tag exists or not., Nested tag storing the value on the 'val' attribute (+70 more)
...
Cohesion: 0.04
Nodes (59): ExtensionList, Percentage, Connection, ConnectorLocking, ConnectorNonVisual, ConnectorShape, NonVisualConnectorProperties, ShapeMeta (+51 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (74): Loading(), ConsultationDashboard(), Document, ConsultationTool(), ConsultationToolProps, DigitalSigner, ConsultationTool, SignPage() (+66 more)
...
Cohesion: 0.07
Nodes (70): completeSchema, POST(), addDays(), clampStepIndex(), completeTenantProductTour(), createTenantProductTourState(), ensureTenantProductTourState(), evaluateTenantProductTourEligibility() (+62 more)

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (46): ensureBucket(), POST(), sanitizeFileName(), ensureBucket(), POST(), sanitizeFileName(), finalizeLease(), FinalizeLeaseParams (+38 more)

### Community 12 - "Community 12"
Cohesion: 0.07
Nodes (55): GET(), AuditEvent, extractIpAddress(), extractUserAgent(), logAuditEvent(), sendLeaseActivatedNotification(), sendSigningLinkEmail(), sendTenantSignedNotification() (+47 more)
...
Cohesion: 0.07
Nodes (45): AdminSidebar(), NAV_ITEMS, AdminLayout(), ThemeProvider(), AuthContext, AuthContextValue, AuthProvider(), AuthState (+37 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (21): ArrayFormula, DataTableFormula, Hyperlink, HyperlinkList, Break, ColBreak, RowBreak, Make sure a row contains always the same number of cells or values (+13 more)
...
Cohesion: 0.06
Nodes (36): VALUES, WHO_IT_SERVES, geistMono, geistSans, metadata, RootLayout(), HOW_IT_WORKS, IRIS_WORKFLOWS (+28 more)
...
Cohesion: 0.11
Nodes (37): upsertPaymentReceipt(), computeAmountTag(), DbClient, expireInPersonIntents(), getInPersonIntentExpiry(), getOrCreateDirectConversation(), insertPaymentAuditEvent(), MessageOptions (+29 more)
...
Cohesion: 0.12
Nodes (8): PlotArea(), PageMargins, Identical to openpyxl.worksheet.page.Pagemargins but element names are different, cols(), DummyWorksheet, Normalise cell range references, Reference, rows()
...
Cohesion: 0.08
Nodes (42): DELETE(), UpdateListingBody, getLandlordProperties(), getPropertyById(), Amenity, AmenityBooking, Application, ApplicationSource (+34 more)

### Community 33 - "Community 33"
Cohesion: 0.05
Nodes (27): read_chart(), Max, Min, Values must be less than a `max` value, Values must be greater than a `min` value, Return a new range with cells common to this range and *other*          :type ot, Return the minimal superset of this range and *other*. This new range         wi, collapse_cell_addresses() (+19 more)
...
Cohesion: 0.07
Nodes (13): AuthorList, CommentRecord, CommentSheet, from_comments(), Properties, Create the VML for comments, Comment, Create a detached copy of this comment. (+5 more)

### Community 43 - "Community 43"
Cohesion: 0.06
Nodes (16): CustomChartsheetView, CustomChartsheetViews, dict, DefinedNameDict, Utility class for storing defined names.     Allows access by name and separatio, Add names without worrying about key and name matching., PageMargins, PrintOptions (+8 more)

### Community 44 - "Community 44"
Cohesion: 0.1
Nodes (23): BannerNotification, DashboardBanner(), DashboardBannerProps, formatTimeAgo(), SearchResult, SearchResultType, LandlordNavbar(), NAV_ITEMS (+15 more)

### Community 45 - "Community 45"
Cohesion: 0.1
Nodes (28): ActorProfile, ApplicationResponse, ApplicationRow, AuditRow, buildComplianceChecklist(), ComplianceChecklist, DEFAULT_COMPLIANCE_CHECKLIST, extractMissingColumn() (+20 more)
...
Cohesion: 0.08
Nodes (17): ColorList, builtin_format_code(), builtin_format_id(), is_timedelta_format(), NumberFormat, NumberFormatList, Return one of the standard format codes by index., Return the id of a standard style. (+9 more)
...
Cohesion: 0.08
Nodes (14): DocumentProperties, High-level properties of the document.     Defined in ECMA-376 Par2 Annex D, Find all sheets in the workbook and return the link to the source file., Bind defined names and other definitions to worksheets or the workbook, WorkbookParser, Create a worksheet (at an optional index).          :param title: optional title, Add an worksheet (at an optional index)., Returns a worksheet by its name.          :param name: the name of the worksheet (+6 more)
...
Cohesion: 0.09
Nodes (5): _convert(), Length, MatchPattern, Values must match a regex pattern, Check value is of or can be converted to expected type.
...
Cohesion: 0.12
Nodes (7): Sequence, Border options for use in styles.     Caution: if you do not specify a border_st, Side, _assign_position(), Automatically assign positions if a list of colours is provided.      It is not, Stop, StopList
...
Cohesion: 0.12
Nodes (9): DefinedName, ExternalReference, create_named_range(), get_active_sheet(), Write the core workbook xml., Write the workbook relationships xml., Write the package relationships, Return the index of the active sheet.     If the sheet set to active is hidden r (+1 more)
...
Cohesion: 0.12
Nodes (6): Alignment, Alignment options for use in styles., ArrayDescriptor, CellStyleList, Protection, Protection options for use in styles.

### Community 98 - "Community 98"
Cohesion: 0.11
Nodes (9): defaultdict, Add to zipfile and update manifest, Write the relevant child objects and add links, Map fields to associated conditional formats by priority, Return a dictionary of format objects keyed by (field id and format property)., Group formats by field index and priority.         Sorted to match sorting and g, DefinedNameList, Break names down into sheet locals and globals (+1 more)
...
Cohesion: 0.19
Nodes (15): LeaseStatusBadgeProps, STATUS_STYLES, GET(), isNonEmptyString(), logOptionalQueryFailure(), OptionalTenantStateClient, resolvePaymentStatus(), resolveTenantStatus() (+7 more)
...
## Knowledge Gaps
- **1913 isolated node(s):** `supabase`, `supabase`, `supabase`, `supabase`, `fs` (+1908 more)
...
- **Why does `Serialisable` connect `Community 1` to `Community 0`, `Community 2`, `Community 4`, `Community 7`, `Community 16`, `Community 147`, `Community 21`, `Community 25`, `Community 28`, `Community 29`, `Community 158`, `Community 287`, `Community 160`, `Community 33`, `Community 159`, `Community 42`, `Community 43`, `Community 52`, `Community 53`, `Community 54`, `Community 57`, `Community 58`, `Community 59`, `Community 63`, `Community 200`, `Community 79`, `Community 84`, `Community 85`, `Community 88`, `Community 90`, `Community 95`, `Community 97`, `Community 98`, `Community 104`, `Community 110`, `Community 119`?**
  _High betweenness centrality (0.156) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 2` to `Community 1`, `Community 5`, `Community 6`, `Community 9`, `Community 10`, `Community 11`, `Community 142`, `Community 17`, `Community 20`, `Community 24`, `Community 27`, `Community 155`, `Community 30`, `Community 35`, `Community 38`, `Community 170`, `Community 171`, `Community 172`, `Community 45`, `Community 62`, `Community 67`, `Community 93`, `Community 122`, `Community 123`, `Community 124`?**
  _High betweenness centrality (0.122) - this node is a cross-community bridge._
- **Why does `Boolean` connect `Community 2` to `Community 1`, `Community 197`, `Community 198`, `Community 38`, `Community 102`, `Community 9`, `Community 6`, `Community 11`, `Community 44`, `Community 45`, `Community 10`, `Community 14`, `Community 17`, `Community 20`, `Community 24`, `Community 123`, `Community 30`?**
