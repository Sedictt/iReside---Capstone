...
## Corpus Check
- 988 files · ~7,163,322 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9239 nodes · 21149 edges · 700 communities (499 shown, 201 thin omitted)
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 4458 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f6f381a3`
...
## Communities (700 total, 201 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (148): _3DBase, InlineFont, PhoneticProperties, PhoneticText, Font for inline text because, yes what you need are different objects with the s, RichText, Text, _3DBase (+140 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (111): Alias, HexBinary, Relation, MultiSequence, MultiSequencePart, NestedSequence, Allow a multisequence to be built up from parts      Excluded from the instance, Wrap a sequence in an containing object (+103 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (94): Bool, title_maker(), Convertible, EmptyTag, NestedValue, Boolean if a tag exists or not., Nested tag storing the value on the 'val' attribute, ColorChoice (+86 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (64): ActionBody, getStateForAction(), InquiryAction, isValidAction(), MessageUserAction, PUT(), RouteParams, GET() (+56 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (80): CommentRecord, Properties, ExtensionList, Percentage, Objects can serialise to XML their attributes and child objects.     The followi, Serialisable, Connection, ConnectorLocking (+72 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (102): ChatUser, ContactCard(), ContactCardProps, ContactsSidebar(), DEFAULT_CHAT_STATE, EMPTY_ARRAY, EMPTY_OBJECT, formatConversationTimestamp() (+94 more)
...
Cohesion: 0.04
Nodes (66): generateOTP(), GET(), POST(), ensureBucket(), POST(), sanitizeFileName(), ensureBucket(), POST() (+58 more)
...
Cohesion: 0.05
Nodes (61): ConsultationDashboard(), Document, ConsultationTool(), ConsultationToolProps, DigitalSigner, ConsultationTool, SignPage(), BusinessPermitCard() (+53 more)
...
Cohesion: 0.03
Nodes (42): Alias, Aliases can be used when either the desired attribute name is not allowed     or, CellRange, Extension, Size in hundredths of points.     In theory other units of measurement can be us, TextPoint, A sequence of primitive types that are stored as a single attribute.     "val" i, ValueSequence (+34 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (72): advancePaymentSchema, POST(), ActiveLeaseWorkspaceRow, AppSupabaseClient, BillingLeaseRow, buildInvoiceListItem(), createAdvancePayment(), createMultiMonthAdvancePayment() (+64 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (73): GET(), openai, POST(), DELETE(), UpdateListingBody, formatContextForAI(), getTenantContext(), getLandlordProperties() (+65 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (62): SigningMode, SigningModeSelector(), SigningModeSelectorProps, BackgroundGlow(), Noise(), TOOL_ACCENTS, TOOL_GLOWS, ToolAccessBar() (+54 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (44): VALUES, WHO_IT_SERVES, HOW_IT_WORKS, IRIS_WORKFLOWS, OUTCOMES, ScrollyTellingLandingPage(), SHOWCASE_MODULES, mockApplications (+36 more)

### Community 16 - "Community 16"
Cohesion: 0.08
Nodes (60): ensureBucket(), InviteRecord, loadInviteRecord(), POST(), sanitizeFileName(), buildPaymentPreview(), formatInviteError(), GET() (+52 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (48): GET(), getBillingWorkspace(), BILLING_BUCKETS, DEFAULT_LIMITS, ensureBucket(), removeBillingFile(), uploadBillingFile(), sanitizeFileName() (+40 more)

### Community 18 - "Community 18"
Cohesion: 0.06
Nodes (42): buildInvoiceLabel(), buildOverdueLabel(), DashboardData, DEFAULT_QUICK_ACTIONS, formatCurrency(), formatCurrencyParts(), formatDueDate(), ICON_MAP (+34 more)
...
Cohesion: 0.04
Nodes (36): read_chart(), defaultdict, Max, Min, Values must be less than a `max` value, Values must be greater than a `min` value, MultiCellRange, absolute_coordinate() (+28 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (28): DataValidationList, Need to skip validations that have no cell ranges, PrintOptions, Worksheet print options, ScenarioList, columns(), Returns a cell object based on the given coordinates.          Usage: cell(row=1, Internal method for getting a cell from a worksheet.         Will create a new c (+20 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (42): coordinate(), coordinate(), cols(), DummyWorksheet, Return and remove the first cell, Normalise cell range references, Reference, rows() (+34 more)

### Community 23 - "Community 23"
Cohesion: 0.06
Nodes (15): Border, Border positioning for use in styles., HyperlinkList, MergeCell, MergeCells, Related, create_temporary_file(), Return all rows, and any cells that they contain (+7 more)
...
Cohesion: 0.05
Nodes (17): ArrayFormula, DataTableFormula, Break, ColBreak, RowBreak, Outline, PageSetupProperties, WorksheetProperties (+9 more)
...
Cohesion: 0.08
Nodes (28): SignaturePad(), SignaturePadProps, DigitalSigner(), DigitalSignerProps, PdfPage, Signature, workerUrl, playSound() (+20 more)
...
Cohesion: 0.06
Nodes (12): Cell, column_letter(), comment(), get_time_format(), get_type(), Check string coding, length, and line break character, Tries to convert Error" else N/A, Given a value, infer the correct data type (+4 more)

### Community 43 - "Community 43"
Cohesion: 0.08
Nodes (27): ActiveLeasesTab(), ActiveLeasesTabProps, ArchiveTab(), ArchiveTabProps, LeaseAuditTrail(), CardVariant, formatCurrency(), formatDate() (+19 more)

### Community 44 - "Community 44"
Cohesion: 0.08
Nodes (27): ComplaintModalProps, ComplaintModalProps, UnitHistoryModalProps, UnitTooltip(), UnitTooltipProps, VisualCanvasProps, VisualBuilderStateProps, DEFAULT_FLOOR_LAYOUTS (+19 more)
...
Cohesion: 0.09
Nodes (15): FileRecoveryProperties, PivotCache, Represent the workbook file in the archive, WorkbookPackage, FunctionGroup, FunctionGroupList, CalcProperties, FileVersion (+7 more)
...
Cohesion: 0.15
Nodes (26): ALLOWED_STATUSES, createLeaseRecord(), createPaymentRecords(), generateTempPassword(), isAllowedStatus(), POST(), rollbackLeaseAndAccount(), rollbackTenantAccount() (+18 more)
...
Cohesion: 0.1
Nodes (13): Generate string representation of XML element.      All subelements are included, tostring(), ExtendedProperties, See 22.2      Most of this is irrelevant but Excel is very picky about the versi, Write the workbook relationships xml., Serialise to XML and write to archive, ExcelWriter, Write links to external workbooks (+5 more)
...
Cohesion: 0.11
Nodes (13): DocsPage(), UnitMapFeatureSection(), FeaturesPage(), metadata, Section, DocDetailPage(), DOCS_CONTENT, cardHover (+5 more)
...
Cohesion: 0.11
Nodes (7): Sequence, _assign_position(), Automatically assign positions if a list of colours is provided.      It is not, StopList, apply_stylesheet(), from_tree(), Add styles to workbook if present
...
Cohesion: 0.16
Nodes (16): CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, Property, PropertyContext, PropertyContextValue, useProperty() (+8 more)
...
Cohesion: 0.08
Nodes (7): _convert(), Default, Length, MatchPattern, When called returns an instance of the expected type.     Additional default val, Values must match a regex pattern, Check value is of or can be converted to expected type.
...
Cohesion: 0.13
Nodes (19): evaluateTenantProductTourEligibility(), getTenantProductTourRequiredStep(), isNextProductTourStepSubmission(), TENANT_PRODUCT_TOUR_STEPS, TenantProductTourState, POST(), INITIAL_TOUR_UI_STATE, isTourEnabledClient() (+11 more)
...
Cohesion: 0.14
Nodes (19): AddTenantModal(), AddTenantModalProps, formatLeaseEnd(), Tenant, TenantPaymentStatus, TenantsContent(), TenantsPage(), TenantStatus (+11 more)

### Community 94 - "Community 94"
Cohesion: 0.12
Nodes (16): geistMono, geistSans, metadata, RootLayout(), ConsentSettings, CookieConsent(), SettingToggle(), FramerMotionProvider() (+8 more)
...
Cohesion: 0.1
Nodes (11): DocumentProperties, High-level properties of the document.     Defined in ECMA-376 Par2 Annex D, Create a worksheet (at an optional index).          :param title: optional title, Add an worksheet (at an optional index)., Returns a worksheet by its name.          :param name: the name of the worksheet, Save the current workbook under the given `filename`.         Use this function, Copy an existing worksheet in the current workbook          .. warning::, Close workbook file if open. Only affects read-only and write-only modes. (+3 more)
...
Cohesion: 0.1
Nodes (16): NextPayment, OverduePayment, PaymentSummaryProps, LeaseInfo, TenantDashboardHeaderProps, UnitHistoryModalProps, Activity, Document (+8 more)
...
Cohesion: 0.09
Nodes (21): 10. Glossary, 1. What is iReside?, 2. The Big Picture: How Everything Connects, 3.1 Super Administrator, 3.2 Landlord, 3.3 Tenant, 3.4 Role-Based Access Control (RBAC), 3. User Roles & Access (+13 more)
...
Cohesion: 0.18
Nodes (7): ChildSheet, Represents a reference to a worksheet or chartsheet in workbook.xml      It cont, ExternalReference, get_active_sheet(), Write the core workbook xml., Return the index of the active sheet.     If the sheet set to active is hidden r, WorkbookWriter
...
Cohesion: 0.26
Nodes (9): completeSchema, POST(), LANDLORD_PRODUCT_TOUR_STEPS, isGuidedTenantProductTourEnabled(), POST(), skipSchema, POST(), stepSchema (+1 more)
...
Cohesion: 0.15
Nodes (16): useOptionalProperty(), useVisualBuilderState(), QuickActionGuardResult, QuickActionType, dbUnitToCanvasUnit(), formatFloorWatermark(), getFloorDisplayLabel(), parseFloorNumber() (+8 more)
...
Cohesion: 0.12
Nodes (7): Find all sheets in the workbook and return the link to the source file., Bind defined names and other definitions to worksheets or the workbook, WorkbookParser, DefinedNameList, destinations(), Check for whether DefinedName with the same name and scope already         exist, type()

### Community 151 - "Community 151"
Cohesion: 0.14
Nodes (6): CustomChartsheetView, CustomChartsheetViews, PageMargins, PrintPageSetup, Worksheet print page setup, Information about page margins for view/print layouts.     Standard values (in i
...
Cohesion: 0.15
Nodes (10): is_date(), builtin_format_code(), builtin_format_id(), is_date_format(), is_datetime(), is_timedelta_format(), Return date, time or datetime, Return one of the standard format codes by index. (+2 more)
...
Cohesion: 0.25
Nodes (11): ExpenseItem, HeroStat(), InputField(), InvoicesPage(), LedgerMetric(), SelectField(), StudioLineItem(), StudioStep (+3 more)
...
Cohesion: 0.13
Nodes (8): sheetname(), quote_sheetname(), Add quotes around sheetnames if they contain spaces., DefinedName, create_named_range(), PrintTitles, Contains at least either a range of rows or columns, print_titles()
...
Cohesion: 0.45
Nodes (8): LandlordProductTourTriggerSource, TenantProductTourTriggerSource, DELETE(), GET(), parseBoolean(), resolveOnboardingCompleted(), resolveRole(), resolveTriggerSource()
...
Cohesion: 0.27
Nodes (5): ColorChoice, GlowEffect, InnerShadowEffect, OuterShadow, PresetShadowEffect
...
Cohesion: 0.31
Nodes (6): CATEGORY_META, MessageReportAction, MessageReportCategory, MessageReportState, MessageReportWizardProps, normalizePastedMessageId()
...
## Knowledge Gaps
- **2887 isolated node(s):** `supabase`, `supabase`, `supabase`, `supabase`, `eslintConfig` (+2882 more)
...
- **Why does `Serialisable` connect `Community 4` to `Community 0`, `Community 1`, `Community 2`, `Community 134`, `Community 266`, `Community 11`, `Community 20`, `Community 21`, `Community 22`, `Community 151`, `Community 23`, `Community 150`, `Community 25`, `Community 155`, `Community 28`, `Community 157`, `Community 165`, `Community 37`, `Community 45`, `Community 46`, `Community 58`, `Community 60`, `Community 64`, `Community 65`, `Community 321`, `Community 198`, `Community 71`, `Community 72`, `Community 73`, `Community 74`, `Community 95`, `Community 96`, `Community 98`, `Community 366`, `Community 111`, `Community 112`, `Community 240`, `Community 114`, `Community 115`, `Community 116`, `Community 122`, `Community 254`, `Community 127`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 1` to `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 12`, `Community 13`, `Community 14`, `Community 143`, `Community 16`, `Community 24`, `Community 29`, `Community 33`, `Community 40`, `Community 173`, `Community 174`, `Community 49`, `Community 50`, `Community 56`, `Community 186`, `Community 63`, `Community 220`, `Community 236`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `Boolean` connect `Community 1` to `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 263`, `Community 7`, `Community 10`, `Community 143`, `Community 16`, `Community 24`, `Community 29`, `Community 33`, `Community 39`, `Community 40`, `Community 174`, `Community 49`, `Community 57`, `Community 187`, `Community 83`, `Community 252`?**
