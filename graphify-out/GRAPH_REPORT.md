...
## Corpus Check
- 980 files · ~7,142,156 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8960 nodes · 20844 edges · 651 communities (449 shown, 202 thin omitted)
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 4458 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c5f6493b`
...
## Communities (651 total, 202 thin omitted)
...
Cohesion: 0.04
Nodes (130): _3DBase, InlineFont, PhoneticProperties, PhoneticText, Font for inline text because, yes what you need are different objects with the s, RichText, Text, _3DBase (+122 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (82): AuthorList, CommentRecord, CommentSheet, from_comments(), Properties, Base64Binary, CellRange, Extension (+74 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (82): Float, CellIsRule(), ColorScale, ColorScaleRule(), DataBar, DataBarRule(), FormatObject, FormulaRule() (+74 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (78): ExtensionList, Percentage, Connection, ConnectorLocking, ConnectorNonVisual, ConnectorShape, NonVisualConnectorProperties, ShapeMeta (+70 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (81): Bool, title_maker(), ColorChoice, Convertible, EmptyTag, NestedText, NestedValue, Boolean if a tag exists or not. (+73 more)
...
Cohesion: 0.04
Nodes (78): AdminSidebar(), NAV_ITEMS, AdminLayout(), geistMono, geistSans, metadata, RootLayout(), ThemeProvider() (+70 more)
...
Cohesion: 0.03
Nodes (45): PUT(), RouteParams, GET(), getDashboardPathForRole(), PUT(), PUT(), RouteParams, GET() (+37 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (79): ActionBody, ALLOWED_STATUSES, createLeaseRecord(), createPaymentRecords(), generateTempPassword(), getStateForAction(), InquiryAction, isAllowedStatus() (+71 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (62): generateOTP(), GET(), POST(), ensureBucket(), POST(), sanitizeFileName(), ensureBucket(), POST() (+54 more)
...
Cohesion: 0.05
Nodes (75): GET(), openai, POST(), UpdateListingBody, formatContextForAI(), getTenantContext(), AmenityInsert, deleteAmenity() (+67 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (54): array, CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, useAuth(), Property, PropertyContext (+46 more)
...
Cohesion: 0.06
Nodes (39): GET(), GET(), POST(), GET(), POST(), DELETE(), GET(), RouteContext (+31 more)

### Community 19 - "Community 19"
Cohesion: 0.09
Nodes (57): advancePaymentSchema, POST(), ActiveLeaseWorkspaceRow, AppSupabaseClient, BillingLeaseRow, buildInvoiceListItem(), createAdvancePayment(), createMultiMonthAdvancePayment() (+49 more)
...
Cohesion: 0.07
Nodes (37): Document, DocumentsPage(), LandlordProfile, VerificationInfo, useAppToast(), LeaseDocument(), DigitalSigner, LandlordLeaseSigningPage() (+29 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (43): column_letter(), coordinate(), cols(), DummyWorksheet, Return and remove the first cell, Normalise cell range references, Reference, rows() (+35 more)
...
Cohesion: 0.05
Nodes (18): from_ISO8601(), Convert from a timestamp string to a datetime object. According to     18.17.4 i, ArrayFormula, DataTableFormula, Break, ColBreak, RowBreak, _cast_number() (+10 more)
...
Cohesion: 0.11
Nodes (11): PlotArea(), Level, MultiLevelStrData, MultiLevelStrRef, NumberValueDescriptor, NumData, NumVal, Collection of utility primitives for charts. (+3 more)

### Community 28 - "Community 28"
Cohesion: 0.07
Nodes (33): buildInvoiceLabel(), buildOverdueLabel(), DashboardData, formatCurrency(), formatCurrencyParts(), formatDueDate(), TenantDashboard(), LeaseHubContent() (+25 more)

### Community 29 - "Community 29"
Cohesion: 0.07
Nodes (36): parseIncome(), WalkInApplicationModal(), ActionItem, ActionItemCard(), ActionRequired(), ActionRequiredAction, ActionRequiredState, ActionSummary (+28 more)
...
Cohesion: 0.05
Nodes (20): PageMargins, Identical to openpyxl.worksheet.page.Pagemargins but element names are different, Chartsheet, CustomChartsheetView, CustomChartsheetViews, ChartsheetProperties, ChartsheetProtection, WebPublishItem (+12 more)
...
Cohesion: 0.09
Nodes (38): InvoiceListItem, InvoiceReadingDetail, formatDateLong(), formatPhpCurrency(), buildFaceToFacePreviewInvoice(), buildSelectivePreviewInvoice(), CheckoutPage(), Field() (+30 more)
...
Cohesion: 0.06
Nodes (23): Max, Min, Values must be less than a `max` value, Values must be greater than a `min` value, Return a new range with cells common to this range and *other*          :type ot, Return the minimal superset of this range and *other*. This new range         wi, collapse_cell_addresses(), DataValidation (+15 more)

### Community 46 - "Community 46"
Cohesion: 0.07
Nodes (20): BoundDictionary, defaultdict, StyleableObject, Base class for styleble objects implementing proxy and lookup functions, StyleableObject, BoundDictionary, A default dictionary where elements are tightly coupled.      The factory method, Break names down into sheet locals and globals (+12 more)
...
Cohesion: 0.11
Nodes (29): PAYMENT_METHODS, PaymentRecordForm(), PaymentRecordFormProps, SigningMode, SigningModeSelector(), SigningModeSelectorProps, BackgroundGlow(), Noise() (+21 more)
...
Cohesion: 0.1
Nodes (14): ConsentSettings, CookieConsent(), SettingToggle(), DocsPage(), UnitMapFeatureSection(), FeaturesPage(), metadata, DocDetailPage() (+6 more)
...
Cohesion: 0.12
Nodes (7): Simplified named tuple with an array, StyleArray, NamedStyleDescriptor, NumberFormatDescriptor, style_id(), StyleArrayDescriptor, StyleDescriptor
...
Cohesion: 0.24
Nodes (13): completeSchema, POST(), getTenantProductTourRequiredStep(), isGuidedTenantProductTourEnabled(), replayTenantProductTour(), POST(), POST(), skipSchema (+5 more)
...
Cohesion: 0.2
Nodes (11): SignaturePad(), SignaturePadProps, DigitalSigner(), DigitalSignerProps, PdfPage, Signature, workerUrl, canvas (+3 more)

### Community 125 - "Community 125"
Cohesion: 0.16
Nodes (7): DefinedName, create_named_range(), get_active_sheet(), Write the core workbook xml., Write the workbook relationships xml., Return the index of the active sheet.     If the sheet set to active is hidden r, WorkbookWriter
...
Cohesion: 0.21
Nodes (7): CardVariant, formatCurrency(), formatDate(), LeaseCard(), LeaseCardProps, LeaseTermProgress(), TooltipContent
...
Cohesion: 0.31
Nodes (3): copy(), Copy the values, styles, dimensions, merged cells, margins, and     print/page s, WorksheetCopy
...
- **Why does `Serialisable` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 140`, `Community 19`, `Community 22`, `Community 24`, `Community 27`, `Community 31`, `Community 32`, `Community 35`, `Community 41`, `Community 45`, `Community 46`, `Community 179`, `Community 63`, `Community 68`, `Community 76`, `Community 82`, `Community 87`, `Community 92`, `Community 103`, `Community 232`, `Community 233`, `Community 106`, `Community 125`, `Community 126`?**
  _High betweenness centrality (0.132) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 19` to `Community 0`, `Community 2`, `Community 4`, `Community 6`, `Community 9`, `Community 11`, `Community 14`, `Community 16`, `Community 147`, `Community 29`, `Community 157`, `Community 33`, `Community 161`, `Community 34`, `Community 39`, `Community 47`, `Community 49`, `Community 50`, `Community 55`, `Community 67`, `Community 81`, `Community 85`, `Community 214`, `Community 215`, `Community 213`?**
  _High betweenness centrality (0.103) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 8` to `Community 6`, `Community 7`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 272`, `Community 147`, `Community 20`, `Community 21`, `Community 23`, `Community 26`, `Community 28`, `Community 29`, `Community 158`, `Community 160`, `Community 161`, `Community 34`, `Community 298`, `Community 174`, `Community 175`, `Community 48`, `Community 49`, `Community 52`, `Community 54`, `Community 55`, `Community 56`, `Community 65`, `Community 71`, `Community 73`, `Community 101`, `Community 111`, `Community 243`, `Community 244`, `Community 117`, `Community 116`, `Community 124`?**
