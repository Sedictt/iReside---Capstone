...
Cohesion: 0.02
Nodes (65): Sequence, String, Alignment, Alignment options for use in styles., Border, Border options for use in styles.     Caution: if you do not specify a border_st, Border positioning for use in styles., Side (+57 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (107): ThemeToggle(), ChatUser, ContactCard(), ContactCardProps, ContactsSidebar(), DEFAULT_CHAT_STATE, EMPTY_ARRAY, EMPTY_OBJECT (+99 more)
...
Cohesion: 0.03
Nodes (59): PUT(), RouteParams, GET(), getDashboardPathForRole(), PUT(), PUT(), RouteParams, GET() (+51 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (73): ExtensionList, Percentage, Connection, ConnectorLocking, ConnectorNonVisual, ConnectorShape, NonVisualConnectorProperties, ShapeMeta (+65 more)
...
Cohesion: 0.04
Nodes (74): AdminSidebar(), NAV_ITEMS, AdminLayout(), ThemeProvider(), AuthContext, AuthContextValue, AuthProvider(), AuthState (+66 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (56): Objects can serialise to XML their attributes and child objects.     The followi, Serialisable, DigSigBlob, VectorLpstr, VectorVariant, FileExtension, Override, Index (+48 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (53): Base64Binary, CellRange, Extension, Size in hundredths of points.     In theory other units of measurement can be us, TextPoint, UniversalMeasure, A sequence of primitive types that are stored as a single attribute.     "val" i, ValueSequence (+45 more)
...
Cohesion: 0.03
Nodes (49): Guid, DocumentProperties, High-level properties of the document.     Defined in ECMA-376 Par2 Annex D, Represents many kinds of relationships., `type` can be used as a shorthand with the default relationships namespace, Relationship, ChildSheet, FileRecoveryProperties (+41 more)

### Community 11 - "Community 11"
Cohesion: 0.09
Nodes (49): Alias, MultiSequence, MultiSequencePart, NestedSequence, Allow a multisequence to be built up from parts      Excluded from the instance, Wrap a sequence in an containing object, Sequences can contain objects with different tags, ElementList (+41 more)
...
Cohesion: 0.05
Nodes (53): generateOTP(), GET(), POST(), ensureBucket(), POST(), sanitizeFileName(), ensureBucket(), POST() (+45 more)
...
Cohesion: 0.05
Nodes (57): ConsultationDashboard(), Document, ConsultationTool(), ConsultationToolProps, DigitalSigner, ConsultationTool, SignPage(), BusinessPermitCard() (+49 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (61): array, CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, useAuth(), Property, PropertyContext (+53 more)
...
Cohesion: 0.09
Nodes (48): _3DBase, AreaChart, AreaChart3D, _AreaChartBase, ChartLines, NumericAxis, SeriesAxis, TextAxis (+40 more)

### Community 20 - "Community 20"
Cohesion: 0.07
Nodes (53): InlineFont, PhoneticProperties, PhoneticText, Font for inline text because, yes what you need are different objects with the s, RichText, Text, Set the categories / x-axis values, AxDataSource (+45 more)
...
Cohesion: 0.05
Nodes (56): GET(), GET(), POST(), ActivityItem, Announcement, buildUtilities(), BUILT_IN_QUICK_ACTIONS, DashboardResponse (+48 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (40): product(), build_workbook(), format_case_id(), resolve_output_path(), bottom(), cells(), cols(), left() (+32 more)
...
Cohesion: 0.05
Nodes (36): ConsentSettings, CookieConsent(), SettingToggle(), DocsHeader(), DocsHeaderProps, DocsLayout(), DOCS_NAV, DocsSidebar() (+28 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (36): Bool, Level, MultiLevelStrData, MultiLevelStrRef, NumberValueDescriptor, NumData, NumVal, Data should be numerical but isn't always :-/ (+28 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (21): MergedCell, Describes the properties of a cell in a merged cell and helps to     display the, CellRange, HyperlinkList, MergeCell, MergeCells, MergedCellRange, MergedCellRange stores the border information of a merged cell in the top     le (+13 more)

### Community 29 - "Community 29"
Cohesion: 0.04
Nodes (39): Cell, column_letter(), get_time_format(), get_type(), is_date(), Check string coding, length, and line break character, Tries to convert Error" else N/A, Given a value, infer the correct data type (+31 more)

### Community 30 - "Community 30"
Cohesion: 0.11
Nodes (45): ICON_MAP, LandlordQuestBoard(), LandlordQuestBoardProps, addDays(), clampStepIndex(), completeLandlordProductTour(), createLandlordProductTourState(), ensureLandlordProductTourState() (+37 more)

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (40): coordinate(), coordinate(), Return and remove the first cell, defaultdict, This module contains code to translate formulae across cells in a worksheet.  Th, Convert the formula into A1 notation, or as row and column coordinates, Raised when a formula can't be translated across cells.      This error arises w, Returns a list with the tokens comprising the formula. (+32 more)
...
Cohesion: 0.05
Nodes (29): make_operand(), make_separator(), make_subexp(), This module contains a tokenizer for Excel formulae.  The tokenizer is based on, Consume all the text between square brackets [].          Returns the number of, Base class for all Tokenizer errors., Consume the text following a '#' as an error.          Looks for a match in self, Consume a string of consecutive spaces.          Returns the number of spaces fo (+21 more)

### Community 37 - "Community 37"
Cohesion: 0.05
Nodes (22): PageMargins, Identical to openpyxl.worksheet.page.Pagemargins but element names are different, Chartsheet, CustomChartsheetView, CustomChartsheetViews, ChartsheetProperties, ChartsheetProtection, WebPublishItem (+14 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (15): Modifies a formula so that it can be translated from one cell to another.      `, Translator, ArrayFormula, DataTableFormula, Break, ColBreak, RowBreak, read_dimension() (+7 more)

### Community 39 - "Community 39"
Cohesion: 0.07
Nodes (29): VALUES, WHO_IT_SERVES, geistMono, geistSans, metadata, RootLayout(), HOW_IT_WORKS, IRIS_WORKFLOWS (+21 more)
...
Cohesion: 0.06
Nodes (20): BoundDictionary, StyleableObject, Base class for styleble objects implementing proxy and lookup functions, StyleableObject, BoundDictionary, A default dictionary where elements are tightly coupled.      The factory method, boundaries(), ColumnDimension (+12 more)
...
Cohesion: 0.09
Nodes (23): _BaseAxis, DateAxis, DisplayUnitsLabel, DisplayUnitsLabelList, Scaling, AxId, ChartContainer, ChartSpace (+15 more)
...
Cohesion: 0.08
Nodes (27): ComplaintModalProps, ComplaintModalProps, TransferRequestModal(), TransferRequestModalProps, UnitHistoryModalProps, UnitTooltip(), UnitTooltipProps, VisualCanvasProps (+19 more)

### Community 60 - "Community 60"
Cohesion: 0.18
Nodes (3): PlotArea(), Collection of utility primitives for charts., ManualLayout
...
Cohesion: 0.18
Nodes (22): ActionBody, ALLOWED_STATUSES, createLeaseRecord(), createPaymentRecords(), generateTempPassword(), getStateForAction(), InquiryAction, isAllowedStatus() (+14 more)
...
Cohesion: 0.09
Nodes (11): Safely and consistently format numeric values, safe_string(), _explicit_none(), Override serialisation because explicit none required, namespaced(), Utility to create a namespaced tag for an object, Convert the sequence represented by the descriptor to an XML element, Convert the sequence represented by the descriptor to an XML element (+3 more)
...
Cohesion: 0.14
Nodes (15): FloorSelector(), FloorSelectorProps, FloorTab, DbUnit, FloorId, QuickActionGuardResult, QuickActionType, dbUnitToCanvasUnit() (+7 more)
...
Cohesion: 0.3
Nodes (8): sendLandlordRegistrationApproved(), sendProspectPaymentRequestEmail(), sendRegistrationOTP(), sendTenantOnboardingReminder(), transporter, POST(), generateTempPassword(), POST()
...
Cohesion: 0.15
Nodes (12): 18. Glossary, 1.1 What is iReside?, 1.2 Who Uses iReside?, 1.3 Supported Devices, 1. Welcome to iReside, 7.1 Adding a Property, 7.2 Adding Units, 7.3 Unit Status Colors (+4 more)
...
Cohesion: 0.4
Nodes (6): useOptionalProperty(), useVisualBuilderState(), formatFloorWatermark(), getFloorDisplayLabel(), parseFloorNumber(), VisualBuilder()
...
- **Why does `Serialisable` connect `Community 7` to `Community 0`, `Community 2`, `Community 4`, `Community 8`, `Community 138`, `Community 10`, `Community 11`, `Community 19`, `Community 20`, `Community 276`, `Community 21`, `Community 27`, `Community 28`, `Community 31`, `Community 33`, `Community 37`, `Community 38`, `Community 41`, `Community 50`, `Community 180`, `Community 60`, `Community 70`, `Community 202`, `Community 76`, `Community 78`, `Community 87`, `Community 92`, `Community 102`, `Community 106`?**
  _High betweenness centrality (0.135) - this node is a cross-community bridge._
- **Why does `Boolean` connect `Community 11` to `Community 1`, `Community 2`, `Community 4`, `Community 133`, `Community 6`, `Community 7`, `Community 9`, `Community 12`, `Community 13`, `Community 14`, `Community 144`, `Community 156`, `Community 30`, `Community 168`, `Community 47`, `Community 48`, `Community 53`, `Community 54`, `Community 74`, `Community 232`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 11` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 133`, `Community 7`, `Community 9`, `Community 13`, `Community 14`, `Community 144`, `Community 18`, `Community 22`, `Community 24`, `Community 25`, `Community 155`, `Community 157`, `Community 30`, `Community 44`, `Community 47`, `Community 48`, `Community 54`, `Community 58`, `Community 199`, `Community 200`, `Community 218`, `Community 117`?**
