...
## Corpus Check
- 983 files · ~7,148,088 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9057 nodes · 20952 edges · 672 communities (473 shown, 199 thin omitted)
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 4458 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a9c53d45`
...
## Communities (672 total, 199 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (151): CustomChartsheetViews, WebPublishItems, DrawingHF, CommentRecord, Properties, Base64Binary, CellRange, Extension (+143 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (131): _3DBase, PhoneticProperties, PhoneticText, RichText, Text, _3DBase, Base class for 3D charts, Surface (+123 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (74): ExtensionList, Percentage, Connection, ConnectorLocking, ConnectorNonVisual, ConnectorShape, NonVisualConnectorProperties, Shape (+66 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (55): PUT(), RouteParams, GET(), getDashboardPathForRole(), PUT(), PUT(), RouteParams, GET() (+47 more)
...
Cohesion: 0.07
Nodes (79): Bool, title_maker(), ColorChoice, Convertible, HexBinary, EmptyTag, NestedValue, Boolean if a tag exists or not. (+71 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (79): AnalyticsPage(), DEFAULT_EXTENDED_KPIS, DEFAULT_FINANCIAL_CHART, DEFAULT_OPERATIONAL_SNAPSHOT, DEFAULT_PRIMARY_KPIS, ExportAuditItem, formatIsoDate(), getDateLabels() (+71 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (57): generateOTP(), GET(), POST(), ensureBucket(), POST(), sanitizeFileName(), ensureBucket(), POST() (+49 more)
...
Cohesion: 0.05
Nodes (58): ConsultationDashboard(), Document, ConsultationTool(), ConsultationToolProps, DigitalSigner, ConsultationTool, SignPage(), BusinessPermitCard() (+50 more)

### Community 10 - "Community 10"
Cohesion: 0.09
Nodes (44): Alias, MultiSequence, MultiSequencePart, Allow a multisequence to be built up from parts      Excluded from the instance, Sequences can contain objects with different tags, CacheDefinition, CacheField, CacheHierarchy (+36 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (28): DataValidationList, Need to skip validations that have no cell ranges, ArrayFormula, DataTableFormula, PageMargins, PrintOptions, PrintPageSetup, Worksheet print options (+20 more)
...
Cohesion: 0.07
Nodes (47): AdminLayout(), ThemeProvider(), AuthContext, AuthContextValue, AuthProvider(), AuthState, isAuthoritativeAuthError(), useAuth() (+39 more)
...
Cohesion: 0.04
Nodes (32): AuthorList, CommentSheet, from_comments(), Alignment, Alignment options for use in styles., ArrayDescriptor, CellStyle, CellStyleList (+24 more)

### Community 18 - "Community 18"
Cohesion: 0.06
Nodes (55): formatPhpCurrency(), CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, useProperty(), ActionButton(), CreditCardIcon() (+47 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (51): BillingWorkspace, NextPayment, OverduePayment, PaymentSummaryProps, LeaseInfo, TenantDashboardHeaderProps, UnitHistoryModalProps, buildInvoiceLabel() (+43 more)
...
Cohesion: 0.04
Nodes (33): defaultdict, Max, Min, Values must be less than a `max` value, Values must be greater than a `min` value, MultiCellRange, Break names down into sheet locals and globals, collapse_cell_addresses() (+25 more)

### Community 24 - "Community 24"
Cohesion: 0.07
Nodes (32): Document, DocumentsPage(), LandlordProfile, VerificationInfo, LeaseDocument(), LeaseHubContent(), LeasesPage(), TabId (+24 more)
...
Cohesion: 0.09
Nodes (13): PlotArea(), Level, MultiLevelStrData, MultiLevelStrRef, NumberValueDescriptor, NumData, NumVal, Collection of utility primitives for charts. (+5 more)

### Community 27 - "Community 27"
Cohesion: 0.07
Nodes (38): GET(), GET(), POST(), GET(), POST(), finalizeLease(), FinalizeLeaseParams, generateTempPassword() (+30 more)

### Community 28 - "Community 28"
Cohesion: 0.08
Nodes (29): VALUES, WHO_IT_SERVES, AdminSidebar(), NAV_ITEMS, HOW_IT_WORKS, IRIS_WORKFLOWS, OUTCOMES, ScrollyTellingLandingPage() (+21 more)

### Community 29 - "Community 29"
Cohesion: 0.07
Nodes (33): DashboardBackground(), DashboardBackgroundProps, BannerNotification, DashboardBanner(), DashboardBannerProps, formatTimeAgo(), SearchResult, SearchResultType (+25 more)
...
Cohesion: 0.06
Nodes (22): CustomChartsheetView, Strict, escape(), r"""     Convert ASCII < 31 to OOXML: \n == _x + hex(ord(\n)) + _, r"""     Convert escaped strings to ASCIII: _x000a_ == \n, unescape(), _WorkbookChild, from_str() (+14 more)

### Community 52 - "Community 52"
Cohesion: 0.08
Nodes (23): geistMono, geistSans, metadata, RootLayout(), Loading(), ConsentSettings, CookieConsent(), SettingToggle() (+15 more)
...
Cohesion: 0.11
Nodes (18): SignaturePad(), SignaturePadProps, DigitalSigner(), DigitalSignerProps, PdfPage, Signature, workerUrl, playSound() (+10 more)
...
Cohesion: 0.09
Nodes (11): Sequence, Border options for use in styles.     Caution: if you do not specify a border_st, Side, _assign_position(), Automatically assign positions if a list of colours is provided.      It is not, Stop, StopList, _no_value() (+3 more)
...
Cohesion: 0.11
Nodes (12): Generate string representation of XML element.      All subelements are included, tostring(), ExtendedProperties, See 22.2      Most of this is irrelevant but Excel is very picky about the versi, Serialise to XML and write to archive, ExcelWriter, Write links to external workbooks, Write data into the archive. (+4 more)
...
Cohesion: 0.1
Nodes (13): Error for trying to modify a read-only workbook, ReadOnlyWorkbookException, Create a worksheet (at an optional index).          :param title: optional title, Add an worksheet (at an optional index)., Remove `worksheet` from this workbook., Returns a worksheet by its name.          :param name: the name of the worksheet, Save the current workbook under the given `filename`.         Use this function, Copy an existing worksheet in the current workbook          .. warning:: (+5 more)
...
Cohesion: 0.1
Nodes (9): Chartsheet, ChartsheetProperties, ChartsheetProtection, WebPublishItem, SheetBackgroundPicture, ChartsheetView, ChartsheetViewList, _Protected (+1 more)
...
Cohesion: 0.14
Nodes (17): LeaseAuditTrail(), LeaseStatusBadge(), LeaseStatusBadgeProps, STATUS_STYLES, LayoutGrid(), LeasesContent(), LeasesPage(), LeaseStatus (+9 more)
...
Cohesion: 0.1
Nodes (4): active(), get_index(), Move a sheet or sheetname, Return the index of a worksheet.

### Community 106 - "Community 106"
Cohesion: 0.1
Nodes (10): DifferentialStyleList, Dedupable container for differential styles., Check to see whether style already exists and append it if does not., Add a differential style and return its index, builtin_format_code(), builtin_format_id(), is_timedelta_format(), Return one of the standard format codes by index. (+2 more)
...
Cohesion: 0.14
Nodes (17): array, DbUnit, QuickActionGuardResult, QuickActionType, dbUnitToCanvasUnit(), formatFloorWatermark(), getFloorDisplayLabel(), parseFloorNumber() (+9 more)
...
Cohesion: 0.2
Nodes (12): metricIcons, OperationalSnapshotCard(), OperationalSnapshotCardProps, SnapshotMetric, statusStyles, toneStyles, ActionMenu(), AdminUsersPage() (+4 more)
...
Cohesion: 0.12
Nodes (12): code:typescript (it('returns ordered photos for album', async () => {), code:bash (git add src/lib/community/actions.ts), code:typescript (it('fetches posts for landlord properties with filters', asy), code:bash (git add src/lib/community/actions.ts), code:typescript (it('toggles reaction on post', async () => {), code:bash (git add src/lib/community/actions.ts), code:bash (git add src/lib/community/actions.ts), Phase 2: Server Actions & Data Layer (+4 more)
...
Cohesion: 0.39
Nodes (7): getActiveLease(), getLandlordLeases(), getLandlordRenewalRequests(), getLeaseById(), getRenewalRequestById(), getTenantLeases(), getTenantRenewalRequests()
...
Cohesion: 0.53
Nodes (4): EVENT_LABELS, formatAuditTimestamp(), LeaseAuditEvent, LeaseAuditTrailProps
...
Cohesion: 0.67
Nodes (3): Size in hundredths of points.     In theory other units of measurement can be us, TextPoint, MinMax
...
- **Why does `Serialisable` connect `Community 0` to `Community 128`, `Community 1`, `Community 2`, `Community 5`, `Community 10`, `Community 11`, `Community 17`, `Community 146`, `Community 21`, `Community 22`, `Community 23`, `Community 26`, `Community 31`, `Community 43`, `Community 47`, `Community 51`, `Community 188`, `Community 61`, `Community 189`, `Community 63`, `Community 66`, `Community 452`, `Community 70`, `Community 71`, `Community 73`, `Community 213`, `Community 91`, `Community 92`, `Community 96`, `Community 106`, `Community 107`, `Community 113`, `Community 114`?**
  _High betweenness centrality (0.140) - this node is a cross-community bridge._
- **Why does `Boolean` connect `Community 10` to `Community 0`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 13`, `Community 15`, `Community 16`, `Community 29`, `Community 35`, `Community 36`, `Community 163`, `Community 41`, `Community 177`, `Community 49`, `Community 90`, `Community 95`, `Community 102`, `Community 243`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 10` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 12`, `Community 13`, `Community 15`, `Community 16`, `Community 18`, `Community 32`, `Community 162`, `Community 35`, `Community 36`, `Community 163`, `Community 41`, `Community 176`, `Community 55`, `Community 209`, `Community 212`, `Community 90`, `Community 228`, `Community 110`, `Community 126`, `Community 127`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
