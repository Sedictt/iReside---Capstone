...
## Corpus Check
- 983 files · ~7,147,953 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9057 nodes · 20952 edges · 676 communities (475 shown, 201 thin omitted)
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 4458 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c3c5e55a`
...
## Communities (676 total, 201 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (97): CustomChartsheetViews, Base64Binary, CellRange, Extension, Guid, Size in hundredths of points.     In theory other units of measurement can be us, TextPoint, UniversalMeasure (+89 more)
...
Cohesion: 0.05
Nodes (107): ChatUser, ContactCard(), ContactCardProps, DEFAULT_CHAT_STATE, EMPTY_ARRAY, EMPTY_OBJECT, formatConversationTimestamp(), formatMiniTimestamp() (+99 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (71): Alias, MultiSequence, MultiSequencePart, NestedSequence, Allow a multisequence to be built up from parts      Excluded from the instance, Wrap a sequence in an containing object, Sequences can contain objects with different tags, ElementList (+63 more)
...
Cohesion: 0.06
Nodes (72): ColorChoice, ColorChoice, HSLColor, RGBPercent, SchemeColor, SystemColor, Transform, Connection (+64 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (80): Loading(), formatPhpCurrency(), ConsultationDashboard(), Document, ConsultationTool(), ConsultationToolProps, DigitalSigner, GlobalLoadingContext (+72 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (73): Bool, PhoneticProperties, PhoneticText, RichText, Text, Level, MultiLevelStrData, MultiLevelStrRef (+65 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (73): AnalyticsPage(), DEFAULT_EXTENDED_KPIS, DEFAULT_FINANCIAL_CHART, DEFAULT_OPERATIONAL_SNAPSHOT, DEFAULT_PRIMARY_KPIS, ExportAuditItem, formatIsoDate(), getDateLabels() (+65 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (60): AdminSidebar(), NAV_ITEMS, AdminLayout(), geistMono, geistSans, metadata, RootLayout(), ThemeProvider() (+52 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (52): Percentage, Shape, anchor(), AdjPoint2D, AdjustHandleList, Backdrop, Bevel, Camera (+44 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (55): generateOTP(), GET(), POST(), ensureBucket(), POST(), sanitizeFileName(), assertAdmin(), MUTABLE_STATUSES (+47 more)
...
Cohesion: 0.08
Nodes (59): completeSchema, POST(), ICON_MAP, LandlordQuestBoard(), LandlordQuestBoardProps, addDays(), clampStepIndex(), completeLandlordProductTour() (+51 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (38): AuthorList, CommentRecord, CommentSheet, from_comments(), Properties, Alias, Aliases can be used when either the desired attribute name is not allowed     or, Use a set to keep values unique (+30 more)
...
Cohesion: 0.06
Nodes (45): GET(), GET(), POST(), ensureBucket(), POST(), sanitizeFileName(), GET(), POST() (+37 more)

### Community 19 - "Community 19"
Cohesion: 0.07
Nodes (46): CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, Property, PropertyContext, PropertyContextValue, useOptionalProperty() (+38 more)
...
Cohesion: 0.04
Nodes (24): ReadOnlyCell, dict, DefinedNameDict, Utility class for storing defined names.     Allows access by name and separatio, Add names without worrying about key and name matching., ArrayFormula, DataTableFormula, Outline (+16 more)
...
Cohesion: 0.08
Nodes (33): VALUES, WHO_IT_SERVES, HOW_IT_WORKS, IRIS_WORKFLOWS, OUTCOMES, ScrollyTellingLandingPage(), SHOWCASE_MODULES, ApplyPage() (+25 more)
...
Cohesion: 0.05
Nodes (38): coordinate(), coordinate(), cols(), DummyWorksheet, Return and remove the first cell, Normalise cell range references, Reference, rows() (+30 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (31): MultiCellRange, Strict, escape(), r"""     Convert ASCII < 31 to OOXML: \n == _x + hex(ord(\n)) + _, r"""     Convert escaped strings to ASCIII: _x000a_ == \n, unescape(), _WorkbookChild, from_str() (+23 more)
...
Cohesion: 0.07
Nodes (50): onboardingSchema, RouteParams, Amenity, AmenityBooking, Application, ApplicationSource, ApplicationWithDetails, ConsultationDocument (+42 more)
...
Cohesion: 0.07
Nodes (25): ConsentSettings, CookieConsent(), SettingToggle(), DocsPage(), ActiveLeasesTab(), ActiveLeasesTabProps, ArchiveTab(), ArchiveTabProps (+17 more)

### Community 37 - "Community 37"
Cohesion: 0.07
Nodes (34): ActionItem, ActionItemCard(), ActionRequired(), ActionRequiredAction, ActionRequiredState, ActionSummary, formatDateLabel(), getDaysUntil() (+26 more)
...
Cohesion: 0.06
Nodes (26): defaultdict, Max, Min, Values must be less than a `max` value, Values must be greater than a `min` value, Break names down into sheet locals and globals, collapse_cell_addresses(), DataValidation (+18 more)

### Community 45 - "Community 45"
Cohesion: 0.07
Nodes (17): Sequence, Border options for use in styles.     Caution: if you do not specify a border_st, Side, _assign_position(), Automatically assign positions if a list of colours is provided.      It is not, Stop, StopList, _no_value() (+9 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (16): Cell, column_letter(), comment(), get_time_format(), get_type(), is_date(), Check string coding, length, and line break character, Tries to convert Error" else N/A (+8 more)
...
Cohesion: 0.17
Nodes (4): PlotArea(), Collection of utility primitives for charts., PageMargins, Identical to openpyxl.worksheet.page.Pagemargins but element names are different

### Community 52 - "Community 52"
Cohesion: 0.08
Nodes (27): ComplaintModalProps, ComplaintModalProps, TransferRequestModal(), TransferRequestModalProps, UnitHistoryModalProps, VisualCanvasProps, useVisualBuilderState(), VisualBuilderStateProps (+19 more)
...
Cohesion: 0.06
Nodes (11): CustomChartsheetView, PageMargins, PrintOptions, PrintPageSetup, Worksheet print options, Worksheet print page setup, Information about page margins for view/print layouts.     Standard values (in i, Break (+3 more)
...
Cohesion: 0.1
Nodes (14): CellRichText, _check_element(), _check_rich_text(), from_tree(), Returns a list of the strings contained.         The main reason for this is to, Represents text string in a specific format      This class is used as part of c, Return the full XML representation, Represents a rich text string.      Initialize with a list made of pure strings (+6 more)
...
Cohesion: 0.09
Nodes (19): WriteOnlyCell(), Exception, coordinate_from_string(), Convert a coordinate string like 'B12' to a tuple ('B', 12), CellCoordinatesException, IllegalCharacterError, NamedRangeException, The data submitted which cannot be used directly in Excel files. It     must be (+11 more)
...
Cohesion: 0.18
Nodes (23): ADVANCE_TEMPLATE_KEYS, ApplicationPaymentRequestStatus, ApplicationPaymentRequirementType, applyPaymentPendingExpiry(), areRequiredPaymentRequestsCompleted(), asRecord(), buildPortalToken(), buildPortalUrl() (+15 more)
...
Cohesion: 0.11
Nodes (19): **3.5.1 Proposed System Context Diagram** {#3.5.1-proposed-system-context-diagram}, **3.5.2 Proposed System Level 1 Diagram** {#3.5.2-proposed-system-level-1-diagram}, **3.5.3 Activity Diagram for Functional Requirements** {#3.5.3-activity-diagram-for-functional-requirements}, **3.5.4 Use Case Diagram![][image12]** {#3.5.4-use-case-diagram}, **3.5.4 Use Case Diagram![][image8]** {#3.5.4-use-case-diagram}, **3.5.5 Use Case Scenario** {#3.5.5-use-case-scenario}, **3.5.6 Hierarchical Diagram or Entity Relationship Diagram** {#3.5.6-hierarchical-diagram-or-entity-relationship-diagram}, **3.5.7 Data Dictionary** {#3.5.7-data-dictionary} (+11 more)
...
Cohesion: 0.22
Nodes (12): GET(), openai, POST(), formatContextForAI(), getTenantContext(), getLandlordProperties(), getPropertyById(), Lease (+4 more)
...
Cohesion: 0.19
Nodes (7): ExcelReader, _find_workbook_part(), load_workbook(), Read an Excel package and dispatch the contents to the relevant modules, Open the given filename and return the workbook      :param filename: the path t, Does a first check whether filename is a string or a file-like     object. If it, _validate_archive()

### Community 142 - "Community 142"
Cohesion: 0.12
Nodes (13): code:typescript (it('returns poll results with aggregated vote counts', async), code:bash (npx vitest --run), code:typescript (it('returns ordered photos for album', async () => {), code:bash (git add src/lib/community/actions.ts), code:typescript (it('allows tenant to vote on poll (upsert)', async () => {), code:bash (npx vitest --run), code:bash (git add src/lib/community/actions.ts), code:bash (git add src/lib/community/actions.ts) (+5 more)
...
Cohesion: 0.15
Nodes (14): FloorSelector(), FloorSelectorProps, FloorTab, FloorId, QuickActionGuardResult, QuickActionType, dbUnitToCanvasUnit(), formatFloorWatermark() (+6 more)
...
Cohesion: 0.18
Nodes (5): Find all sheets in the workbook and return the link to the source file., Bind defined names and other definitions to worksheets or the workbook, WorkbookParser, DefinedNameList, Check for whether DefinedName with the same name and scope already         exist
...
Cohesion: 0.22
Nodes (9): Alternative Flows, Alternative Flows, FEATURE 4: Payment & Billing Processing, Main Flow, Main Flow, Objective, Objective, Swimlanes (+1 more)
...
Cohesion: 0.25
Nodes (7): 2.1 Description and Priority, 2.2.1 Positive Flow, 2.2.2 Negative Flow, 2.2 Stimulus / Response, 2.3 Functional Requirements, 2. Property and Unit Management, iReside Functional Requirements (Updated)
...
Cohesion: 0.33
Nodes (4): PRIORITIES, Priority, PrioritySelectorProps, styles
...
Cohesion: 0.4
Nodes (6): array, formatFloorWatermark(), getFloorDisplayLabel(), parseFloorNumber(), SidebarBlockLibrary(), VisualBuilder()
...
## Knowledge Gaps
- **2756 isolated node(s):** `supabase`, `supabase`, `supabase`, `supabase`, `eslintConfig` (+2751 more)
...
- **Why does `Serialisable` connect `Community 0` to `Community 1`, `Community 130`, `Community 3`, `Community 5`, `Community 7`, `Community 10`, `Community 15`, `Community 146`, `Community 147`, `Community 149`, `Community 21`, `Community 24`, `Community 25`, `Community 26`, `Community 32`, `Community 33`, `Community 43`, `Community 44`, `Community 45`, `Community 51`, `Community 54`, `Community 185`, `Community 187`, `Community 63`, `Community 64`, `Community 67`, `Community 68`, `Community 72`, `Community 77`, `Community 95`, `Community 107`, `Community 243`, `Community 115`, `Community 117`?**
  _High betweenness centrality (0.140) - this node is a cross-community bridge._
- **Why does `Boolean` connect `Community 3` to `Community 0`, `Community 256`, `Community 2`, `Community 5`, `Community 7`, `Community 9`, `Community 11`, `Community 12`, `Community 14`, `Community 16`, `Community 34`, `Community 35`, `Community 162`, `Community 41`, `Community 175`, `Community 49`, `Community 90`, `Community 94`, `Community 103`, `Community 241`, `Community 242`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 3` to `Community 0`, `Community 128`, `Community 2`, `Community 129`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 11`, `Community 13`, `Community 14`, `Community 16`, `Community 28`, `Community 161`, `Community 34`, `Community 35`, `Community 162`, `Community 41`, `Community 183`, `Community 56`, `Community 71`, `Community 76`, `Community 209`, `Community 210`, `Community 90`, `Community 225`, `Community 112`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
