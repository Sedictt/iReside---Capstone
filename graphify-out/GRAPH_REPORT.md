# Graph Report - iReside  (2026-05-12)

## Corpus Check
- 936 files · ~6,968,965 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8101 nodes · 19881 edges · 591 communities (399 shown, 192 thin omitted)
- Extraction: 78% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 4458 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5a4f5d06`
...
## Communities (591 total, 192 thin omitted)
...
Cohesion: 0.05
Nodes (109): completeSchema, POST(), ICON_MAP, LandlordQuestBoardProps, addDays(), clampStepIndex(), completeLandlordProductTour(), createLandlordProductTourState() (+101 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (82): AdminChatModerationPage(), BannedTerm, ModerationReportCard(), ReportRow, ReportStatus, STATUS_OPTIONS, ContractActions(), ContractActionsProps (+74 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (80): AdminSidebar(), NAV_ITEMS, AdminLayout(), geistMono, geistSans, metadata, RootLayout(), CookieConsent() (+72 more)
...
Cohesion: 0.03
Nodes (57): Base64Binary, CellRange, Extension, Size in hundredths of points.     In theory other units of measurement can be us, TextPoint, UniversalMeasure, A sequence of primitive types that are stored as a single attribute.     "val" i, ValueSequence (+49 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (62): ExtensionList, Percentage, Connection, ConnectorLocking, ConnectorNonVisual, ConnectorShape, NonVisualConnectorProperties, ShapeMeta (+54 more)
...
Cohesion: 0.03
Nodes (44): PageMargins, Identical to openpyxl.worksheet.page.Pagemargins but element names are different, Chartsheet, CustomChartsheetView, CustomChartsheetViews, ChartsheetProperties, ChartsheetProtection, WebPublishItem (+36 more)
...
Cohesion: 0.04
Nodes (52): InlineFont, PhoneticProperties, PhoneticText, Font for inline text because, yes what you need are different objects with the s, RichText, Text, Level, MultiLevelStrData (+44 more)
...
Cohesion: 0.04
Nodes (37): Guid, DocumentProperties, High-level properties of the document.     Defined in ECMA-376 Par2 Annex D, ChildSheet, FileRecoveryProperties, PivotCache, Represents a reference to a worksheet or chartsheet in workbook.xml      It cont, Represent the workbook file in the archive (+29 more)
...
Cohesion: 0.04
Nodes (27): MergedCell, Describes the properties of a cell in a merged cell and helps to     display the, CellRange, Modifies a formula so that it can be translated from one cell to another.      `, Translator, ArrayFormula, DataTableFormula, Hyperlink (+19 more)
...
Cohesion: 0.06
Nodes (49): CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, Property, PropertyContext, PropertyContextValue, useProperty() (+41 more)
...
Cohesion: 0.07
Nodes (31): NestedSequence, Wrap a sequence in an containing object, ElementList, Return a dictionary of relations keyed by id, RelationshipList, Index, AutoSortScope, ChartFormat (+23 more)

### Community 19 - "Community 19"
Cohesion: 0.08
Nodes (35): _3DBase, Base class for 3D charts, Surface, View3D, _BaseAxis, DateAxis, DisplayUnitsLabel, DisplayUnitsLabelList (+27 more)

### Community 20 - "Community 20"
Cohesion: 0.08
Nodes (31): Shape, anchor(), Drawing, a drawing object - eg container for shapes or charts         we assume user spec, PresetGeometry2D, GraphicFrame, GroupShape, Image (+23 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (34): sheetname(), MultiCellRange, Strict, absolute_coordinate(), quote_sheetname(), Add quotes around sheetnames if they contain spaces., Convert a coordinate to an absolute coordinate string (B12 -> $B$12), escape() (+26 more)
...
Cohesion: 0.07
Nodes (44): ApplicationsPage(), Applicant, ApplicationsSkeletonList(), ApplicationStatus, calculateApplicationProgress(), formatCurrency(), formatDate(), formatDocumentLabel() (+36 more)
...
Cohesion: 0.14
Nodes (43): InvoiceModal(), CashPaymentInterface(), CashPaymentInterfaceProps, ChatHeader(), buildListFetchErrorMessage(), buildPaymentHistoryErrorMessage(), ConversationMessage, ConversationSummary (+35 more)
...
Cohesion: 0.05
Nodes (24): read_chart(), _convert(), Max, Min, Check value is of or can be converted to expected type., Values must be less than a `max` value, Values must be greater than a `min` value, collapse_cell_addresses() (+16 more)
...
Cohesion: 0.06
Nodes (36): column_letter(), coordinate(), Return and remove the first cell, product(), cols_from_range(), column_index_from_string(), coordinate_from_string(), coordinate_to_tuple() (+28 more)
...
Cohesion: 0.09
Nodes (42): getLandlordProperties(), getPropertyById(), Amenity, AmenityBooking, Application, ApplicationSource, ApplicationWithDetails, ConsultationDocument (+34 more)
...
Cohesion: 0.09
Nodes (27): array, Document, DocumentsPage(), LandlordProfile, VerificationInfo, LeaseDocument(), DEFAULT_OCCUPANCY, ENUM_TO_PROPERTY_TYPE (+19 more)

### Community 46 - "Community 46"
Cohesion: 0.07
Nodes (12): Sequence, _assign_position(), GradientFill, Automatically assign positions if a list of colours is provided.      It is not, Fill areas with gradient      Two types of gradient fill are supported:, Stop, StopList, builtin_format_id() (+4 more)
...
Cohesion: 0.07
Nodes (18): BoundDictionary, defaultdict, Map fields to associated conditional formats by priority, StyleableObject, BoundDictionary, A default dictionary where elements are tightly coupled.      The factory method, Break names down into sheet locals and globals, ColumnDimension (+10 more)
...
Cohesion: 0.12
Nodes (27): ChatUser, ContactCard(), ContactCardProps, DEFAULT_CHAT_STATE, EMPTY_ARRAY, EMPTY_OBJECT, formatConversationTimestamp(), formatMiniTimestamp() (+19 more)
...
Cohesion: 0.09
Nodes (28): VisualCanvasProps, VisualBuilderStateProps, DEFAULT_FLOOR_LAYOUTS, EMPTY_FLOOR_LAYOUT, INITIAL_UNITS, CanvasItemKind, Corridor, CorridorResizeHandle (+20 more)
...
Cohesion: 0.11
Nodes (18): Set the categories / x-axis values, AxDataSource, NumDataSource, NumRef, StrRef, ErrorBars, DataPoint, Marker (+10 more)
...
Cohesion: 0.12
Nodes (27): checkbox, emailInput, forgotPasswordLink, label, logo, mockPush, mockRouter(), mockSearchParams() (+19 more)

### Community 74 - "Community 74"
Cohesion: 0.13
Nodes (23): AnalyticsPage(), DEFAULT_EXTENDED_KPIS, DEFAULT_FINANCIAL_CHART, DEFAULT_OPERATIONAL_SNAPSHOT, DEFAULT_PRIMARY_KPIS, ExportAuditItem, formatIsoDate(), getDateLabels() (+15 more)
...
Cohesion: 0.14
Nodes (23): PAYMENT_METHODS, PaymentRecordForm(), PaymentRecordFormProps, SigningMode, SigningModeSelector(), SigningModeSelectorProps, ToolAccessBar(), ACTIVE_REQUIREMENT_KEYS (+15 more)
...
Cohesion: 0.27
Nodes (19): extractIpAddress(), extractUserAgent(), sendTenantSignedNotification(), isValidLeaseStatusTransition(), getImageDimensions(), isSignatureEmpty(), isValidBase64(), retryWithBackoff() (+11 more)

### Community 94 - "Community 94"
Cohesion: 0.13
Nodes (17): assertAdmin(), DELETE(), MUTABLE_STATUSES, PATCH(), RegistrationRecord, UpdateListingBody, ApplicantProfile, assertAdmin() (+9 more)
...
Cohesion: 0.11
Nodes (13): CellStyleList, ColorList, builtin_format_code(), is_timedelta_format(), NumberFormat, NumberFormatList, Return one of the standard format codes by index., Merge named style names "cellStyles" with their associated styles         "cellS (+5 more)
...
Cohesion: 0.15
Nodes (18): buildInvoiceLabel(), buildOverdueLabel(), DashboardData, formatCurrency(), formatCurrencyParts(), formatDueDate(), TenantDashboard(), TENANT_DASHBOARD_TOUR_STEPS (+10 more)
...
Cohesion: 0.2
Nodes (17): sendLandlordCredentialsCopy(), sendLandlordOnboardingMagicLink(), sendLandlordRegistrationApproved(), sendLeaseActivatedNotification(), sendProspectPaymentRequestEmail(), sendRegistrationOTP(), sendTenantCredentials(), sendTenantOnboardingReminder() (+9 more)
...
Cohesion: 0.23
Nodes (10): ChatHeaderProps, ContactItem(), ContactItemProps, ContactListProps, ContactItem, PaymentIssueResolver(), PaymentIssueResolverProps, ROLE_META (+2 more)
...
Cohesion: 0.12
Nodes (13): code:typescript (it('fetches comments with nested replies (max depth 2)', asy), code:bash (git add src/lib/community/actions.ts), code:typescript (it('allows landlord to update post title/content', async () ), code:typescript (it('allows landlord to archive post', async () => {), code:bash (git add src/lib/community/actions.ts), code:typescript (it('toggles reaction on post', async () => {), code:bash (git add src/lib/community/actions.ts), code:bash (git add src/lib/community/actions.ts) (+5 more)
...
Cohesion: 0.29
Nodes (12): BadgeRole, ChatUser, ContactCard(), ContactCardProps, DEFAULT_CHAT_STATE, formatConversationTimestamp(), formatMiniTimestamp(), MiniChatMessage (+4 more)
...
Cohesion: 0.28
Nodes (9): useOptionalProperty(), useVisualBuilderState(), formatFloorWatermark(), getFloorDisplayLabel(), parseFloorNumber(), formatFloorWatermark(), getFloorDisplayLabel(), parseFloorNumber() (+1 more)
...
Cohesion: 0.53
Nodes (4): formatDate(), getPaymentCategory(), PaymentCategory, PaymentItem
...
## Knowledge Gaps
- **2121 isolated node(s):** `supabase`, `supabase`, `supabase`, `supabase`, `eslintConfig` (+2116 more)
...
- **Why does `Serialisable` connect `Community 8` to `Community 0`, `Community 5`, `Community 6`, `Community 133`, `Community 10`, `Community 139`, `Community 12`, `Community 11`, `Community 14`, `Community 15`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 29`, `Community 32`, `Community 33`, `Community 35`, `Community 42`, `Community 46`, `Community 51`, `Community 185`, `Community 57`, `Community 60`, `Community 68`, `Community 69`, `Community 84`, `Community 89`, `Community 217`, `Community 96`, `Community 97`, `Community 227`, `Community 228`, `Community 102`, `Community 105`, `Community 106`, `Community 109`, `Community 118`, `Community 119`?**
  _High betweenness centrality (0.152) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 2` to `Community 1`, `Community 3`, `Community 132`, `Community 9`, `Community 13`, `Community 16`, `Community 17`, `Community 144`, `Community 23`, `Community 24`, `Community 154`, `Community 27`, `Community 28`, `Community 155`, `Community 162`, `Community 163`, `Community 37`, `Community 294`, `Community 167`, `Community 45`, `Community 55`, `Community 56`, `Community 59`, `Community 67`, `Community 74`, `Community 76`, `Community 77`, `Community 83`, `Community 88`, `Community 216`, `Community 99`, `Community 108`, `Community 113`, `Community 116`, `Community 117`, `Community 126`?**
  _High betweenness centrality (0.136) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 11` to `Community 0`, `Community 1`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 138`, `Community 23`, `Community 24`, `Community 25`, `Community 151`, `Community 36`, `Community 41`, `Community 169`, `Community 44`, `Community 50`, `Community 52`, `Community 56`, `Community 58`, `Community 59`, `Community 67`, `Community 195`, `Community 198`, `Community 199`, `Community 75`, `Community 94`?**
