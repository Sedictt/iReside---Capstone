...
## Corpus Check
- 921 files · ~6,901,688 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7634 nodes · 19087 edges · 562 communities (377 shown, 185 thin omitted)
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 4452 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1fcffb40`
...
## Communities (562 total, 185 thin omitted)
...
Cohesion: 0.05
Nodes (81): Alias, MultiSequence, MultiSequencePart, NestedSequence, Allow a multisequence to be built up from parts      Excluded from the instance, Wrap a sequence in an containing object, Sequences can contain objects with different tags, PresetGeometry2D (+73 more)
...
Cohesion: 0.03
Nodes (77): Connection, ConnectorLocking, ConnectorNonVisual, ConnectorShape, NonVisualConnectorProperties, Shape, ShapeMeta, anchor() (+69 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (60): Chartsheet, ChartsheetProperties, ChartsheetProtection, WebPublishItem, WebPublishItems, DrawingHF, SheetBackgroundPicture, ChartsheetView (+52 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (81): ActionBody, ALLOWED_STATUSES, createLeaseRecord(), createPaymentRecords(), generateTempPassword(), getStateForAction(), InquiryAction, isAllowedStatus() (+73 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (70): Bool, PhoneticProperties, PhoneticText, RichText, Text, Level, MultiLevelStrData, MultiLevelStrRef (+62 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (81): ChatUser, ContactCard(), ContactCardProps, DEFAULT_CHAT_STATE, formatConversationTimestamp(), formatMiniTimestamp(), MiniChatMessage, MiniChatState (+73 more)

### Community 8 - "Community 8"
Cohesion: 0.08
Nodes (59): ColorChoice, Percentage, ColorChoice, HSLColor, RGBPercent, SchemeColor, SystemColor, Transform (+51 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (57): VALUES, WHO_IT_SERVES, AdminSidebar(), NAV_ITEMS, HOW_IT_WORKS, IRIS_WORKFLOWS, OUTCOMES, ScrollyTellingLandingPage() (+49 more)
...
Cohesion: 0.04
Nodes (41): Alias, Aliases can be used when either the desired attribute name is not allowed     or, CellRange, A sequence of primitive types that are stored as a single attribute.     "val" i, ValueSequence, String, Extension, ExtensionList (+33 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (53): AnalyticsPage(), DEFAULT_EXTENDED_KPIS, DEFAULT_FINANCIAL_CHART, DEFAULT_OPERATIONAL_SNAPSHOT, DEFAULT_PRIMARY_KPIS, ExportAuditItem, formatIsoDate(), getDateLabels() (+45 more)
...
Cohesion: 0.08
Nodes (37): AdminLayout(), geistMono, geistSans, metadata, RootLayout(), ThemeProvider(), AuthContext, AuthContextValue (+29 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (22): DataValidationList, Need to skip validations that have no cell ranges, ArrayFormula, DataTableFormula, PrintOptions, Worksheet print options, Break, ColBreak (+14 more)

### Community 20 - "Community 20"
Cohesion: 0.06
Nodes (63): array, TenantUnitMapData, TenantUnitMapPage(), VisualPlannerPage(), UnitListingWizard(), CanvasItemKind, canViewTenantProfile, ComplaintModal() (+55 more)

### Community 21 - "Community 21"
Cohesion: 0.08
Nodes (53): buildHeuristicMaintenanceTriage(), clampConfidence(), computeMaintenanceTriageHash(), DISTRESSED_KEYWORDS, HIGH_KEYWORDS, MaintenanceSentiment, MaintenanceTriageInput, MaintenanceTriageResult (+45 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (37): LeaseDocument(), LeaseHubContent(), LeasesPage(), TabId, GET(), TENANT_LEASE_TOUR_STEPS, DEFAULT_OCCUPANCY, ENUM_TO_PROPERTY_TYPE (+29 more)
...
Cohesion: 0.09
Nodes (45): applyLexiconRedaction(), applyPatternRedaction(), buildWholeTermRegex(), condenseRedactionMarkers(), detectPhishing(), detectSpam(), escapeRegExp(), hasLexiconMatch() (+37 more)
...
Cohesion: 0.06
Nodes (34): column_letter(), coordinate(), Return and remove the first cell, product(), build_workbook(), format_case_id(), resolve_output_path(), cols_from_range() (+26 more)
...
Cohesion: 0.06
Nodes (20): read_external_link(), DocumentProperties, High-level properties of the document.     Defined in ECMA-376 Par2 Annex D, Find all sheets in the workbook and return the link to the source file., Bind defined names and other definitions to worksheets or the workbook, WorkbookParser, TableStyleList, Error for trying to modify a read-only workbook (+12 more)
...
Cohesion: 0.1
Nodes (29): buildInvoiceLabel(), buildOverdueLabel(), DashboardData, formatCurrency(), formatCurrencyParts(), formatDueDate(), TenantDashboard(), TENANT_DASHBOARD_TOUR_STEPS (+21 more)

### Community 45 - "Community 45"
Cohesion: 0.06
Nodes (13): PageMargins, Identical to openpyxl.worksheet.page.Pagemargins but element names are different, CustomChartsheetView, CustomChartsheetViews, avoid_duplicate_name(), Naive check to see whether name already exists.     If name does exist suggest a, title(), _WorkbookChild (+5 more)
...
Cohesion: 0.11
Nodes (30): ADVANCE_TEMPLATE_KEYS, buildPaymentPreview(), DEPOSIT_TEMPLATE_KEYS, InviteApplicationType, InviteListItem, InviteMode, InviteRequirementKey, parseAmount() (+22 more)
...
Cohesion: 0.07
Nodes (21): Max, Min, Values must be less than a `max` value, Values must be greater than a `min` value, collapse_cell_addresses(), DataValidation, expand_cell_ranges(), Adds a cell or cell coordinate to this validator (+13 more)
...
Cohesion: 0.09
Nodes (17): Alignment, Alignment options for use in styles., Border, Border positioning for use in styles., ArrayDescriptor, CellStyle, _NamedCellStyle, _NamedCellStyleList (+9 more)
...
Cohesion: 0.16
Nodes (25): addDays(), clampStepIndex(), createTenantProductTourState(), ensureTenantProductTourState(), getTenantProductTourSkipCooldownDays(), getTenantProductTourState(), getTenantProductTourStepById(), isTourStatus() (+17 more)
...
Cohesion: 0.09
Nodes (16): Sequence, _assign_position(), Fill, GradientFill, PatternFill, Automatically assign positions if a list of colours is provided.      It is not, Fill areas with gradient      Two types of gradient fill are supported:, Area fill patterns for use in styles.     Caution: if you do not specify a fill_ (+8 more)
...
Cohesion: 0.11
Nodes (5): Border options for use in styles.     Caution: if you do not specify a border_st, Side, apply_stylesheet(), from_tree(), Add styles to workbook if present
...
Cohesion: 0.13
Nodes (11): ExcelReader, _find_workbook_part(), load_workbook(), Read an Excel package and dispatch the contents to the relevant modules, Open the given filename and return the workbook      :param filename: the path t, Does a first check whether filename is a string or a file-like     object. If it, _validate_archive(), Read in all shared strings in the table (+3 more)
...
Cohesion: 0.26
Nodes (13): completeSchema, POST(), completeTenantProductTour(), isGuidedTenantProductTourEnabled(), skipTenantProductTour(), TENANT_PRODUCT_TOUR_STEPS, POST(), skipSchema (+5 more)
...
Cohesion: 0.24
Nodes (14): config, middleware(), isAllowlistedTenantRoute(), isAllowlistedTenantWritePath(), isPublicRoute(), isTenantApiWriteRequest(), isTourAutoStartRoute(), PUBLIC_EXACT_ROUTES (+6 more)
...
Cohesion: 0.17
Nodes (12): read_chart(), get_dependents(), get_rel(), get_rels_path(), Normalise dependency file paths to absolute ones      Relative paths are relativ, Get related object based on id or rel_type, Find relationships by content-type         NB. these content-types namespaced ob, Convert relative path to absolutes that can be loaded from a zip     archive. (+4 more)
...
Cohesion: 0.22
Nodes (12): evaluateTenantProductTourEligibility(), getTenantProductTourRequiredStep(), isNextProductTourStepSubmission(), replayTenantProductTour(), TenantProductTourState, POST(), baseState(), result (+4 more)
...
Cohesion: 0.33
Nodes (9): ActionItem, ActionRequired(), ActionSummary, formatDateLabel(), getDaysUntil(), MaintenanceRequestItem, statusLabel, TenantItem (+1 more)
...
Cohesion: 0.46
Nodes (6): DbUnit, FloorConfig, floorDisplayName(), FloorLane(), MapSetupWizardProps, SortableUnit()
...
Cohesion: 0.6
Nodes (4): isTourEnabledClient(), StepProgressPayload, TenantProductTourOverlay(), TourApiPayload
...
## Knowledge Gaps
- **1895 isolated node(s):** `supabase`, `supabase`, `supabase`, `supabase`, `fs` (+1890 more)
...
- **Why does `Serialisable` connect `Community 4` to `Community 0`, `Community 1`, `Community 3`, `Community 6`, `Community 8`, `Community 12`, `Community 19`, `Community 25`, `Community 27`, `Community 28`, `Community 33`, `Community 164`, `Community 41`, `Community 45`, `Community 179`, `Community 53`, `Community 54`, `Community 56`, `Community 58`, `Community 59`, `Community 62`, `Community 63`, `Community 64`, `Community 67`, `Community 71`, `Community 76`, `Community 79`, `Community 81`, `Community 86`, `Community 92`, `Community 94`, `Community 98`, `Community 103`, `Community 104`, `Community 106`?**
  _High betweenness centrality (0.147) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 1` to `Community 2`, `Community 3`, `Community 4`, `Community 131`, `Community 6`, `Community 135`, `Community 7`, `Community 10`, `Community 11`, `Community 15`, `Community 17`, `Community 149`, `Community 21`, `Community 152`, `Community 29`, `Community 36`, `Community 39`, `Community 40`, `Community 173`, `Community 47`, `Community 176`, `Community 178`, `Community 61`, `Community 84`, `Community 88`, `Community 123`, `Community 127`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 13` to `Community 133`, `Community 134`, `Community 7`, `Community 9`, `Community 141`, `Community 142`, `Community 15`, `Community 16`, `Community 18`, `Community 20`, `Community 21`, `Community 22`, `Community 149`, `Community 152`, `Community 150`, `Community 31`, `Community 40`, `Community 43`, `Community 44`, `Community 46`, `Community 47`, `Community 175`, `Community 60`, `Community 61`, `Community 66`, `Community 201`, `Community 209`, `Community 210`, `Community 211`, `Community 84`, `Community 212`, `Community 88`, `Community 90`, `Community 91`, `Community 95`, `Community 96`, `Community 110`, `Community 116`, `Community 122`, `Community 253`, `Community 126`, `Community 127`?**
