...
## Corpus Check
- 981 files · ~7,142,934 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8965 nodes · 20853 edges · 657 communities (456 shown, 201 thin omitted)
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 4458 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `743bab2e`
...
## Communities (657 total, 201 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (102): Level, MultiLevelStrData, MultiLevelStrRef, NumData, NumVal, StrData, StrVal, Chartsheet (+94 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (110): ThemeToggle(), ThemeToggleProps, ChatUser, ContactCard(), ContactCardProps, ContactsSidebar(), DEFAULT_CHAT_STATE, EMPTY_ARRAY (+102 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (82): title_maker(), ColorChoice, Convertible, HexBinary, Percentage, EmptyTag, NestedText, NestedValue (+74 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (93): AnalyticsPage(), DEFAULT_EXTENDED_KPIS, DEFAULT_FINANCIAL_CHART, DEFAULT_OPERATIONAL_SNAPSHOT, DEFAULT_PRIMARY_KPIS, ExportAuditItem, formatIsoDate(), getDateLabels() (+85 more)
...
Cohesion: 0.04
Nodes (65): Loading(), ConsultationDashboard(), Document, ConsultationTool(), ConsultationToolProps, DigitalSigner, GlobalLoadingContext, GlobalLoadingContextType (+57 more)
...
Cohesion: 0.03
Nodes (46): Base64Binary, CellRange, Extension, Size in hundredths of points.     In theory other units of measurement can be us, TextPoint, UniversalMeasure, A sequence of primitive types that are stored as a single attribute.     "val" i, ValueSequence (+38 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (78): ActorProfile, ApplicationResponse, ApplicationRow, AuditRow, buildComplianceChecklist(), ComplianceChecklist, DEFAULT_COMPLIANCE_CHECKLIST, extractMissingColumn() (+70 more)
...
Cohesion: 0.05
Nodes (59): CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, useAuth(), Property, PropertyContext, PropertyContextValue (+51 more)

### Community 12 - "Community 12"
Cohesion: 0.07
Nodes (51): _3DBase, AreaChart, AreaChart3D, _AreaChartBase, ChartLines, NumericAxis, SeriesAxis, TextAxis (+43 more)

### Community 13 - "Community 13"
Cohesion: 0.06
Nodes (43): Shape, anchor(), Drawing, a drawing object - eg container for shapes or charts         we assume user spec, Point2D, PositiveSize2D, PresetGeometry2D, Transform2D (+35 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (49): generateOTP(), GET(), POST(), ensureBucket(), POST(), sanitizeFileName(), assertAdmin(), MUTABLE_STATUSES (+41 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (47): DocsHeader(), DocsHeaderProps, DocsLayout(), DOCS_NAV, DocsSidebar(), NavItem, NavSection, Layout() (+39 more)
...
Cohesion: 0.05
Nodes (32): Guid, Relation, ChildSheet, FileRecoveryProperties, PivotCache, Represents a reference to a worksheet or chartsheet in workbook.xml      It cont, Represent the workbook file in the archive, WorkbookPackage (+24 more)

### Community 18 - "Community 18"
Cohesion: 0.06
Nodes (44): buildInvoiceLabel(), buildOverdueLabel(), DashboardData, formatCurrency(), formatCurrencyParts(), formatDueDate(), TenantDashboard(), LeaseDocument() (+36 more)

### Community 19 - "Community 19"
Cohesion: 0.07
Nodes (33): NestedSequence, Wrap a sequence in an containing object, ElementList, Return a dictionary of relations keyed by id, RelationshipList, Index, AutoSortScope, ChartFormat (+25 more)

### Community 20 - "Community 20"
Cohesion: 0.08
Nodes (35): _BaseAxis, DateAxis, DisplayUnitsLabel, DisplayUnitsLabelList, Scaling, AxId, ChartContainer, ChartSpace (+27 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (24): ReadOnlyCell, dict, DefinedNameDict, Utility class for storing defined names.     Allows access by name and separatio, Add names without worrying about key and name matching., ArrayFormula, DataTableFormula, Break (+16 more)

### Community 22 - "Community 22"
Cohesion: 0.07
Nodes (43): GET(), getBillingWorkspace(), BILLING_BUCKETS, DEFAULT_LIMITS, ensureBucket(), removeBillingFile(), uploadBillingFile(), sanitizeFileName() (+35 more)

### Community 23 - "Community 23"
Cohesion: 0.09
Nodes (56): advancePaymentSchema, POST(), ActiveLeaseWorkspaceRow, AppSupabaseClient, BillingLeaseRow, buildInvoiceListItem(), createAdvancePayment(), createMultiMonthAdvancePayment() (+48 more)
...
Cohesion: 0.06
Nodes (38): VALUES, WHO_IT_SERVES, HOW_IT_WORKS, IRIS_WORKFLOWS, OUTCOMES, ScrollyTellingLandingPage(), SHOWCASE_MODULES, mockApplications (+30 more)
...
Cohesion: 0.05
Nodes (39): coordinate(), cols(), DummyWorksheet, Return and remove the first cell, Normalise cell range references, Reference, rows(), product() (+31 more)

### Community 29 - "Community 29"
Cohesion: 0.13
Nodes (32): computeAmountTag(), DbClient, expireInPersonIntents(), getInPersonIntentExpiry(), getOrCreateDirectConversation(), insertPaymentAuditEvent(), MessageOptions, NotifyOptions (+24 more)

### Community 30 - "Community 30"
Cohesion: 0.11
Nodes (39): NumberValueDescriptor, Data should be numerical but isn't always :-/, ManualLayout, DataPoint, PictureOptions, DoughnutChart, PieChart, PieChart3D (+31 more)

### Community 31 - "Community 31"
Cohesion: 0.06
Nodes (13): HyperlinkList, MergeCell, MergeCells, Related, create_temporary_file(), Return all rows, and any cells that they contain, As per discusion with the OOXML Working Group global sort state is not required., Comments & VBA controls use VML and require an additional element         that i (+5 more)
...
Cohesion: 0.05
Nodes (18): DocumentProperties, High-level properties of the document.     Defined in ECMA-376 Par2 Annex D, TableStyleList, active(), get_index(), Create a worksheet (at an optional index).          :param title: optional title, Add an worksheet (at an optional index)., Move a sheet or sheetname (+10 more)
...
Cohesion: 0.05
Nodes (31): Cell, column_letter(), coordinate(), get_time_format(), get_type(), Check string coding, length, and line break character, Tries to convert Error" else N/A, Given a value, infer the correct data type (+23 more)

### Community 36 - "Community 36"
Cohesion: 0.06
Nodes (25): columns(), _gutter(), Returns a cell object based on the given coordinates.          Usage: cell(row=1, Internal method for getting a cell from a worksheet.         Will create a new c, Internal method for adding cell objects., Convenience access by Excel style coordinates          The key can be a single c, Produces cells from the worksheet, by row. Specify the iteration range         u, Produces cells from the worksheet, by column. Specify the iteration range (+17 more)

### Community 37 - "Community 37"
Cohesion: 0.06
Nodes (22): BoundDictionary, StyleableObject, Base class for styleble objects implementing proxy and lookup functions, StyleableObject, BoundDictionary, A default dictionary where elements are tightly coupled.      The factory method, ColumnDimension, Dimension (+14 more)

### Community 38 - "Community 38"
Cohesion: 0.06
Nodes (27): Alignment, Alignment options for use in styles., Border, Border positioning for use in styles., CellStyle, Fill, GradientFill, PatternFill (+19 more)
...
Cohesion: 0.05
Nodes (21): sheetname(), MultiCellRange, absolute_coordinate(), quote_sheetname(), Add quotes around sheetnames if they contain spaces., Convert a coordinate to an absolute coordinate string (B12 -> $B$12), ColRange, from_string() (+13 more)
...
Cohesion: 0.07
Nodes (12): Simplified named tuple with an array, StyleArray, Return a copy of the proxied object., Add proxied object to another instance and return the combined object, Return a copy of the proxied object. Keyword args will be passed through, Proxy formatting objects so that they cannot be altered, StyleProxy, NamedStyleDescriptor (+4 more)
...
Cohesion: 0.08
Nodes (19): is_date(), CellStyleList, ColorList, builtin_format_code(), builtin_format_id(), is_date_format(), is_datetime(), is_timedelta_format() (+11 more)

### Community 63 - "Community 63"
Cohesion: 0.15
Nodes (24): LandlordProductTourTriggerSource, resolveTenantProductTourEligibility(), TenantProductTourTriggerSource, config, middleware(), auth(), isAllowlistedTenantRoute(), isAllowlistedTenantWritePath() (+16 more)
...
Cohesion: 0.07
Nodes (12): _convert(), DateTime, Default, Length, MatchPattern, Min, When called returns an instance of the expected type.     Additional default val, Values must match a regex pattern (+4 more)
...
Cohesion: 0.09
Nodes (13): etree_write_cell(), lxml_write_cell(), Set coordinate and datatype, _set_attributes(), Safely and consistently format numeric values, safe_string(), _explicit_none(), Override serialisation because explicit none required (+5 more)

### Community 69 - "Community 69"
Cohesion: 0.11
Nodes (15): Generate string representation of XML element.      All subelements are included, tostring(), get_rels_path(), Convert relative path to absolutes that can be loaded from a zip     archive., Add to zipfile and update manifest, Write the relevant child objects and add links, InvalidFileException, Error for trying to open a non-ooxml file. (+7 more)
...
Cohesion: 0.07
Nodes (9): PrintOptions, PrintPageSetup, Worksheet print options, Worksheet print page setup, Outline, PageSetupProperties, WorksheetProperties, ScenarioList (+1 more)
...
Cohesion: 0.12
Nodes (25): InvoiceListItem, InvoiceReadingDetail, formatPhpCurrency(), buildFaceToFacePreviewInvoice(), buildSelectivePreviewInvoice(), CheckoutPage(), Field(), InvoiceDetail (+17 more)
...
Cohesion: 0.19
Nodes (13): completeSchema, POST(), LANDLORD_PRODUCT_TOUR_STEPS, isGuidedTenantProductTourEnabled(), TENANT_PRODUCT_TOUR_STEPS, POST(), POST(), skipSchema (+5 more)
...
Cohesion: 0.07
Nodes (17): defaultdict, Max, Values must be less than a `max` value, Break names down into sheet locals and globals, collapse_cell_addresses(), DataValidation, DataValidationList, expand_cell_ranges() (+9 more)
...
Cohesion: 0.21
Nodes (18): ApplicationIdentityStep(), ApplicationProfileStep(), CardFrame(), GlassInput(), GlassInputProps, SharedStepProps, DEFAULT_CHECKLIST, DEFAULT_EMPLOYMENT (+10 more)
...
Cohesion: 0.13
Nodes (18): array, DbUnit, FloorId, QuickActionGuardResult, QuickActionType, dbUnitToCanvasUnit(), formatFloorWatermark(), getFloorDisplayLabel() (+10 more)
...
Cohesion: 0.13
Nodes (11): read_chart(), read_external_link(), get_dependents(), get_rel(), Normalise dependency file paths to absolute ones      Relative paths are relativ, Get related object based on id or rel_type, Find relationships by content-type         NB. these content-types namespaced ob, find_images() (+3 more)
...
Cohesion: 0.12
Nodes (7): Alias, Aliases can be used when either the desired attribute name is not allowed     or, Use a set to keep values unique, UniqueSequence, from_tree(), from_tree(), localname()
...
Cohesion: 0.19
Nodes (8): hash_password(), Create a password hash from a given string for protecting a worksheet     only., from_tree(), Set a revision password on this workbook., Set a password on this workbook., revisionsPassword(), workbookPassword(), Set a password on this sheet.
...
Cohesion: 0.15
Nodes (12): 14.1 Accessing the Map, 14.2 What the Map Shows, 14.3 Interacting with the Map, 14.4 2D and 3D Views, 14. Viewing the Unit Map, 18. Glossary, 1.1 What is iReside?, 1.2 Who Uses iReside? (+4 more)
...
Cohesion: 0.3
Nodes (8): applyLiveFieldValidation(), InviteApplicationClient(), InvitePayload, REQUIREMENT_LABELS, Seal(), SummaryCard(), UploadedRequirementDocument, InviteApplicationPage()
...
Cohesion: 0.27
Nodes (4): password(), _Protected, Information about protection of various aspects of a sheet. True values     mean, SheetProtection
...
## Knowledge Gaps
- **2680 isolated node(s):** `supabase`, `supabase`, `supabase`, `supabase`, `eslintConfig` (+2675 more)
...
- **Why does `Serialisable` connect `Community 0` to `Community 2`, `Community 8`, `Community 137`, `Community 10`, `Community 12`, `Community 13`, `Community 17`, `Community 146`, `Community 19`, `Community 20`, `Community 147`, `Community 21`, `Community 28`, `Community 285`, `Community 30`, `Community 31`, `Community 33`, `Community 34`, `Community 37`, `Community 38`, `Community 53`, `Community 62`, `Community 64`, `Community 68`, `Community 70`, `Community 71`, `Community 80`, `Community 81`, `Community 216`, `Community 97`, `Community 99`, `Community 103`, `Community 232`, `Community 110`, `Community 117`, `Community 121`, `Community 122`, `Community 123`, `Community 381`, `Community 382`?**
  _High betweenness centrality (0.139) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 10` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 9`, `Community 14`, `Community 16`, `Community 23`, `Community 29`, `Community 165`, `Community 166`, `Community 39`, `Community 41`, `Community 46`, `Community 52`, `Community 189`, `Community 74`, `Community 76`, `Community 78`, `Community 209`, `Community 211`, `Community 212`, `Community 230`, `Community 106`, `Community 107`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 3` to `Community 1`, `Community 255`, `Community 5`, `Community 6`, `Community 7`, `Community 11`, `Community 15`, `Community 18`, `Community 24`, `Community 26`, `Community 32`, `Community 166`, `Community 40`, `Community 169`, `Community 41`, `Community 170`, `Community 49`, `Community 51`, `Community 180`, `Community 54`, `Community 182`, `Community 57`, `Community 189`, `Community 74`, `Community 76`, `Community 209`, `Community 88`, `Community 106`, `Community 107`, `Community 112`, `Community 113`, `Community 114`, `Community 115`, `Community 120`, `Community 127`?**
