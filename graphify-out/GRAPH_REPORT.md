# Graph Report - iReside  (2026-05-10)

## Corpus Check
- 935 files · ~6,907,494 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7786 nodes · 19357 edges · 573 communities (385 shown, 188 thin omitted)
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 4456 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `68756c63`
...
- `checkAndFixProperty()` --calls--> `createAdminClient()`  [EXTRACTED]
...
## Communities (573 total, 188 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (140): _3DBase, PhoneticProperties, PhoneticText, RichText, Text, _3DBase, Base class for 3D charts, Surface (+132 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (93): AuthorList, CommentRecord, CommentSheet, Properties, Base64Binary, CellRange, Extension, Guid (+85 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (87): Alias, MultiSequence, MultiSequencePart, NestedSequence, Allow a multisequence to be built up from parts      Excluded from the instance, Wrap a sequence in an containing object, Sequences can contain objects with different tags, ElementList (+79 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (88): ExtensionList, Percentage, Connection, ConnectorLocking, ConnectorNonVisual, ConnectorShape, NonVisualConnectorProperties, Shape (+80 more)
...
Cohesion: 0.05
Nodes (97): ThemeToggle(), ThemeToggleProps, ChatUser, ContactCard(), ContactCardProps, ContactsSidebar(), DEFAULT_CHAT_STATE, formatConversationTimestamp() (+89 more)
...
Cohesion: 0.05
Nodes (57): CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, useAuth(), Property, PropertyContext, PropertyContextValue (+49 more)

### Community 11 - "Community 11"
Cohesion: 0.07
Nodes (63): addComment(), approveResidentPost(), canCreatePostType(), CommunityRole, createAnnouncementPost(), createDiscussionPost(), createPhotoAlbumPost(), createPollPost() (+55 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (46): ConsultationDashboard(), Document, ConsultationTool(), ConsultationToolProps, DigitalSigner, ConsultationTool, SignPage(), BusinessPermitCard() (+38 more)
...
Cohesion: 0.06
Nodes (47): buildInvoiceLabel(), buildOverdueLabel(), DashboardData, formatCurrency(), formatCurrencyParts(), formatDueDate(), TenantDashboard(), Document (+39 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (48): VALUES, WHO_IT_SERVES, geistMono, geistSans, metadata, RootLayout(), HOW_IT_WORKS, IRIS_WORKFLOWS (+40 more)

### Community 16 - "Community 16"
Cohesion: 0.07
Nodes (49): getBillingWorkspace(), BILLING_BUCKETS, DEFAULT_LIMITS, ensureBucket(), removeBillingFile(), uploadBillingFile(), GET(), POST() (+41 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (53): PAYMENT_METHODS, PaymentRecordForm(), PaymentRecordFormProps, SigningMode, SigningModeSelector(), SigningModeSelectorProps, ACTIVE_REQUIREMENT_KEYS, BackgroundGlow() (+45 more)
...
Cohesion: 0.09
Nodes (40): GET(), isJsonObject(), MessageBody, POST(), CreateConversationBody, GET(), POST(), ALLOWED_MIME_TYPES (+32 more)
...
Cohesion: 0.08
Nodes (49): CanvasItemKind, canViewTenantProfile, ComplaintModal(), Corridor, CorridorResizeHandle, daysRemaining, DbUnit, dbUnitToCanvasUnit() (+41 more)
...
Cohesion: 0.05
Nodes (17): ReadOnlyCell, ArrayFormula, DataTableFormula, Make sure a row contains always the same number of cells or values, Cells are returned by a generator which can be empty, Remove worksheet dimensions if these are incorrect in the worksheet source., Parse xml source on demand, must close after use, The source worksheet file may have columns or rows missing.         Missing cell (+9 more)
...
Cohesion: 0.13
Nodes (7): PlotArea(), Collection of utility primitives for charts., cols(), DummyWorksheet, Normalise cell range references, Reference, rows()
...
Cohesion: 0.08
Nodes (25): Bool, DateTime, Descriptor, A sequence (list or tuple) that may only contain objects of the declared     typ, Sequence, NestedText, NestedDateTime, QualifiedDateTime (+17 more)
...
Cohesion: 0.09
Nodes (40): getLandlordProperties(), getPropertyById(), Amenity, AmenityBooking, Application, ApplicationSource, ApplicationWithDetails, ConsultationDocument (+32 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (18): column_letter(), comment(), coordinate(), get_time_format(), get_type(), is_date(), Given a value, infer the correct data type, value() (+10 more)

### Community 39 - "Community 39"
Cohesion: 0.06
Nodes (26): Cell, Check string coding, length, and line break character, Tries to convert Error" else N/A, Returns a cell location relative to this cell.          :param row: number of ro, Describes cell associated properties.      Properties of interest include style,, WriteOnlyCell(), Exception, CellCoordinatesException (+18 more)
...
Cohesion: 0.06
Nodes (24): read_chart(), defaultdict, Max, Min, Values must be less than a `max` value, Values must be greater than a `min` value, Break names down into sheet locals and globals, collapse_cell_addresses() (+16 more)
...
Cohesion: 0.09
Nodes (10): Sequence, Border options for use in styles.     Caution: if you do not specify a border_st, Side, _assign_position(), Automatically assign positions if a list of colours is provided.      It is not, Stop, StopList, apply_stylesheet() (+2 more)

### Community 51 - "Community 51"
Cohesion: 0.07
Nodes (9): PrintOptions, Worksheet print options, Break, ColBreak, RowBreak, password(), Information about protection of various aspects of a sheet. True values     mean, SheetProtection (+1 more)
...
Cohesion: 0.07
Nodes (11): ASCII, _convert(), DateTime, Default, MatchPattern, When called returns an instance of the expected type.     Additional default val, Values must match a regex pattern, Values must of a particular type (+3 more)
...
Cohesion: 0.18
Nodes (21): ActionBody, ALLOWED_STATUSES, createLeaseRecord(), createPaymentRecords(), generateTempPassword(), getStateForAction(), InquiryAction, isAllowedStatus() (+13 more)
...
Cohesion: 0.1
Nodes (12): sheetname(), absolute_coordinate(), quote_sheetname(), Add quotes around sheetnames if they contain spaces., Convert a coordinate to an absolute coordinate string (B12 -> $B$12), DefinedName, create_named_range(), get_active_sheet() (+4 more)

### Community 74 - "Community 74"
Cohesion: 0.09
Nodes (12): DocumentProperties, High-level properties of the document.     Defined in ECMA-376 Par2 Annex D, TableStyleList, Create a worksheet (at an optional index).          :param title: optional title, Add an worksheet (at an optional index)., Returns a worksheet by its name.          :param name: the name of the worksheet, Save the current workbook under the given `filename`.         Use this function, Copy an existing worksheet in the current workbook          .. warning:: (+4 more)
...
Cohesion: 0.08
Nodes (13): MultiCellRange, ColRange, from_string(), PrintArea, PrintTitles, Contains at least either a range of rows or columns, Represent a range of at least one column, Represent a range of at least one row (+5 more)
...
Cohesion: 0.25
Nodes (15): AuditEvent, extractIpAddress(), extractUserAgent(), sendLeaseActivatedNotification(), getAllowedTransitions(), getTransitionErrorMessage(), isValidLeaseStatusTransition(), VALID_TRANSITIONS (+7 more)

### Community 89 - "Community 89"
Cohesion: 0.11
Nodes (15): String, Alignment, Alignment options for use in styles., CellStyle, _NamedCellStyle, _NamedCellStyleList, NamedStyleList, Named styles are editable and can be applied to multiple objects      As only th (+7 more)
...
Cohesion: 0.19
Nodes (14): evaluateTenantProductTourEligibility(), getTenantProductTourRequiredStep(), isNextProductTourStepSubmission(), TenantProductTourState, isTourEnabledClient(), StepProgressPayload, TenantProductTourOverlay(), TourApiPayload (+6 more)
...
Cohesion: 0.12
Nodes (10): Border, Border positioning for use in styles., PatternFill, Area fill patterns for use in styles.     Caution: if you do not specify a fill_, NamedStyle, Return a style array representing the current style, Return equivalent XfStyle, Return relevant named style (+2 more)
...
Cohesion: 0.22
Nodes (8): DocsPage(), UnitMapFeatureSection(), FeaturesPage(), metadata, DocDetailPage(), DOCS_CONTENT, Button(), buttonVariants

### Community 118 - "Community 118"
Cohesion: 0.25
Nodes (12): sendLandlordCredentialsCopy(), sendLandlordOnboardingMagicLink(), sendLandlordRegistrationApproved(), sendProspectPaymentRequestEmail(), sendRegistrationOTP(), sendTenantOnboardingReminder(), sendTenantSignedNotification(), transporter (+4 more)
...
Cohesion: 0.14
Nodes (12): code:typescript (// src/lib/community/queries.ts), code:typescript (// src/lib/community/__tests__/queries.test.ts), code:bash (cd src/lib/community), code:bash (npx vitest --run), code:bash (git add src/lib/community/queries.ts src/lib/community/__tes), code:typescript (it('returns ordered photos for album', async () => {), code:bash (git add src/lib/community/actions.ts), code:bash (git add src/lib/community/actions.ts) (+4 more)
...
Cohesion: 0.21
Nodes (12): AMENITIES, Amenity, amenityToModalData(), Booking, BookingModalData, bookingToDisplay(), DisplayBooking, formatBookingDate() (+4 more)
...
Cohesion: 0.18
Nodes (6): dict, DefinedNameDict, destinations(), Utility class for storing defined names.     Allows access by name and separatio, Add names without worrying about key and name matching., type()
...
Cohesion: 0.36
Nodes (4): formatRelativeDate(), GET(), InquiryItem, NotificationItem
...
Cohesion: 0.33
Nodes (7): array, useOptionalProperty(), formatFloorWatermark(), getFloorDisplayLabel(), parseFloorNumber(), SidebarBlockLibrary(), VisualBuilder()
...
Cohesion: 0.38
Nodes (3): Outline, PageSetupProperties, WorksheetProperties
...
Cohesion: 1.0
Nodes (3): evaluateQuickAction(), executeQuickAction(), handleQuickAction()
...
## Knowledge Gaps
- **1970 isolated node(s):** `supabase`, `supabase`, `supabase`, `supabase`, `fs` (+1965 more)
...
- **Why does `Serialisable` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 5`, `Community 22`, `Community 25`, `Community 27`, `Community 29`, `Community 32`, `Community 34`, `Community 164`, `Community 39`, `Community 41`, `Community 43`, `Community 50`, `Community 51`, `Community 183`, `Community 184`, `Community 58`, `Community 63`, `Community 64`, `Community 65`, `Community 72`, `Community 73`, `Community 74`, `Community 79`, `Community 80`, `Community 85`, `Community 89`, `Community 98`, `Community 102`, `Community 107`, `Community 244`, `Community 124`?**
  _High betweenness centrality (0.154) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 7` to `Community 6`, `Community 135`, `Community 8`, `Community 10`, `Community 12`, `Community 14`, `Community 15`, `Community 144`, `Community 17`, `Community 145`, `Community 152`, `Community 153`, `Community 24`, `Community 158`, `Community 44`, `Community 45`, `Community 46`, `Community 49`, `Community 56`, `Community 62`, `Community 67`, `Community 78`, `Community 213`, `Community 214`, `Community 87`, `Community 92`, `Community 94`, `Community 99`, `Community 100`, `Community 111`, `Community 117`, `Community 122`, `Community 127`?**
  _High betweenness centrality (0.144) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 2` to `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 134`, `Community 135`, `Community 136`, `Community 9`, `Community 6`, `Community 13`, `Community 17`, `Community 20`, `Community 21`, `Community 23`, `Community 153`, `Community 163`, `Community 36`, `Community 44`, `Community 48`, `Community 177`, `Community 49`, `Community 179`, `Community 180`, `Community 55`, `Community 56`, `Community 92`?**
