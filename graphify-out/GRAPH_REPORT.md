...
## Corpus Check
- 983 files · ~7,147,961 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9057 nodes · 20952 edges · 677 communities (474 shown, 203 thin omitted)
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 4458 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7dc4d91e`
...
## Communities (677 total, 203 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (109): Alias, HexBinary, Relation, MultiSequence, MultiSequencePart, NestedSequence, Allow a multisequence to be built up from parts      Excluded from the instance, Wrap a sequence in an containing object (+101 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (130): _3DBase, PhoneticProperties, PhoneticText, RichText, Text, _3DBase, Base class for 3D charts, Surface (+122 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (81): CustomChartsheetViews, Base64Binary, CellRange, Extension, Guid, Size in hundredths of points.     In theory other units of measurement can be us, TextPoint, UniversalMeasure (+73 more)
...
Cohesion: 0.06
Nodes (79): Bool, title_maker(), ColorChoice, Convertible, EmptyTag, NestedValue, Boolean if a tag exists or not., Nested tag storing the value on the 'val' attribute (+71 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (70): ExtensionList, Percentage, Connection, ConnectorLocking, ConnectorNonVisual, ConnectorShape, NonVisualConnectorProperties, Shape (+62 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (80): ThemeToggle(), ThemeToggleProps, ChatUser, ContactCard(), ContactCardProps, ContactsSidebar(), DEFAULT_CHAT_STATE, EMPTY_ARRAY (+72 more)
...
Cohesion: 0.04
Nodes (67): AnalyticsPage(), DEFAULT_EXTENDED_KPIS, DEFAULT_FINANCIAL_CHART, DEFAULT_OPERATIONAL_SNAPSHOT, DEFAULT_PRIMARY_KPIS, ExportAuditItem, formatIsoDate(), getDateLabels() (+59 more)
...
Cohesion: 0.05
Nodes (49): ConsultationDashboard(), Document, ConsultationTool(), ConsultationToolProps, DigitalSigner, ConsultationTool, SignPage(), BusinessPermitCard() (+41 more)
...
Cohesion: 0.06
Nodes (44): generateOTP(), GET(), POST(), ensureBucket(), POST(), sanitizeFileName(), RouteContext, fileSchema (+36 more)
...
Cohesion: 0.04
Nodes (24): CustomChartsheetView, ArrayFormula, DataTableFormula, PageMargins, PrintOptions, PrintPageSetup, Worksheet print options, Worksheet print page setup (+16 more)

### Community 18 - "Community 18"
Cohesion: 0.06
Nodes (50): CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, Property, PropertyContext, PropertyContextValue, PropertyProvider() (+42 more)
...
Cohesion: 0.07
Nodes (41): GET(), GET(), POST(), ensureBucket(), POST(), sanitizeFileName(), GET(), POST() (+33 more)

### Community 21 - "Community 21"
Cohesion: 0.07
Nodes (36): LeaseDocument(), LeaseHubContent(), LeasesPage(), TabId, TENANT_LEASE_TOUR_STEPS, DEFAULT_OCCUPANCY, ENUM_TO_PROPERTY_TYPE, NewAssetContent() (+28 more)
...
Cohesion: 0.06
Nodes (31): DocsHeader(), DocsHeaderProps, DocsLayout(), DOCS_NAV, DocsSidebar(), NavItem, NavSection, Layout() (+23 more)
...
Cohesion: 0.09
Nodes (14): PlotArea(), Level, MultiLevelStrData, MultiLevelStrRef, NumberValueDescriptor, NumData, NumVal, Collection of utility primitives for charts. (+6 more)
...
Cohesion: 0.05
Nodes (27): Max, Min, Values must be less than a `max` value, Values must be greater than a `min` value, MultiCellRange, Return a new range with cells common to this range and *other*          :type ot, Return the minimal superset of this range and *other*. This new range         wi, ColRange (+19 more)
...
Cohesion: 0.09
Nodes (27): ApplyPage(), LeaseHeader(), LeaseHeaderProps, PRIORITIES, Priority, PrioritySelectorProps, styles, AlbumGrid() (+19 more)
...
Cohesion: 0.08
Nodes (29): ComplaintModalProps, ComplaintModalProps, FloorSelector(), FloorSelectorProps, FloorTab, UnitHistoryModalProps, VisualCanvasProps, useVisualBuilderState() (+21 more)
...
Cohesion: 0.09
Nodes (23): VALUES, WHO_IT_SERVES, geistMono, geistSans, metadata, RootLayout(), HOW_IT_WORKS, IRIS_WORKFLOWS (+15 more)

### Community 56 - "Community 56"
Cohesion: 0.11
Nodes (29): buildInvoiceLabel(), buildOverdueLabel(), DashboardData, DEFAULT_QUICK_ACTIONS, formatCurrency(), formatCurrencyParts(), formatDueDate(), ICON_MAP (+21 more)
...
Cohesion: 0.12
Nodes (15): Generate string representation of XML element.      All subelements are included, tostring(), ExtendedProperties, See 22.2      Most of this is irrelevant but Excel is very picky about the versi, get_rels_path(), Convert relative path to absolutes that can be loaded from a zip     archive., InvalidFileException, Error for trying to open a non-ooxml file. (+7 more)
...
Cohesion: 0.15
Nodes (10): read_chart(), find_images(), Given the path to a drawing file extract charts and images      Ignore errors du, ExcelReader, _find_workbook_part(), load_workbook(), Read an Excel package and dispatch the contents to the relevant modules, Open the given filename and return the workbook      :param filename: the path t (+2 more)
...
Cohesion: 0.12
Nodes (13): code:typescript (it('returns poll results with aggregated vote counts', async), code:bash (npx vitest --run), code:typescript (it('fetches posts for landlord properties with filters', asy), code:bash (git add src/lib/community/actions.ts), code:typescript (it('allows tenant to vote on poll (upsert)', async () => {), code:bash (npx vitest --run), code:bash (git add src/lib/community/actions.ts), code:bash (git add src/lib/community/actions.ts) (+5 more)
...
Cohesion: 0.15
Nodes (12): 15.1 How It Works, 15.2 For Landlords, 15.3 For Tenants, 15. Utility Billing, 18. Glossary, 7.1 Adding a Property, 7.2 Adding Units, 7.3 Unit Status Colors (+4 more)
...
Cohesion: 0.22
Nodes (7): get_dependents(), get_rel(), Normalise dependency file paths to absolute ones      Relative paths are relativ, Get related object based on id or rel_type, Find relationships by content-type         NB. these content-types namespaced ob, pivot_caches(), rels()
...
Cohesion: 0.5
Nodes (4): **2.5.1 Comprehensive Property Management Platforms** {#2.5.1-comprehensive-property-management-platforms}, **2.5.2 International and Specialized Property Management Solutions** {#2.5.2-international-and-specialized-property-management-solutions}, **2.5.3 Condominium and Specialized Vertical Solutions** {#2.5.3-condominium-and-specialized-vertical-solutions}, **2.5 Related Systems** {#2.5-related-systems}
...
- **Why does `Serialisable` connect `Community 2` to `Community 0`, `Community 1`, `Community 4`, `Community 5`, `Community 13`, `Community 17`, `Community 145`, `Community 147`, `Community 22`, `Community 25`, `Community 26`, `Community 32`, `Community 37`, `Community 45`, `Community 46`, `Community 181`, `Community 53`, `Community 189`, `Community 63`, `Community 65`, `Community 68`, `Community 69`, `Community 72`, `Community 73`, `Community 91`, `Community 96`, `Community 108`, `Community 114`, `Community 115`, `Community 244`, `Community 117`, `Community 116`?**
  _High betweenness centrality (0.140) - this node is a cross-community bridge._
- **Why does `Boolean` connect `Community 0` to `Community 256`, `Community 2`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 11`, `Community 14`, `Community 15`, `Community 16`, `Community 34`, `Community 35`, `Community 163`, `Community 42`, `Community 43`, `Community 177`, `Community 49`, `Community 90`, `Community 95`, `Community 105`, `Community 242`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 0` to `Community 128`, `Community 129`, `Community 2`, `Community 3`, `Community 5`, `Community 10`, `Community 11`, `Community 14`, `Community 15`, `Community 16`, `Community 144`, `Community 31`, `Community 34`, `Community 35`, `Community 163`, `Community 162`, `Community 42`, `Community 43`, `Community 176`, `Community 57`, `Community 209`, `Community 210`, `Community 90`, `Community 228`, `Community 111`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
