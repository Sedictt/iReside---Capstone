# Graph Report - iReside  (2026-05-19)

## Corpus Check
- 987 files · ~7,160,293 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9204 nodes · 21113 edges · 680 communities (481 shown, 199 thin omitted)
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 4458 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `99a91cdc`
...
## Communities (680 total, 199 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (86): ExtensionList, Percentage, Connection, ConnectorLocking, ConnectorNonVisual, ConnectorShape, NonVisualConnectorProperties, Shape (+78 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (65): Alignment, Alignment options for use in styles., Border, Border positioning for use in styles., ArrayDescriptor, CellStyle, CellStyleList, Convert to StyleArray (+57 more)
...
Cohesion: 0.04
Nodes (86): AdminSidebar(), NAV_ITEMS, AdminLayout(), geistMono, geistSans, metadata, RootLayout(), ThemeProvider() (+78 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (81): title_maker(), ColorChoice, Convertible, HexBinary, Relation, EmptyTag, NestedValue, Boolean if a tag exists or not. (+73 more)
...
Cohesion: 0.04
Nodes (80): CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, Property, PropertyContext, PropertyContextValue, PropertyProvider() (+72 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (54): Base64Binary, CellRange, Extension, Size in hundredths of points.     In theory other units of measurement can be us, TextPoint, UniversalMeasure, A sequence of primitive types that are stored as a single attribute.     "val" i, ValueSequence (+46 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (87): ApplicationIdentityStep(), ApplicationProfileStep(), applyLiveFieldValidation(), CardFrame(), GlassInput(), GlassInputProps, SharedStepProps, ensureBucket() (+79 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (57): Objects can serialise to XML their attributes and child objects.     The followi, Serialisable, CellIsRule(), ColorScale, ColorScaleRule(), DataBar, DataBarRule(), FormatObject (+49 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (59): Loading(), ConsultationDashboard(), Document, ConsultationTool(), ConsultationToolProps, DigitalSigner, GlobalLoadingContext, GlobalLoadingContextType (+51 more)
...
Cohesion: 0.05
Nodes (51): generateOTP(), GET(), POST(), ensureBucket(), POST(), sanitizeFileName(), ensureBucket(), POST() (+43 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (46): VALUES, WHO_IT_SERVES, HOW_IT_WORKS, IRIS_WORKFLOWS, OUTCOMES, ScrollyTellingLandingPage(), SHOWCASE_MODULES, ApplyPage() (+38 more)

### Community 17 - "Community 17"
Cohesion: 0.08
Nodes (56): InlineFont, PhoneticProperties, PhoneticText, Font for inline text because, yes what you need are different objects with the s, RichText, Text, _3DBase, Base class for 3D charts (+48 more)
...
Cohesion: 0.05
Nodes (50): array, buildInvoiceLabel(), buildOverdueLabel(), DashboardData, DEFAULT_QUICK_ACTIONS, formatCurrency(), formatCurrencyParts(), formatDueDate() (+42 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (36): NestedSequence, Wrap a sequence in an containing object, Index, AutoSortScope, ChartFormat, ColHierarchiesUsage, ConditionalFormat, ConditionalFormatList (+28 more)

### Community 22 - "Community 22"
Cohesion: 0.09
Nodes (42): _3DBase, AreaChart, AreaChart3D, _AreaChartBase, DateAxis, NumericAxis, SeriesAxis, TextAxis (+34 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (55): SigningMode, SigningModeSelector(), SigningModeSelectorProps, ACTIVE_REQUIREMENT_KEYS, BackgroundGlow(), CardFrame(), CardFrameProps, ConfirmationModal() (+47 more)

### Community 24 - "Community 24"
Cohesion: 0.07
Nodes (45): GET(), getBillingWorkspace(), recordUtilityReading(), BILLING_BUCKETS, DEFAULT_LIMITS, ensureBucket(), removeBillingFile(), uploadBillingFile() (+37 more)
...
Cohesion: 0.09
Nodes (54): advancePaymentSchema, POST(), ActiveLeaseWorkspaceRow, AppSupabaseClient, BillingLeaseRow, buildInvoiceListItem(), createAdvancePayment(), createMultiMonthAdvancePayment() (+46 more)

### Community 27 - "Community 27"
Cohesion: 0.1
Nodes (46): ICON_MAP, LandlordQuestBoard(), LandlordQuestBoardProps, addDays(), clampStepIndex(), completeLandlordProductTour(), createLandlordProductTourState(), ensureLandlordProductTourState() (+38 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (35): Bool, Level, MultiLevelStrData, MultiLevelStrRef, NumberValueDescriptor, NumVal, Data should be numerical but isn't always :-/, StrData (+27 more)
...
Cohesion: 0.05
Nodes (13): ArrayFormula, DataTableFormula, Break, ColBreak, RowBreak, read_dimension(), _cast_number(), parse_richtext_string() (+5 more)

### Community 33 - "Community 33"
Cohesion: 0.07
Nodes (30): SignaturePad(), SignaturePadProps, DigitalSigner(), DigitalSignerProps, PdfPage, Signature, workerUrl, SOUND_PATHS (+22 more)

### Community 34 - "Community 34"
Cohesion: 0.05
Nodes (21): Cell, column_letter(), coordinate(), get_time_format(), get_type(), is_date(), Check string coding, length, and line break character, Tries to convert Error" else N/A (+13 more)
...
Cohesion: 0.05
Nodes (23): sheetname(), MultiCellRange, absolute_coordinate(), quote_sheetname(), Add quotes around sheetnames if they contain spaces., Convert a coordinate to an absolute coordinate string (B12 -> $B$12), ColRange, from_string() (+15 more)

### Community 37 - "Community 37"
Cohesion: 0.06
Nodes (34): BillingWorkspace, NextPayment, OverduePayment, PaymentSummaryProps, LeaseInfo, TenantDashboardHeaderProps, UnitHistoryModalProps, Action (+26 more)

### Community 38 - "Community 38"
Cohesion: 0.06
Nodes (35): product(), build_workbook(), format_case_id(), resolve_output_path(), cols_from_range(), column_index_from_string(), coordinate_from_string(), get_column_interval() (+27 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (16): hash_password(), Create a password hash from a given string for protecting a worksheet     only., avoid_duplicate_name(), Naive check to see whether name already exists.     If name does exist suggest a, title(), from_tree(), Set a revision password on this workbook., Set a password on this workbook. (+8 more)
...
Cohesion: 0.08
Nodes (26): AxId, Set the categories / x-axis values, AxDataSource, NumDataSource, NumRef, StrRef, ErrorBars, Layout (+18 more)
...
Cohesion: 0.06
Nodes (20): ASCII, _convert(), DateTime, Default, Length, MatchPattern, Max, Min (+12 more)
...
Cohesion: 0.07
Nodes (18): BoundDictionary, StyleableObject, Base class for styleble objects implementing proxy and lookup functions, StyleableObject, BoundDictionary, A default dictionary where elements are tightly coupled.      The factory method, ColumnDimension, Dimension (+10 more)
...
Cohesion: 0.08
Nodes (23): WriteOnlyCell(), Exception, CellCoordinatesException, IllegalCharacterError, NamedRangeException, The data submitted which cannot be used directly in Excel files. It     must be, Error for badly formatted named ranges., Error for bad sheet names. (+15 more)
...
Cohesion: 0.18
Nodes (19): extractIpAddress(), extractUserAgent(), sendLeaseActivatedNotification(), sendTenantSignedNotification(), generateLeasePdf(), LeasePdfData, getAllowedTransitions(), getTransitionErrorMessage() (+11 more)
...
Cohesion: 0.08
Nodes (13): Cached, Caching metaclass     Child classes will only create new instances of themselves, Singleton metaclass     Based on Python Cookbook 3rd Edition Recipe 9.13     Onl, Singleton, Alias, Aliases can be used when either the desired attribute name is not allowed     or, MetaSerialisable, MetaStrict (+5 more)
...
Cohesion: 0.21
Nodes (15): GET(), AuditEvent, logAuditEvent(), sendSigningLinkEmail(), generateLandlordSigningLink(), generateSigningToken(), generateTokenWithHash(), getJwtSecret() (+7 more)
...
Cohesion: 0.13
Nodes (12): read_chart(), find_images(), Given the path to a drawing file extract charts and images      Ignore errors du, ExcelReader, _find_workbook_part(), load_workbook(), Read an Excel package and dispatch the contents to the relevant modules, Open the given filename and return the workbook      :param filename: the path t (+4 more)
...
Cohesion: 0.15
Nodes (7): Return the full XML representation, namespaced(), Utility to create a namespaced tag for an object, Convert the sequence represented by the descriptor to an XML element, Convert the sequence represented by the descriptor to an XML element, element(), whitespace()

### Community 120 - "Community 120"
Cohesion: 0.12
Nodes (11): read_external_link(), get_dependents(), get_rel(), Normalise dependency file paths to absolute ones      Relative paths are relativ, Get related object based on id or rel_type, Find relationships by content-type         NB. these content-types namespaced ob, pivot_caches(), Find all sheets in the workbook and return the link to the source file. (+3 more)
...
Cohesion: 0.12
Nodes (6): DummyCode, Safely and consistently format numeric values, safe_string(), _explicit_none(), Override serialisation because explicit none required, _no_value()
...
Cohesion: 0.17
Nodes (6): ChartContainer, ChartSpace, Protection, PivotFormat, PivotSource, PrintSettings
...
Cohesion: 0.22
Nodes (6): CellRichText, _check_element(), _check_rich_text(), Returns a list of the strings contained.         The main reason for this is to, Represents a rich text string.      Initialize with a list made of pure strings, list
...
Cohesion: 0.12
Nodes (12): code:typescript (it('returns poll results with aggregated vote counts', async), code:bash (npx vitest --run), code:typescript (it('fetches comments with nested replies (max depth 2)', asy), code:bash (git add src/lib/community/actions.ts), code:typescript (it('allows landlord to approve resident discussion post', as), code:bash (git add src/lib/community/actions.ts), code:bash (git add src/lib/community/actions.ts), Phase 2: Server Actions & Data Layer (+4 more)
...
Cohesion: 0.36
Nodes (7): useAppToast(), DigitalSigner, LandlordLeaseSigningPage(), LandlordSigningContent(), LeaseDetails, LeaseSigningContent(), TenantLeaseSigningPage()
...
Cohesion: 0.15
Nodes (5): Return a copy of the proxied object., Add proxied object to another instance and return the combined object, Return a copy of the proxied object. Keyword args will be passed through, Proxy formatting objects so that they cannot be altered, StyleProxy
...
Cohesion: 0.24
Nodes (4): comment(), copy(), Copy the values, styles, dimensions, merged cells, margins, and     print/page s, WorksheetCopy
...
Cohesion: 0.29
Nodes (3): from_tree(), Represents text string in a specific format      This class is used as part of c, TextBlock
...
## Knowledge Gaps
- **2867 isolated node(s):** `supabase`, `supabase`, `supabase`, `supabase`, `eslintConfig` (+2862 more)
...
- **Why does `Serialisable` connect `Community 10` to `Community 0`, `Community 1`, `Community 4`, `Community 8`, `Community 139`, `Community 142`, `Community 14`, `Community 17`, `Community 18`, `Community 21`, `Community 22`, `Community 405`, `Community 28`, `Community 30`, `Community 32`, `Community 35`, `Community 42`, `Community 48`, `Community 179`, `Community 58`, `Community 61`, `Community 69`, `Community 72`, `Community 204`, `Community 78`, `Community 91`, `Community 103`, `Community 106`, `Community 110`, `Community 247`, `Community 125`?**
  _High betweenness centrality (0.135) - this node is a cross-community bridge._
- **Why does `Boolean` connect `Community 14` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 134`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 15`, `Community 148`, `Community 27`, `Community 166`, `Community 45`, `Community 46`, `Community 52`, `Community 53`, `Community 101`, `Community 105`, `Community 235`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 14` to `Community 0`, `Community 2`, `Community 4`, `Community 5`, `Community 134`, `Community 9`, `Community 10`, `Community 13`, `Community 15`, `Community 19`, `Community 148`, `Community 23`, `Community 24`, `Community 26`, `Community 27`, `Community 156`, `Community 167`, `Community 41`, `Community 45`, `Community 46`, `Community 53`, `Community 57`, `Community 201`, `Community 202`, `Community 76`, `Community 219`?**
