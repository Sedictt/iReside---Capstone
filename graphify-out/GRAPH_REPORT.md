...
## Corpus Check
- 920 files · ~6,955,606 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7595 nodes · 19000 edges · 574 communities (387 shown, 187 thin omitted)
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 4449 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `36e6959c`
...
## Communities (574 total, 187 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.06
Nodes (81): Alias, HexBinary, Relation, MultiSequence, MultiSequencePart, NestedSequence, Allow a multisequence to be built up from parts      Excluded from the instance, Wrap a sequence in an containing object (+73 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (81): ExtensionList, Percentage, Connection, ConnectorLocking, ConnectorNonVisual, ConnectorShape, NonVisualConnectorProperties, Shape (+73 more)
...
Cohesion: 0.03
Nodes (65): Objects can serialise to XML their attributes and child objects.     The followi, Serialisable, CellIsRule(), ColorScale, ColorScaleRule(), DataBar, DataBarRule(), FormatObject (+57 more)
...
Cohesion: 0.05
Nodes (55): generateOTP(), GET(), POST(), ensureBucket(), POST(), sanitizeFileName(), ensureBucket(), POST() (+47 more)
...
Cohesion: 0.04
Nodes (44): CommentRecord, Properties, Base64Binary, Extension, Guid, Size in hundredths of points.     In theory other units of measurement can be us, TextPoint, UniversalMeasure (+36 more)

### Community 12 - "Community 12"
Cohesion: 0.07
Nodes (51): Bool, InlineFont, PhoneticProperties, PhoneticText, Font for inline text because, yes what you need are different objects with the s, RichText, Text, Level (+43 more)
...
Cohesion: 0.1
Nodes (47): ColorChoice, ColorChoice, HSLColor, RGBPercent, SchemeColor, SystemColor, Transform, AlphaBiLevelEffect (+39 more)

### Community 15 - "Community 15"
Cohesion: 0.06
Nodes (47): ChartLines, ExternalData, Protection, ManualLayout, CustomSplit, DoughnutChart, PieChart, PieChart3D (+39 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (24): DataValidationList, Need to skip validations that have no cell ranges, SheetFormatProperties, PrintOptions, PrintPageSetup, Worksheet print options, Worksheet print page setup, Break (+16 more)

### Community 17 - "Community 17"
Cohesion: 0.07
Nodes (39): AdminSidebar(), NAV_ITEMS, HOW_IT_WORKS, IRIS_WORKFLOWS, OUTCOMES, ScrollyTellingLandingPage(), SHOWCASE_MODULES, ThemeToggle() (+31 more)

### Community 18 - "Community 18"
Cohesion: 0.1
Nodes (41): _3DBase, AreaChart, AreaChart3D, _AreaChartBase, NumericAxis, SeriesAxis, TextAxis, BarChart (+33 more)

### Community 19 - "Community 19"
Cohesion: 0.07
Nodes (39): CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, useAuth(), Property, PropertyContext, PropertyContextValue (+31 more)
...
Cohesion: 0.07
Nodes (36): ConsultationDashboard(), Document, ConsultationTool(), ConsultationToolProps, DigitalSigner, ConsultationTool, SignPage(), AddAmenityModal() (+28 more)
...
Cohesion: 0.08
Nodes (28): _BaseAxis, DateAxis, DisplayUnitsLabel, DisplayUnitsLabelList, Scaling, AxId, ChartContainer, ChartSpace (+20 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (22): Alias, Aliases can be used when either the desired attribute name is not allowed     or, Use a set to keep values unique, UniqueSequence, CellRange, MultiCellRange, Check whether comparisons between ranges are possible.         Cannot compare ra, Shift the focus of the range according to the shift values (*col_shift*, *row_sh (+14 more)
...
Cohesion: 0.06
Nodes (20): Cell, MergedCell, Check string coding, length, and line break character, Tries to convert Error" else N/A, Returns a cell location relative to this cell.          :param row: number of ro, Describes the properties of a cell in a merged cell and helps to     display the, Describes cell associated properties.      Properties of interest include style,, CellRange (+12 more)

### Community 43 - "Community 43"
Cohesion: 0.1
Nodes (22): LeaseDocument(), GET(), DEFAULT_OCCUPANCY, ENUM_TO_PROPERTY_TYPE, NewAssetContent(), NewAssetPage(), PROPERTY_TYPE_TO_ENUM, Step (+14 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (23): defaultdict, Max, Min, Values must be less than a `max` value, Values must be greater than a `min` value, Break names down into sheet locals and globals, Return a new range with cells common to this range and *other*          :type ot, Return the minimal superset of this range and *other*. This new range         wi (+15 more)
...
Cohesion: 0.07
Nodes (17): BoundDictionary, Base class for styleble objects implementing proxy and lookup functions, StyleableObject, BoundDictionary, A default dictionary where elements are tightly coupled.      The factory method, ColumnDimension, Dimension, DimensionHolder (+9 more)
...
Cohesion: 0.1
Nodes (18): WriteOnlyCell(), Exception, CellCoordinatesException, NamedRangeException, Error for badly formatted named ranges., Error for bad sheet names., Error for trying to modify a read-only workbook, Error when attempting to perform operations on a dump workbook     while it has (+10 more)
...
Cohesion: 0.09
Nodes (14): Set the categories / x-axis values, Add a range of data in a single pass.         The default is to treat each colum, Append a data series to the chart, Combine the chart with another one, AxDataSource, NumDataSource, NumRef, StrRef (+6 more)
...
Cohesion: 0.19
Nodes (15): LeaseStatusBadge(), LeaseStatusBadgeProps, STATUS_STYLES, GET(), isNonEmptyString(), logOptionalQueryFailure(), OptionalTenantStateClient, resolvePaymentStatus() (+7 more)
...
Cohesion: 0.15
Nodes (9): make_subexp(), Consume all the text between square brackets [].          Returns the number of, Base class for all Tokenizer errors., Consumes a ( or { character.          Returns the number of characters consumed., Consumes a } or ) character.          Returns the number of characters consumed., Ensure that there's no token currently being parsed.          Or if there is a t, Return a closing token that matches this token's type., Parse a "-delimited string or '-delimited link.          The offset must be poin (+1 more)
...
Cohesion: 0.39
Nodes (5): ActionBody, getStateForAction(), InquiryAction, isValidAction(), MessageUserAction
...
Cohesion: 0.33
Nodes (3): PageMargins, PrintSettings, Identical to openpyxl.worksheet.page.Pagemargins but element names are different
...
Cohesion: 0.8
Nodes (3): sendTenantOnboardingReminder(), generateTempPassword(), POST()
...
Cohesion: 0.4
Nodes (3): make_operand(), Consume the text following a '#' as an error.          Looks for a match in self, If there's a token being parsed, add it to the item list.
...
- **Why does `Serialisable` connect `Community 4` to `Community 0`, `Community 1`, `Community 259`, `Community 5`, `Community 11`, `Community 12`, `Community 14`, `Community 15`, `Community 16`, `Community 18`, `Community 20`, `Community 150`, `Community 27`, `Community 28`, `Community 161`, `Community 35`, `Community 42`, `Community 44`, `Community 45`, `Community 47`, `Community 48`, `Community 178`, `Community 57`, `Community 58`, `Community 64`, `Community 68`, `Community 202`, `Community 77`, `Community 81`, `Community 82`, `Community 84`, `Community 86`, `Community 214`, `Community 94`, `Community 96`, `Community 100`, `Community 105`, `Community 240`, `Community 123`?**
  _High betweenness centrality (0.149) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 0` to `Community 1`, `Community 2`, `Community 130`, `Community 4`, `Community 129`, `Community 3`, `Community 9`, `Community 10`, `Community 147`, `Community 23`, `Community 25`, `Community 30`, `Community 31`, `Community 32`, `Community 159`, `Community 39`, `Community 172`, `Community 173`, `Community 174`, `Community 55`, `Community 62`, `Community 63`, `Community 65`, `Community 88`, `Community 89`, `Community 97`, `Community 104`, `Community 127`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 8` to `Community 129`, `Community 258`, `Community 3`, `Community 7`, `Community 10`, `Community 139`, `Community 13`, `Community 17`, `Community 146`, `Community 19`, `Community 147`, `Community 21`, `Community 148`, `Community 23`, `Community 22`, `Community 26`, `Community 29`, `Community 43`, `Community 46`, `Community 176`, `Community 49`, `Community 50`, `Community 55`, `Community 63`, `Community 66`, `Community 76`, `Community 211`, `Community 212`, `Community 213`, `Community 89`, `Community 93`, `Community 98`, `Community 99`, `Community 109`, `Community 110`, `Community 119`, `Community 122`?**
