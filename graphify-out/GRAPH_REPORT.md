...
## Corpus Check
- 984 files · ~7,157,127 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9165 nodes · 21059 edges · 690 communities (488 shown, 202 thin omitted)
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 4458 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `eacdff03`
...
## Communities (690 total, 202 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (90): NumVal, StrVal, ExtensionList, Percentage, Connection, ConnectorLocking, ConnectorNonVisual, ConnectorShape (+82 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (109): ChatUser, ContactCard(), ContactCardProps, DEFAULT_CHAT_STATE, EMPTY_ARRAY, EMPTY_OBJECT, formatConversationTimestamp(), formatMiniTimestamp() (+101 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (81): title_maker(), ColorChoice, Convertible, HexBinary, Relation, EmptyTag, NestedText, NestedValue (+73 more)
...
Cohesion: 0.04
Nodes (72): AdminSidebar(), NAV_ITEMS, AdminLayout(), geistMono, geistSans, metadata, RootLayout(), ThemeProvider() (+64 more)
...
Cohesion: 0.04
Nodes (86): array, GET(), openai, POST(), assertAdmin(), DELETE(), MUTABLE_STATUSES, PATCH() (+78 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (56): generateOTP(), GET(), POST(), ensureBucket(), POST(), sanitizeFileName(), ensureBucket(), POST() (+48 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (44): Level, MultiLevelStrData, MultiLevelStrRef, NumData, StrData, Chartsheet, CustomChartsheetView, CustomChartsheetViews (+36 more)
...
Cohesion: 0.03
Nodes (55): Float, CellIsRule(), ColorScale, ColorScaleRule(), DataBar, DataBarRule(), FormatObject, FormulaRule() (+47 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (60): ConsultationDashboard(), Document, ConsultationTool(), ConsultationToolProps, DigitalSigner, ConsultationTool, SignPage(), BusinessPermitCard() (+52 more)
...
Cohesion: 0.11
Nodes (49): _3DBase, AreaChart, AreaChart3D, _AreaChartBase, _BaseAxis, ChartLines, DateAxis, NumericAxis (+41 more)

### Community 18 - "Community 18"
Cohesion: 0.07
Nodes (65): advancePaymentSchema, POST(), ActiveLeaseWorkspaceRow, AppSupabaseClient, BillingLeaseRow, buildInvoiceListItem(), createAdvancePayment(), createMultiMonthAdvancePayment() (+57 more)

### Community 19 - "Community 19"
Cohesion: 0.06
Nodes (52): CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, useAuth(), Property, PropertyContext, PropertyContextValue (+44 more)
...
Cohesion: 0.06
Nodes (33): ElementList, Return a dictionary of relations keyed by id, RelationshipList, Index, AutoSortScope, ChartFormat, ColHierarchiesUsage, ConditionalFormat (+25 more)

### Community 22 - "Community 22"
Cohesion: 0.07
Nodes (38): DisplayUnitsLabel, ErrorBars, ManualLayout, PictureOptions, ASCII, Bool, _convert(), Convertible (+30 more)

### Community 23 - "Community 23"
Cohesion: 0.06
Nodes (39): VALUES, WHO_IT_SERVES, HOW_IT_WORKS, IRIS_WORKFLOWS, OUTCOMES, ScrollyTellingLandingPage(), SHOWCASE_MODULES, ApplyPage() (+31 more)
...
Cohesion: 0.05
Nodes (47): BillingWorkspace, NextPayment, OverduePayment, PaymentSummaryProps, LeaseInfo, TenantDashboardHeaderProps, UnitHistoryModalProps, Action (+39 more)
...
Cohesion: 0.07
Nodes (40): GET(), getBillingWorkspace(), BILLING_BUCKETS, DEFAULT_LIMITS, ensureBucket(), removeBillingFile(), uploadBillingFile(), sanitizeFileName() (+32 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (28): PrintOptions, Worksheet print options, ScenarioList, columns(), Returns a cell object based on the given coordinates.          Usage: cell(row=1, Internal method for getting a cell from a worksheet.         Will create a new c, Internal method for adding cell objects., Convenience access by Excel style coordinates          The key can be a single c (+20 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (41): Checklist, Deduction, MoveOutInspectionForm(), MoveOutInspectionFormProps, [actionLoading, setActionLoading], [denialReason, setDenialReason], [error, setError], [isInspecting, setIsInspecting] (+33 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (36): DocsPage(), ActiveLeasesTab(), ActiveLeasesTabProps, ArchiveTab(), ArchiveTabProps, CardVariant, formatCurrency(), formatDate() (+28 more)
...
Cohesion: 0.05
Nodes (41): column_letter(), coordinate(), coordinate(), Return and remove the first cell, product(), build_workbook(), format_case_id(), resolve_output_path() (+33 more)

### Community 33 - "Community 33"
Cohesion: 0.06
Nodes (15): Border, Border positioning for use in styles., MergeCell, MergeCells, Related, TablePartList, create_temporary_file(), Return all rows, and any cells that they contain (+7 more)
...
Cohesion: 0.05
Nodes (17): dict, DefinedNameDict, Utility class for storing defined names.     Allows access by name and separatio, Add names without worrying about key and name matching., HyperlinkList, Break, ColBreak, RowBreak (+9 more)
...
Cohesion: 0.06
Nodes (20): BoundDictionary, StyleableObject, BoundDictionary, A default dictionary where elements are tightly coupled.      The factory method, ColumnDimension, Dimension, DimensionHolder, Information about the display properties of a column. (+12 more)

### Community 38 - "Community 38"
Cohesion: 0.07
Nodes (35): TenantInviteManager(), ActionItem, ActionItemCard(), ActionRequired(), ActionRequiredAction, ActionRequiredState, ActionSummary, formatDateLabel() (+27 more)
...
Cohesion: 0.08
Nodes (22): DisplayUnitsLabelList, AxId, PlotArea(), ChartContainer, ChartSpace, ExternalData, Protection, DataLabel (+14 more)
...
Cohesion: 0.11
Nodes (31): ActorProfile, ApplicationResponse, ApplicationRow, AuditRow, buildComplianceChecklist(), ComplianceChecklist, DEFAULT_COMPLIANCE_CHECKLIST, extractMissingColumn() (+23 more)

### Community 51 - "Community 51"
Cohesion: 0.17
Nodes (29): ensureBucket(), InviteRecord, loadInviteRecord(), POST(), sanitizeFileName(), buildPaymentPreview(), formatInviteError(), GET() (+21 more)

### Community 52 - "Community 52"
Cohesion: 0.07
Nodes (19): Cell, get_time_format(), get_type(), is_date(), MergedCell, Check string coding, length, and line break character, Tries to convert Error" else N/A, Given a value, infer the correct data type (+11 more)

### Community 53 - "Community 53"
Cohesion: 0.19
Nodes (3): NumberValueDescriptor, Collection of utility primitives for charts., Data should be numerical but isn't always :-/
...
Cohesion: 0.07
Nodes (21): defaultdict, Max, Min, Values must be less than a `max` value, Values must be greater than a `min` value, Break names down into sheet locals and globals, collapse_cell_addresses(), DataValidationList (+13 more)
...
Cohesion: 0.08
Nodes (17): escape(), r"""     Convert ASCII < 31 to OOXML: \n == _x + hex(ord(\n)) + _, r"""     Convert escaped strings to ASCIII: _x000a_ == \n, unescape(), _WorkbookChild, from_str(), from_tree(), HeaderFooter (+9 more)
...
Cohesion: 0.15
Nodes (24): fetchIrisHistory(), FetchIrisHistoryOptions, getCachedIrisHistory(), getCacheStorageKey(), IrisHistoryCacheEntry, IrisHistoryFetchResult, IrisHistoryMessage, isFresh() (+16 more)

### Community 73 - "Community 73"
Cohesion: 0.11
Nodes (12): Generate string representation of XML element.      All subelements are included, tostring(), ExtendedProperties, See 22.2      Most of this is irrelevant but Excel is very picky about the versi, Write to zipfile and update manifest, ExcelWriter, Write links to external workbooks, Write data into the archive. (+4 more)

### Community 74 - "Community 74"
Cohesion: 0.1
Nodes (8): _no_value(), builtin_format_id(), is_datetime(), Return date, time or datetime, Return the id of a standard style., apply_stylesheet(), from_tree(), Add styles to workbook if present
...
Cohesion: 0.11
Nodes (15): Exception, CellCoordinatesException, NamedRangeException, Error for badly formatted named ranges., Error for bad sheet names., Error when attempting to perform operations on a dump workbook     while it has, Error for converting between numeric and A1-style cell references., SheetTitleException (+7 more)

### Community 91 - "Community 91"
Cohesion: 0.11
Nodes (15): Set the categories / x-axis values, Add a range of data in a single pass.         The default is to treat each colum, Append a data series to the chart, Combine the chart with another one, AxDataSource, NumDataSource, NumRef, StrRef (+7 more)
...
Cohesion: 0.15
Nodes (21): SigningMode, SigningModeSelector(), SigningModeSelectorProps, ToolAccessBar(), ACTIVE_REQUIREMENT_KEYS, BackgroundGlow(), CardFrame(), CardFrameProps (+13 more)

### Community 94 - "Community 94"
Cohesion: 0.12
Nodes (13): ExcelReader, _find_workbook_part(), load_workbook(), Read an Excel package and dispatch the contents to the relevant modules, Open the given filename and return the workbook      :param filename: the path t, Does a first check whether filename is a string or a file-like     object. If it, _validate_archive(), pivot_caches() (+5 more)
...
Cohesion: 0.12
Nodes (4): _cast_number(), parse_richtext_string(), Convert numbers as string to an int or float, Parse inline string and preserve rich text formatting
...
Cohesion: 0.16
Nodes (12): read_chart(), read_external_link(), get_dependents(), get_rel(), get_rels_path(), Normalise dependency file paths to absolute ones      Relative paths are relativ, Get related object based on id or rel_type, Find relationships by content-type         NB. these content-types namespaced ob (+4 more)
...
Cohesion: 0.14
Nodes (9): InlineFont, PhoneticProperties, PhoneticText, Font for inline text because, yes what you need are different objects with the s, RichText, Text, Font, Font (+1 more)
...
Cohesion: 0.12
Nodes (12): code:typescript (it('fetches posts for landlord properties with filters', asy), code:bash (git add src/lib/community/actions.ts), code:typescript (it('toggles reaction on post', async () => {), code:bash (git add src/lib/community/actions.ts), code:bash (git add src/lib/community/actions.ts), code:typescript (it('allows tenant to report a post', async () => {), code:bash (git add src/lib/community/actions.ts), Phase 2: Server Actions & Data Layer (+4 more)
...
Cohesion: 0.12
Nodes (8): ComplaintModalProps, ComplaintModalProps, TransferRequestModal(), TransferRequestModalProps, UnitHistoryModalProps, UnitTooltip(), UnitTooltipProps, Unit

### Community 153 - "Community 153"
Cohesion: 0.25
Nodes (14): formatPhpCurrency(), ActionButton(), CreditCardIcon(), DiagnosisCard(), F2FActionCenter(), InvoiceDetail, Metric(), mockInvoice() (+6 more)

### Community 154 - "Community 154"
Cohesion: 0.15
Nodes (8): Scaling, NumFmt, NumberFormatDescriptor, Allow direct assignment of format code, The value can be either a cell reference or a text element     If both are prese, Text, TrendlineLabel, Typed
...
Cohesion: 0.2
Nodes (6): NamedStyle, Return a style array representing the current style, Return equivalent XfStyle, Return relevant named style, Named and editable styles, Bind a named style to a workbook
...
Cohesion: 0.53
Nodes (4): LeaseStatusBadge(), LeaseStatusBadgeProps, STATUS_STYLES, LeaseStatus
...
## Knowledge Gaps
- **2842 isolated node(s):** `supabase`, `supabase`, `supabase`, `supabase`, `eslintConfig` (+2837 more)
...
- **Why does `Serialisable` connect `Community 10` to `Community 0`, `Community 2`, `Community 131`, `Community 7`, `Community 13`, `Community 15`, `Community 16`, `Community 17`, `Community 21`, `Community 22`, `Community 154`, `Community 28`, `Community 285`, `Community 33`, `Community 35`, `Community 36`, `Community 37`, `Community 44`, `Community 53`, `Community 58`, `Community 59`, `Community 188`, `Community 189`, `Community 186`, `Community 67`, `Community 70`, `Community 73`, `Community 209`, `Community 210`, `Community 91`, `Community 92`, `Community 356`, `Community 101`, `Community 102`, `Community 105`, `Community 106`, `Community 109`, `Community 240`, `Community 118`?**
  _High betweenness centrality (0.132) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 15` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 8`, `Community 9`, `Community 10`, `Community 140`, `Community 12`, `Community 145`, `Community 18`, `Community 153`, `Community 26`, `Community 162`, `Community 164`, `Community 166`, `Community 42`, `Community 43`, `Community 45`, `Community 50`, `Community 51`, `Community 56`, `Community 64`, `Community 93`, `Community 224`, `Community 225`, `Community 227`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `Boolean` connect `Community 15` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 165`, `Community 6`, `Community 38`, `Community 9`, `Community 10`, `Community 42`, `Community 43`, `Community 45`, `Community 12`, `Community 11`, `Community 49`, `Community 50`, `Community 249`, `Community 26`?**
