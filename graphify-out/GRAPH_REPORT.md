# Graph Report - iReside  (2026-05-16)

## Corpus Check
- 981 files · ~7,143,280 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8960 nodes · 20844 edges · 665 communities (465 shown, 200 thin omitted)
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 4458 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c106dca2`
...
## Communities (665 total, 200 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (99): Alias, Alias, Aliases can be used when either the desired attribute name is not allowed     or, Relation, MultiSequence, MultiSequencePart, NestedSequence, Allow a multisequence to be built up from parts      Excluded from the instance (+91 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (113): Bool, InlineFont, PhoneticProperties, PhoneticText, Font for inline text because, yes what you need are different objects with the s, RichText, Text, _3DBase (+105 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (86): ExtensionList, Percentage, Objects can serialise to XML their attributes and child objects.     The followi, Serialisable, Connection, ConnectorLocking, ConnectorNonVisual, ConnectorShape (+78 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (61): PUT(), RouteParams, GET(), getDashboardPathForRole(), PUT(), PUT(), RouteParams, GET() (+53 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (72): _3DBase, AreaChart, AreaChart3D, _AreaChartBase, ChartLines, NumericAxis, SeriesAxis, TextAxis (+64 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (68): Chartsheet, CustomChartsheetView, CustomChartsheetViews, ChartsheetProperties, ChartsheetProtection, WebPublishItem, WebPublishItems, DrawingHF (+60 more)
...
Cohesion: 0.03
Nodes (43): Base64Binary, CellRange, Extension, Size in hundredths of points.     In theory other units of measurement can be us, TextPoint, UniversalMeasure, MatchPattern, MinMax (+35 more)
...
Cohesion: 0.06
Nodes (51): AdminLayout(), geistMono, geistSans, metadata, RootLayout(), ThemeProvider(), AuthContext, AuthContextValue (+43 more)

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (56): generateOTP(), GET(), POST(), GET(), isJsonObject(), MessageBody, POST(), CreateConversationBody (+48 more)
...
Cohesion: 0.05
Nodes (64): GET(), openai, POST(), POST(), UpdateListingBody, formatContextForAI(), getTenantContext(), getActiveLease() (+56 more)

### Community 15 - "Community 15"
Cohesion: 0.07
Nodes (66): advancePaymentSchema, POST(), ActiveLeaseWorkspaceRow, AppSupabaseClient, BillingLeaseRow, buildInvoiceListItem(), createAdvancePayment(), createMultiMonthAdvancePayment() (+58 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (51): GET(), ensureBucket(), POST(), sanitizeFileName(), getBillingWorkspace(), BILLING_BUCKETS, DEFAULT_LIMITS, ensureBucket() (+43 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (45): VALUES, WHO_IT_SERVES, AdminSidebar(), NAV_ITEMS, HOW_IT_WORKS, IRIS_WORKFLOWS, OUTCOMES, ScrollyTellingLandingPage() (+37 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (28): PrintOptions, PrintPageSetup, Worksheet print options, Worksheet print page setup, ScenarioList, columns(), Returns a cell object based on the given coordinates.          Usage: cell(row=1, Internal method for getting a cell from a worksheet.         Will create a new c (+20 more)

### Community 19 - "Community 19"
Cohesion: 0.06
Nodes (39): buildInvoiceLabel(), buildOverdueLabel(), DashboardData, formatCurrency(), formatCurrencyParts(), formatDueDate(), TenantDashboard(), LeaseDocument() (+31 more)
...
Cohesion: 0.05
Nodes (31): defaultdict, Max, Min, Values must be less than a `max` value, Values must be greater than a `min` value, MultiCellRange, Break names down into sheet locals and globals, collapse_cell_addresses() (+23 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (16): ArrayFormula, DataTableFormula, Break, ColBreak, RowBreak, Outline, PageSetupProperties, WorksheetProperties (+8 more)
...
Cohesion: 0.06
Nodes (14): Border, Border positioning for use in styles., HyperlinkList, MergeCell, MergeCells, create_temporary_file(), Return all rows, and any cells that they contain, As per discusion with the OOXML Working Group global sort state is not required. (+6 more)
...
Cohesion: 0.06
Nodes (21): BoundDictionary, StyleableObject, BoundDictionary, A default dictionary where elements are tightly coupled.      The factory method, boundaries(), ColumnDimension, Dimension, DimensionHolder (+13 more)
...
Cohesion: 0.13
Nodes (34): upsertPaymentReceipt(), computeAmountTag(), DbClient, expireInPersonIntents(), getInPersonIntentExpiry(), getOrCreateDirectConversation(), insertPaymentAuditEvent(), MessageOptions (+26 more)

### Community 29 - "Community 29"
Cohesion: 0.13
Nodes (37): completeSchema, POST(), addDays(), clampStepIndex(), completeTenantProductTour(), createTenantProductTourState(), ensureTenantProductTourState(), getTenantProductTourRequiredStep() (+29 more)
...
Cohesion: 0.07
Nodes (27): DateTime, Descriptor, Strict, A sequence (list or tuple) that may only contain objects of the declared     typ, Use a set to keep values unique, Sequence, UniqueSequence, NestedText (+19 more)
...
Cohesion: 0.15
Nodes (38): ICON_MAP, LandlordQuestBoard(), LandlordQuestBoardProps, addDays(), clampStepIndex(), completeLandlordProductTour(), createLandlordProductTourState(), ensureLandlordProductTourState() (+30 more)

### Community 40 - "Community 40"
Cohesion: 0.07
Nodes (25): make_operand(), make_separator(), make_subexp(), This module contains a tokenizer for Excel formulae.  The tokenizer is based on, Consume all the text between square brackets [].          Returns the number of, Base class for all Tokenizer errors., Consume the text following a '#' as an error.          Looks for a match in self, Consume a string of consecutive spaces.          Returns the number of spaces fo (+17 more)

### Community 41 - "Community 41"
Cohesion: 0.07
Nodes (13): Sequence, Border options for use in styles.     Caution: if you do not specify a border_st, Side, _assign_position(), Automatically assign positions if a list of colours is provided.      It is not, StopList, builtin_format_id(), Return the id of a standard style. (+5 more)
...
Cohesion: 0.1
Nodes (31): PAYMENT_METHODS, PaymentRecordForm(), PaymentRecordFormProps, SigningMode, SigningModeSelector(), SigningModeSelectorProps, BackgroundGlow(), Noise() (+23 more)
...
Cohesion: 0.1
Nodes (24): ConsultationDashboard(), Document, ConsultationTool(), ConsultationToolProps, DigitalSigner, ConsultationTool, SignPage(), ActionButton() (+16 more)
...
Cohesion: 0.1
Nodes (22): DashboardBackground(), DashboardBackgroundProps, BannerNotification, DashboardBanner(), DashboardBannerProps, formatTimeAgo(), SearchResult, SearchResultType (+14 more)
...
Cohesion: 0.08
Nodes (17): CellStyleList, ColorList, NamedStyleList, Named styles are editable and can be applied to multiple objects      As only th, Allow a list of named styles to be passed in and index them., Some applications contain duplicate definitions either by name or         refere, builtin_format_code(), is_timedelta_format() (+9 more)

### Community 64 - "Community 64"
Cohesion: 0.12
Nodes (21): GlassCard(), LandlordSettings(), SettingField(), SettingsCategory, SIDEBAR_ITEMS, SidebarItem, SubNav(), ToggleSwitch() (+13 more)

### Community 65 - "Community 65"
Cohesion: 0.1
Nodes (17): read_chart(), get_dependents(), get_rel(), Normalise dependency file paths to absolute ones      Relative paths are relativ, Get related object based on id or rel_type, Find relationships by content-type         NB. these content-types namespaced ob, find_images(), Given the path to a drawing file extract charts and images      Ignore errors du (+9 more)
...
Cohesion: 0.09
Nodes (22): WriteOnlyCell(), Exception, coordinate_from_string(), Convert a coordinate string like 'B12' to a tuple ('B', 12), CellCoordinatesException, IllegalCharacterError, InvalidFileException, NamedRangeException (+14 more)
...
Cohesion: 0.13
Nodes (25): ActivityItem, Announcement, buildUtilities(), GET(), isPendingStatus(), LeaseSummary, NextPayment, normalizeCategory() (+17 more)
...
Cohesion: 0.11
Nodes (23): VisualCanvasProps, useOptionalProperty(), useVisualBuilderState(), VisualBuilderStateProps, DEFAULT_FLOOR_LAYOUTS, EMPTY_FLOOR_LAYOUT, INITIAL_UNITS, CanvasItemKind (+15 more)
...
Cohesion: 0.1
Nodes (13): DocumentProperties, High-level properties of the document.     Defined in ECMA-376 Par2 Annex D, Error for trying to modify a read-only workbook, ReadOnlyWorkbookException, Create a worksheet (at an optional index).          :param title: optional title, Add an worksheet (at an optional index)., Returns a worksheet by its name.          :param name: the name of the worksheet, Save the current workbook under the given `filename`.         Use this function (+5 more)
...
Cohesion: 0.17
Nodes (20): ApplicationsPage(), Applicant, ApplicationsSkeletonList(), ApplicationStatus, calculateApplicationProgress(), formatCurrency(), formatDate(), formatDocumentLabel() (+12 more)
...
Cohesion: 0.18
Nodes (16): BusinessPermitCard(), BusinessPermitCardProps, calculateLeaseProgress(), formatCurrency(), formatRelativeDate(), LandlordProfilePage(), LandlordProperty, resolveGoogleAvatarUrl() (+8 more)
...
Cohesion: 0.25
Nodes (14): AuditEvent, extractIpAddress(), extractUserAgent(), logAuditEvent(), sendLeaseActivatedNotification(), sendTenantSignedNotification(), generateLeasePdf(), LeasePdfData (+6 more)
...
Cohesion: 0.11
Nodes (10): MergedCell, Describes the properties of a cell in a merged cell and helps to     display the, CellRange, Hyperlink, MergedCellRange, MergedCellRange stores the border information of a merged cell in the top     le, If the upper left cell of the merged cell does not yet exist, it is         crea, Each cell of the merged cell is created as MergedCell if it does not         alr (+2 more)
...
Cohesion: 0.1
Nodes (10): read_external_link(), Find all sheets in the workbook and return the link to the source file., Bind defined names and other definitions to worksheets or the workbook, WorkbookParser, DefinedName, DefinedNameList, destinations(), Check for whether DefinedName with the same name and scope already         exist (+2 more)
...
Cohesion: 0.12
Nodes (12): NextPayment, OverduePayment, PaymentSummaryProps, LeaseInfo, TenantDashboardHeaderProps, UnitHistoryModalProps, ClientOnlyDate(), ClientOnlyDateProps (+4 more)

### Community 126 - "Community 126"
Cohesion: 0.13
Nodes (6): AuthorList, from_comments(), Create the VML for comments, Create VML for comments, _shape_factory(), ShapeWriter
...
Cohesion: 0.16
Nodes (13): This module contains code to translate formulae across cells in a worksheet.  Th, Convert the formula into A1 notation, or as row and column coordinates, Raised when a formula can't be translated across cells.      This error arises w, Modifies a formula so that it can be translated from one cell to another.      `, Returns a list with the tokens comprising the formula., strip_ws_name(), translate_col(), translate_range() (+5 more)
...
Cohesion: 0.12
Nodes (13): code:typescript (it('returns ordered photos for album', async () => {), code:bash (git add src/lib/community/actions.ts), code:typescript (it('allows tenant to vote on poll (upsert)', async () => {), code:bash (npx vitest --run), code:bash (git add src/lib/community/actions.ts), code:typescript (it('adds top-level comment', async () => {), code:bash (git add src/lib/community/actions.ts), code:bash (git add src/lib/community/actions.ts) (+5 more)
...
Cohesion: 0.13
Nodes (14): **2.1 Technical Background** {#2.1-technical-background}, **2.2.1 Frontend Framework: Next.js (React)** {#2.2.1-frontend-framework:-next.js-(react)}, **2.2 Justification of the Technology Stack** {#2.2-justification-of-the-technology-stack}, **2.6.1  Comparative Analysis of Property Management Systems** {#2.6.1-comparative-analysis-of-property-management-systems}, **2.6 Synthesis and Gap Analysis** {#2.6-synthesis-and-gap-analysis}, **APPENDICES** {#appendices}, **BIBLIOGRAPHY** {#bibliography}, **CHAPTER 1** {#chapter-1} (+6 more)
...
Cohesion: 0.14
Nodes (7): absolute_coordinate(), quote_sheetname(), Add quotes around sheetnames if they contain spaces., Convert a coordinate to an absolute coordinate string (B12 -> $B$12), PrintTitles, Contains at least either a range of rows or columns, print_titles()
...
Cohesion: 0.15
Nodes (12): 14.1 Accessing the Map, 14.2 What the Map Shows, 14.3 Interacting with the Map, 14.4 2D and 3D Views, 14. Viewing the Unit Map, 18. Glossary, 3.1 Screen Layout, 3.2 Dark Mode (+4 more)
...
Cohesion: 0.43
Nodes (4): Loading(), LoadingSpinner(), LoadingSpinnerProps, PageLoader()
...
## Knowledge Gaps
- **2679 isolated node(s):** `supabase`, `supabase`, `supabase`, `supabase`, `eslintConfig` (+2674 more)
...
- **Why does `Serialisable` connect `Community 2` to `Community 0`, `Community 1`, `Community 4`, `Community 5`, `Community 8`, `Community 264`, `Community 12`, `Community 15`, `Community 18`, `Community 20`, `Community 21`, `Community 22`, `Community 24`, `Community 152`, `Community 26`, `Community 27`, `Community 31`, `Community 41`, `Community 52`, `Community 55`, `Community 61`, `Community 63`, `Community 195`, `Community 197`, `Community 71`, `Community 74`, `Community 86`, `Community 93`, `Community 108`, `Community 109`, `Community 110`, `Community 113`, `Community 249`, `Community 126`?**
  _High betweenness centrality (0.132) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 15` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 11`, `Community 13`, `Community 14`, `Community 28`, `Community 157`, `Community 29`, `Community 37`, `Community 39`, `Community 167`, `Community 169`, `Community 47`, `Community 48`, `Community 54`, `Community 67`, `Community 77`, `Community 216`, `Community 217`, `Community 231`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 7` to `Community 260`, `Community 6`, `Community 9`, `Community 10`, `Community 141`, `Community 15`, `Community 144`, `Community 17`, `Community 143`, `Community 19`, `Community 25`, `Community 157`, `Community 30`, `Community 29`, `Community 33`, `Community 34`, `Community 289`, `Community 39`, `Community 169`, `Community 43`, `Community 46`, `Community 48`, `Community 50`, `Community 51`, `Community 180`, `Community 181`, `Community 182`, `Community 53`, `Community 54`, `Community 60`, `Community 64`, `Community 192`, `Community 70`, `Community 91`, `Community 92`, `Community 95`, `Community 96`, `Community 104`, `Community 232`, `Community 233`, `Community 112`, `Community 117`, `Community 119`, `Community 125`?**
