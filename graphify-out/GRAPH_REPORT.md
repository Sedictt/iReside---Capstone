...
## Corpus Check
- 933 files · ~6,907,013 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7733 nodes · 19225 edges · 559 communities (368 shown, 191 thin omitted)
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 4454 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d27bc94f`
...
## Communities (559 total, 191 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (119): PhoneticProperties, PhoneticText, RichText, Text, _3DBase, Base class for 3D charts, Surface, View3D (+111 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (79): Chartsheet, CustomChartsheetView, CustomChartsheetViews, ChartsheetProperties, ChartsheetProtection, WebPublishItem, WebPublishItems, DrawingHF (+71 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (87): Alias, HexBinary, Relation, MultiSequence, MultiSequencePart, NestedSequence, Allow a multisequence to be built up from parts      Excluded from the instance, Wrap a sequence in an containing object (+79 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (74): Objects can serialise to XML their attributes and child objects.     The followi, Serialisable, Connection, ConnectorLocking, ConnectorNonVisual, ConnectorShape, NonVisualConnectorProperties, Shape (+66 more)
...
Cohesion: 0.05
Nodes (112): completeSchema, POST(), ICON_MAP, LandlordQuestBoard(), LandlordQuestBoardProps, addDays(), clampStepIndex(), completeLandlordProductTour() (+104 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (94): ThemeToggle(), ThemeToggleProps, ChatUser, ContactCard(), ContactCardProps, DEFAULT_CHAT_STATE, formatConversationTimestamp(), formatMiniTimestamp() (+86 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (62): ensureBucket(), POST(), sanitizeFileName(), ensureBucket(), POST(), sanitizeFileName(), finalizeLease(), FinalizeLeaseParams (+54 more)
...
Cohesion: 0.04
Nodes (74): formatPhpCurrency(), ConsultationDashboard(), Document, ConsultationTool(), ConsultationToolProps, DigitalSigner, ConsultationTool, SignPage() (+66 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (72): CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, useProfileCard(), Property, PropertyContext, PropertyContextValue (+64 more)
...
Cohesion: 0.03
Nodes (49): ManualLayout, CellRange, Extension, ExtensionList, Size in hundredths of points.     In theory other units of measurement can be us, TextPoint, A sequence of primitive types that are stored as a single attribute.     "val" i, ValueSequence (+41 more)

### Community 13 - "Community 13"
Cohesion: 0.08
Nodes (52): _3DBase, AreaChart, AreaChart3D, _AreaChartBase, ChartLines, NumericAxis, SeriesAxis, TextAxis (+44 more)
...
Cohesion: 0.1
Nodes (48): ColorChoice, Percentage, ColorChoice, HSLColor, RGBPercent, SchemeColor, SystemColor, Transform (+40 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (52): AnalyticsPage(), DEFAULT_EXTENDED_KPIS, DEFAULT_FINANCIAL_CHART, DEFAULT_OPERATIONAL_SNAPSHOT, DEFAULT_PRIMARY_KPIS, ExportAuditItem, formatIsoDate(), getDateLabels() (+44 more)

### Community 17 - "Community 17"
Cohesion: 0.09
Nodes (51): GET(), AuditEvent, extractIpAddress(), extractUserAgent(), logAuditEvent(), sendLeaseActivatedNotification(), sendSigningLinkEmail(), sendTenantSignedNotification() (+43 more)

### Community 18 - "Community 18"
Cohesion: 0.07
Nodes (50): ApplicationsPage(), Applicant, ApplicationsSkeletonList(), ApplicationStatus, calculateApplicationProgress(), formatCurrency(), formatDate(), formatDocumentLabel() (+42 more)

### Community 19 - "Community 19"
Cohesion: 0.06
Nodes (35): HOW_IT_WORKS, IRIS_WORKFLOWS, OUTCOMES, ScrollyTellingLandingPage(), SHOWCASE_MODULES, mockApplications, MyApplicationsPage(), properties (+27 more)
...
Cohesion: 0.06
Nodes (34): Float, CellIsRule(), ColorScale, ColorScaleRule(), DataBar, DataBarRule(), FormatObject, FormulaRule() (+26 more)
...
Cohesion: 0.05
Nodes (30): Alignment, Alignment options for use in styles., Border, Border positioning for use in styles., ArrayDescriptor, CellStyle, _assign_position(), Fill (+22 more)

### Community 24 - "Community 24"
Cohesion: 0.07
Nodes (35): Document, DocumentsPage(), LandlordProfile, VerificationInfo, LeaseDocument(), LeaseHubContent(), LeasesPage(), TabId (+27 more)
...
Cohesion: 0.06
Nodes (33): VALUES, WHO_IT_SERVES, geistMono, geistSans, metadata, RootLayout(), Loading(), CookieConsent() (+25 more)
...
Cohesion: 0.06
Nodes (34): product(), build_workbook(), format_case_id(), resolve_output_path(), Border options for use in styles.     Caution: if you do not specify a border_st, Side, cols_from_range(), column_index_from_string() (+26 more)
...
Cohesion: 0.09
Nodes (30): ActorProfile, ApplicationResponse, ApplicationRow, AuditRow, buildComplianceChecklist(), ComplianceChecklist, DEFAULT_COMPLIANCE_CHECKLIST, extractMissingColumn() (+22 more)

### Community 49 - "Community 49"
Cohesion: 0.06
Nodes (23): Max, Min, Values must be less than a `max` value, Values must be greater than a `min` value, collapse_cell_addresses(), DataValidation, DataValidationList, expand_cell_ranges() (+15 more)
...
Cohesion: 0.07
Nodes (17): DocumentProperties, High-level properties of the document.     Defined in ECMA-376 Par2 Annex D, DifferentialStyleList, Dedupable container for differential styles., Check to see whether style already exists and append it if does not., Add a differential style and return its index, Error for trying to modify a read-only workbook, ReadOnlyWorkbookException (+9 more)
...
Cohesion: 0.1
Nodes (18): read_chart(), get_dependents(), get_rel(), get_rels_path(), Normalise dependency file paths to absolute ones      Relative paths are relativ, Get related object based on id or rel_type, Find relationships by content-type         NB. these content-types namespaced ob, Convert relative path to absolutes that can be loaded from a zip     archive. (+10 more)
...
Cohesion: 0.08
Nodes (15): CellStyleList, Convert to StyleArray, Extract protection and alignments, convert to style array, builtin_format_code(), is_timedelta_format(), NumberFormatList, Return one of the standard format codes by index., Merge named style names "cellStyles" with their associated styles         "cellS (+7 more)
...
Cohesion: 0.07
Nodes (9): from_comments(), Create the VML for comments, Comment, Create a detached copy of this comment., Bind comment to a particular cell, Unbind a comment from a cell, Create VML for comments, _shape_factory() (+1 more)

### Community 67 - "Community 67"
Cohesion: 0.08
Nodes (7): PrintOptions, Worksheet print options, _cast_number(), parse_richtext_string(), Convert numbers as string to an int or float, Parse inline string and preserve rich text formatting, ScenarioList

### Community 68 - "Community 68"
Cohesion: 0.09
Nodes (20): WriteOnlyCell(), Exception, CellCoordinatesException, IllegalCharacterError, InvalidFileException, NamedRangeException, The data submitted which cannot be used directly in Excel files. It     must be, Error for badly formatted named ranges. (+12 more)
...
Cohesion: 0.19
Nodes (22): fetchIrisHistory(), FetchIrisHistoryOptions, getCachedIrisHistory(), getCacheStorageKey(), IrisHistoryCacheEntry, IrisHistoryFetchResult, IrisHistoryMessage, isFresh() (+14 more)
...
Cohesion: 0.11
Nodes (12): FileExtension, Manifest, Override, Custom serialisation method to allow setting a default namespace, Check whether a particular content type is contained, Find specific content-type, Find all elements of a specific content-type, Add content object to the package manifest         # needs a contract... (+4 more)
...
Cohesion: 0.14
Nodes (12): code:typescript (// src/lib/community/queries.ts), code:typescript (// src/lib/community/__tests__/queries.test.ts), code:bash (cd src/lib/community), code:bash (npx vitest --run), code:bash (git add src/lib/community/queries.ts src/lib/community/__tes), code:typescript (it('enforces rate limit of 5 posts per 24h', async () => {), code:bash (git add src/lib/community/actions.ts), code:bash (git add src/lib/community/actions.ts) (+4 more)
...
Cohesion: 0.22
Nodes (4): PageMargins, Identical to openpyxl.worksheet.page.Pagemargins but element names are different, _WorkbookChild, HeaderFooter

### Community 178 - "Community 178"
Cohesion: 0.2
Nodes (5): defaultdict, Map fields to associated conditional formats by priority, Return a dictionary of format objects keyed by (field id and format property)., Group formats by field index and priority.         Sorted to match sorting and g, Break names down into sheet locals and globals
...
## Knowledge Gaps
- **1943 isolated node(s):** `supabase`, `supabase`, `supabase`, `supabase`, `fs` (+1938 more)
...
- **Why does `Serialisable` connect `Community 3` to `Community 0`, `Community 1`, `Community 130`, `Community 2`, `Community 132`, `Community 12`, `Community 13`, `Community 15`, `Community 21`, `Community 150`, `Community 23`, `Community 30`, `Community 31`, `Community 36`, `Community 37`, `Community 40`, `Community 177`, `Community 49`, `Community 51`, `Community 53`, `Community 60`, `Community 61`, `Community 62`, `Community 65`, `Community 67`, `Community 72`, `Community 80`, `Community 81`, `Community 84`, `Community 85`, `Community 91`, `Community 96`?**
  _High betweenness centrality (0.153) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 2` to `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 18`, `Community 148`, `Community 22`, `Community 27`, `Community 28`, `Community 32`, `Community 162`, `Community 165`, `Community 166`, `Community 39`, `Community 42`, `Community 45`, `Community 48`, `Community 119`, `Community 121`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 16` to `Community 129`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 138`, `Community 11`, `Community 10`, `Community 139`, `Community 14`, `Community 18`, `Community 19`, `Community 22`, `Community 24`, `Community 28`, `Community 29`, `Community 34`, `Community 50`, `Community 59`, `Community 199`, `Community 71`, `Community 79`, `Community 94`, `Community 223`, `Community 222`, `Community 226`, `Community 104`, `Community 106`, `Community 114`, `Community 118`, `Community 120`?**
