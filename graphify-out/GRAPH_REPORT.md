# Graph Report - iReside  (2026-05-23)

## Corpus Check
- 736 files · ~7,030,230 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9431 nodes · 21337 edges · 714 communities (516 shown, 198 thin omitted)
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 4458 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5fcd8983`
...
## Communities (714 total, 198 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (124): CommentRecord, CommentSheet, Properties, Base64Binary, CellRange, Extension, Guid, Size in hundredths of points.     In theory other units of measurement can be us (+116 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (149): _3DBase, InlineFont, PhoneticProperties, PhoneticText, Font for inline text because, yes what you need are different objects with the s, RichText, Text, _3DBase (+141 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (70): PUT(), RouteParams, GET(), getDashboardPathForRole(), PUT(), PUT(), RouteParams, GET() (+62 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (92): title_maker(), ColorChoice, Convertible, HexBinary, Percentage, EmptyTag, NestedValue, Boolean if a tag exists or not. (+84 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (112): ChatUser, ContactCard(), ContactCardProps, ContactsSidebar(), DEFAULT_CHAT_STATE, EMPTY_ARRAY, EMPTY_OBJECT, formatConversationTimestamp() (+104 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (68): Connection, ConnectorLocking, ConnectorNonVisual, ConnectorShape, NonVisualConnectorProperties, Shape, ShapeMeta, anchor() (+60 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (74): AdminSidebar(), NAV_ITEMS, AdminLayout(), geistMono, geistSans, metadata, RootLayout(), ThemeProvider() (+66 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (71): AnalyticsPage(), DEFAULT_EXTENDED_KPIS, DEFAULT_FINANCIAL_CHART, DEFAULT_OPERATIONAL_SNAPSHOT, DEFAULT_PRIMARY_KPIS, ExportAuditItem, formatIsoDate(), getDateLabels() (+63 more)
...
Cohesion: 0.05
Nodes (54): generateOTP(), GET(), POST(), ensureBucket(), POST(), sanitizeFileName(), ensureBucket(), POST() (+46 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (72): addComment(), approveResidentPost(), canCreatePostType(), CommunityRole, createAnnouncementPost(), createDiscussionPost(), createPhotoAlbumPost(), createPollPost() (+64 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (59): array, buildInvoiceLabel(), buildOverdueLabel(), DashboardData, DEFAULT_QUICK_ACTIONS, formatCurrency(), formatCurrencyParts(), formatDueDate() (+51 more)
...
Cohesion: 0.08
Nodes (58): completeSchema, POST(), ICON_MAP, LandlordQuestBoard(), LandlordQuestBoardProps, addDays(), clampStepIndex(), completeLandlordProductTour() (+50 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (59): CalendarEvent, EVENT_TYPE_STYLES, LandlordCalendarPage(), MONTH_NAMES, WEEKDAYS, CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub() (+51 more)

### Community 16 - "Community 16"
Cohesion: 0.08
Nodes (63): ensureBucket(), InviteRecord, loadInviteRecord(), POST(), sanitizeFileName(), buildPaymentPreview(), formatInviteError(), GET() (+55 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (62): addDays(), clampStepIndex(), completeTenantProductTour(), createTenantProductTourState(), ensureTenantProductTourState(), evaluateTenantProductTourEligibility(), getTenantProductTourRequiredStep(), getTenantProductTourSkipCooldownDays() (+54 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (24): DataValidationList, Need to skip validations that have no cell ranges, ArrayFormula, DataTableFormula, HyperlinkList, PrintOptions, Worksheet print options, Break (+16 more)

### Community 19 - "Community 19"
Cohesion: 0.07
Nodes (47): GET(), getBillingWorkspace(), BILLING_BUCKETS, DEFAULT_LIMITS, ensureBucket(), removeBillingFile(), uploadBillingFile(), GET() (+39 more)
...
Cohesion: 0.05
Nodes (46): BillingWorkspace, NextPayment, OverduePayment, PaymentSummaryProps, LeaseInfo, TenantDashboardHeaderProps, Action, BillingOperationsPanel() (+38 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (36): make_operand(), make_separator(), make_subexp(), This module contains a tokenizer for Excel formulae.  The tokenizer is based on, Consume all the text between square brackets [].          Returns the number of, Base class for all Tokenizer errors., Consume the text following a '#' as an error.          Looks for a match in self, Consume a string of consecutive spaces.          Returns the number of spaces fo (+28 more)

### Community 24 - "Community 24"
Cohesion: 0.06
Nodes (34): Bool, NumberValueDescriptor, Data should be numerical but isn't always :-/, Descriptor, Alias, Aliases can be used when either the desired attribute name is not allowed     or, Strict, NestedText (+26 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (40): column_letter(), coordinate(), cols(), DummyWorksheet, Return and remove the first cell, Normalise cell range references, Reference, rows() (+32 more)

### Community 26 - "Community 26"
Cohesion: 0.06
Nodes (13): MergeCell, MergeCells, Related, TablePartList, create_temporary_file(), Return all rows, and any cells that they contain, As per discusion with the OOXML Working Group global sort state is not required., Comments & VBA controls use VML and require an additional element         that i (+5 more)

### Community 27 - "Community 27"
Cohesion: 0.12
Nodes (35): computeAmountTag(), DbClient, expireInPersonIntents(), getInPersonIntentExpiry(), getOrCreateDirectConversation(), insertPaymentAuditEvent(), MessageOptions, NotifyOptions (+27 more)
...
Cohesion: 0.05
Nodes (20): DocumentProperties, High-level properties of the document.     Defined in ECMA-376 Par2 Annex D, TableStyleList, Error for trying to modify a read-only workbook, ReadOnlyWorkbookException, active(), get_index(), Create a worksheet (at an optional index).          :param title: optional title (+12 more)
...
Cohesion: 0.06
Nodes (23): Alignment, Alignment options for use in styles., Border, Border positioning for use in styles., ArrayDescriptor, CellStyle, _NamedCellStyle, _NamedCellStyleList (+15 more)
...
Cohesion: 0.05
Nodes (16): Cell, comment(), coordinate(), get_time_format(), get_type(), is_date(), Check string coding, length, and line break character, Tries to convert Error" else N/A (+8 more)
...
Cohesion: 0.06
Nodes (22): defaultdict, Max, Min, Values must be less than a `max` value, Values must be greater than a `min` value, Break names down into sheet locals and globals, collapse_cell_addresses(), DataValidation (+14 more)

### Community 50 - "Community 50"
Cohesion: 0.17
Nodes (3): PlotArea(), PageMargins, Identical to openpyxl.worksheet.page.Pagemargins but element names are different

### Community 51 - "Community 51"
Cohesion: 0.07
Nodes (17): CellStyleList, Convert to StyleArray, Extract protection and alignments, convert to style array, ColorList, builtin_format_code(), is_timedelta_format(), NumberFormat, NumberFormatList (+9 more)
...
Cohesion: 0.07
Nodes (14): ReadOnlyCell, dict, DefinedNameDict, Utility class for storing defined names.     Allows access by name and separatio, Add names without worrying about key and name matching., Make sure a row contains always the same number of cells or values, Cells are returned by a generator which can be empty, Loop through all the cells to get the size of a worksheet.         Do this only (+6 more)

### Community 60 - "Community 60"
Cohesion: 0.07
Nodes (11): CustomChartsheetView, CustomChartsheetViews, avoid_duplicate_name(), Naive check to see whether name already exists.     If name does exist suggest a, title(), _WorkbookChild, HeaderFooter, PageMargins (+3 more)
...
Cohesion: 0.07
Nodes (10): AuthorList, from_comments(), Create the VML for comments, Comment, Create a detached copy of this comment., Bind comment to a particular cell, Unbind a comment from a cell, Create VML for comments (+2 more)
...
Cohesion: 0.1
Nodes (6): _no_value(), builtin_format_id(), Return the id of a standard style., apply_stylesheet(), from_tree(), Add styles to workbook if present
...
Cohesion: 0.12
Nodes (20): Float, CellIsRule(), ColorScale, ColorScaleRule(), DataBar, DataBarRule(), FormatObject, FormulaRule() (+12 more)

### Community 72 - "Community 72"
Cohesion: 0.11
Nodes (12): CellRichText, _check_element(), _check_rich_text(), from_tree(), Returns a list of the strings contained.         The main reason for this is to, Represents text string in a specific format      This class is used as part of c, Return the full XML representation, Represents a rich text string.      Initialize with a list made of pure strings (+4 more)

### Community 73 - "Community 73"
Cohesion: 0.07
Nodes (6): _convert(), Default, Length, When called returns an instance of the expected type.     Additional default val, Check value is of or can be converted to expected type., expected_type()
...
Cohesion: 0.1
Nodes (18): Loading(), GlobalLoadingContext, GlobalLoadingContextType, GlobalLoadingProvider(), TenantSettingsPage(), updateTenantPassword(), GlassCard(), Section (+10 more)
...
Cohesion: 0.09
Nodes (11): Chartsheet, ChartsheetProperties, ChartsheetProtection, WebPublishItem, WebPublishItems, DrawingHF, SheetBackgroundPicture, ChartsheetView (+3 more)
...
Cohesion: 0.12
Nodes (13): Generate string representation of XML element.      All subelements are included, tostring(), ExtendedProperties, See 22.2      Most of this is irrelevant but Excel is very picky about the versi, InvalidFileException, Error for trying to open a non-ooxml file., ExcelWriter, Write links to external workbooks (+5 more)
...
Cohesion: 0.1
Nodes (17): WriteOnlyCell(), Exception, CellCoordinatesException, IllegalCharacterError, NamedRangeException, The data submitted which cannot be used directly in Excel files. It     must be, Error for badly formatted named ranges., Error for bad sheet names. (+9 more)

### Community 85 - "Community 85"
Cohesion: 0.14
Nodes (21): ActorProfile, ApplicationResponse, ApplicationRow, AuditRow, buildComplianceChecklist(), ComplianceChecklist, DEFAULT_COMPLIANCE_CHECKLIST, extractMissingColumn() (+13 more)

### Community 86 - "Community 86"
Cohesion: 0.24
Nodes (17): AuditEvent, extractIpAddress(), extractUserAgent(), logAuditEvent(), sendLeaseActivatedNotification(), sendTenantSignedNotification(), getAllowedTransitions(), getTransitionErrorMessage() (+9 more)
...
Cohesion: 0.09
Nodes (21): DummyCode, DateTime, days_to_time(), from_excel(), from_ISO8601(), Convert Excel serial to Python datetime, Convert a time value to fractions of day, Convert a timedelta value to fractions of a day (+13 more)
...
Cohesion: 0.12
Nodes (21): VisualCanvasProps, useOptionalProperty(), useVisualBuilderState(), VisualBuilderStateProps, DEFAULT_FLOOR_LAYOUTS, EMPTY_FLOOR_LAYOUT, INITIAL_UNITS, CanvasItemKind (+13 more)

### Community 94 - "Community 94"
Cohesion: 0.23
Nodes (13): GET(), sendSigningLinkEmail(), generateLandlordSigningLink(), generateSigningToken(), generateTokenWithHash(), getJwtSecret(), hashToken(), SigningTokenPayload (+5 more)
...
Cohesion: 0.13
Nodes (10): DocsPage(), Section, DocDetailPage(), DOCS_CONTENT, cardHover, fadeInUp, staggerContainer, Section (+2 more)
...
Cohesion: 0.11
Nodes (12): Sequence, _assign_position(), Fill, from_tree(), GradientFill, PatternFill, Automatically assign positions if a list of colours is provided.      It is not, Fill areas with gradient      Two types of gradient fill are supported: (+4 more)
...
Cohesion: 0.23
Nodes (14): sendLandlordCredentialsCopy(), sendLandlordRegistrationApproved(), sendProspectPaymentRequestEmail(), sendRegistrationOTP(), sendTenantCredentials(), sendTenantOnboardingReminder(), transporter, generateSigningLink() (+6 more)
...
Cohesion: 0.13
Nodes (14): ActiveLeasesTab(), ActiveLeasesTabProps, ArchiveTab(), ArchiveTabProps, CardVariant, formatCurrency(), formatDate(), LeaseCard() (+6 more)

### Community 109 - "Community 109"
Cohesion: 0.14
Nodes (16): LeaseStatusBadge(), LeaseStatusBadgeProps, STATUS_STYLES, LayoutGrid(), LeasesContent(), LeasesPage(), LeaseStatus, DropdownMenuCheckboxItem (+8 more)
...
Cohesion: 0.12
Nodes (11): Convert the formula into A1 notation, or as row and column coordinates, Modifies a formula so that it can be translated from one cell to another.      `, Returns a list with the tokens comprising the formula., Translator, coordinate_to_tuple(), Convert an Excel style coordinate to (row, column) tuple, Pane, Information about the visible portions of this sheet. (+3 more)
...
Cohesion: 0.21
Nodes (16): ApplicationsPage(), Applicant, ApplicationsSkeletonList(), ApplicationStatus, calculateApplicationProgress(), formatCurrency(), formatDate(), formatDocumentLabel() (+8 more)
...
Cohesion: 0.11
Nodes (18): **2.1 Technical Background** {#2.1-technical-background}, **2.2.1 Frontend Framework: Next.js (React)** {#2.2.1-frontend-framework:-next.js-(react)}, **2.2 Justification of the Technology Stack** {#2.2-justification-of-the-technology-stack}, **2.5.1 Comprehensive Property Management Platforms** {#2.5.1-comprehensive-property-management-platforms}, **2.5.2 International and Specialized Property Management Solutions** {#2.5.2-international-and-specialized-property-management-solutions}, **2.5.3 Condominium and Specialized Vertical Solutions** {#2.5.3-condominium-and-specialized-vertical-solutions}, **2.5 Related Systems** {#2.5-related-systems}, **2.6.1  Comparative Analysis of Property Management Systems** {#2.6.1-comparative-analysis-of-property-management-systems} (+10 more)
...
Cohesion: 0.23
Nodes (13): InvoiceListItem, InvoiceReadingDetail, formatDateLong(), formatPhpCurrency(), buildFaceToFacePreviewInvoice(), buildSelectivePreviewInvoice(), CheckoutPage(), Field() (+5 more)
...
Cohesion: 0.25
Nodes (13): ActionButton(), CreditCardIcon(), DiagnosisCard(), F2FActionCenter(), InvoiceDetail, Metric(), mockInvoice(), ReadingField() (+5 more)
...
Cohesion: 0.15
Nodes (12): 10.1 Submitting a Request (Tenants), 10.2 Urgency, 10.3 Tracking Status, 10.4 Responding to Requests (Landlords), 10. Maintenance Requests, 15.1 How It Works, 15.2 For Landlords, 15.3 For Tenants (+4 more)
...
Cohesion: 0.18
Nodes (5): Add to zipfile and update manifest, Write the relevant child objects and add links, Map fields to associated conditional formats by priority, Return a dictionary of format objects keyed by (field id and format property)., Group formats by field index and priority.         Sorted to match sorting and g
...
Cohesion: 0.22
Nodes (4): CellSmartTag, CellSmartTagPr, CellSmartTags, SmartTags
...
Cohesion: 0.22
Nodes (5): MultiCellRange, absolute_coordinate(), Convert a coordinate to an absolute coordinate string (B12 -> $B$12), PrintArea, print_area()
...
Cohesion: 0.32
Nodes (5): build_workbook(), format_case_id(), resolve_output_path(), Border options for use in styles.     Caution: if you do not specify a border_st, Side
...
Cohesion: 0.48
Nodes (5): EVENT_LABELS, formatAuditTimestamp(), LeaseAuditEvent, LeaseAuditTrail(), LeaseAuditTrailProps
...
## Knowledge Gaps
- **2998 isolated node(s):** `eslintConfig`, `nextConfig`, `config`, `supabase`, `supabase` (+2993 more)
...
- **Why does `Serialisable` connect `Community 0` to `Community 1`, `Community 3`, `Community 5`, `Community 8`, `Community 140`, `Community 18`, `Community 24`, `Community 25`, `Community 26`, `Community 283`, `Community 284`, `Community 413`, `Community 30`, `Community 32`, `Community 37`, `Community 42`, `Community 48`, `Community 49`, `Community 50`, `Community 51`, `Community 59`, `Community 60`, `Community 62`, `Community 65`, `Community 71`, `Community 204`, `Community 79`, `Community 80`, `Community 81`, `Community 96`, `Community 102`, `Community 103`, `Community 107`, `Community 114`, `Community 124`, `Community 253`, `Community 254`?**
  _High betweenness centrality (0.122) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 7` to `Community 4`, `Community 6`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 17`, `Community 20`, `Community 21`, `Community 22`, `Community 149`, `Community 148`, `Community 29`, `Community 293`, `Community 294`, `Community 168`, `Community 170`, `Community 46`, `Community 47`, `Community 178`, `Community 179`, `Community 181`, `Community 53`, `Community 188`, `Community 321`, `Community 66`, `Community 75`, `Community 99`, `Community 108`, `Community 109`, `Community 111`, `Community 367`, `Community 117`, `Community 119`, `Community 127`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 8` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 9`, `Community 12`, `Community 14`, `Community 16`, `Community 144`, `Community 17`, `Community 21`, `Community 149`, `Community 27`, `Community 31`, `Community 33`, `Community 167`, `Community 40`, `Community 179`, `Community 54`, `Community 210`, `Community 85`, `Community 214`, `Community 215`, `Community 231`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
