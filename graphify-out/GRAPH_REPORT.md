...
## Corpus Check
- 951 files · ~6,981,969 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7895 nodes · 19580 edges · 572 communities (383 shown, 189 thin omitted)
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 4456 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c5ff86a4`
...
Cohesion: 0.03
Nodes (78): ExtensionList, Relation, Connection, ConnectorLocking, ConnectorNonVisual, ConnectorShape, NonVisualConnectorProperties, Shape (+70 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (84): title_maker(), ColorChoice, Convertible, HexBinary, Percentage, EmptyTag, NestedInteger, NestedText (+76 more)
...
Cohesion: 0.06
Nodes (95): ThemeToggle(), ThemeToggleProps, ChatUser, ContactCard(), ContactCardProps, DEFAULT_CHAT_STATE, formatConversationTimestamp(), formatMiniTimestamp() (+87 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (60): Level, MultiLevelStrData, MultiLevelStrRef, NumData, NumVal, StrData, StrVal, Chartsheet (+52 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (62): AdminSidebar(), NAV_ITEMS, AdminLayout(), ThemeProvider(), AuthProvider(), newNotification, NotificationAction, NotificationContext (+54 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (66): ConsultationDashboard(), Document, ConsultationTool(), ConsultationToolProps, DigitalSigner, AuthContext, AuthContextValue, AuthState (+58 more)
...
Cohesion: 0.05
Nodes (58): AnalyticsPage(), DEFAULT_EXTENDED_KPIS, DEFAULT_FINANCIAL_CHART, DEFAULT_OPERATIONAL_SNAPSHOT, DEFAULT_PRIMARY_KPIS, ExportAuditItem, formatIsoDate(), getDateLabels() (+50 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (41): NestedSequence, Wrap a sequence in an containing object, Index, AutoSortScope, ChartFormat, ColHierarchiesUsage, ConditionalFormat, ConditionalFormatList (+33 more)
...
Cohesion: 0.07
Nodes (67): completeSchema, POST(), addDays(), clampStepIndex(), completeTenantProductTour(), createTenantProductTourState(), ensureTenantProductTourState(), evaluateTenantProductTourEligibility() (+59 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (42): Base64Binary, CellRange, Extension, Size in hundredths of points.     In theory other units of measurement can be us, TextPoint, UniversalMeasure, A sequence of primitive types that are stored as a single attribute.     "val" i, ValueSequence (+34 more)

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (58): GET(), AuditEvent, extractIpAddress(), extractUserAgent(), logAuditEvent(), sendLandlordOnboardingMagicLink(), sendLandlordRegistrationApproved(), sendLeaseActivatedNotification() (+50 more)

### Community 14 - "Community 14"
Cohesion: 0.07
Nodes (64): addComment(), approveResidentPost(), canCreatePostType(), CommunityRole, createAnnouncementPost(), createDiscussionPost(), createPhotoAlbumPost(), createPollPost() (+56 more)
...
Cohesion: 0.05
Nodes (52): buildInvoiceLabel(), buildOverdueLabel(), DashboardData, formatCurrency(), formatCurrencyParts(), formatDueDate(), TenantDashboard(), LeaseDocument() (+44 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (44): generateOTP(), GET(), POST(), ensureBucket(), POST(), sanitizeFileName(), fileSchema, landlordRegistrationSchema (+36 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (32): Guid, Represents many kinds of relationships., `type` can be used as a shorthand with the default relationships namespace, Relationship, ChildSheet, FileRecoveryProperties, PivotCache, Represents a reference to a worksheet or chartsheet in workbook.xml      It cont (+24 more)

### Community 19 - "Community 19"
Cohesion: 0.1
Nodes (42): PhoneticProperties, PhoneticText, RichText, Text, ChartLines, DisplayUnitsLabel, DisplayUnitsLabelList, ErrorBars (+34 more)

### Community 20 - "Community 20"
Cohesion: 0.1
Nodes (47): ICON_MAP, LandlordQuestBoard(), LandlordQuestBoardProps, addDays(), clampStepIndex(), completeLandlordProductTour(), createLandlordProductTourState(), ensureLandlordProductTourState() (+39 more)

### Community 21 - "Community 21"
Cohesion: 0.11
Nodes (36): _3DBase, AreaChart, AreaChart3D, _AreaChartBase, _BaseAxis, DateAxis, NumericAxis, Scaling (+28 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (42): Loading(), BillingWorkspace, Action, BillingOperationsPanel(), Field(), initialState, makeDraft(), State (+34 more)

### Community 23 - "Community 23"
Cohesion: 0.07
Nodes (42): PAYMENT_METHODS, PaymentRecordForm(), PaymentRecordFormProps, SigningMode, SigningModeSelector(), SigningModeSelectorProps, BackgroundGlow(), Noise() (+34 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (22): ReadOnlyCell, dict, DefinedNameDict, Utility class for storing defined names.     Allows access by name and separatio, Add names without worrying about key and name matching., ArrayFormula, DataTableFormula, Hyperlink (+14 more)

### Community 25 - "Community 25"
Cohesion: 0.07
Nodes (39): GET(), ensureBucket(), POST(), sanitizeFileName(), GET(), POST(), GET(), POST() (+31 more)
...
Cohesion: 0.05
Nodes (35): Cell, column_letter(), comment(), get_time_format(), get_type(), is_date(), Check string coding, length, and line break character, Tries to convert Error" else N/A (+27 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (39): coordinate(), coordinate(), cols(), DummyWorksheet, Return and remove the first cell, Normalise cell range references, Reference, rows() (+31 more)

### Community 29 - "Community 29"
Cohesion: 0.07
Nodes (43): ADVANCE_TEMPLATE_KEYS, buildPaymentPreview(), DEPOSIT_TEMPLATE_KEYS, InviteApplicationType, InviteListItem, InviteMode, InviteRequirementKey, parseAmount() (+35 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (34): make_operand(), make_separator(), make_subexp(), This module contains a tokenizer for Excel formulae.  The tokenizer is based on, Consume all the text between square brackets [].          Returns the number of, Base class for all Tokenizer errors., Consume the text following a '#' as an error.          Looks for a match in self, Consume a string of consecutive spaces.          Returns the number of spaces fo (+26 more)

### Community 31 - "Community 31"
Cohesion: 0.06
Nodes (32): VALUES, WHO_IT_SERVES, HOW_IT_WORKS, IRIS_WORKFLOWS, OUTCOMES, ScrollyTellingLandingPage(), SHOWCASE_MODULES, mockApplications (+24 more)
...
Cohesion: 0.13
Nodes (34): computeAmountTag(), DbClient, expireInPersonIntents(), getInPersonIntentExpiry(), getOrCreateDirectConversation(), insertPaymentAuditEvent(), MessageOptions, NotifyOptions (+26 more)

### Community 35 - "Community 35"
Cohesion: 0.08
Nodes (50): CanvasItemKind, canViewTenantProfile, ComplaintModal(), Corridor, CorridorResizeHandle, daysRemaining, DbUnit, dbUnitToCanvasUnit() (+42 more)
...
Cohesion: 0.07
Nodes (24): geistMono, geistSans, metadata, RootLayout(), CookieConsent(), GlobalLoadingContext, GlobalLoadingContextType, GlobalLoadingProvider() (+16 more)
...
Cohesion: 0.06
Nodes (17): Simplified named tuple with an array, StyleArray, NamedStyle, Return a style array representing the current style, Return equivalent XfStyle, Named and editable styles, Bind a named style to a workbook, Return a copy of the proxied object. (+9 more)
...
Cohesion: 0.09
Nodes (24): AxId, Set the categories / x-axis values, AxDataSource, NumDataSource, NumRef, StrRef, DataPoint, Marker (+16 more)
...
Cohesion: 0.07
Nodes (18): ChartBase, PlotArea(), Normalise and rebase series: sort by order and then rebase order, Add a range of data in a single pass.         The default is to treat each colum, Append a data series to the chart, Base class for all charts, Combine the chart with another one, ChartContainer (+10 more)
...
Cohesion: 0.06
Nodes (9): PrintOptions, Worksheet print options, Break, ColBreak, RowBreak, Outline, PageSetupProperties, WorksheetProperties (+1 more)
...
Cohesion: 0.08
Nodes (17): Alignment, Alignment options for use in styles., Border, Border positioning for use in styles., ArrayDescriptor, _NamedCellStyle, _NamedCellStyleList, NamedStyleList (+9 more)
...
Cohesion: 0.1
Nodes (5): builtin_format_id(), Return the id of a standard style., apply_stylesheet(), from_tree(), Add styles to workbook if present
...
Cohesion: 0.07
Nodes (24): ComplaintModalProps, TransferRequestModal(), TransferRequestModalProps, UnitHistoryModalProps, UnitTooltip(), UnitTooltipProps, DEFAULT_FLOOR_LAYOUTS, EMPTY_FLOOR_LAYOUT (+16 more)
...
Cohesion: 0.1
Nodes (10): _explicit_none(), Override serialisation because explicit none required, namespaced(), Utility to create a namespaced tag for an object, Convert the sequence represented by the descriptor to an XML element, Convert the sequence represented by the descriptor to an XML element, from_tree(), element() (+2 more)
...
Cohesion: 0.22
Nodes (12): assertAdmin(), MUTABLE_STATUSES, PATCH(), RegistrationRecord, ApplicantProfile, assertAdmin(), GET(), RegistrationRow (+4 more)
...
Cohesion: 0.15
Nodes (16): DbUnit, FloorId, QuickActionGuardResult, QuickActionType, dbUnitToCanvasUnit(), formatFloorWatermark(), getFloorDisplayLabel(), parseFloorNumber() (+8 more)
...
Cohesion: 0.18
Nodes (5): Safely and consistently format numeric values, safe_string(), _no_value(), DefinedName, create_named_range()
...
## Knowledge Gaps
- **2011 isolated node(s):** `supabase`, `supabase`, `supabase`, `supabase`, `fs` (+2006 more)
...
- **Why does `Serialisable` connect `Community 12` to `Community 0`, `Community 1`, `Community 129`, `Community 4`, `Community 7`, `Community 9`, `Community 18`, `Community 19`, `Community 21`, `Community 406`, `Community 24`, `Community 28`, `Community 33`, `Community 162`, `Community 164`, `Community 40`, `Community 43`, `Community 45`, `Community 46`, `Community 177`, `Community 51`, `Community 53`, `Community 55`, `Community 57`, `Community 58`, `Community 67`, `Community 68`, `Community 69`, `Community 72`, `Community 203`, `Community 77`, `Community 80`, `Community 212`, `Community 213`, `Community 88`, `Community 91`, `Community 95`, `Community 99`, `Community 100`, `Community 101`, `Community 102`, `Community 239`, `Community 114`?**
  _High betweenness centrality (0.167) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 7` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 135`, `Community 11`, `Community 12`, `Community 15`, `Community 143`, `Community 17`, `Community 20`, `Community 23`, `Community 29`, `Community 32`, `Community 34`, `Community 36`, `Community 38`, `Community 173`, `Community 175`, `Community 49`, `Community 52`, `Community 59`, `Community 189`, `Community 190`, `Community 79`, `Community 97`, `Community 123`?**
  _High betweenness centrality (0.138) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 8` to `Community 128`, `Community 3`, `Community 5`, `Community 6`, `Community 10`, `Community 11`, `Community 14`, `Community 16`, `Community 145`, `Community 146`, `Community 147`, `Community 20`, `Community 22`, `Community 23`, `Community 153`, `Community 29`, `Community 31`, `Community 35`, `Community 36`, `Community 42`, `Community 54`, `Community 59`, `Community 76`, `Community 211`, `Community 86`, `Community 97`, `Community 105`, `Community 107`, `Community 236`, `Community 113`, `Community 125`?**
