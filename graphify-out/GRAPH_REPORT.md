# Graph Report - iReside  (2026-05-20)

## Corpus Check
- 994 files · ~7,165,476 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9290 nodes · 21197 edges · 690 communities (493 shown, 197 thin omitted)
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 4458 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9462b917`
...
## Communities (690 total, 197 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (105): ChatUser, ContactCard(), ContactCardProps, DEFAULT_CHAT_STATE, EMPTY_ARRAY, EMPTY_OBJECT, formatConversationTimestamp(), formatMiniTimestamp() (+97 more)
...
Cohesion: 0.07
Nodes (80): title_maker(), ColorChoice, Convertible, HexBinary, Relation, EmptyTag, NestedValue, Boolean if a tag exists or not. (+72 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (87): AnalyticsPage(), DEFAULT_EXTENDED_KPIS, DEFAULT_FINANCIAL_CHART, DEFAULT_OPERATIONAL_SNAPSHOT, DEFAULT_PRIMARY_KPIS, ExportAuditItem, formatIsoDate(), getDateLabels() (+79 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (78): AdminSidebar(), NAV_ITEMS, AdminLayout(), ThemeProvider(), AuthContext, AuthContextValue, AuthProvider(), AuthState (+70 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (55): PageMargins, Identical to openpyxl.worksheet.page.Pagemargins but element names are different, Chartsheet, CustomChartsheetView, CustomChartsheetViews, ChartsheetProperties, ChartsheetProtection, WebPublishItem (+47 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (50): Base64Binary, CellRange, Extension, Size in hundredths of points.     In theory other units of measurement can be us, TextPoint, UniversalMeasure, A sequence of primitive types that are stored as a single attribute.     "val" i, ValueSequence (+42 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (55): ExtensionList, Percentage, Connection, ConnectorLocking, ConnectorNonVisual, ConnectorShape, NonVisualConnectorProperties, ShapeMeta (+47 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (58): VALUES, WHO_IT_SERVES, HOW_IT_WORKS, IRIS_WORKFLOWS, OUTCOMES, ScrollyTellingLandingPage(), SHOWCASE_MODULES, ApplyPage() (+50 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (64): Loading(), ConsultationDashboard(), Document, ConsultationTool(), ConsultationToolProps, DigitalSigner, ConsultationTool, SignPage() (+56 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (73): addComment(), approveResidentPost(), canCreatePostType(), CommunityRole, createAnnouncementPost(), createDiscussionPost(), createPhotoAlbumPost(), createPollPost() (+65 more)
...
Cohesion: 0.04
Nodes (54): generateOTP(), GET(), POST(), assertAdmin(), MUTABLE_STATUSES, PATCH(), RegistrationRecord, fileSchema (+46 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (38): Guid, DocumentProperties, High-level properties of the document.     Defined in ECMA-376 Par2 Annex D, Represents many kinds of relationships., `type` can be used as a shorthand with the default relationships namespace, Relationship, ChildSheet, FileRecoveryProperties (+30 more)
...
Cohesion: 0.06
Nodes (53): CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, Property, PropertyContext, PropertyContextValue, useProperty() (+45 more)

### Community 16 - "Community 16"
Cohesion: 0.08
Nodes (61): ensureBucket(), InviteRecord, loadInviteRecord(), POST(), sanitizeFileName(), buildPaymentPreview(), formatInviteError(), GET() (+53 more)

### Community 17 - "Community 17"
Cohesion: 0.07
Nodes (37): Shape, anchor(), Drawing, a drawing object - eg container for shapes or charts         we assume user spec, PresetGeometry2D, GraphicData, GraphicFrame, GraphicFrameLocking (+29 more)

### Community 18 - "Community 18"
Cohesion: 0.09
Nodes (49): InlineFont, PhoneticProperties, PhoneticText, Font for inline text because, yes what you need are different objects with the s, RichText, Text, _3DBase, Base class for 3D charts (+41 more)
...
Cohesion: 0.05
Nodes (43): GET(), ensureBucket(), POST(), sanitizeFileName(), GET(), POST(), ensureBucket(), POST() (+35 more)

### Community 21 - "Community 21"
Cohesion: 0.09
Nodes (37): _3DBase, AreaChart, AreaChart3D, _AreaChartBase, NumericAxis, SeriesAxis, TextAxis, BarChart (+29 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (40): Bool, MultiLevelStrData, MultiLevelStrRef, NumberValueDescriptor, NumData, NumVal, Data should be numerical but isn't always :-/, StrData (+32 more)

### Community 23 - "Community 23"
Cohesion: 0.06
Nodes (59): GET(), openai, POST(), UpdateListingBody, formatContextForAI(), getTenantContext(), getLandlordProperties(), getPropertyById() (+51 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (27): days_to_time(), from_excel(), from_ISO8601(), Convert Excel serial to Python datetime, Convert a time value to fractions of day, Convert a timedelta value to fractions of a day, Convert from a datetime to a timestamp string., Convert from a timestamp string to a datetime object. According to     18.17.4 i (+19 more)

### Community 25 - "Community 25"
Cohesion: 0.06
Nodes (32): NestedSequence, Wrap a sequence in an containing object, Index, AutoSortScope, ChartFormat, ColHierarchiesUsage, ConditionalFormat, ConditionalFormatList (+24 more)
...
Cohesion: 0.07
Nodes (55): evaluateQuickAction(), CanvasItemKind, canViewTenantProfile, ComplaintModal(), Corridor, CorridorResizeHandle, daysRemaining, DbUnit (+47 more)

### Community 29 - "Community 29"
Cohesion: 0.12
Nodes (35): upsertPaymentReceipt(), computeAmountTag(), DbClient, expireInPersonIntents(), getInPersonIntentExpiry(), getOrCreateDirectConversation(), insertPaymentAuditEvent(), MessageOptions (+27 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (25): sheetname(), MultiCellRange, absolute_coordinate(), quote_sheetname(), Add quotes around sheetnames if they contain spaces., Convert a coordinate to an absolute coordinate string (B12 -> $B$12), ColRange, from_string() (+17 more)

### Community 31 - "Community 31"
Cohesion: 0.12
Nodes (38): ICON_MAP, LandlordQuestBoardProps, addDays(), clampStepIndex(), completeLandlordProductTour(), createLandlordProductTourState(), ensureLandlordProductTourState(), evaluateLandlordProductTourEligibility() (+30 more)

### Community 32 - "Community 32"
Cohesion: 0.09
Nodes (27): _BaseAxis, DateAxis, DisplayUnitsLabel, DisplayUnitsLabelList, Scaling, ExternalData, Protection, NumFmt (+19 more)
...
Cohesion: 0.05
Nodes (18): Cell, column_letter(), coordinate(), get_time_format(), get_type(), Check string coding, length, and line break character, Tries to convert Error" else N/A, Given a value, infer the correct data type (+10 more)
...
Cohesion: 0.05
Nodes (22): ASCII, _convert(), DateTime, Default, Length, MatchPattern, Max, Min (+14 more)

### Community 39 - "Community 39"
Cohesion: 0.06
Nodes (18): CellRange, MultiCellRange, Check whether comparisons between ranges are possible.         Cannot compare ra, Shift the focus of the range according to the shift values (*col_shift*, *row_sh, Test whether the ranges are not equal.          :type other: openpyxl.worksheet., Represents a range in a sheet: title and coordinates.      This object is used t, Test whether the ranges are equal.          :type other: openpyxl.worksheet.cell, Test whether every cell in this range is also in *other*.          :type other: (+10 more)
...
Cohesion: 0.07
Nodes (25): Float, CellIsRule(), ColorScale, ColorScaleRule(), DataBar, DataBarRule(), FormatObject, FormulaRule() (+17 more)

### Community 45 - "Community 45"
Cohesion: 0.07
Nodes (25): Alignment, Alignment options for use in styles., Border, Border positioning for use in styles., CellStyle, Fill, PatternFill, Area fill patterns for use in styles.     Caution: if you do not specify a fill_ (+17 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (15): active(), get_index(), Create a worksheet (at an optional index).          :param title: optional title, Add an worksheet (at an optional index)., Move a sheet or sheetname, Remove `worksheet` from this workbook., Return the index of a worksheet., Returns a worksheet by its name.          :param name: the name of the worksheet (+7 more)

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (33): product(), build_workbook(), format_case_id(), resolve_output_path(), Border options for use in styles.     Caution: if you do not specify a border_st, Side, cols_from_range(), column_index_from_string() (+25 more)
...
Cohesion: 0.05
Nodes (21): Strict, escape(), r"""     Convert ASCII < 31 to OOXML: \n == _x + hex(ord(\n)) + _, r"""     Convert escaped strings to ASCIII: _x000a_ == \n, unescape(), avoid_duplicate_name(), Naive check to see whether name already exists.     If name does exist suggest a, title() (+13 more)
...
Cohesion: 0.07
Nodes (29): ComplaintModalProps, ComplaintModalProps, TransferRequestModal(), TransferRequestModalProps, UnitHistoryModalProps, UnitTooltip(), UnitTooltipProps, VisualCanvasProps (+21 more)
...
Cohesion: 0.07
Nodes (20): etree_write_cell(), lxml_write_cell(), Set coordinate and datatype, _set_attributes(), Safely and consistently format numeric values, safe_string(), _explicit_none(), Override serialisation because explicit none required (+12 more)
...
Cohesion: 0.15
Nodes (23): GET(), logAuditEvent(), sendSigningLinkEmail(), generateLandlordSigningLink(), generateSigningToken(), generateTokenWithHash(), getJwtSecret(), hashToken() (+15 more)

### Community 61 - "Community 61"
Cohesion: 0.08
Nodes (13): is_date(), Sequence, _assign_position(), Automatically assign positions if a list of colours is provided.      It is not, StopList, builtin_format_id(), is_date_format(), is_datetime() (+5 more)
...
Cohesion: 0.09
Nodes (20): Set the categories / x-axis values, Add a range of data in a single pass.         The default is to treat each colum, Append a data series to the chart, Combine the chart with another one, AxDataSource, NumDataSource, NumRef, StrRef (+12 more)

### Community 64 - "Community 64"
Cohesion: 0.08
Nodes (12): Simplified named tuple with an array, StyleArray, Add proxied object to another instance and return the combined object, Proxy formatting objects so that they cannot be altered, StyleProxy, NamedStyleDescriptor, NumberFormatDescriptor, Base class for styleble objects implementing proxy and lookup functions (+4 more)

### Community 65 - "Community 65"
Cohesion: 0.07
Nodes (16): BoundDictionary, StyleableObject, BoundDictionary, A default dictionary where elements are tightly coupled.      The factory method, ColumnDimension, Dimension, DimensionHolder, Information about the display properties of a column. (+8 more)
...
Cohesion: 0.13
Nodes (26): formatPhpCurrency(), ActionButton(), CreditCardIcon(), DiagnosisCard(), F2FActionCenter(), InvoiceDetail, InvoiceModal(), Metric() (+18 more)

### Community 80 - "Community 80"
Cohesion: 0.1
Nodes (12): MergedCell, Describes the properties of a cell in a merged cell and helps to     display the, CellRange, MergedCellRange, MergedCellRange stores the border information of a merged cell in the top     le, If the upper left cell of the merged cell does not yet exist, it is         crea, Each cell of the merged cell is created as MergedCell if it does not         alr, Create a parser and apply it to a workbook (+4 more)
...
Cohesion: 0.16
Nodes (20): ADVANCE_TEMPLATE_KEYS, buildPaymentPreview(), DEPOSIT_TEMPLATE_KEYS, InviteApplicationType, InviteListItem, InviteMode, InviteRequirementKey, parseAmount() (+12 more)
...
Cohesion: 0.24
Nodes (16): AuditEvent, extractIpAddress(), extractUserAgent(), sendLeaseActivatedNotification(), sendTenantSignedNotification(), getAllowedTransitions(), getTransitionErrorMessage(), isValidLeaseStatusTransition() (+8 more)
...
Cohesion: 0.2
Nodes (17): POST(), sendLandlordCredentialsCopy(), sendLandlordOnboardingMagicLink(), sendLandlordRegistrationApproved(), sendProspectPaymentRequestEmail(), sendRegistrationOTP(), sendTenantCredentials(), sendTenantOnboardingReminder() (+9 more)
...
Cohesion: 0.15
Nodes (18): BillingWorkspace, Action, BillingOperationsPanel(), Field(), initialState, makeDraft(), State, today (+10 more)
...
Cohesion: 0.14
Nodes (17): evaluateTenantProductTourEligibility(), getTenantProductTourRequiredStep(), isNextProductTourStepSubmission(), TenantProductTourState, INITIAL_TOUR_UI_STATE, isTourEnabledClient(), StepProgressPayload, TenantProductTourOverlay() (+9 more)
...
Cohesion: 0.12
Nodes (12): CellStyleList, builtin_format_code(), is_timedelta_format(), NumberFormat, NumberFormatList, Return one of the standard format codes by index., Merge named style names "cellStyles" with their associated styles         "cellS, Expand a named style reference element to a         named style object by bindin (+4 more)

### Community 111 - "Community 111"
Cohesion: 0.11
Nodes (12): hash_password(), Create a password hash from a given string for protecting a worksheet     only., from_tree(), Set a revision password on this workbook., Set a password on this workbook., revisionsPassword(), workbookPassword(), password() (+4 more)
...
Cohesion: 0.16
Nodes (17): buildInvoiceLabel(), buildOverdueLabel(), DashboardData, DEFAULT_QUICK_ACTIONS, formatCurrency(), formatCurrencyParts(), formatDueDate(), ICON_MAP (+9 more)

### Community 115 - "Community 115"
Cohesion: 0.14
Nodes (17): EVENT_LABELS, formatAuditTimestamp(), LeaseAuditEvent, LeaseAuditTrail(), LeaseAuditTrailProps, LayoutGrid(), LeasesContent(), LeasesPage() (+9 more)
...
Cohesion: 0.26
Nodes (10): completeSchema, POST(), isGuidedTenantProductTourEnabled(), TENANT_PRODUCT_TOUR_STEPS, POST(), POST(), POST(), resolveTenantRole() (+2 more)
...
Cohesion: 0.11
Nodes (10): defaultdict, Break names down into sheet locals and globals, collapse_cell_addresses(), DataValidation, DataValidationList, expand_cell_ranges(), Adds a cell or cell coordinate to this validator, Need to skip validations that have no cell ranges (+2 more)
...
Cohesion: 0.29
Nodes (13): getBillingWorkspace(), recordUtilityReading(), BILLING_BUCKETS, DEFAULT_LIMITS, ensureBucket(), removeBillingFile(), uploadBillingFile(), GET() (+5 more)
...
Cohesion: 0.13
Nodes (11): NextPayment, OverduePayment, PaymentSummaryProps, LeaseInfo, TenantDashboardHeaderProps, UnitHistoryModalProps, ClientOnlyDate(), ClientOnlyDateProps (+3 more)
...
Cohesion: 0.14
Nodes (5): ArrayDescriptor, Convert to StyleArray, Extract protection and alignments, convert to style array, IndexedList, List with optimised access by value     Based on Alex Martelli's recipe      htt
...
Cohesion: 0.29
Nodes (10): addOneYear(), ADVANCE_TEMPLATE_KEYS, ApprovalResult, ContractData, ContractPreviewModalProps, ContractTemplateLike, DEPOSIT_TEMPLATE_KEYS, isoDateToday() (+2 more)
...
Cohesion: 0.24
Nodes (10): QuickActionGuardResult, QuickActionType, dbUnitToCanvasUnit(), formatFloorWatermark(), getFloorDisplayLabel(), parseFloorNumber(), QUICK_ACTION_META, QUICK_ACTIONS_BY_STATUS (+2 more)
...
## Knowledge Gaps
- **2924 isolated node(s):** `supabase`, `supabase`, `supabase`, `supabase`, `eslintConfig` (+2919 more)
...
- **Why does `Serialisable` connect `Community 5` to `Community 129`, `Community 2`, `Community 6`, `Community 7`, `Community 11`, `Community 13`, `Community 17`, `Community 18`, `Community 21`, `Community 22`, `Community 151`, `Community 24`, `Community 25`, `Community 32`, `Community 33`, `Community 35`, `Community 39`, `Community 44`, `Community 45`, `Community 47`, `Community 49`, `Community 55`, `Community 60`, `Community 61`, `Community 63`, `Community 64`, `Community 65`, `Community 80`, `Community 216`, `Community 92`, `Community 93`, `Community 101`, `Community 110`, `Community 111`, `Community 118`, `Community 248`, `Community 121`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 11` to `Community 0`, `Community 1`, `Community 2`, `Community 5`, `Community 133`, `Community 7`, `Community 12`, `Community 14`, `Community 16`, `Community 19`, `Community 23`, `Community 29`, `Community 31`, `Community 36`, `Community 43`, `Community 172`, `Community 186`, `Community 70`, `Community 72`, `Community 76`, `Community 79`, `Community 213`, `Community 214`, `Community 88`, `Community 100`, `Community 230`?**
  _High betweenness centrality (0.103) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 3` to `Community 128`, `Community 0`, `Community 4`, `Community 8`, `Community 9`, `Community 10`, `Community 140`, `Community 14`, `Community 15`, `Community 19`, `Community 149`, `Community 155`, `Community 28`, `Community 156`, `Community 286`, `Community 31`, `Community 37`, `Community 173`, `Community 176`, `Community 51`, `Community 54`, `Community 56`, `Community 58`, `Community 186`, `Community 62`, `Community 190`, `Community 71`, `Community 72`, `Community 79`, `Community 82`, `Community 88`, `Community 104`, `Community 232`, `Community 114`, `Community 115`, `Community 125`, `Community 127`?**
