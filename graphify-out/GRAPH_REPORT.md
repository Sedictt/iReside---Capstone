...
## Corpus Check
- 982 files · ~7,143,291 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8969 nodes · 20860 edges · 652 communities (450 shown, 202 thin omitted)
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 4458 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `952729e9`
...
## Communities (652 total, 202 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (113): Alias, SheetBackgroundPicture, HexBinary, Relation, MultiSequence, MultiSequencePart, NestedSequence, Allow a multisequence to be built up from parts      Excluded from the instance (+105 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (131): _3DBase, InlineFont, PhoneticProperties, PhoneticText, Font for inline text because, yes what you need are different objects with the s, RichText, Text, _3DBase (+123 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (63): PUT(), RouteParams, GET(), getDashboardPathForRole(), PUT(), PUT(), RouteParams, GET() (+55 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (71): CommentRecord, Properties, ExtensionList, Percentage, Objects can serialise to XML their attributes and child objects.     The followi, Serialisable, Connection, ConnectorLocking (+63 more)
...
Cohesion: 0.05
Nodes (98): ThemeToggle(), ThemeToggleProps, ChatUser, ContactCard(), ContactCardProps, ContactsSidebar(), DEFAULT_CHAT_STATE, EMPTY_ARRAY (+90 more)
...
Cohesion: 0.04
Nodes (66): Loading(), ConsultationDashboard(), Document, ConsultationTool(), ConsultationToolProps, DigitalSigner, GlobalLoadingContext, GlobalLoadingContextType (+58 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (70): useAppToast(), POST(), DigitalSigner, LandlordLeaseSigningPage(), LandlordSigningContent(), LeaseDetails, LeaseSigningContent(), TenantLeaseSigningPage() (+62 more)
...
Cohesion: 0.04
Nodes (47): Sequence, Alignment, Alignment options for use in styles., Border, Border options for use in styles.     Caution: if you do not specify a border_st, Border positioning for use in styles., Side, CellStyle (+39 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (59): array, CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, Property, PropertyContext, PropertyContextValue (+51 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (42): Alias, Aliases can be used when either the desired attribute name is not allowed     or, CellRange, Extension, Size in hundredths of points.     In theory other units of measurement can be us, TextPoint, UniversalMeasure, Strict (+34 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (66): GET(), openai, POST(), DELETE(), UpdateListingBody, formatContextForAI(), getTenantContext(), getLandlordProperties() (+58 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (26): MergedCell, Describes the properties of a cell in a merged cell and helps to     display the, CellRange, ArrayFormula, DataTableFormula, HyperlinkList, MergedCellRange, MergedCellRange stores the border information of a merged cell in the top     le (+18 more)
...
Cohesion: 0.04
Nodes (35): Cell, column_letter(), coordinate(), get_time_format(), get_type(), is_date(), Check string coding, length, and line break character, Tries to convert Error" else N/A (+27 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (42): make_operand(), make_separator(), make_subexp(), This module contains a tokenizer for Excel formulae.  The tokenizer is based on, Consume all the text between square brackets [].          Returns the number of, Base class for all Tokenizer errors., Consume the text following a '#' as an error.          Looks for a match in self, Consume a string of consecutive spaces.          Returns the number of spaces fo (+34 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (37): DocsPage(), UnitMapFeatureSection(), FeaturesPage(), metadata, ActiveLeasesTab(), ActiveLeasesTabProps, ArchiveTab(), ArchiveTabProps (+29 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (15): MergeCell, MergeCells, Related, Serialise to XML and write to archive, Table, TablePartList, create_temporary_file(), Return all rows, and any cells that they contain (+7 more)
...
Cohesion: 0.11
Nodes (45): getBillingWorkspace(), recordUtilityReading(), upsertPaymentReceipt(), BILLING_BUCKETS, DEFAULT_LIMITS, ensureBucket(), removeBillingFile(), uploadBillingFile() (+37 more)

### Community 24 - "Community 24"
Cohesion: 0.06
Nodes (32): mockApplications, MyApplicationsPage(), properties, recentActivity, ApplyPage(), MAINTENANCE_CATEGORIES, MaintenanceCategoryId, DocsHeader() (+24 more)
...
Cohesion: 0.1
Nodes (49): advancePaymentSchema, POST(), ActiveLeaseWorkspaceRow, AppSupabaseClient, BillingLeaseRow, buildInvoiceListItem(), createAdvancePayment(), createMultiMonthAdvancePayment() (+41 more)
...
Cohesion: 0.05
Nodes (31): read_chart(), Max, Min, Values must be less than a `max` value, Values must be greater than a `min` value, Return a new range with cells common to this range and *other*          :type ot, Return the minimal superset of this range and *other*. This new range         wi, collapse_cell_addresses() (+23 more)

### Community 30 - "Community 30"
Cohesion: 0.07
Nodes (33): Checklist, Deduction, MoveOutInspectionForm(), MoveOutInspectionFormProps, [actionLoading, setActionLoading], [denialReason, setDenialReason], [error, setError], [isInspecting, setIsInspecting] (+25 more)
...
Cohesion: 0.12
Nodes (35): ICON_MAP, LandlordQuestBoardProps, addDays(), clampStepIndex(), completeLandlordProductTour(), createLandlordProductTourState(), ensureLandlordProductTourState(), getLandlordProductTourRequiredStep() (+27 more)
...
Cohesion: 0.05
Nodes (18): CustomChartsheetView, CustomChartsheetViews, PageMargins, PrintOptions, PrintPageSetup, Worksheet print options, Worksheet print page setup, Information about page margins for view/print layouts.     Standard values (in i (+10 more)

### Community 35 - "Community 35"
Cohesion: 0.09
Nodes (29): LeaseDocument(), LeaseHubContent(), LeasesPage(), TabId, DEFAULT_OCCUPANCY, ENUM_TO_PROPERTY_TYPE, NewAssetContent(), NewAssetPage() (+21 more)
...
Cohesion: 0.06
Nodes (26): Float, ConditionalFormatting, ConditionalFormattingList, Add a rule for a cell range, Check whether a certain cell is affected by the formatting, Conditional formatting rules., Add a rule such as ColorScaleRule, FormulaRule or CellIsRule           The prior, Get the rules for a cell range (+18 more)
...
Cohesion: 0.09
Nodes (22): Base64Binary, Guid, MatchPattern, ChildSheet, FileRecoveryProperties, PivotCache, Represents a reference to a worksheet or chartsheet in workbook.xml      It cont, Represent the workbook file in the archive (+14 more)
...
Cohesion: 0.06
Nodes (23): BoundDictionary, defaultdict, Map fields to associated conditional formats by priority, StyleableObject, Base class for styleble objects implementing proxy and lookup functions, StyleableObject, BoundDictionary, A default dictionary where elements are tightly coupled.      The factory method (+15 more)
...
Cohesion: 0.1
Nodes (35): InvoiceListItem, InvoiceReadingDetail, formatPhpCurrency(), buildFaceToFacePreviewInvoice(), buildSelectivePreviewInvoice(), CheckoutPage(), Field(), InvoiceDetail (+27 more)
...
Cohesion: 0.08
Nodes (11): _no_value(), builtin_format_code(), builtin_format_id(), is_timedelta_format(), Return one of the standard format codes by index., Return the id of a standard style., style_id(), apply_stylesheet() (+3 more)
...
Cohesion: 0.18
Nodes (28): addDays(), clampStepIndex(), completeTenantProductTour(), createTenantProductTourState(), ensureTenantProductTourState(), getTenantProductTourSkipCooldownDays(), getTenantProductTourState(), getTenantProductTourStepById() (+20 more)

### Community 69 - "Community 69"
Cohesion: 0.1
Nodes (13): Generate string representation of XML element.      All subelements are included, tostring(), ExtendedProperties, See 22.2      Most of this is irrelevant but Excel is very picky about the versi, Write to zipfile and update manifest, Write the workbook relationships xml., ExcelWriter, Write links to external workbooks (+5 more)
...
Cohesion: 0.08
Nodes (11): Chartsheet, ChartsheetProperties, ChartsheetProtection, WebPublishItem, WebPublishItems, DrawingHF, ChartsheetView, ChartsheetViewList (+3 more)
...
Cohesion: 0.13
Nodes (20): CommandCenter(), CommandCenterProps, NextMove, StatCard, urgencyStyles, LandlordWelcomeLightbox(), INACTIVE_INVITE_STATUSES, LandlordDashboard() (+12 more)
...
Cohesion: 0.14
Nodes (19): DateTime, Descriptor, A sequence (list or tuple) that may only contain objects of the declared     typ, Use a set to keep values unique, Sequence, UniqueSequence, NestedText, NestedDateTime (+11 more)
...
Cohesion: 0.09
Nodes (12): MultiCellRange, absolute_coordinate(), Convert a coordinate to an absolute coordinate string (B12 -> $B$12), ColRange, from_string(), PrintArea, Represent a range of at least one column, Represent a range of at least one row (+4 more)
...
Cohesion: 0.26
Nodes (12): completeSchema, POST(), isGuidedTenantProductTourEnabled(), TENANT_PRODUCT_TOUR_STEPS, POST(), POST(), skipSchema, POST() (+4 more)
...
Cohesion: 0.13
Nodes (9): sheetname(), quote_sheetname(), Add quotes around sheetnames if they contain spaces., DefinedName, create_named_range(), get_active_sheet(), Write the core workbook xml., Return the index of the active sheet.     If the sheet set to active is hidden r (+1 more)
...
Cohesion: 0.15
Nodes (14): ActionItem, ActionItemCard(), ActionRequired(), ActionRequiredAction, ActionRequiredState, ActionSummary, formatDateLabel(), getDaysUntil() (+6 more)
...
Cohesion: 0.12
Nodes (8): Find all sheets in the workbook and return the link to the source file., Bind defined names and other definitions to worksheets or the workbook, WorkbookParser, DefinedNameList, Check for whether DefinedName with the same name and scope already         exist, PrintTitles, Contains at least either a range of rows or columns, print_titles()
...
Cohesion: 0.36
Nodes (11): evaluateLandlordProductTourEligibility(), isGuidedLandlordProductTourEnabled(), LandlordProductTourTriggerSource, resolveLandlordProductTourEligibility(), TenantProductTourTriggerSource, DELETE(), GET(), parseBoolean() (+3 more)
...
Cohesion: 0.18
Nodes (6): Control, ControlProperty, Controls, ObjectAnchor, ObjectPr, OleObject
...
Cohesion: 0.29
Nodes (7): INITIAL_TOUR_UI_STATE, isTourEnabledClient(), StepProgressPayload, TenantProductTourOverlay(), TourApiPayload, TourUiAction, TourUiState
...
Cohesion: 0.22
Nodes (4): Add to zipfile and update manifest, Write the relevant child objects and add links, Return a dictionary of format objects keyed by (field id and format property)., Group formats by field index and priority.         Sorted to match sorting and g
...
## Knowledge Gaps
- **2682 isolated node(s):** `supabase`, `supabase`, `supabase`, `supabase`, `eslintConfig` (+2677 more)
...
- **Why does `Serialisable` connect `Community 3` to `Community 0`, `Community 1`, `Community 4`, `Community 12`, `Community 141`, `Community 14`, `Community 142`, `Community 16`, `Community 21`, `Community 25`, `Community 27`, `Community 29`, `Community 34`, `Community 37`, `Community 39`, `Community 40`, `Community 167`, `Community 41`, `Community 301`, `Community 434`, `Community 64`, `Community 69`, `Community 70`, `Community 75`, `Community 76`, `Community 342`, `Community 87`, `Community 343`, `Community 92`, `Community 93`, `Community 105`, `Community 106`, `Community 107`, `Community 239`, `Community 240`, `Community 115`, `Community 116`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 7` to `Community 128`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 137`, `Community 11`, `Community 13`, `Community 20`, `Community 22`, `Community 24`, `Community 30`, `Community 31`, `Community 32`, `Community 162`, `Community 35`, `Community 164`, `Community 174`, `Community 175`, `Community 48`, `Community 50`, `Community 52`, `Community 54`, `Community 182`, `Community 59`, `Community 66`, `Community 67`, `Community 68`, `Community 82`, `Community 100`, `Community 108`, `Community 109`, `Community 237`, `Community 114`, `Community 119`, `Community 249`, `Community 251`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 0` to `Community 2`, `Community 3`, `Community 5`, `Community 10`, `Community 138`, `Community 15`, `Community 17`, `Community 23`, `Community 26`, `Community 32`, `Community 161`, `Community 162`, `Community 36`, `Community 45`, `Community 175`, `Community 48`, `Community 51`, `Community 59`, `Community 68`, `Community 205`, `Community 206`, `Community 78`, `Community 221`, `Community 100`?**
