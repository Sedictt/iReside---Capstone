...
## Corpus Check
- 993 files · ~7,165,313 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9289 nodes · 21197 edges · 695 communities (496 shown, 199 thin omitted)
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 4458 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `66bf1a24`
...
## Communities (695 total, 199 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (110): ChatUser, ContactCard(), ContactCardProps, ContactsSidebar(), DEFAULT_CHAT_STATE, EMPTY_ARRAY, EMPTY_OBJECT, formatConversationTimestamp() (+102 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (56): PUT(), RouteParams, GET(), getDashboardPathForRole(), PUT(), PUT(), RouteParams, GET() (+48 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (78): title_maker(), ColorChoice, Convertible, HexBinary, EmptyTag, NestedValue, Boolean if a tag exists or not., Nested tag storing the value on the 'val' attribute (+70 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (75): AdminLayout(), geistMono, geistSans, metadata, RootLayout(), ThemeProvider(), AuthContext, AuthContextValue (+67 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (56): PageMargins, Identical to openpyxl.worksheet.page.Pagemargins but element names are different, Chartsheet, CustomChartsheetView, CustomChartsheetViews, ChartsheetProperties, ChartsheetProtection, WebPublishItem (+48 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (58): ExtensionList, Percentage, Connection, ConnectorLocking, ConnectorNonVisual, ConnectorShape, NonVisualConnectorProperties, ShapeMeta (+50 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (67): generateOTP(), GET(), POST(), ensureBucket(), POST(), sanitizeFileName(), ensureBucket(), POST() (+59 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (47): CellRange, A sequence of primitive types that are stored as a single attribute.     "val" i, ValueSequence, ExternalBook, ExternalCell, ExternalDefinedName, ExternalLink, ExternalRow (+39 more)
...
Cohesion: 0.06
Nodes (63): InlineFont, PhoneticProperties, PhoneticText, Font for inline text because, yes what you need are different objects with the s, RichText, Text, _3DBase, Base class for 3D charts (+55 more)

### Community 10 - "Community 10"
Cohesion: 0.05
Nodes (62): ConsultationDashboard(), Document, ConsultationTool(), ConsultationToolProps, DigitalSigner, ConsultationTool, SignPage(), AddAmenityModal() (+54 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (44): ElementList, Represents many kinds of relationships., `type` can be used as a shorthand with the default relationships namespace, Return a dictionary of relations keyed by id, Relationship, RelationshipList, Index, AutoSortScope (+36 more)
...
Cohesion: 0.1
Nodes (46): Alias, MultiSequence, MultiSequencePart, NestedSequence, Allow a multisequence to be built up from parts      Excluded from the instance, Wrap a sequence in an containing object, Sequences can contain objects with different tags, CacheDefinition (+38 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (75): GET(), openai, POST(), formatContextForAI(), getTenantContext(), getActiveLease(), getLandlordLeases(), getLandlordRenewalRequests() (+67 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (63): formatPhpCurrency(), CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, Property, PropertyContext, PropertyContextValue (+55 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (60): AdminChatModerationPage(), BannedTerm, ModerationReportCard(), ReportRow, ReportStatus, STATUS_OPTIONS, BulkOrganizerPanel(), BulkOrganizerPanelProps (+52 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (52): buildInvoiceLabel(), buildOverdueLabel(), DashboardData, DEFAULT_QUICK_ACTIONS, formatCurrency(), formatCurrencyParts(), formatDueDate(), ICON_MAP (+44 more)
...
Cohesion: 0.1
Nodes (46): _3DBase, AreaChart, AreaChart3D, _AreaChartBase, ChartLines, NumericAxis, SeriesAxis, TextAxis (+38 more)

### Community 20 - "Community 20"
Cohesion: 0.07
Nodes (63): advancePaymentSchema, POST(), ActiveLeaseWorkspaceRow, AppSupabaseClient, BillingLeaseRow, buildInvoiceListItem(), createAdvancePayment(), createMultiMonthAdvancePayment() (+55 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (35): Base64Binary, Extension, Guid, Size in hundredths of points.     In theory other units of measurement can be us, Relation, TextPoint, UniversalMeasure, MatchPattern (+27 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (41): VALUES, WHO_IT_SERVES, AdminSidebar(), NAV_ITEMS, HOW_IT_WORKS, IRIS_WORKFLOWS, OUTCOMES, ScrollyTellingLandingPage() (+33 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (44): ConsentSettings, CookieConsent(), SettingToggle(), DocsPage(), ActiveLeasesTab(), ActiveLeasesTabProps, ArchiveTab(), ArchiveTabProps (+36 more)
...
Cohesion: 0.07
Nodes (42): GET(), GET(), POST(), GET(), POST(), GET(), formatDate(), getPaymentCategory() (+34 more)

### Community 27 - "Community 27"
Cohesion: 0.08
Nodes (31): _BaseAxis, DateAxis, DisplayUnitsLabel, DisplayUnitsLabelList, Scaling, AxId, ChartContainer, ChartSpace (+23 more)

### Community 28 - "Community 28"
Cohesion: 0.08
Nodes (28): Shape, anchor(), Drawing, a drawing object - eg container for shapes or charts         we assume user spec, PresetGeometry2D, GraphicFrame, GroupShape, Image (+20 more)
...
Cohesion: 0.07
Nodes (34): Loading(), BillingWorkspace, GlobalLoadingContext, GlobalLoadingContextType, GlobalLoadingProvider(), Action, BillingOperationsPanel(), Field() (+26 more)

### Community 34 - "Community 34"
Cohesion: 0.06
Nodes (35): coordinate(), Return and remove the first cell, product(), build_workbook(), format_case_id(), resolve_output_path(), Border options for use in styles.     Caution: if you do not specify a border_st, Side (+27 more)
...
Cohesion: 0.07
Nodes (18): BoundDictionary, StyleableObject, BoundDictionary, A default dictionary where elements are tightly coupled.      The factory method, boundaries(), ColumnDimension, Dimension, DimensionHolder (+10 more)
...
Cohesion: 0.14
Nodes (36): ICON_MAP, LandlordQuestBoardProps, addDays(), clampStepIndex(), completeLandlordProductTour(), createLandlordProductTourState(), ensureLandlordProductTourState(), evaluateLandlordProductTourEligibility() (+28 more)

### Community 49 - "Community 49"
Cohesion: 0.05
Nodes (15): Cell, column_letter(), coordinate(), get_time_format(), get_type(), MergedCell, Check string coding, length, and line break character, Tries to convert Error" else N/A (+7 more)
...
Cohesion: 0.07
Nodes (18): _NamedCellStyleList, NamedStyleList, Named styles are editable and can be applied to multiple objects      As only th, Allow a list of named styles to be passed in and index them., Container for named cell style objects      Not used in client code, Some applications contain duplicate definitions either by name or         refere, NumberFormatDescriptor, Protection (+10 more)
...
Cohesion: 0.08
Nodes (19): Sequence, Border, Border positioning for use in styles., _assign_position(), Fill, GradientFill, PatternFill, Automatically assign positions if a list of colours is provided.      It is not (+11 more)
...
Cohesion: 0.09
Nodes (10): is_date(), _no_value(), builtin_format_id(), is_date_format(), is_datetime(), Return date, time or datetime, Return the id of a standard style., apply_stylesheet() (+2 more)

### Community 76 - "Community 76"
Cohesion: 0.09
Nodes (22): WriteOnlyCell(), Exception, coordinate_from_string(), Convert a coordinate string like 'B12' to a tuple ('B', 12), CellCoordinatesException, IllegalCharacterError, NamedRangeException, The data submitted which cannot be used directly in Excel files. It     must be (+14 more)
...
Cohesion: 0.1
Nodes (25): FloorSelector(), FloorSelectorProps, FloorTab, VisualCanvasProps, useOptionalProperty(), useVisualBuilderState(), VisualBuilderStateProps, DEFAULT_FLOOR_LAYOUTS (+17 more)
...
Cohesion: 0.19
Nodes (12): completeSchema, POST(), LANDLORD_PRODUCT_TOUR_STEPS, isGuidedTenantProductTourEnabled(), POST(), POST(), skipSchema, POST() (+4 more)
...
Cohesion: 0.14
Nodes (19): Bool, DateTime, Descriptor, Strict, A sequence (list or tuple) that may only contain objects of the declared     typ, Sequence, NestedText, NestedDateTime (+11 more)
...
Cohesion: 0.11
Nodes (8): Alignment, Alignment options for use in styles., ArrayDescriptor, CellStyle, Convert to StyleArray, Extract protection and alignments, convert to style array, IndexedList, List with optimised access by value     Based on Alex Martelli's recipe      htt
...
Cohesion: 0.11
Nodes (10): ComplaintModalProps, ComplaintModalProps, TransferRequestModal(), TransferRequestModalProps, UnitHistoryModalProps, UnitTooltip(), UnitTooltipProps, Unit (+2 more)
...
Cohesion: 0.12
Nodes (13): code:typescript (it('fetches comments with nested replies (max depth 2)', asy), code:bash (git add src/lib/community/actions.ts), code:typescript (it('allows tenant to vote on poll (upsert)', async () => {), code:bash (npx vitest --run), code:bash (git add src/lib/community/actions.ts), code:typescript (it('toggles reaction on post', async () => {), code:bash (git add src/lib/community/actions.ts), code:bash (git add src/lib/community/actions.ts) (+5 more)
...
Cohesion: 0.17
Nodes (14): array, DbUnit, QuickActionGuardResult, QuickActionType, dbUnitToCanvasUnit(), formatFloorWatermark(), getFloorDisplayLabel(), parseFloorNumber() (+6 more)
...
Cohesion: 0.14
Nodes (13): **3.1 Development Model** {#3.1-development-model}, **3.3.1 Functional Requirements** {#3.3.1-functional-requirements}, **3.3 Requirement Analysis/Documentation** {#3.3-requirement-analysis/documentation}, **3.4 Project Description** {#3.4-project-description}, **APPENDICES** {#appendices}, **BIBLIOGRAPHY** {#bibliography}, **CHAPTER 1** {#chapter-1}, **CHAPTER 2** {#chapter-2} (+5 more)
...
Cohesion: 0.42
Nodes (9): LandlordProductTourTriggerSource, resolveLandlordProductTourEligibility(), TenantProductTourTriggerSource, DELETE(), GET(), parseBoolean(), resolveOnboardingCompleted(), resolveRole() (+1 more)
...
Cohesion: 0.22
Nodes (5): CellRange, MergedCellRange, MergedCellRange stores the border information of a merged cell in the top     le, If the upper left cell of the merged cell does not yet exist, it is         crea, Each cell of the merged cell is created as MergedCell if it does not         alr
...
Cohesion: 0.29
Nodes (4): Alias, Aliases can be used when either the desired attribute name is not allowed     or, Use a set to keep values unique, UniqueSequence
...
Cohesion: 0.33
Nodes (3): Add a range of data in a single pass.         The default is to treat each colum, Append a data series to the chart, Combine the chart with another one

### Community 319 - "Community 319"
Cohesion: 0.33
Nodes (6): **3.2.1 Research Locale** {#3.2.1-research-locale}, **3.2.2 Respondents** {#3.2.2-respondents}, **3.2.3 Population And Sampling Techniques** {#3.2.3-population-and-sampling-techniques}, **3.2.4 Research Instruments** {#3.2.4-research-instruments}, **3.2.8 Ethical Considerations**   {#3.2.8-ethical-considerations}, **3.2 Research Design** {#3.2-research-design}
...
- **Why does `Serialisable` connect `Community 4` to `Community 2`, `Community 5`, `Community 261`, `Community 7`, `Community 9`, `Community 11`, `Community 13`, `Community 19`, `Community 21`, `Community 24`, `Community 154`, `Community 27`, `Community 28`, `Community 34`, `Community 35`, `Community 39`, `Community 46`, `Community 49`, `Community 57`, `Community 58`, `Community 69`, `Community 197`, `Community 71`, `Community 74`, `Community 80`, `Community 216`, `Community 89`, `Community 90`, `Community 91`, `Community 218`, `Community 98`, `Community 107`, `Community 108`, `Community 112`, `Community 118`, `Community 249`, `Community 125`, `Community 126`?**
  _High betweenness centrality (0.135) - this node is a cross-community bridge._
- **Why does `Boolean` connect `Community 13` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 12`, `Community 159`, `Community 37`, `Community 171`, `Community 44`, `Community 45`, `Community 48`, `Community 51`, `Community 61`, `Community 99`, `Community 103`, `Community 114`, `Community 248`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 13` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 136`, `Community 12`, `Community 14`, `Community 15`, `Community 18`, `Community 20`, `Community 159`, `Community 37`, `Community 169`, `Community 44`, `Community 45`, `Community 174`, `Community 48`, `Community 61`, `Community 66`, `Community 215`, `Community 233`, `Community 124`?**
