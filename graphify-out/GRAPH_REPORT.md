...
## Corpus Check
- 935 files · ~6,907,488 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7786 nodes · 19357 edges · 572 communities (384 shown, 188 thin omitted)
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 4456 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `64067be9`
...
## Communities (572 total, 188 thin omitted)
...
Cohesion: 0.02
Nodes (79): AuthorList, CommentRecord, CommentSheet, Properties, Base64Binary, CellRange, Extension, Guid (+71 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (113): AnalyticsPage(), DEFAULT_EXTENDED_KPIS, DEFAULT_FINANCIAL_CHART, DEFAULT_OPERATIONAL_SNAPSHOT, DEFAULT_PRIMARY_KPIS, ExportAuditItem, formatIsoDate(), getDateLabels() (+105 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (49): PUT(), RouteParams, GET(), getDashboardPathForRole(), PUT(), PUT(), RouteParams, GET() (+41 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (70): Percentage, Connection, ConnectorLocking, ConnectorNonVisual, ConnectorShape, NonVisualConnectorProperties, ShapeMeta, AdjPoint2D (+62 more)
...
Cohesion: 0.07
Nodes (75): title_maker(), ColorChoice, Convertible, EmptyTag, NestedValue, Boolean if a tag exists or not., Nested tag storing the value on the 'val' attribute, ColorChoice (+67 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (70): AdminSidebar(), NAV_ITEMS, AdminLayout(), geistMono, geistSans, metadata, RootLayout(), CookieConsent() (+62 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (76): Loading(), ConsultationDashboard(), Document, ConsultationTool(), ConsultationToolProps, DigitalSigner, ConsultationTool, SignPage() (+68 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (70): CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, useAuth(), Property, PropertyContext, PropertyContextValue (+62 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (60): buildInvoiceLabel(), buildOverdueLabel(), DashboardData, formatCurrency(), formatCurrencyParts(), formatDueDate(), TenantDashboard(), Document (+52 more)
...
Cohesion: 0.05
Nodes (47): PhoneticProperties, PhoneticText, RichText, Text, Level, MultiLevelStrData, MultiLevelStrRef, NumberValueDescriptor (+39 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (29): Cell, MergedCell, Tries to convert Error" else N/A, Returns a cell location relative to this cell.          :param row: number of ro, Describes the properties of a cell in a merged cell and helps to     display the, Describes cell associated properties.      Properties of interest include style,, CellRange, StyleableObject (+21 more)

### Community 15 - "Community 15"
Cohesion: 0.06
Nodes (40): generateOTP(), GET(), POST(), assertAdmin(), MUTABLE_STATUSES, PATCH(), RegistrationRecord, fileSchema (+32 more)

### Community 16 - "Community 16"
Cohesion: 0.07
Nodes (56): array, useOptionalProperty(), CanvasItemKind, canViewTenantProfile, ComplaintModal(), Corridor, CorridorResizeHandle, daysRemaining (+48 more)
...
Cohesion: 0.06
Nodes (27): Modifies a formula so that it can be translated from one cell to another.      `, Translator, _gutter(), Returns a cell object based on the given coordinates.          Usage: cell(row=1, Internal method for getting a cell from a worksheet.         Will create a new c, Internal method for adding cell objects., Convenience access by Excel style coordinates          The key can be a single c, Produces cells from the worksheet, by row. Specify the iteration range         u (+19 more)

### Community 20 - "Community 20"
Cohesion: 0.08
Nodes (34): ensureBucket(), POST(), sanitizeFileName(), ensureBucket(), POST(), sanitizeFileName(), GET(), POST() (+26 more)

### Community 21 - "Community 21"
Cohesion: 0.11
Nodes (41): ADVANCE_TEMPLATE_KEYS, ApplicationPaymentRequestStatus, ApplicationPaymentRequirementType, applyPaymentPendingExpiry(), areRequiredPaymentRequestsCompleted(), asRecord(), buildPortalToken(), buildPortalUrl() (+33 more)
...
Cohesion: 0.06
Nodes (36): column_letter(), coordinate(), Return and remove the first cell, product(), build_workbook(), format_case_id(), resolve_output_path(), cols_from_range() (+28 more)
...
Cohesion: 0.08
Nodes (28): VALUES, WHO_IT_SERVES, HOW_IT_WORKS, IRIS_WORKFLOWS, OUTCOMES, ScrollyTellingLandingPage(), SHOWCASE_MODULES, DocsHeader() (+20 more)
...
Cohesion: 0.07
Nodes (12): Sequence, Border options for use in styles.     Caution: if you do not specify a border_st, Side, _assign_position(), Automatically assign positions if a list of colours is provided.      It is not, Stop, StopList, builtin_format_id() (+4 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (26): read_chart(), defaultdict, Max, Min, Values must be less than a `max` value, Values must be greater than a `min` value, Break names down into sheet locals and globals, collapse_cell_addresses() (+18 more)
...
Cohesion: 0.07
Nodes (19): BoundDictionary, Base class for styleble objects implementing proxy and lookup functions, StyleableObject, BoundDictionary, A default dictionary where elements are tightly coupled.      The factory method, ColumnDimension, Dimension, DimensionHolder (+11 more)
...
Cohesion: 0.06
Nodes (18): dict, DocumentProperties, High-level properties of the document.     Defined in ECMA-376 Par2 Annex D, TableStyleList, DefinedNameDict, destinations(), Utility class for storing defined names.     Allows access by name and separatio, Add names without worrying about key and name matching. (+10 more)
...
Cohesion: 0.17
Nodes (21): AuditEvent, extractIpAddress(), extractUserAgent(), logAuditEvent(), sendLeaseActivatedNotification(), sendTenantSignedNotification(), generateLeasePdf(), LeasePdfData (+13 more)
...
Cohesion: 0.09
Nodes (21): Check string coding, length, and line break character, WriteOnlyCell(), Exception, CellCoordinatesException, IllegalCharacterError, NamedRangeException, The data submitted which cannot be used directly in Excel files. It     must be, Error for badly formatted named ranges. (+13 more)
...
Cohesion: 0.07
Nodes (9): MultiCellRange, PrintOptions, Worksheet print options, PrintArea, password(), Information about protection of various aspects of a sheet. True values     mean, SheetProtection, ScenarioList (+1 more)
...
Cohesion: 0.13
Nodes (15): read_external_link(), get_dependents(), get_rel(), get_rels_path(), Normalise dependency file paths to absolute ones      Relative paths are relativ, Get related object based on id or rel_type, Find relationships by content-type         NB. these content-types namespaced ob, Convert relative path to absolutes that can be loaded from a zip     archive. (+7 more)
...
Cohesion: 0.1
Nodes (10): ColRange, from_string(), PrintTitles, Contains at least either a range of rows or columns, Represent a range of at least one column, Represent a range of at least one row, RowRange, print_title_cols() (+2 more)
...
Cohesion: 0.18
Nodes (10): POST(), getActiveLease(), getLandlordLeases(), getLandlordRenewalRequests(), getLeaseById(), getRenewalRequestById(), getTenantLeases(), getTenantRenewalRequests() (+2 more)
...
Cohesion: 0.14
Nodes (5): from_comments(), Create the VML for comments, Create VML for comments, _shape_factory(), ShapeWriter
...
Cohesion: 0.12
Nodes (12): code:typescript (it('returns poll results with aggregated vote counts', async), code:bash (npx vitest --run), code:typescript (it('fetches comments with nested replies (max depth 2)', asy), code:bash (git add src/lib/community/actions.ts), code:typescript (it('adds top-level comment', async () => {), code:bash (git add src/lib/community/actions.ts), code:bash (git add src/lib/community/actions.ts), Phase 2: Server Actions & Data Layer (+4 more)
...
- **Why does `Serialisable` connect `Community 2` to `Community 0`, `Community 1`, `Community 130`, `Community 5`, `Community 7`, `Community 13`, `Community 14`, `Community 22`, `Community 27`, `Community 28`, `Community 30`, `Community 33`, `Community 36`, `Community 37`, `Community 38`, `Community 168`, `Community 42`, `Community 44`, `Community 64`, `Community 65`, `Community 67`, `Community 71`, `Community 72`, `Community 73`, `Community 78`, `Community 209`, `Community 82`, `Community 87`, `Community 96`, `Community 100`, `Community 105`, `Community 110`, `Community 245`, `Community 124`?**
  _High betweenness centrality (0.154) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 3` to `Community 259`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 137`, `Community 16`, `Community 146`, `Community 147`, `Community 26`, `Community 155`, `Community 157`, `Community 158`, `Community 163`, `Community 43`, `Community 45`, `Community 46`, `Community 48`, `Community 54`, `Community 60`, `Community 63`, `Community 195`, `Community 77`, `Community 85`, `Community 218`, `Community 93`, `Community 109`, `Community 117`, `Community 127`?**
  _High betweenness centrality (0.144) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 0` to `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 136`, `Community 137`, `Community 138`, `Community 15`, `Community 17`, `Community 21`, `Community 23`, `Community 25`, `Community 157`, `Community 39`, `Community 167`, `Community 43`, `Community 48`, `Community 52`, `Community 181`, `Community 182`, `Community 54`, `Community 184`, `Community 60`, `Community 62`, `Community 81`?**
