...
## Corpus Check
- 971 files · ~7,131,988 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8682 nodes · 20542 edges · 641 communities (443 shown, 198 thin omitted)
- Extraction: 78% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 4458 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e5bbf424`
...
## Communities (641 total, 198 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (90): CustomChartsheetView, CustomChartsheetViews, CommentRecord, CommentSheet, Properties, Base64Binary, CellRange, Extension (+82 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (97): Percentage, Connection, ConnectorLocking, ConnectorNonVisual, ConnectorShape, NonVisualConnectorProperties, Shape, ShapeMeta (+89 more)
...
Cohesion: 0.05
Nodes (105): ThemeToggle(), ThemeToggleProps, ChatUser, ContactCard(), ContactCardProps, ContactsSidebar(), DEFAULT_CHAT_STATE, EMPTY_ARRAY (+97 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (79): Bool, title_maker(), ColorChoice, HexBinary, Relation, EmptyTag, Boolean if a tag exists or not., NestedSequence (+71 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (52): PUT(), RouteParams, expireInPersonIntents(), GET(), getDashboardPathForRole(), PUT(), PUT(), RouteParams (+44 more)
...
Cohesion: 0.04
Nodes (69): NextPayment, OverduePayment, PaymentSummaryProps, LeaseInfo, TenantDashboardHeaderProps, UnitHistoryModalProps, ConsultationDashboard(), Document (+61 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (79): completeSchema, POST(), addDays(), clampStepIndex(), completeTenantProductTour(), createTenantProductTourState(), ensureTenantProductTourState(), evaluateTenantProductTourEligibility() (+71 more)
...
Cohesion: 0.05
Nodes (55): PhoneticProperties, PhoneticText, RichText, Text, Level, MultiLevelStrData, MultiLevelStrRef, NumberValueDescriptor (+47 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (41): ElementList, Represents many kinds of relationships., `type` can be used as a shorthand with the default relationships namespace, Return a dictionary of relations keyed by id, Relationship, RelationshipList, Index, AutoSortScope (+33 more)
...
Cohesion: 0.05
Nodes (61): SigningMode, SigningModeSelector(), SigningModeSelectorProps, BackgroundGlow(), Noise(), TOOL_ACCENTS, TOOL_GLOWS, ToolAccessBar() (+53 more)
...
Cohesion: 0.04
Nodes (19): PrintOptions, PrintPageSetup, Worksheet print options, Worksheet print page setup, Break, ColBreak, RowBreak, Outline (+11 more)
...
Cohesion: 0.1
Nodes (42): getBillingWorkspace(), BILLING_BUCKETS, DEFAULT_LIMITS, ensureBucket(), removeBillingFile(), uploadBillingFile(), sanitizeFileName(), computeAmountTag() (+34 more)
...
Cohesion: 0.11
Nodes (40): ICON_MAP, LandlordQuestBoardProps, addDays(), clampStepIndex(), completeLandlordProductTour(), createLandlordProductTourState(), ensureLandlordProductTourState(), evaluateLandlordProductTourEligibility() (+32 more)
...
Cohesion: 0.07
Nodes (34): buildInvoiceLabel(), buildOverdueLabel(), DashboardData, formatCurrency(), formatCurrencyParts(), formatDueDate(), TenantDashboard(), LeaseHubContent() (+26 more)
...
Cohesion: 0.07
Nodes (47): DELETE(), UpdateListingBody, onboardingSchema, RouteParams, Amenity, AmenityBooking, Application, ApplicationSource (+39 more)
...
Cohesion: 0.09
Nodes (24): HOW_IT_WORKS, IRIS_WORKFLOWS, OUTCOMES, ScrollyTellingLandingPage(), SHOWCASE_MODULES, ApplyPage(), DocsHeader(), DocsHeaderProps (+16 more)
...
Cohesion: 0.08
Nodes (22): VALUES, WHO_IT_SERVES, geistMono, geistSans, metadata, RootLayout(), Loading(), GlobalLoadingContext (+14 more)
...
Cohesion: 0.12
Nodes (23): Document, DocumentsPage(), LandlordProfile, VerificationInfo, LeaseDocument(), DEFAULT_OCCUPANCY, ENUM_TO_PROPERTY_TYPE, NewAssetContent() (+15 more)

### Community 50 - "Community 50"
Cohesion: 0.08
Nodes (25): ComplaintModalProps, ComplaintModalProps, TransferRequestModal(), TransferRequestModalProps, UnitHistoryModalProps, VisualCanvasProps, VisualBuilderStateProps, DEFAULT_FLOOR_LAYOUTS (+17 more)

### Community 51 - "Community 51"
Cohesion: 0.12
Nodes (21): Deduction, MoveOutInspectionForm(), MoveOutInspectionFormProps, [actionLoading, setActionLoading], [denialReason, setDenialReason], [error, setError], [isInspecting, setIsInspecting], MoveOutRequest (+13 more)
...
Cohesion: 0.12
Nodes (11): DocsPage(), UnitMapFeatureSection(), FeaturesPage(), metadata, DocDetailPage(), DOCS_CONTENT, cardHover, fadeInUp (+3 more)

### Community 76 - "Community 76"
Cohesion: 0.22
Nodes (18): AuditEvent, extractIpAddress(), extractUserAgent(), logAuditEvent(), sendLeaseActivatedNotification(), sendTenantSignedNotification(), generateLeasePdf(), getAllowedTransitions() (+10 more)
...
Cohesion: 0.13
Nodes (13): read_chart(), Override, get_dependents(), Normalise dependency file paths to absolute ones      Relative paths are relativ, find_images(), Given the path to a drawing file extract charts and images      Ignore errors du, ExcelReader, _find_workbook_part() (+5 more)
...
Cohesion: 0.09
Nodes (11): Alignment, Alignment options for use in styles., Border, Border positioning for use in styles., ArrayDescriptor, NamedStyleList, Named styles are editable and can be applied to multiple objects      As only th, Allow a list of named styles to be passed in and index them. (+3 more)

### Community 98 - "Community 98"
Cohesion: 0.12
Nodes (14): make_operand(), Consume all the text between square brackets [].          Returns the number of, Base class for all Tokenizer errors., Consume the text following a '#' as an error.          Looks for a match in self, A tokenizer for Excel worksheet formulae.      Converts a str string representin, Consumes a } or ) character.          Returns the number of characters consumed., Consumes a + or - character if part of a number in sci. notation.          Retur, Ensure that there's no token currently being parsed.          Or if there is a t (+6 more)

### Community 99 - "Community 99"
Cohesion: 0.09
Nodes (4): DefinedName, destinations(), type(), create_named_range()
...
Cohesion: 0.11
Nodes (11): make_separator(), make_subexp(), This module contains a tokenizer for Excel formulae.  The tokenizer is based on, Consume a string of consecutive spaces.          Returns the number of spaces fo, Consume the characters constituting an operator.          Returns the number of, Consumes a ( or { character.          Returns the number of characters consumed., Consumes a ; or , character.          Returns the number of characters consumed., A token in an Excel formula.      Tokens have three attributes:      * `value`: (+3 more)
...
Cohesion: 0.12
Nodes (12): code:typescript (it('returns ordered photos for album', async () => {), code:bash (git add src/lib/community/actions.ts), code:typescript (it('adds top-level comment', async () => {), code:bash (git add src/lib/community/actions.ts), code:bash (git add src/lib/community/actions.ts), code:typescript (it('allows tenant to report a post', async () => {), code:bash (git add src/lib/community/actions.ts), Phase 2: Server Actions & Data Layer (+4 more)
...
Cohesion: 0.24
Nodes (14): ActivityItem, Announcement, buildUtilities(), GET(), isPendingStatus(), LeaseSummary, NextPayment, normalizeCategory() (+6 more)
...
Cohesion: 0.2
Nodes (11): This module contains code to translate formulae across cells in a worksheet.  Th, Convert the formula into A1 notation, or as row and column coordinates, Raised when a formula can't be translated across cells.      This error arises w, Modifies a formula so that it can be translated from one cell to another.      `, Returns a list with the tokens comprising the formula., strip_ws_name(), translate_col(), translate_range() (+3 more)
...
Cohesion: 0.26
Nodes (9): getActiveLease(), getLandlordLeases(), getLandlordRenewalRequests(), getLeaseById(), getRenewalRequestById(), getTenantLeases(), getTenantRenewalRequests(), POST() (+1 more)
...
Cohesion: 0.22
Nodes (11): array, useOptionalProperty(), useVisualBuilderState(), formatFloorWatermark(), getFloorDisplayLabel(), parseFloorNumber(), formatFloorWatermark(), getFloorDisplayLabel() (+3 more)
...
Cohesion: 0.16
Nodes (4): Add to zipfile and update manifest, Write the relevant child objects and add links, Write to zipfile and update manifest, Serialise to XML and write to archive
...
Cohesion: 0.18
Nodes (10): 10. Glossary, 1. What is iReside?, 2. The Big Picture: How Everything Connects, code:block1 (┌───────────────────────────────────────────────────────────), Contact & Support, How Data Flows, iReside Technical Documentation, Quick Reference: Module Overview (+2 more)

### Community 214 - "Community 214"
Cohesion: 0.18
Nodes (11): 4.3 Tenant Portal, 4.6 Community Hub, 4. Core Modules, code:block2 (┌───────────────────────────────────────────────────────────), Features, Key Features, Moderation, Post Types (+3 more)
...
Cohesion: 0.22
Nodes (9): DbUnit, FloorId, QuickActionGuardResult, QuickActionType, dbUnitToCanvasUnit(), QUICK_ACTION_META, QUICK_ACTIONS_BY_STATUS, UNIT_SIZE_BY_BEDS (+1 more)
...
Cohesion: 0.22
Nodes (5): get_rel(), Get related object based on id or rel_type, Find relationships by content-type         NB. these content-types namespaced ob, pivot_caches(), rels()
...
Cohesion: 0.25
Nodes (8): 4.5 AI Assistant (iRis), code:block4 (Tenant: "What amenities are available?"), Cost, How It Works (Technical), Privacy & Security, What Can iRis Answer?, What It Does, What Makes iRis Special
...
Cohesion: 0.29
Nodes (7): 4.8 Payment Processing, code:block6 (┌──────────────┐), In-Person Payment Flow, Payment Receipts, Payment Workflow, Supported Payment Methods, What It Does

### Community 288 - "Community 288"
Cohesion: 0.29
Nodes (7): 4.9 Maintenance System, AI-Powered Triage, code:block7 (┌───────┐), Notification Triggers, Request Submission, Status Lifecycle, What It Does
...
Cohesion: 0.33
Nodes (6): 4.4 Financial Ledger, code:block3 (┌────────────────────────────────────────┐), Landlord View, Tenant View, What It Does, Why Itemized?

### Community 309 - "Community 309"
Cohesion: 0.33
Nodes (6): 4.2 Landlord Dashboard, Dashboard Metrics, Date Range Flexibility, Reporting & Exports, Viewing Modes, What It Does

### Community 310 - "Community 310"
Cohesion: 0.33
Nodes (6): 9. API Overview, API Routes Structure, code:block10 (/api/), code:json ({), code:json ({), Example: iRis Chat API
...
Cohesion: 0.33
Nodes (6): 4.7 Lease Management, code:block5 (┌─────────┐), Digital Lease Signing, Lease Documents, Lease Status State Machine, What It Does
...
Cohesion: 0.4
Nodes (5): 4.1 Unit Map - Visual Floor Planning, Color-Coded Status System, How It Feels to Use, Technical Highlights, What It Does
...
## Knowledge Gaps
- **2493 isolated node(s):** `supabase`, `supabase`, `supabase`, `supabase`, `eslintConfig` (+2488 more)
...
- **Why does `Serialisable` connect `Community 0` to `Community 1`, `Community 2`, `Community 4`, `Community 11`, `Community 140`, `Community 13`, `Community 14`, `Community 18`, `Community 21`, `Community 24`, `Community 285`, `Community 30`, `Community 33`, `Community 39`, `Community 41`, `Community 44`, `Community 46`, `Community 174`, `Community 185`, `Community 187`, `Community 62`, `Community 64`, `Community 66`, `Community 69`, `Community 70`, `Community 71`, `Community 73`, `Community 77`, `Community 86`, `Community 91`, `Community 92`, `Community 97`, `Community 99`, `Community 101`, `Community 105`, `Community 108`, `Community 254`?**
  _High betweenness centrality (0.145) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 11` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 134`, `Community 132`, `Community 9`, `Community 12`, `Community 16`, `Community 17`, `Community 147`, `Community 20`, `Community 149`, `Community 22`, `Community 26`, `Community 29`, `Community 158`, `Community 159`, `Community 36`, `Community 52`, `Community 54`, `Community 206`, `Community 207`, `Community 90`, `Community 223`?**
  _High betweenness centrality (0.118) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 7` to `Community 3`, `Community 133`, `Community 6`, `Community 134`, `Community 8`, `Community 9`, `Community 10`, `Community 138`, `Community 15`, `Community 16`, `Community 149`, `Community 22`, `Community 279`, `Community 280`, `Community 25`, `Community 278`, `Community 27`, `Community 159`, `Community 161`, `Community 38`, `Community 171`, `Community 45`, `Community 48`, `Community 49`, `Community 51`, `Community 179`, `Community 53`, `Community 54`, `Community 182`, `Community 61`, `Community 75`, `Community 84`, `Community 93`, `Community 104`, `Community 106`, `Community 111`, `Community 112`, `Community 120`, `Community 121`, `Community 250`?**
