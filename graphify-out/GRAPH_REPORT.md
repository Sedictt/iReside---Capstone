...
## Corpus Check
- 933 files · ~6,906,421 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7738 nodes · 19311 edges · 566 communities (378 shown, 188 thin omitted)
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 4456 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `905d4a3a`
...
## Communities (566 total, 188 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (129): _3DBase, PhoneticProperties, PhoneticText, RichText, Text, _3DBase, Base class for 3D charts, Surface (+121 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (105): Alias, HexBinary, Relation, MultiSequence, MultiSequencePart, NestedSequence, Allow a multisequence to be built up from parts      Excluded from the instance, Wrap a sequence in an containing object (+97 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (72): DrawingHF, CellRange, Extension, Size in hundredths of points.     In theory other units of measurement can be us, TextPoint, Strict, A sequence of primitive types that are stored as a single attribute.     "val" i, ValueSequence (+64 more)
...
Cohesion: 0.03
Nodes (82): AnalyticsPage(), DEFAULT_EXTENDED_KPIS, DEFAULT_FINANCIAL_CHART, DEFAULT_OPERATIONAL_SNAPSHOT, DEFAULT_PRIMARY_KPIS, ExportAuditItem, formatIsoDate(), getDateLabels() (+74 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (66): CommentRecord, Properties, ExtensionList, Percentage, Connection, ConnectorLocking, ConnectorNonVisual, ConnectorShape (+58 more)
...
Cohesion: 0.04
Nodes (63): ConsultationDashboard(), Document, ConsultationTool(), ConsultationToolProps, DigitalSigner, ConsultationTool, SignPage(), BusinessPermitCard() (+55 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (51): AdminLayout(), geistMono, geistSans, metadata, RootLayout(), CookieConsent(), ThemeProvider(), AuthContext (+43 more)

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (52): CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, Property, PropertyContext, PropertyContextValue, useProperty() (+44 more)

### Community 12 - "Community 12"
Cohesion: 0.05
Nodes (47): array, buildInvoiceLabel(), buildOverdueLabel(), DashboardData, formatCurrency(), formatCurrencyParts(), formatDueDate(), TenantDashboard() (+39 more)

### Community 13 - "Community 13"
Cohesion: 0.06
Nodes (41): assertAdmin(), MUTABLE_STATUSES, PATCH(), RegistrationRecord, generateTempPassword(), POST(), ensureBucket(), POST() (+33 more)

### Community 14 - "Community 14"
Cohesion: 0.07
Nodes (37): VALUES, WHO_IT_SERVES, AdminSidebar(), NAV_ITEMS, HOW_IT_WORKS, IRIS_WORKFLOWS, OUTCOMES, ScrollyTellingLandingPage() (+29 more)

### Community 15 - "Community 15"
Cohesion: 0.1
Nodes (52): POST(), addDays(), clampStepIndex(), completeTenantProductTour(), createTenantProductTourState(), ensureTenantProductTourState(), evaluateTenantProductTourEligibility(), getTenantProductTourRequiredStep() (+44 more)

### Community 16 - "Community 16"
Cohesion: 0.09
Nodes (49): completeSchema, ICON_MAP, LandlordQuestBoard(), LandlordQuestBoardProps, addDays(), clampStepIndex(), completeLandlordProductTour(), createLandlordProductTourState() (+41 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (22): dict, DefinedNameDict, Utility class for storing defined names.     Allows access by name and separatio, Add names without worrying about key and name matching., Break, ColBreak, RowBreak, Make sure a row contains always the same number of cells or values (+14 more)

### Community 18 - "Community 18"
Cohesion: 0.07
Nodes (39): ensureBucket(), POST(), sanitizeFileName(), ensureBucket(), POST(), sanitizeFileName(), GET(), POST() (+31 more)
...
Cohesion: 0.05
Nodes (39): column_letter(), coordinate(), cols(), DummyWorksheet, Return and remove the first cell, Normalise cell range references, Reference, rows() (+31 more)
...
Cohesion: 0.07
Nodes (38): parseIncome(), WalkInApplicationModal(), ActionItem, ActionItemCard(), ActionRequired(), ActionSummary, formatDateLabel(), getDaysUntil() (+30 more)
...
Cohesion: 0.05
Nodes (17): Cell, comment(), coordinate(), get_time_format(), get_type(), is_date(), Check string coding, length, and line break character, Tries to convert Error" else N/A (+9 more)
...
Cohesion: 0.06
Nodes (15): Simplified named tuple with an array, StyleArray, copy(), Return a copy of the proxied object., Add proxied object to another instance and return the combined object, Return a copy of the proxied object. Keyword args will be passed through, Proxy formatting objects so that they cannot be altered, StyleProxy (+7 more)
...
Cohesion: 0.07
Nodes (20): Return the full XML representation, etree_write_cell(), lxml_write_cell(), Set coordinate and datatype, _set_attributes(), DummyCode, Safely and consistently format numeric values, safe_string() (+12 more)
...
Cohesion: 0.09
Nodes (21): WriteOnlyCell(), Exception, coordinate_from_string(), Convert a coordinate string like 'B12' to a tuple ('B', 12), CellCoordinatesException, IllegalCharacterError, NamedRangeException, The data submitted which cannot be used directly in Excel files. It     must be (+13 more)
...
Cohesion: 0.13
Nodes (13): make_operand(), Consume all the text between square brackets [].          Returns the number of, Base class for all Tokenizer errors., Consume the text following a '#' as an error.          Looks for a match in self, A tokenizer for Excel worksheet formulae.      Converts a str string representin, Consumes a + or - character if part of a number in sci. notation.          Retur, Ensure that there's no token currently being parsed.          Or if there is a t, If there's a token being parsed, add it to the item list. (+5 more)
...
Cohesion: 0.26
Nodes (15): ApplicationPaymentRequestStatus, ApplicationPaymentRequirementType, asRecord(), buildPortalToken(), buildPortalUrl(), DEPOSIT_TEMPLATE_KEYS, normalizeChecklist(), parseAmountValue() (+7 more)

### Community 116 - "Community 116"
Cohesion: 0.22
Nodes (11): EVENT_LABELS, formatAuditTimestamp(), LeaseAuditEvent, LeaseAuditTrail(), LeaseAuditTrailProps, LeaseStatusBadge(), LeaseStatusBadgeProps, STATUS_STYLES (+3 more)
...
- **Why does `Serialisable` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 5`, `Community 134`, `Community 133`, `Community 17`, `Community 21`, `Community 22`, `Community 25`, `Community 154`, `Community 26`, `Community 31`, `Community 34`, `Community 163`, `Community 38`, `Community 41`, `Community 42`, `Community 43`, `Community 45`, `Community 48`, `Community 49`, `Community 52`, `Community 53`, `Community 56`, `Community 59`, `Community 65`, `Community 201`, `Community 79`, `Community 85`, `Community 89`, `Community 92`, `Community 95`, `Community 96`, `Community 106`, `Community 373`, `Community 124`?**
  _High betweenness centrality (0.157) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 4` to `Community 128`, `Community 129`, `Community 6`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 141`, `Community 14`, `Community 142`, `Community 16`, `Community 19`, `Community 20`, `Community 150`, `Community 23`, `Community 151`, `Community 152`, `Community 28`, `Community 54`, `Community 58`, `Community 186`, `Community 69`, `Community 73`, `Community 76`, `Community 78`, `Community 210`, `Community 84`, `Community 94`, `Community 99`, `Community 104`, `Community 111`, `Community 116`, `Community 117`, `Community 118`, `Community 123`, `Community 252`?**
  _High betweenness centrality (0.143) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 1` to `Community 128`, `Community 2`, `Community 130`, `Community 5`, `Community 6`, `Community 7`, `Community 13`, `Community 15`, `Community 16`, `Community 151`, `Community 23`, `Community 28`, `Community 29`, `Community 32`, `Community 33`, `Community 160`, `Community 44`, `Community 173`, `Community 174`, `Community 175`, `Community 50`, `Community 55`, `Community 58`, `Community 82`, `Community 115`, `Community 118`, `Community 127`?**
