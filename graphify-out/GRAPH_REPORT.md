...
## Corpus Check
- 930 files · ~6,906,664 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7712 nodes · 19185 edges · 567 communities (377 shown, 190 thin omitted)
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 4454 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6f9ff088`
...
## Communities (567 total, 190 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (133): PageMargins, Identical to openpyxl.worksheet.page.Pagemargins but element names are different, Chartsheet, CustomChartsheetView, CustomChartsheetViews, ChartsheetProperties, ChartsheetProtection, WebPublishItem (+125 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (144): _3DBase, Bool, InlineFont, PhoneticProperties, PhoneticText, Font for inline text because, yes what you need are different objects with the s, RichText, Text (+136 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (94): Alias, HexBinary, Relation, MultiSequence, MultiSequencePart, NestedSequence, Allow a multisequence to be built up from parts      Excluded from the instance, Wrap a sequence in an containing object (+86 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (73): ExtensionList, Connection, ConnectorLocking, ConnectorNonVisual, ConnectorShape, NonVisualConnectorProperties, Shape, ShapeMeta (+65 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (79): title_maker(), ColorChoice, Convertible, Percentage, EmptyTag, NestedText, NestedValue, Boolean if a tag exists or not. (+71 more)
...
Cohesion: 0.04
Nodes (72): VALUES, WHO_IT_SERVES, AdminSidebar(), NAV_ITEMS, AdminLayout(), HOW_IT_WORKS, IRIS_WORKFLOWS, OUTCOMES (+64 more)
...
Cohesion: 0.05
Nodes (48): ensureBucket(), POST(), sanitizeFileName(), ensureBucket(), POST(), sanitizeFileName(), finalizeLease(), FinalizeLeaseParams (+40 more)

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (62): useAppToast(), DigitalSigner, LandlordLeaseSigningPage(), LandlordSigningContent(), LeaseDetails, LeaseSigningContent(), TenantLeaseSigningPage(), GET() (+54 more)
...
Cohesion: 0.05
Nodes (56): CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, Property, PropertyContext, PropertyContextValue, useProperty() (+48 more)
...
Cohesion: 0.04
Nodes (21): SheetFormatProperties, ArrayFormula, DataTableFormula, HyperlinkList, PrintOptions, Worksheet print options, Break, ColBreak (+13 more)
...
Cohesion: 0.06
Nodes (45): buildInvoiceLabel(), buildOverdueLabel(), DashboardData, formatCurrency(), formatCurrencyParts(), formatDueDate(), TenantDashboard(), Document (+37 more)
...
Cohesion: 0.06
Nodes (30): Float, ConditionalFormatting, ConditionalFormattingList, Add a rule for a cell range, Check whether a certain cell is affected by the formatting, Conditional formatting rules., Add a rule such as ColorScaleRule, FormulaRule or CellIsRule           The prior, Get the rules for a cell range (+22 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (23): MultiCellRange, CellRange, MultiCellRange, Check whether comparisons between ranges are possible.         Cannot compare ra, Shift the focus of the range according to the shift values (*col_shift*, *row_sh, Test whether the ranges are not equal.          :type other: openpyxl.worksheet., Represents a range in a sheet: title and coordinates.      This object is used t, Test whether the ranges are equal.          :type other: openpyxl.worksheet.cell (+15 more)
...
Cohesion: 0.11
Nodes (34): generateOTP(), GET(), POST(), ActionBody, ALLOWED_STATUSES, createLeaseRecord(), createPaymentRecords(), generateTempPassword() (+26 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (17): DocumentProperties, High-level properties of the document.     Defined in ECMA-376 Par2 Annex D, active(), get_index(), Create a worksheet (at an optional index).          :param title: optional title, Add an worksheet (at an optional index)., Move a sheet or sheetname, Remove `worksheet` from this workbook. (+9 more)
...
Cohesion: 0.07
Nodes (19): Border, Border positioning for use in styles., CellStyleList, ColorList, NamedStyleList, Named styles are editable and can be applied to multiple objects      As only th, Allow a list of named styles to be passed in and index them., Some applications contain duplicate definitions either by name or         refere (+11 more)

### Community 44 - "Community 44"
Cohesion: 0.07
Nodes (19): etree_write_cell(), lxml_write_cell(), Set coordinate and datatype, _set_attributes(), Safely and consistently format numeric values, safe_string(), _explicit_none(), Override serialisation because explicit none required (+11 more)

### Community 45 - "Community 45"
Cohesion: 0.07
Nodes (18): BoundDictionary, defaultdict, StyleableObject, BoundDictionary, A default dictionary where elements are tightly coupled.      The factory method, Break names down into sheet locals and globals, ColumnDimension, Dimension (+10 more)
...
Cohesion: 0.08
Nodes (25): Cell, Check string coding, length, and line break character, Tries to convert Error" else N/A, Returns a cell location relative to this cell.          :param row: number of ro, Describes cell associated properties.      Properties of interest include style,, WriteOnlyCell(), Exception, CellCoordinatesException (+17 more)
...
Cohesion: 0.14
Nodes (18): assertAdmin(), DELETE(), MUTABLE_STATUSES, PATCH(), RegistrationRecord, UpdateListingBody, ApplicantProfile, assertAdmin() (+10 more)
...
Cohesion: 0.11
Nodes (20): cols_from_range(), column_index_from_string(), coordinate_from_string(), coordinate_to_tuple(), get_column_interval(), range_boundaries(), range_to_tuple(), Convert ASCII column name (base 26) to decimal with 1-based index      Character (+12 more)
...
Cohesion: 0.14
Nodes (14): product(), build_workbook(), format_case_id(), resolve_output_path(), Border options for use in styles.     Caution: if you do not specify a border_st, Side, bottom(), cells() (+6 more)
...
Cohesion: 0.12
Nodes (12): code:typescript (it('fetches comments with nested replies (max depth 2)', asy), code:bash (git add src/lib/community/actions.ts), code:typescript (it('allows landlord to approve resident discussion post', as), code:bash (git add src/lib/community/actions.ts), code:typescript (it('fetches posts for landlord properties with filters', asy), code:bash (git add src/lib/community/actions.ts), code:bash (git add src/lib/community/actions.ts), Phase 2: Server Actions & Data Layer (+4 more)
...
## Knowledge Gaps
- **1936 isolated node(s):** `supabase`, `supabase`, `supabase`, `supabase`, `fs` (+1931 more)
...
- **Why does `Serialisable` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 142`, `Community 15`, `Community 19`, `Community 20`, `Community 24`, `Community 281`, `Community 26`, `Community 155`, `Community 29`, `Community 32`, `Community 43`, `Community 44`, `Community 45`, `Community 46`, `Community 50`, `Community 182`, `Community 183`, `Community 56`, `Community 55`, `Community 315`, `Community 61`, `Community 68`, `Community 197`, `Community 74`, `Community 79`, `Community 80`, `Community 211`, `Community 87`, `Community 88`, `Community 92`, `Community 97`, `Community 113`?**
  _High betweenness centrality (0.157) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 2` to `Community 0`, `Community 5`, `Community 6`, `Community 7`, `Community 10`, `Community 140`, `Community 16`, `Community 22`, `Community 23`, `Community 153`, `Community 27`, `Community 36`, `Community 166`, `Community 39`, `Community 169`, `Community 170`, `Community 51`, `Community 63`, `Community 71`, `Community 83`, `Community 100`, `Community 109`, `Community 118`, `Community 119`, `Community 120`?**
  _High betweenness centrality (0.126) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 9` to `Community 130`, `Community 131`, `Community 5`, `Community 6`, `Community 8`, `Community 11`, `Community 12`, `Community 13`, `Community 140`, `Community 14`, `Community 139`, `Community 17`, `Community 18`, `Community 34`, `Community 41`, `Community 42`, `Community 49`, `Community 51`, `Community 180`, `Community 58`, `Community 60`, `Community 63`, `Community 73`, `Community 204`, `Community 205`, `Community 78`, `Community 207`, `Community 83`, `Community 91`, `Community 101`, `Community 110`, `Community 119`, `Community 121`?**
