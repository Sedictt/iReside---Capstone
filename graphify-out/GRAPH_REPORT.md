...
## Corpus Check
- 936 files · ~6,968,957 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8101 nodes · 19881 edges · 597 communities (401 shown, 196 thin omitted)
- Extraction: 78% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 4458 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `868c08f6`
...
## Communities (597 total, 196 thin omitted)
...
Cohesion: 0.03
Nodes (57): Chartsheet, ChartsheetProperties, ChartsheetProtection, WebPublishItem, WebPublishItems, DrawingHF, SheetBackgroundPicture, ChartsheetView (+49 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (46): PUT(), RouteParams, GET(), getDashboardPathForRole(), PUT(), PUT(), RouteParams, GET() (+38 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (59): title_maker(), ExtensionList, HexBinary, EmptyTag, Boolean if a tag exists or not., ColorChoiceDescriptor, Objects can choose from 7 different kinds of color system.     Assume RGBHex if, Connection (+51 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (53): Shape, anchor(), Drawing, a drawing object - eg container for shapes or charts         we assume user spec, AdjPoint2D, AdjustHandleList, Backdrop, Bevel (+45 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (70): SignaturePad(), SignaturePadProps, ApplyPage(), AdminChatModerationPage(), BannedTerm, ModerationReportCard(), ReportRow, ReportStatus (+62 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (43): CellRange, A sequence of primitive types that are stored as a single attribute.     "val" i, ValueSequence, ExternalBook, ExternalCell, ExternalDefinedName, ExternalLink, ExternalRow (+35 more)
...
Cohesion: 0.06
Nodes (45): generateOTP(), GET(), POST(), assertAdmin(), MUTABLE_STATUSES, PATCH(), RegistrationRecord, RouteContext (+37 more)

### Community 10 - "Community 10"
Cohesion: 0.07
Nodes (56): InlineFont, PhoneticProperties, PhoneticText, Font for inline text because, yes what you need are different objects with the s, RichText, Text, DisplayUnitsLabel, DisplayUnitsLabelList (+48 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (40): ElementList, Represents many kinds of relationships., `type` can be used as a shorthand with the default relationships namespace, Return a dictionary of relations keyed by id, Relationship, RelationshipList, Index, AutoSortScope (+32 more)

### Community 12 - "Community 12"
Cohesion: 0.1
Nodes (48): ColorChoice, Convertible, Percentage, NestedValue, Nested tag storing the value on the 'val' attribute, ColorChoice, ColorMapping, HSLColor (+40 more)
...
Cohesion: 0.05
Nodes (40): PageMargins, Identical to openpyxl.worksheet.page.Pagemargins but element names are different, CustomChartsheetView, CustomChartsheetViews, Base64Binary, Guid, Size in hundredths of points.     In theory other units of measurement can be us, Relation (+32 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (26): ReadOnlyCell, dict, DefinedNameDict, Utility class for storing defined names.     Allows access by name and separatio, Add names without worrying about key and name matching., ArrayFormula, DataTableFormula, Hyperlink (+18 more)
...
Cohesion: 0.07
Nodes (39): VALUES, WHO_IT_SERVES, NAV_ITEMS, HOW_IT_WORKS, IRIS_WORKFLOWS, OUTCOMES, ScrollyTellingLandingPage(), SHOWCASE_MODULES (+31 more)
...
Cohesion: 0.08
Nodes (38): AdminSidebar(), AdminLayout(), ThemeProvider(), AuthContext, AuthContextValue, AuthProvider(), AuthState, isAuthoritativeAuthError() (+30 more)
...
Cohesion: 0.06
Nodes (45): ADVANCE_TEMPLATE_KEYS, buildPaymentPreview(), DEPOSIT_TEMPLATE_KEYS, InviteApplicationType, InviteListItem, InviteMode, InviteRequirementKey, parseAmount() (+37 more)
...
Cohesion: 0.12
Nodes (31): AreaChart, AreaChart3D, _AreaChartBase, _BaseAxis, ChartLines, DateAxis, NumericAxis, SeriesAxis (+23 more)
...
Cohesion: 0.06
Nodes (30): MAINTENANCE_CATEGORIES, MaintenanceCategoryId, DashboardBackground(), DashboardBackgroundProps, BannerNotification, DashboardBanner(), DashboardBannerProps, formatTimeAgo() (+22 more)
...
Cohesion: 0.05
Nodes (27): read_chart(), defaultdict, _convert(), Max, Min, Check value is of or can be converted to expected type., Values must be less than a `max` value, Values must be greater than a `min` value (+19 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (37): column_letter(), coordinate(), Return and remove the first cell, product(), cols_from_range(), column_index_from_string(), coordinate_from_string(), get_column_interval() (+29 more)

### Community 32 - "Community 32"
Cohesion: 0.09
Nodes (38): ApplicationsPage(), Applicant, ApplicationsSkeletonList(), ApplicationStatus, calculateApplicationProgress(), formatCurrency(), formatDate(), formatDocumentLabel() (+30 more)
...
Cohesion: 0.08
Nodes (28): _3DBase, ChartBase, Normalise and rebase series: sort by order and then rebase order, Set the categories / x-axis values, Add a range of data in a single pass.         The default is to treat each colum, Append a data series to the chart, Base class for all charts, Combine the chart with another one (+20 more)
...
Cohesion: 0.09
Nodes (20): Scaling, AxId, PlotArea(), ChartContainer, ChartSpace, ExternalData, Protection, DataLabel (+12 more)
...
Cohesion: 0.12
Nodes (34): ApplicationPaymentRequestStatus, ApplicationPaymentRequirementType, applyPaymentPendingExpiry(), areRequiredPaymentRequestsCompleted(), asRecord(), buildPortalToken(), buildPortalUrl(), hashPortalToken() (+26 more)
...
Cohesion: 0.07
Nodes (24): Sequence, Border, Border positioning for use in styles., _assign_position(), Fill, GradientFill, PatternFill, Automatically assign positions if a list of colours is provided.      It is not (+16 more)

### Community 53 - "Community 53"
Cohesion: 0.16
Nodes (24): ChatHeader(), ChatHeaderProps, ContactItem(), ContactItemProps, ContactList(), ContactListProps, MessageComposer(), MessageComposerProps (+16 more)
...
Cohesion: 0.12
Nodes (28): ChatUser, ContactCard(), ContactCardProps, DEFAULT_CHAT_STATE, EMPTY_ARRAY, EMPTY_OBJECT, formatConversationTimestamp(), formatMiniTimestamp() (+20 more)
...
Cohesion: 0.11
Nodes (24): array, Document, DocumentsPage(), LandlordProfile, VerificationInfo, LeaseDocument(), DEFAULT_OCCUPANCY, ENUM_TO_PROPERTY_TYPE (+16 more)
...
Cohesion: 0.1
Nodes (18): geistMono, geistSans, metadata, RootLayout(), CookieConsent(), DocsPage(), FramerMotionProvider(), DocDetailPage() (+10 more)
...
Cohesion: 0.18
Nodes (26): InvoiceModal(), buildListFetchErrorMessage(), buildPaymentHistoryErrorMessage(), ConversationMessage, ConversationSummary, createOrGetDirectConversation(), fetchConversationMessages(), fetchConversationPaymentHistory() (+18 more)
...
Cohesion: 0.08
Nodes (10): ASCII, DateTime, Default, Length, MatchPattern, When called returns an instance of the expected type.     Additional default val, Values must match a regex pattern, Values must of a particular type (+2 more)
...
Cohesion: 0.13
Nodes (3): apply_stylesheet(), from_tree(), Add styles to workbook if present
...
Cohesion: 0.26
Nodes (15): extractIpAddress(), extractUserAgent(), sendLeaseActivatedNotification(), sendTenantSignedNotification(), getAllowedTransitions(), getTransitionErrorMessage(), isValidLeaseStatusTransition(), VALID_TRANSITIONS (+7 more)
...
Cohesion: 0.12
Nodes (12): code:typescript (it('returns ordered photos for album', async () => {), code:bash (git add src/lib/community/actions.ts), code:typescript (it('fetches posts for landlord properties with filters', asy), code:bash (git add src/lib/community/actions.ts), code:bash (git add src/lib/community/actions.ts), code:typescript (it('allows tenant to report a post', async () => {), code:bash (git add src/lib/community/actions.ts), Phase 2: Server Actions & Data Layer (+4 more)
...
Cohesion: 0.29
Nodes (5): NumFmt, NumberFormatDescriptor, Allow direct assignment of format code, TrendlineLabel, Typed
...
- **Why does `Serialisable` connect `Community 1` to `Community 3`, `Community 4`, `Community 261`, `Community 6`, `Community 133`, `Community 8`, `Community 132`, `Community 10`, `Community 11`, `Community 12`, `Community 14`, `Community 142`, `Community 15`, `Community 274`, `Community 21`, `Community 24`, `Community 27`, `Community 30`, `Community 33`, `Community 36`, `Community 38`, `Community 40`, `Community 45`, `Community 47`, `Community 52`, `Community 190`, `Community 62`, `Community 191`, `Community 74`, `Community 334`, `Community 87`, `Community 97`, `Community 230`, `Community 231`, `Community 103`, `Community 232`, `Community 107`, `Community 108`, `Community 109`, `Community 112`, `Community 120`?**
  _High betweenness centrality (0.152) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 5` to `Community 0`, `Community 130`, `Community 7`, `Community 13`, `Community 16`, `Community 17`, `Community 19`, `Community 22`, `Community 26`, `Community 28`, `Community 29`, `Community 158`, `Community 32`, `Community 165`, `Community 37`, `Community 166`, `Community 167`, `Community 168`, `Community 299`, `Community 172`, `Community 53`, `Community 55`, `Community 56`, `Community 58`, `Community 59`, `Community 61`, `Community 66`, `Community 69`, `Community 71`, `Community 330`, `Community 206`, `Community 79`, `Community 78`, `Community 91`, `Community 228`, `Community 102`, `Community 115`, `Community 118`, `Community 119`, `Community 255`?**
  _High betweenness centrality (0.136) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 8` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 9`, `Community 22`, `Community 23`, `Community 155`, `Community 32`, `Community 35`, `Community 43`, `Community 46`, `Community 174`, `Community 50`, `Community 54`, `Community 55`, `Community 56`, `Community 60`, `Community 61`, `Community 201`, `Community 203`, `Community 204`, `Community 77`, `Community 95`, `Community 102`?**
