...
## Corpus Check
- 962 files · ~7,123,778 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8505 nodes · 20301 edges · 626 communities (423 shown, 203 thin omitted)
- Extraction: 78% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 4458 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c525f631`
...
Cohesion: 0.03
Nodes (144): _3DBase, InlineFont, PhoneticProperties, PhoneticText, Font for inline text because, yes what you need are different objects with the s, RichText, Text, _3DBase (+136 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (90): CommentRecord, Properties, ExtensionList, Percentage, Connection, ConnectorLocking, ConnectorNonVisual, ConnectorShape (+82 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (79): CommentSheet, Alias, Aliases can be used when either the desired attribute name is not allowed     or, Base64Binary, CellRange, Extension, Size in hundredths of points.     In theory other units of measurement can be us, TextPoint (+71 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (74): Alias, MultiSequence, MultiSequencePart, NestedSequence, Allow a multisequence to be built up from parts      Excluded from the instance, Wrap a sequence in an containing object, Sequences can contain objects with different tags, ElementList (+66 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (81): Bool, title_maker(), ColorChoice, Convertible, HexBinary, Relation, EmptyTag, NestedValue (+73 more)
...
Cohesion: 0.05
Nodes (98): ChatUser, ContactCard(), ContactCardProps, ContactsSidebar(), DEFAULT_CHAT_STATE, EMPTY_ARRAY, EMPTY_OBJECT, formatConversationTimestamp() (+90 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (82): Loading(), array, ConsultationDashboard(), Document, ConsultationTool(), ConsultationToolProps, DigitalSigner, GlobalLoadingContext (+74 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (83): mockApplications, MyApplicationsPage(), properties, recentActivity, AdminChatModerationPage(), BannedTerm, ModerationReportCard(), ReportRow (+75 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (68): AdminSidebar(), NAV_ITEMS, AdminLayout(), geistMono, geistSans, metadata, RootLayout(), ThemeProvider() (+60 more)
...
Cohesion: 0.06
Nodes (75): addComment(), approveResidentPost(), canCreatePostType(), CommunityRole, createAnnouncementPost(), createDiscussionPost(), createPhotoAlbumPost(), createPollPost() (+67 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (60): ApplicationsPage(), Applicant, ApplicationsSkeletonList(), ApplicationStatus, calculateApplicationProgress(), formatCurrency(), formatDate(), formatDocumentLabel() (+52 more)

### Community 14 - "Community 14"
Cohesion: 0.06
Nodes (54): CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, useAuth(), Property, PropertyContext, PropertyContextValue (+46 more)
...
Cohesion: 0.04
Nodes (53): column_letter(), coordinate(), cols(), DummyWorksheet, Return and remove the first cell, Normalise cell range references, Reference, rows() (+45 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (33): Guid, Represents many kinds of relationships., `type` can be used as a shorthand with the default relationships namespace, Relationship, ChildSheet, FileRecoveryProperties, PivotCache, Represents a reference to a worksheet or chartsheet in workbook.xml      It cont (+25 more)

### Community 18 - "Community 18"
Cohesion: 0.07
Nodes (38): VALUES, WHO_IT_SERVES, HOW_IT_WORKS, IRIS_WORKFLOWS, OUTCOMES, ScrollyTellingLandingPage(), SHOWCASE_MODULES, ApplyPage() (+30 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (16): Border, Border positioning for use in styles., HyperlinkList, MergeCell, MergeCells, Related, TablePartList, create_temporary_file() (+8 more)
...
Cohesion: 0.08
Nodes (40): GET(), getBillingWorkspace(), recordUtilityReading(), BILLING_BUCKETS, DEFAULT_LIMITS, ensureBucket(), removeBillingFile(), uploadBillingFile() (+32 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (45): BillingWorkspace, NextPayment, OverduePayment, PaymentSummaryProps, LeaseInfo, TenantDashboardHeaderProps, Action, BillingOperationsPanel() (+37 more)
...
Cohesion: 0.05
Nodes (33): Cell, comment(), coordinate(), get_time_format(), get_type(), is_date(), Check string coding, length, and line break character, Tries to convert Error" else N/A (+25 more)
...
Cohesion: 0.07
Nodes (48): DELETE(), UpdateListingBody, getLandlordProperties(), getPropertyById(), Amenity, AmenityBooking, Application, ApplicationSource (+40 more)
...
Cohesion: 0.05
Nodes (20): dict, DefinedNameDict, Utility class for storing defined names.     Allows access by name and separatio, Add names without worrying about key and name matching., ArrayFormula, DataTableFormula, Make sure a row contains always the same number of cells or values, Cells are returned by a generator which can be empty (+12 more)
...
Cohesion: 0.06
Nodes (24): read_chart(), defaultdict, Max, Min, Values must be less than a `max` value, Values must be greater than a `min` value, Break names down into sheet locals and globals, Return a new range with cells common to this range and *other*          :type ot (+16 more)
...
Cohesion: 0.07
Nodes (29): ComplaintModalProps, ComplaintModalProps, TransferRequestModal(), TransferRequestModalProps, UnitHistoryModalProps, UnitHistoryModalProps, VisualCanvasProps, useVisualBuilderState() (+21 more)
...
Cohesion: 0.06
Nodes (11): PrintOptions, PrintPageSetup, Worksheet print options, Worksheet print page setup, Break, ColBreak, RowBreak, Outline (+3 more)

### Community 47 - "Community 47"
Cohesion: 0.07
Nodes (15): Chartsheet, CustomChartsheetView, CustomChartsheetViews, ChartsheetProperties, ChartsheetProtection, WebPublishItem, WebPublishItems, DrawingHF (+7 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (19): MultiCellRange, absolute_coordinate(), quote_sheetname(), Add quotes around sheetnames if they contain spaces., Convert a coordinate to an absolute coordinate string (B12 -> $B$12), DefinedName, create_named_range(), ColRange (+11 more)
...
Cohesion: 0.09
Nodes (18): Return the full XML representation, etree_write_cell(), lxml_write_cell(), Set coordinate and datatype, _set_attributes(), Safely and consistently format numeric values, safe_string(), _explicit_none() (+10 more)
...
Cohesion: 0.1
Nodes (8): Sequence, _assign_position(), Automatically assign positions if a list of colours is provided.      It is not, Stop, StopList, apply_stylesheet(), from_tree(), Add styles to workbook if present
...
Cohesion: 0.13
Nodes (26): InvoiceListItem, InvoiceReadingDetail, formatDateLong(), formatPhpCurrency(), buildFaceToFacePreviewInvoice(), buildSelectivePreviewInvoice(), CheckoutPage(), Field() (+18 more)

### Community 71 - "Community 71"
Cohesion: 0.11
Nodes (14): Generate string representation of XML element.      All subelements are included, tostring(), ExtendedProperties, See 22.2      Most of this is irrelevant but Excel is very picky about the versi, InvalidFileException, Error for trying to open a non-ooxml file., Write the workbook relationships xml., ExcelWriter (+6 more)
...
Cohesion: 0.14
Nodes (9): CellRichText, _check_element(), _check_rich_text(), from_tree(), Returns a list of the strings contained.         The main reason for this is to, Represents text string in a specific format      This class is used as part of c, Represents a rich text string.      Initialize with a list made of pure strings, TextBlock (+1 more)
...
Cohesion: 0.16
Nodes (15): assertAdmin(), MUTABLE_STATUSES, PATCH(), RegistrationRecord, ApplicantProfile, assertAdmin(), GET(), RegistrationRow (+7 more)
...
Cohesion: 0.11
Nodes (9): Alignment, Alignment options for use in styles., ArrayDescriptor, NamedStyleList, Named styles are editable and can be applied to multiple objects      As only th, Allow a list of named styles to be passed in and index them., Some applications contain duplicate definitions either by name or         refere, Protection (+1 more)
...
Cohesion: 0.22
Nodes (11): evaluateTenantProductTourEligibility(), getTenantProductTourRequiredStep(), isNextProductTourStepSubmission(), TenantProductTourState, POST(), baseState(), result, state (+3 more)
...
Cohesion: 0.12
Nodes (13): code:typescript (it('allows tenant to vote on poll (upsert)', async () => {), code:bash (npx vitest --run), code:bash (git add src/lib/community/actions.ts), code:typescript (it('adds top-level comment', async () => {), code:bash (git add src/lib/community/actions.ts), code:bash (git add src/lib/community/actions.ts), code:typescript (it('allows tenant to report a post', async () => {), code:bash (git add src/lib/community/actions.ts) (+5 more)
...
## Knowledge Gaps
- **2392 isolated node(s):** `supabase`, `supabase`, `supabase`, `supabase`, `eslintConfig` (+2387 more)
...
- **Why does `Serialisable` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 136`, `Community 268`, `Community 16`, `Community 17`, `Community 19`, `Community 29`, `Community 31`, `Community 39`, `Community 43`, `Community 45`, `Community 46`, `Community 47`, `Community 48`, `Community 176`, `Community 178`, `Community 54`, `Community 61`, `Community 65`, `Community 195`, `Community 67`, `Community 71`, `Community 72`, `Community 73`, `Community 74`, `Community 81`, `Community 85`, `Community 95`, `Community 96`, `Community 99`, `Community 104`, `Community 109`, `Community 110`?**
  _High betweenness centrality (0.140) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 8` to `Community 260`, `Community 6`, `Community 7`, `Community 135`, `Community 9`, `Community 12`, `Community 13`, `Community 14`, `Community 18`, `Community 20`, `Community 22`, `Community 25`, `Community 26`, `Community 160`, `Community 168`, `Community 44`, `Community 49`, `Community 51`, `Community 52`, `Community 53`, `Community 63`, `Community 64`, `Community 70`, `Community 76`, `Community 80`, `Community 89`, `Community 92`, `Community 103`, `Community 231`, `Community 108`, `Community 121`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 3` to `Community 128`, `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 11`, `Community 13`, `Community 15`, `Community 20`, `Community 21`, `Community 150`, `Community 152`, `Community 28`, `Community 30`, `Community 32`, `Community 36`, `Community 44`, `Community 52`, `Community 59`, `Community 188`, `Community 191`, `Community 64`, `Community 193`, `Community 70`, `Community 76`, `Community 207`, `Community 98`?**
