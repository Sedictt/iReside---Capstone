...
## Corpus Check
- 921 files · ~6,956,727 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7599 nodes · 19009 edges · 559 communities (375 shown, 184 thin omitted)
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 4449 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `94ee2db5`
...
## Communities (559 total, 184 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (81): PUT(), RouteParams, ensureBucket(), POST(), sanitizeFileName(), GET(), getDashboardPathForRole(), PUT() (+73 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (84): title_maker(), ColorChoice, Convertible, HexBinary, EmptyTag, NestedInteger, NestedText, NestedValue (+76 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (111): completeSchema, POST(), ICON_MAP, LandlordQuestBoard(), LandlordQuestBoardProps, addDays(), clampStepIndex(), completeLandlordProductTour() (+103 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (71): Set the categories / x-axis values, ExternalData, Protection, AxDataSource, Level, MultiLevelStrData, MultiLevelStrRef, NumberValueDescriptor (+63 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (92): ChatUser, ContactCard(), ContactCardProps, DEFAULT_CHAT_STATE, formatConversationTimestamp(), formatMiniTimestamp(), MiniChatMessage, MiniChatState (+84 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (60): ManualLayout, ExtensionList, Percentage, Connection, ConnectorLocking, ConnectorNonVisual, ConnectorShape, NonVisualConnectorProperties (+52 more)
...
Cohesion: 0.03
Nodes (46): CellRange, A sequence of primitive types that are stored as a single attribute.     "val" i, ValueSequence, ExternalBook, ExternalCell, ExternalDefinedName, ExternalLink, ExternalRow (+38 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (58): PhoneticProperties, PhoneticText, RichText, Text, CellIsRule(), ColorScale, ColorScaleRule(), DataBar (+50 more)
...
Cohesion: 0.06
Nodes (49): AdminSidebar(), NAV_ITEMS, AdminLayout(), geistMono, geistSans, metadata, RootLayout(), ThemeProvider() (+41 more)
...
Cohesion: 0.05
Nodes (70): DocsPage(), UnitMapFeatureSection(), FeaturesPage(), metadata, DocDetailPage(), DOCS_CONTENT, Button(), buttonVariants (+62 more)

### Community 14 - "Community 14"
Cohesion: 0.06
Nodes (48): VALUES, WHO_IT_SERVES, HOW_IT_WORKS, IRIS_WORKFLOWS, OUTCOMES, ScrollyTellingLandingPage(), SHOWCASE_MODULES, ThemeToggle() (+40 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (69): GET(), openai, POST(), DELETE(), UpdateListingBody, formatContextForAI(), getTenantContext(), getActiveLease() (+61 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (21): ArrayFormula, DataTableFormula, HyperlinkList, PrintOptions, Worksheet print options, Break, ColBreak, RowBreak (+13 more)
...
Cohesion: 0.06
Nodes (50): array, ConsultationDashboard(), Document, ConsultationTool(), ConsultationToolProps, DigitalSigner, ConsultationTool, SignPage() (+42 more)
...
Cohesion: 0.08
Nodes (36): Shape, anchor(), PresetGeometry2D, GraphicData, GraphicFrame, GraphicFrameLocking, GraphicObject, GroupShape (+28 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (38): ErrorBars, DataPoint, Marker, PictureOptions, ASCII, Bool, _convert(), Convertible (+30 more)
...
Cohesion: 0.08
Nodes (29): _3DBase, _BaseAxis, DateAxis, DisplayUnitsLabel, DisplayUnitsLabelList, NumericAxis, Scaling, SeriesAxis (+21 more)
...
Cohesion: 0.07
Nodes (34): Loading(), GlobalLoadingContext, GlobalLoadingContextType, GlobalLoadingProvider(), BusinessPermitCard(), BusinessPermitCardProps, GlassCard(), LandlordSettings() (+26 more)

### Community 27 - "Community 27"
Cohesion: 0.08
Nodes (33): CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, useProperty(), LeaseAuditTrail(), LeaseStatusBadge(), LeaseStatusBadgeProps (+25 more)

### Community 28 - "Community 28"
Cohesion: 0.14
Nodes (38): AreaChart, AreaChart3D, _AreaChartBase, ChartLines, BarChart, BarChart3D, _BarChartBase, BubbleChart (+30 more)
...
Cohesion: 0.05
Nodes (31): Cell, get_time_format(), get_type(), is_date(), Check string coding, length, and line break character, Tries to convert Error" else N/A, Given a value, infer the correct data type, Returns a cell location relative to this cell.          :param row: number of ro (+23 more)

### Community 31 - "Community 31"
Cohesion: 0.1
Nodes (36): generateOTP(), GET(), POST(), ActionBody, ALLOWED_STATUSES, createLeaseRecord(), createPaymentRecords(), generateTempPassword() (+28 more)
...
Cohesion: 0.06
Nodes (38): column_letter(), coordinate(), coordinate(), Return and remove the first cell, product(), build_workbook(), format_case_id(), resolve_output_path() (+30 more)
...
Cohesion: 0.06
Nodes (20): PageMargins, PrintSettings, Identical to openpyxl.worksheet.page.Pagemargins but element names are different, Chartsheet, CustomChartsheetView, CustomChartsheetViews, ChartsheetProperties, ChartsheetProtection (+12 more)
...
Cohesion: 0.1
Nodes (28): WalkInApplicationModal(), ActionItem, ActionRequired(), ActionSummary, formatDateLabel(), getDaysUntil(), MaintenanceRequestItem, statusLabel (+20 more)

### Community 50 - "Community 50"
Cohesion: 0.08
Nodes (17): Return the full XML representation, etree_write_cell(), lxml_write_cell(), Set coordinate and datatype, _set_attributes(), Safely and consistently format numeric values, safe_string(), _explicit_none() (+9 more)
...
Cohesion: 0.1
Nodes (18): This module contains code to translate formulae across cells in a worksheet.  Th, Convert the formula into A1 notation, or as row and column coordinates, Raised when a formula can't be translated across cells.      This error arises w, Modifies a formula so that it can be translated from one cell to another.      `, Returns a list with the tokens comprising the formula., strip_ws_name(), translate_col(), translate_range() (+10 more)
...
Cohesion: 0.17
Nodes (18): SigningMode, SigningModeSelector(), SigningModeSelectorProps, ACTIVE_REQUIREMENT_KEYS, BackgroundGlow(), CardFrame(), CardFrameProps, ConfirmationModal() (+10 more)
...
Cohesion: 0.15
Nodes (7): NamedStyle, Return a style array representing the current style, Return equivalent XfStyle, Return relevant named style, Named and editable styles, Bind a named style to a workbook, Expand a named style reference element to a         named style object by bindin
...
Cohesion: 0.19
Nodes (5): AxId, PlotArea(), ChartContainer, ChartSpace, Legend
...
Cohesion: 0.27
Nodes (6): DELETE(), PATCH(), PUT(), formatCompactCurrency(), getStatus(), PortfolioStatus
...
## Knowledge Gaps
- **1888 isolated node(s):** `supabase`, `supabase`, `supabase`, `supabase`, `fs` (+1883 more)
...
- **Why does `Serialisable` connect `Community 3` to `Community 1`, `Community 130`, `Community 5`, `Community 7`, `Community 8`, `Community 10`, `Community 16`, `Community 146`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 154`, `Community 28`, `Community 32`, `Community 35`, `Community 36`, `Community 172`, `Community 44`, `Community 47`, `Community 50`, `Community 51`, `Community 57`, `Community 62`, `Community 69`, `Community 198`, `Community 73`, `Community 74`, `Community 75`, `Community 80`, `Community 81`, `Community 210`, `Community 85`, `Community 87`, `Community 94`, `Community 98`, `Community 101`, `Community 236`, `Community 108`, `Community 112`, `Community 118`, `Community 119`, `Community 122`?**
  _High betweenness centrality (0.148) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 10` to `Community 0`, `Community 1`, `Community 128`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 2`, `Community 15`, `Community 144`, `Community 20`, `Community 34`, `Community 166`, `Community 169`, `Community 170`, `Community 41`, `Community 43`, `Community 46`, `Community 49`, `Community 56`, `Community 61`, `Community 65`, `Community 127`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 9` to `Community 128`, `Community 2`, `Community 4`, `Community 6`, `Community 136`, `Community 137`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 144`, `Community 145`, `Community 18`, `Community 19`, `Community 20`, `Community 26`, `Community 27`, `Community 168`, `Community 48`, `Community 49`, `Community 61`, `Community 63`, `Community 195`, `Community 72`, `Community 205`, `Community 206`, `Community 79`, `Community 89`, `Community 90`, `Community 91`, `Community 92`, `Community 93`, `Community 106`, `Community 117`, `Community 121`?**
