...
## Corpus Check
- 933 files · ~6,906,306 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7738 nodes · 19311 edges · 569 communities (381 shown, 188 thin omitted)
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 4456 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f6496c3f`
...
## Communities (569 total, 188 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (104): Alias, HexBinary, Relation, MultiSequence, MultiSequencePart, NestedSequence, Allow a multisequence to be built up from parts      Excluded from the instance, Wrap a sequence in an containing object (+96 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (96): DrawingHF, CommentRecord, Properties, ExtensionList, Percentage, Objects can serialise to XML their attributes and child objects.     The followi, Serialisable, Transform (+88 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (92): _3DBase, AreaChart, AreaChart3D, _AreaChartBase, _BaseAxis, ChartLines, DateAxis, DisplayUnitsLabel (+84 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (79): PUT(), RouteParams, GET(), getDashboardPathForRole(), PUT(), PUT(), RouteParams, ensureBucket() (+71 more)
...
Cohesion: 0.06
Nodes (96): ThemeToggle(), ThemeToggleProps, ChatUser, ContactCard(), ContactCardProps, ContactsSidebar(), DEFAULT_CHAT_STATE, formatConversationTimestamp() (+88 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (80): Bool, PhoneticProperties, PhoneticText, RichText, Text, _3DBase, Base class for 3D charts, Surface (+72 more)
...
Cohesion: 0.05
Nodes (79): addComment(), approveResidentPost(), canCreatePostType(), CommunityRole, createAnnouncementPost(), createDiscussionPost(), createPhotoAlbumPost(), createPollPost() (+71 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (41): Alias, Aliases can be used when either the desired attribute name is not allowed     or, CellRange, A sequence of primitive types that are stored as a single attribute.     "val" i, ValueSequence, String, NumberFormatDescriptor, Extension (+33 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (49): AdminSidebar(), NAV_ITEMS, AdminLayout(), ThemeProvider(), AuthContext, AuthContextValue, AuthProvider(), AuthState (+41 more)

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (46): ensureBucket(), POST(), sanitizeFileName(), assertAdmin(), GET(), MUTABLE_STATUSES, PATCH(), RegistrationRecord (+38 more)

### Community 12 - "Community 12"
Cohesion: 0.05
Nodes (56): array, CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, useAuth(), Property, PropertyContext (+48 more)

### Community 13 - "Community 13"
Cohesion: 0.1
Nodes (45): ColorChoice, ColorChoice, HSLColor, RGBPercent, SchemeColor, SystemColor, AlphaBiLevelEffect, AlphaCeilingEffect (+37 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (51): buildInvoiceLabel(), buildOverdueLabel(), DashboardData, formatCurrency(), formatCurrencyParts(), formatDueDate(), TenantDashboard(), LeaseDocument() (+43 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (22): DataValidationList, Need to skip validations that have no cell ranges, SheetFormatProperties, ArrayFormula, DataTableFormula, HyperlinkList, Break, ColBreak (+14 more)

### Community 16 - "Community 16"
Cohesion: 0.08
Nodes (60): completeSchema, POST(), addDays(), clampStepIndex(), completeTenantProductTour(), createTenantProductTourState(), ensureTenantProductTourState(), evaluateTenantProductTourEligibility() (+52 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (39): VALUES, WHO_IT_SERVES, geistMono, geistSans, metadata, RootLayout(), HOW_IT_WORKS, IRIS_WORKFLOWS (+31 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (46): column_letter(), coordinate(), cols(), DummyWorksheet, Return and remove the first cell, Normalise cell range references, Reference, rows() (+38 more)

### Community 19 - "Community 19"
Cohesion: 0.07
Nodes (58): useOptionalProperty(), CanvasItemKind, canViewTenantProfile, ComplaintModal(), Corridor, CorridorResizeHandle, daysRemaining, DbUnit (+50 more)

### Community 20 - "Community 20"
Cohesion: 0.1
Nodes (38): useAppToast(), DigitalSigner, LandlordLeaseSigningPage(), LandlordSigningContent(), LeaseDetails, LeaseSigningContent(), TenantLeaseSigningPage(), extractIpAddress() (+30 more)
...
Cohesion: 0.05
Nodes (24): PageMargins, Identical to openpyxl.worksheet.page.Pagemargins but element names are different, Chartsheet, CustomChartsheetView, CustomChartsheetViews, ChartsheetProperties, ChartsheetProtection, WebPublishItem (+16 more)
...
Cohesion: 0.08
Nodes (46): DELETE(), UpdateListingBody, getLandlordProperties(), getPropertyById(), Amenity, AmenityBooking, AmenityBookingWithDetails, AmenityWithProperty (+38 more)

### Community 25 - "Community 25"
Cohesion: 0.11
Nodes (35): generateOTP(), GET(), POST(), ActionBody, ALLOWED_STATUSES, createLeaseRecord(), createPaymentRecords(), generateTempPassword() (+27 more)
...
Cohesion: 0.11
Nodes (36): getBillingWorkspace(), recordUtilityReading(), BILLING_BUCKETS, DEFAULT_LIMITS, ensureBucket(), removeBillingFile(), uploadBillingFile(), sanitizeFileName() (+28 more)
...
Cohesion: 0.05
Nodes (24): Alignment, Alignment options for use in styles., Border, Border positioning for use in styles., ArrayDescriptor, Fill, GradientFill, PatternFill (+16 more)
...
Cohesion: 0.09
Nodes (18): Guid, ChildSheet, FileRecoveryProperties, PivotCache, Represents a reference to a worksheet or chartsheet in workbook.xml      It cont, Represent the workbook file in the archive, WorkbookPackage, FunctionGroupList (+10 more)
...
Cohesion: 0.06
Nodes (23): Strict, escape(), r"""     Convert ASCII < 31 to OOXML: \n == _x + hex(ord(\n)) + _, r"""     Convert escaped strings to ASCIII: _x000a_ == \n, unescape(), from_str(), from_tree(), HeaderFooterItem (+15 more)
...
Cohesion: 0.14
Nodes (24): GET(), AuditEvent, logAuditEvent(), sendSigningLinkEmail(), generateLandlordSigningLink(), generateSigningToken(), generateTokenWithHash(), getJwtSecret() (+16 more)

### Community 47 - "Community 47"
Cohesion: 0.08
Nodes (19): Return the full XML representation, etree_write_cell(), lxml_write_cell(), Set coordinate and datatype, _set_attributes(), Safely and consistently format numeric values, safe_string(), _explicit_none() (+11 more)
...
Cohesion: 0.1
Nodes (22): BannerNotification, DashboardBannerProps, formatTimeAgo(), SearchResult, SearchResultType, LandlordNavbar(), NAV_ITEMS, ProfileWidget() (+14 more)
...
Cohesion: 0.09
Nodes (9): Sequence, _assign_position(), Automatically assign positions if a list of colours is provided.      It is not, StopList, builtin_format_id(), Return the id of a standard style., apply_stylesheet(), from_tree() (+1 more)
...
Cohesion: 0.14
Nodes (22): PAYMENT_METHODS, PaymentRecordForm(), PaymentRecordFormProps, SigningMode, SigningModeSelector(), SigningModeSelectorProps, ACTIVE_REQUIREMENT_KEYS, BackgroundGlow() (+14 more)
...
Cohesion: 0.2
Nodes (21): fetchIrisHistory(), FetchIrisHistoryOptions, getCachedIrisHistory(), getCacheStorageKey(), IrisHistoryCacheEntry, IrisHistoryFetchResult, IrisHistoryMessage, isFresh() (+13 more)
...
Cohesion: 0.14
Nodes (12): Override, get_dependents(), Normalise dependency file paths to absolute ones      Relative paths are relativ, find_images(), Given the path to a drawing file extract charts and images      Ignore errors du, ExcelReader, _find_workbook_part(), load_workbook() (+4 more)
...
Cohesion: 0.23
Nodes (17): applyLiveFieldValidation(), CardFrame(), GlassInput(), GlassInputProps, SharedStepProps, DEFAULT_CHECKLIST, DEFAULT_EMPLOYMENT, EmploymentInfo (+9 more)
...
Cohesion: 0.1
Nodes (10): sheetname(), quote_sheetname(), Add quotes around sheetnames if they contain spaces., DefinedName, destinations(), type(), create_named_range(), PrintTitles (+2 more)
...
Cohesion: 0.15
Nodes (7): ExternalReference, get_active_sheet(), Write the core workbook xml., Write the workbook relationships xml., Write the package relationships, Return the index of the active sheet.     If the sheet set to active is hidden r, WorkbookWriter
...
Cohesion: 0.24
Nodes (16): ADVANCE_TEMPLATE_KEYS, ApplicationPaymentRequestStatus, ApplicationPaymentRequirementType, asRecord(), buildPortalToken(), buildPortalUrl(), DEPOSIT_TEMPLATE_KEYS, normalizeChecklist() (+8 more)

### Community 110 - "Community 110"
Cohesion: 0.13
Nodes (10): read_external_link(), get_rel(), get_rels_path(), Get related object based on id or rel_type, Find relationships by content-type         NB. these content-types namespaced ob, Convert relative path to absolutes that can be loaded from a zip     archive., Add to zipfile and update manifest, Write the relevant child objects and add links (+2 more)
...
Cohesion: 0.2
Nodes (13): AMENITIES, Amenity, amenityToModalData(), Booking, BookingModalData, bookingToDisplay(), DisplayBooking, formatBookingDate() (+5 more)
...
Cohesion: 0.17
Nodes (7): Base64Binary, FileSharing, password(), _Protected, Set a password on this sheet., Information about protection of various aspects of a sheet. True values     mean, SheetProtection
...
Cohesion: 0.28
Nodes (9): ApplicationIdentityStep(), ApplicationProfileStep(), InviteApplicationClient(), InvitePayload, REQUIREMENT_LABELS, Seal(), SummaryCard(), UploadedRequirementDocument (+1 more)
...
Cohesion: 0.17
Nodes (7): make_separator(), This module contains a tokenizer for Excel formulae.  The tokenizer is based on, Consume the characters constituting an operator.          Returns the number of, Consumes a ; or , character.          Returns the number of characters consumed., A token in an Excel formula.      Tokens have three attributes:      * `value`:, # TODO: this can probably be sped up using a regex to get to, Token

### Community 151 - "Community 151"
Cohesion: 0.22
Nodes (8): hash_password(), Create a password hash from a given string for protecting a worksheet     only., from_tree(), Set a revision password on this workbook., Set a password on this workbook., revisionsPassword(), workbookPassword(), WorkbookProtection
...
Cohesion: 0.21
Nodes (5): Extension, Size in hundredths of points.     In theory other units of measurement can be us, TextPoint, Strict, MinMax
...
Cohesion: 0.22
Nodes (6): Consume a string of consecutive spaces.          Returns the number of spaces fo, A tokenizer for Excel worksheet formulae.      Converts a str string representin, Consumes a + or - character if part of a number in sci. notation.          Retur, Convert the parsed tokens back to a string., Populate self.items with the tokens from the formula., Tokenizer
...
Cohesion: 0.24
Nodes (6): Convert the formula into A1 notation, or as row and column coordinates, Modifies a formula so that it can be translated from one cell to another.      `, Returns a list with the tokens comprising the formula., Translator, coordinate_to_tuple(), Convert an Excel style coordinate to (row, column) tuple
...
## Knowledge Gaps
- **1946 isolated node(s):** `supabase`, `supabase`, `supabase`, `supabase`, `fs` (+1941 more)
...
- **Why does `Serialisable` connect `Community 1` to `Community 0`, `Community 128`, `Community 2`, `Community 6`, `Community 9`, `Community 13`, `Community 15`, `Community 18`, `Community 22`, `Community 151`, `Community 30`, `Community 159`, `Community 32`, `Community 36`, `Community 38`, `Community 42`, `Community 43`, `Community 44`, `Community 47`, `Community 48`, `Community 177`, `Community 49`, `Community 178`, `Community 52`, `Community 55`, `Community 60`, `Community 63`, `Community 203`, `Community 76`, `Community 82`, `Community 83`, `Community 87`, `Community 88`, `Community 92`, `Community 93`, `Community 98`, `Community 103`, `Community 111`, `Community 376`?**
  _High betweenness centrality (0.157) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 4` to `Community 5`, `Community 135`, `Community 7`, `Community 136`, `Community 10`, `Community 12`, `Community 14`, `Community 144`, `Community 17`, `Community 145`, `Community 19`, `Community 20`, `Community 21`, `Community 146`, `Community 147`, `Community 50`, `Community 51`, `Community 188`, `Community 69`, `Community 70`, `Community 73`, `Community 75`, `Community 81`, `Community 211`, `Community 212`, `Community 214`, `Community 215`, `Community 90`, `Community 96`, `Community 102`, `Community 108`, `Community 115`, `Community 119`, `Community 124`, `Community 125`?**
  _High betweenness centrality (0.143) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 0` to `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 11`, `Community 16`, `Community 145`, `Community 146`, `Community 21`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 158`, `Community 37`, `Community 172`, `Community 45`, `Community 173`, `Community 174`, `Community 54`, `Community 70`, `Community 79`, `Community 90`, `Community 109`, `Community 123`, `Community 124`, `Community 126`?**
