# Graph Report - iReside  (2026-05-27)

## Corpus Check
- 739 files · ~7,084,845 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9483 nodes · 21387 edges · 718 communities (516 shown, 202 thin omitted)
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 4458 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f34358c1`
...
## Communities (718 total, 202 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (63): Alignment, Alignment options for use in styles., Border, Border positioning for use in styles., ArrayDescriptor, CellStyle, CellStyleList, Convert to StyleArray (+55 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (57): PUT(), RouteParams, GET(), getDashboardPathForRole(), PUT(), PUT(), RouteParams, GET() (+49 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (80): _3DBase, Base class for 3D charts, Surface, ExtensionList, Percentage, Transform, Connection, ConnectorLocking (+72 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (57): PageMargins, Identical to openpyxl.worksheet.page.Pagemargins but element names are different, Chartsheet, CustomChartsheetView, CustomChartsheetViews, ChartsheetProperties, ChartsheetProtection, WebPublishItem (+49 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (83): ActionBody, ALLOWED_STATUSES, createLeaseRecord(), createPaymentRecords(), generateTempPassword(), getStateForAction(), InquiryAction, isAllowedStatus() (+75 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (79): AdminChatModerationPage(), BannedTerm, ModerationReportCard(), ReportRow, ReportStatus, STATUS_OPTIONS, BulkOrganizerPanel(), BulkOrganizerPanelProps (+71 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (54): Alias, Base64Binary, CellRange, HexBinary, UniversalMeasure, MultiSequence, MultiSequencePart, Allow a multisequence to be built up from parts      Excluded from the instance (+46 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (48): Guid, DocumentProperties, High-level properties of the document.     Defined in ECMA-376 Par2 Annex D, ChildSheet, FileRecoveryProperties, PivotCache, Represents a reference to a worksheet or chartsheet in workbook.xml      It cont, Represent the workbook file in the archive (+40 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (51): Relation, A sequence of primitive types that are stored as a single attribute.     "val" i, ValueSequence, Shape, anchor(), Drawing, a drawing object - eg container for shapes or charts         we assume user spec, PresetGeometry2D (+43 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (57): InlineFont, PhoneticProperties, PhoneticText, Font for inline text because, yes what you need are different objects with the s, RichText, Text, View3D, Level (+49 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (45): NestedSequence, Wrap a sequence in an containing object, Index, AutoSortScope, ChartFormat, ColHierarchiesUsage, ConditionalFormat, ConditionalFormatList (+37 more)
...
Cohesion: 0.06
Nodes (54): AdminLayout(), geistMono, geistSans, metadata, RootLayout(), ThemeProvider(), AuthContext, AuthContextValue (+46 more)

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (57): _3DBase, AreaChart, AreaChart3D, _AreaChartBase, ChartLines, NumericAxis, BarChart, BarChart3D (+49 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (53): generateOTP(), GET(), POST(), fileSchema, landlordRegistrationSchema, landlordRegistrationWithFilesSchema, POST(), UploadedFile (+45 more)

### Community 15 - "Community 15"
Cohesion: 0.06
Nodes (74): advancePaymentSchema, POST(), ActiveLeaseWorkspaceRow, AppSupabaseClient, BillingLeaseRow, buildInvoiceListItem(), createAdvancePayment(), createMultiMonthAdvancePayment() (+66 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (69): GET(), openai, POST(), assertAdmin(), MUTABLE_STATUSES, PATCH(), RegistrationRecord, UpdateListingBody (+61 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (41): _BaseAxis, DateAxis, DisplayUnitsLabel, DisplayUnitsLabelList, Scaling, SeriesAxis, TextAxis, AxId (+33 more)

### Community 18 - "Community 18"
Cohesion: 0.11
Nodes (44): ColorChoice, ColorChoice, HSLColor, RGBPercent, SchemeColor, SystemColor, AlphaBiLevelEffect, AlphaCeilingEffect (+36 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (27): ReadOnlyCell, dict, DefinedNameDict, Utility class for storing defined names.     Allows access by name and separatio, Add names without worrying about key and name matching., PrintOptions, Worksheet print options, Break (+19 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (47): GET(), ensureBucket(), POST(), sanitizeFileName(), GET(), POST(), ensureBucket(), POST() (+39 more)

### Community 21 - "Community 21"
Cohesion: 0.06
Nodes (48): CalendarEvent, EVENT_TYPE_STYLES, LandlordCalendarPage(), MONTH_NAMES, WEEKDAYS, CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub() (+40 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (43): buildInvoiceLabel(), buildOverdueLabel(), DashboardData, DEFAULT_QUICK_ACTIONS, formatCurrency(), formatCurrencyParts(), formatDueDate(), ICON_MAP (+35 more)

### Community 23 - "Community 23"
Cohesion: 0.06
Nodes (39): VALUES, WHO_IT_SERVES, AdminSidebar(), NAV_ITEMS, HOW_IT_WORKS, IRIS_WORKFLOWS, OUTCOMES, ScrollyTellingLandingPage() (+31 more)

### Community 24 - "Community 24"
Cohesion: 0.1
Nodes (40): upsertPaymentReceipt(), computeAmountTag(), DbClient, expireInPersonIntents(), getInPersonIntentExpiry(), getOrCreateDirectConversation(), insertPaymentAuditEvent(), MessageOptions (+32 more)

### Community 25 - "Community 25"
Cohesion: 0.09
Nodes (54): ensureBucket(), InviteRecord, loadInviteRecord(), POST(), sanitizeFileName(), buildPaymentPreview(), formatInviteError(), GET() (+46 more)
...
Cohesion: 0.06
Nodes (48): ADVANCE_TEMPLATE_KEYS, buildPaymentPreview(), DEPOSIT_TEMPLATE_KEYS, InviteApplicationType, InviteListItem, InviteMode, InviteRequirementKey, parseAmount() (+40 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (48): ApplicationsPage(), Applicant, ApplicationsSkeletonList(), ApplicationStatus, calculateApplicationProgress(), formatCurrency(), formatDate(), formatDocumentLabel() (+40 more)

### Community 29 - "Community 29"
Cohesion: 0.11
Nodes (31): Bool, title_maker(), Convertible, EmptyTag, NestedBool, NestedValue, Boolean if a tag exists or not., Nested tag storing the value on the 'val' attribute (+23 more)

### Community 30 - "Community 30"
Cohesion: 0.12
Nodes (43): InvoiceModal(), ChatHeader(), buildListFetchErrorMessage(), buildPaymentHistoryErrorMessage(), ConversationMessage, ConversationSummary, createOrGetDirectConversation(), fetchConversationMessages() (+35 more)
...
Cohesion: 0.06
Nodes (14): SheetDimension, HyperlinkList, MergeCell, MergeCells, create_temporary_file(), Return all rows, and any cells that they contain, As per discusion with the OOXML Working Group global sort state is not required., Comments & VBA controls use VML and require an additional element         that i (+6 more)
...
Cohesion: 0.05
Nodes (27): Max, Min, Values must be less than a `max` value, Values must be greater than a `min` value, Return a new range with cells common to this range and *other*          :type ot, Return the minimal superset of this range and *other*. This new range         wi, collapse_cell_addresses(), DataValidation (+19 more)
...
Cohesion: 0.06
Nodes (27): ConsentSettings, CookieConsent(), SettingToggle(), DocsPage(), ActiveLeasesTab(), ActiveLeasesTabProps, ArchiveTab(), ArchiveTabProps (+19 more)

### Community 37 - "Community 37"
Cohesion: 0.05
Nodes (20): Use a set to keep values unique, UniqueSequence, CellRange, MultiCellRange, Check whether comparisons between ranges are possible.         Cannot compare ra, Shift the focus of the range according to the shift values (*col_shift*, *row_sh, Test whether the ranges are not equal.          :type other: openpyxl.worksheet., Represents a range in a sheet: title and coordinates.      This object is used t (+12 more)

### Community 38 - "Community 38"
Cohesion: 0.06
Nodes (23): columns(), Returns a cell object based on the given coordinates.          Usage: cell(row=1, Internal method for getting a cell from a worksheet.         Will create a new c, Internal method for adding cell objects., Convenience access by Excel style coordinates          The key can be a single c, Produces cells from the worksheet, by row. Specify the iteration range         u, Produces cells from the worksheet, by column. Specify the iteration range, Add a data-validation object to the sheet.  The data-validation             obje (+15 more)
...
Cohesion: 0.08
Nodes (27): DashboardBackground(), DashboardBackgroundProps, BannerNotification, DashboardBanner(), DashboardBannerProps, formatTimeAgo(), SearchResult, SearchResultType (+19 more)

### Community 41 - "Community 41"
Cohesion: 0.07
Nodes (34): BillingWorkspace, NextPayment, OverduePayment, PaymentSummaryProps, LeaseInfo, TenantDashboardHeaderProps, Action, BillingOperationsPanel() (+26 more)
...
Cohesion: 0.13
Nodes (40): buildHeuristicMaintenanceTriage(), clampConfidence(), computeMaintenanceTriageHash(), DISTRESSED_KEYWORDS, HIGH_KEYWORDS, MaintenanceSentiment, MaintenanceTriageInput, MaintenanceTriageResult (+32 more)
...
Cohesion: 0.06
Nodes (33): product(), build_workbook(), format_case_id(), resolve_output_path(), cols_from_range(), column_index_from_string(), coordinate_from_string(), get_column_interval() (+25 more)
...
Cohesion: 0.05
Nodes (17): column_letter(), coordinate(), get_time_format(), get_type(), is_date(), Given a value, infer the correct data type, value(), coordinate() (+9 more)

### Community 51 - "Community 51"
Cohesion: 0.1
Nodes (24): useAppToast(), DigitalSigner, LandlordLeaseSigningPage(), LandlordSigningContent(), LeaseDetails, LeaseSigningContent(), TenantLeaseSigningPage(), generateLeasePdf() (+16 more)

### Community 52 - "Community 52"
Cohesion: 0.1
Nodes (28): AnalyticsPage(), DEFAULT_EXTENDED_KPIS, DEFAULT_FINANCIAL_CHART, DEFAULT_OPERATIONAL_SNAPSHOT, DEFAULT_PRIMARY_KPIS, ExportAuditItem, formatIsoDate(), getDateLabels() (+20 more)
...
Cohesion: 0.07
Nodes (19): BoundDictionary, defaultdict, StyleableObject, Base class for styleble objects implementing proxy and lookup functions, StyleableObject, BoundDictionary, A default dictionary where elements are tightly coupled.      The factory method, Break names down into sheet locals and globals (+11 more)

### Community 55 - "Community 55"
Cohesion: 0.15
Nodes (33): addDays(), clampStepIndex(), completeLandlordProductTour(), createLandlordProductTourState(), ensureLandlordProductTourState(), evaluateLandlordProductTourEligibility(), getLandlordProductTourRequiredStep(), getLandlordProductTourSkipCooldownDays() (+25 more)

### Community 56 - "Community 56"
Cohesion: 0.07
Nodes (15): MergedCell, Describes the properties of a cell in a merged cell and helps to     display the, CellRange, ArrayFormula, DataTableFormula, MergedCellRange, MergedCellRange stores the border information of a merged cell in the top     le, If the upper left cell of the merged cell does not yet exist, it is         crea (+7 more)

### Community 57 - "Community 57"
Cohesion: 0.07
Nodes (23): Cell, Check string coding, length, and line break character, Tries to convert Error" else N/A, Returns a cell location relative to this cell.          :param row: number of ro, Describes cell associated properties.      Properties of interest include style,, WriteOnlyCell(), Exception, CellCoordinatesException (+15 more)

### Community 58 - "Community 58"
Cohesion: 0.1
Nodes (30): PAYMENT_METHODS, PaymentRecordForm(), PaymentRecordFormProps, SigningMode, SigningModeSelector(), SigningModeSelectorProps, BackgroundGlow(), Noise() (+22 more)
...
Cohesion: 0.07
Nodes (17): BlankFilter, ColorFilter, CustomFilter, CustomFilters, DateGroupItem, DynamicFilter, FilterColumn, Filters (+9 more)
...
Cohesion: 0.06
Nodes (18): sheetname(), MultiCellRange, absolute_coordinate(), quote_sheetname(), Add quotes around sheetnames if they contain spaces., Convert a coordinate to an absolute coordinate string (B12 -> $B$12), ColRange, from_string() (+10 more)
...
Cohesion: 0.08
Nodes (16): etree_write_cell(), lxml_write_cell(), Set coordinate and datatype, _set_attributes(), Safely and consistently format numeric values, safe_string(), _explicit_none(), Override serialisation because explicit none required (+8 more)

### Community 71 - "Community 71"
Cohesion: 0.12
Nodes (21): BusinessPermitCard(), BusinessPermitCardProps, ALLOWED_FILE_TYPES, AvatarPickerAction, AvatarPickerProps, AvatarPickerState, PRESET_COLORS, calculateLeaseProgress() (+13 more)
...
Cohesion: 0.12
Nodes (17): ConsultationDashboard(), Document, ConsultationTool(), ConsultationToolProps, DigitalSigner, ConsultationTool, SignPage(), EditableBio() (+9 more)
...
Cohesion: 0.12
Nodes (25): ActorProfile, ApplicationResponse, ApplicationRow, AuditRow, buildComplianceChecklist(), ComplianceChecklist, DEFAULT_COMPLIANCE_CHECKLIST, extractMissingColumn() (+17 more)
...
Cohesion: 0.1
Nodes (24): FloorSelector(), FloorSelectorProps, FloorTab, VisualCanvasProps, useVisualBuilderState(), VisualBuilderStateProps, DEFAULT_FLOOR_LAYOUTS, EMPTY_FLOOR_LAYOUT (+16 more)
...
Cohesion: 0.13
Nodes (17): Loading(), GlobalLoadingContext, GlobalLoadingContextType, GlobalLoadingProvider(), GlassCard(), LandlordSettings(), SettingField(), SettingsCategory (+9 more)

### Community 96 - "Community 96"
Cohesion: 0.16
Nodes (17): AlbumGrid(), MessageBubble(), MessageBubbleProps, renderSystemIcon(), StatusIcon(), SystemMessage(), MessageList(), MessageListProps (+9 more)
...
Cohesion: 0.14
Nodes (10): Generate string representation of XML element.      All subelements are included, tostring(), Write the workbook relationships xml., ExcelWriter, Write links to external workbooks, Write data into the archive., Save the given workbook on the filesystem under the name filename.      :param w, Write a workbook object to an Excel file. (+2 more)
...
Cohesion: 0.15
Nodes (17): evaluateTenantProductTourEligibility(), isNextProductTourStepSubmission(), TENANT_PRODUCT_TOUR_STEPS, TenantProductTourState, INITIAL_TOUR_UI_STATE, isTourEnabledClient(), StepProgressPayload, TenantProductTourOverlay() (+9 more)
...
Cohesion: 0.1
Nodes (9): comment(), copy(), Return a copy of the proxied object., Add proxied object to another instance and return the combined object, Return a copy of the proxied object. Keyword args will be passed through, Proxy formatting objects so that they cannot be altered, StyleProxy, Copy the values, styles, dimensions, merged cells, margins, and     print/page s (+1 more)
...
Cohesion: 0.22
Nodes (13): ChatUser, formatConversationTimestamp(), mapConversationToUser(), ChatHeaderProps, ContactItem(), ContactItemProps, ContactListProps, ContactItem (+5 more)
...
Cohesion: 0.24
Nodes (12): completeSchema, POST(), getTenantProductTourRequiredStep(), isGuidedTenantProductTourEnabled(), POST(), POST(), skipSchema, POST() (+4 more)
...
Cohesion: 0.22
Nodes (16): array, AddAmenityModal(), AddAmenityModalProps, AMENITY_TYPES, ICONS, ModernSelect(), AmenityInsert, deleteAmenity() (+8 more)
...
Cohesion: 0.18
Nodes (16): fetchMock, filterUsers(), makeUser(), q, resultIds, results, user, userArb (+8 more)
...
Cohesion: 0.17
Nodes (9): ExcelReader, _find_workbook_part(), load_workbook(), Read an Excel package and dispatch the contents to the relevant modules, Open the given filename and return the workbook      :param filename: the path t, Does a first check whether filename is a string or a file-like     object. If it, _validate_archive(), InvalidFileException (+1 more)
...
Cohesion: 0.2
Nodes (15): APARTMENT_DEFAULTS, BOARDING_DEFAULTS, DORM_DEFAULTS, EnvironmentMode, GENDER_OPTIONS, GenderRestrictionMode, getDefaultsForMode(), MODE_INFO (+7 more)

### Community 138 - "Community 138"
Cohesion: 0.19
Nodes (13): Map, Marker, mockProperties, Popup, PropertiesPage(), Property, TileLayer, FILTER_TABS (+5 more)
...
Cohesion: 0.17
Nodes (11): TenantSettingsPage(), updateTenantPassword(), GlassCard(), Section, SectionHeader(), SettingRow(), SettingsCategory, SIDEBAR_ITEMS (+3 more)

### Community 142 - "Community 142"
Cohesion: 0.12
Nodes (18): **3.5.1 Proposed System Context Diagram** {#3.5.1-proposed-system-context-diagram}, **3.5.3 Activity Diagram for Functional Requirements** {#3.5.3-activity-diagram-for-functional-requirements}, **3.5.4 Use Case Diagram** {#3.5.4-use-case-diagram}, **3.5.4 Use Case Diagram![][image12]** {#3.5.4-use-case-diagram}, **3.5.4 Use Case Diagram![][image8]** {#3.5.4-use-case-diagram}, **3.5.5 Use Case Scenario** {#3.5.5-use-case-scenario}, **3.5.6 Hierarchical Diagram or Entity Relationship Diagram** {#3.5.6-hierarchical-diagram-or-entity-relationship-diagram}, **3.5.7 Data Dictionary** {#3.5.7-data-dictionary} (+10 more)
...
Cohesion: 0.16
Nodes (5): AuthorList, CommentRecord, CommentSheet, from_comments(), Properties
...
Cohesion: 0.17
Nodes (15): DbUnit, QuickActionGuardResult, QuickActionType, dbUnitToCanvasUnit(), formatFloorWatermark(), getFloorDisplayLabel(), parseFloorNumber(), QUICK_ACTION_META (+7 more)
...
Cohesion: 0.4
Nodes (10): isGuidedLandlordProductTourEnabled(), LandlordProductTourTriggerSource, resolveLandlordProductTourEligibility(), TenantProductTourTriggerSource, DELETE(), GET(), parseBoolean(), resolveOnboardingCompleted() (+2 more)
...
Cohesion: 0.15
Nodes (12): 15.1 How It Works, 15.2 For Landlords, 15.3 For Tenants, 15. Utility Billing, 16.1 Editing Your Profile, 16.2 Changing Your Password, 16.3 Profile Photo, 16.4 Notification Preferences (+4 more)
...
Cohesion: 0.31
Nodes (11): ChatUser, ContactCard(), ContactCardProps, DEFAULT_CHAT_STATE, formatConversationTimestamp(), formatMiniTimestamp(), MiniChatMessage, MiniChatState (+3 more)
...
Cohesion: 0.17
Nodes (11): 10.1 Unit Tests, 10.2 Integration Tests, 10.3 E2E Tests, 10. Testing Requirements, 1. User Stories, Appendix: Sample Workflow Timeline, code:block16 (Day 1: Tenant submits move-out request (status: pending)), Landlord Stories (+3 more)
...
Cohesion: 0.2
Nodes (11): code:block1 (docs/latest-documentations after major refactor/activity-dia), code:bash (java -jar plantuml.jar docs/latest-documentations\ after\ ma), code:block3 (https://www.plantuml.com/plantuml/uml/SyfFKj2rKt3CoKnELR1Io4), How to View the Diagrams, Option A: Online Renderer (Quickest), Option A: Open .drawio files in diagrams.net, Option B: Use PlantUML, Option B: VS Code Extension (+3 more)
...
Cohesion: 0.24
Nodes (5): cols(), DummyWorksheet, Normalise cell range references, Reference, rows()
...
Cohesion: 0.29
Nodes (7): CATEGORY_META, MessageReportAction, MessageReportCategory, MessageReportState, MessageReportWizard(), MessageReportWizardProps, normalizePastedMessageId()

### Community 256 - "Community 256"
Cohesion: 0.33
Nodes (5): playSound(), SOUND_PATHS, SoundManager, SoundType, useSound()
...
Cohesion: 0.5
Nodes (4): **3.5.2 Proposed System Level 1 Diagram** {#3.5.2-proposed-system-level-1-diagram}, *Figure 5\. Data Flow Diagram Level 1 of Landlord* {#figure-5.-data-flow-diagram-level-1-of-landlord}, *Figure 6\. Data Flow Diagram Level 1 of Tenant* {#figure-6.-data-flow-diagram-level-1-of-tenant}, *Figure 7\. Data Flow Diagram Level 1 of Admin* {#figure-7.-data-flow-diagram-level-1-of-admin}
...
## Knowledge Gaps
- **3040 isolated node(s):** `eslintConfig`, `nextConfig`, `config`, `supabase`, `supabase` (+3035 more)
...
- **Why does `Serialisable` connect `Community 3` to `Community 0`, `Community 2`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 13`, `Community 17`, `Community 18`, `Community 19`, `Community 29`, `Community 160`, `Community 32`, `Community 34`, `Community 37`, `Community 54`, `Community 56`, `Community 443`, `Community 60`, `Community 70`, `Community 211`, `Community 91`, `Community 98`, `Community 232`, `Community 108`, `Community 112`, `Community 498`, `Community 116`, `Community 125`?**
  _High betweenness centrality (0.110) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 5` to `Community 129`, `Community 130`, `Community 137`, `Community 138`, `Community 11`, `Community 12`, `Community 141`, `Community 15`, `Community 21`, `Community 22`, `Community 23`, `Community 154`, `Community 27`, `Community 28`, `Community 30`, `Community 33`, `Community 36`, `Community 40`, `Community 41`, `Community 175`, `Community 178`, `Community 51`, `Community 52`, `Community 179`, `Community 53`, `Community 58`, `Community 61`, `Community 190`, `Community 192`, `Community 325`, `Community 197`, `Community 71`, `Community 73`, `Community 457`, `Community 75`, `Community 95`, `Community 96`, `Community 105`, `Community 239`, `Community 113`, `Community 114`, `Community 255`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 6` to `Community 1`, `Community 2`, `Community 3`, `Community 140`, `Community 14`, `Community 15`, `Community 16`, `Community 24`, `Community 25`, `Community 27`, `Community 28`, `Community 35`, `Community 44`, `Community 173`, `Community 55`, `Community 58`, `Community 61`, `Community 67`, `Community 78`, `Community 86`, `Community 221`, `Community 96`, `Community 238`, `Community 119`?**
