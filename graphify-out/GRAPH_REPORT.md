# Graph Report - iReside  (2026-05-15)

## Corpus Check
- 972 files · ~7,135,176 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8754 nodes · 20622 edges · 653 communities (453 shown, 200 thin omitted)
- Extraction: 78% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 4458 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4e67f4fe`
...
4. `createClient()` - 266 edges
5. `createAdminClient()` - 233 edges
...
## Communities (653 total, 200 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (75): Connection, ConnectorLocking, ConnectorNonVisual, ConnectorShape, NonVisualConnectorProperties, Shape, ShapeMeta, anchor() (+67 more)
...
Cohesion: 0.08
Nodes (75): title_maker(), Convertible, HexBinary, Percentage, Relation, EmptyTag, NestedValue, Boolean if a tag exists or not. (+67 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (55): AuthorList, CommentRecord, CommentSheet, from_comments(), Properties, Base64Binary, Extension, Guid (+47 more)
...
Cohesion: 0.04
Nodes (71): CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, BulkOrganizerPanel(), BulkOrganizerPanelProps, DbUnit, FloorConfig (+63 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (46): generateOTP(), GET(), POST(), ensureBucket(), POST(), sanitizeFileName(), ensureBucket(), POST() (+38 more)
...
Cohesion: 0.05
Nodes (58): AdminLayout(), ThemeProvider(), AuthContext, AuthContextValue, AuthProvider(), AuthState, isAuthoritativeAuthError(), useAuth() (+50 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (76): GET(), openai, POST(), assertAdmin(), DELETE(), MUTABLE_STATUSES, PATCH(), RegistrationRecord (+68 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (42): NestedSequence, Wrap a sequence in an containing object, Index, AutoSortScope, ChartFormat, ColHierarchiesUsage, ConditionalFormat, ConditionalFormatList (+34 more)
...
Cohesion: 0.05
Nodes (53): buildInvoiceLabel(), buildOverdueLabel(), DashboardData, formatCurrency(), formatCurrencyParts(), formatDueDate(), TenantDashboard(), LeaseDocument() (+45 more)
...
Cohesion: 0.04
Nodes (35): Alias, Aliases can be used when either the desired attribute name is not allowed     or, CellRange, A sequence of primitive types that are stored as a single attribute.     "val" i, ValueSequence, ExternalBook, ExternalCell, ExternalDefinedName (+27 more)

### Community 17 - "Community 17"
Cohesion: 0.07
Nodes (48): GET(), getBillingWorkspace(), recordUtilityReading(), BILLING_BUCKETS, DEFAULT_LIMITS, ensureBucket(), removeBillingFile(), uploadBillingFile() (+40 more)

### Community 18 - "Community 18"
Cohesion: 0.06
Nodes (37): PhoneticProperties, PhoneticText, RichText, Text, _3DBase, Base class for 3D charts, Surface, View3D (+29 more)
...
Cohesion: 0.05
Nodes (34): DocsPage(), ActiveLeasesTab(), ActiveLeasesTabProps, ArchiveTab(), ArchiveTabProps, CardVariant, formatCurrency(), formatDate() (+26 more)

### Community 23 - "Community 23"
Cohesion: 0.12
Nodes (31): _3DBase, AreaChart, AreaChart3D, _AreaChartBase, ChartLines, NumericAxis, SeriesAxis, TextAxis (+23 more)

### Community 24 - "Community 24"
Cohesion: 0.09
Nodes (44): DisplayUnitsLabel, DisplayUnitsLabelList, ErrorBars, PictureOptions, CustomSplit, DoughnutChart, PieChart, PieChart3D (+36 more)
...
Cohesion: 0.05
Nodes (17): Modifies a formula so that it can be translated from one cell to another.      `, Translator, coordinate_to_tuple(), Convert an Excel style coordinate to (row, column) tuple, ArrayFormula, DataTableFormula, Break, ColBreak (+9 more)

### Community 27 - "Community 27"
Cohesion: 0.07
Nodes (32): AxId, ChartBase, PlotArea(), Normalise and rebase series: sort by order and then rebase order, Set the categories / x-axis values, Add a range of data in a single pass.         The default is to treat each colum, Append a data series to the chart, Base class for all charts (+24 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (34): geistMono, geistSans, metadata, RootLayout(), Loading(), ConsentSettings, CookieConsent(), SettingToggle() (+26 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (27): columns(), _gutter(), Returns a cell object based on the given coordinates.          Usage: cell(row=1, Internal method for getting a cell from a worksheet.         Will create a new c, Internal method for adding cell objects., Convenience access by Excel style coordinates          The key can be a single c, Produces cells from the worksheet, by row. Specify the iteration range         u, Produces cells from the worksheet, by column. Specify the iteration range (+19 more)
...
Cohesion: 0.13
Nodes (35): generateNextMonthInvoice(), upsertPaymentReceipt(), computeAmountTag(), DbClient, expireInPersonIntents(), getInPersonIntentExpiry(), getOrCreateDirectConversation(), insertPaymentAuditEvent() (+27 more)

### Community 34 - "Community 34"
Cohesion: 0.07
Nodes (30): CellIsRule(), ColorScale, ColorScaleRule(), DataBar, DataBarRule(), FormatObject, FormulaRule(), IconSet (+22 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (21): PageMargins, PrintSettings, Identical to openpyxl.worksheet.page.Pagemargins but element names are different, Chartsheet, CustomChartsheetView, CustomChartsheetViews, ChartsheetProperties, ChartsheetProtection (+13 more)

### Community 36 - "Community 36"
Cohesion: 0.05
Nodes (18): TableStyleList, Error for trying to modify a read-only workbook, ReadOnlyWorkbookException, active(), get_index(), Create a worksheet (at an optional index).          :param title: optional title, Add an worksheet (at an optional index)., Move a sheet or sheetname (+10 more)

### Community 37 - "Community 37"
Cohesion: 0.06
Nodes (19): BoundDictionary, StyleableObject, BoundDictionary, A default dictionary where elements are tightly coupled.      The factory method, ColumnDimension, Dimension, DimensionHolder, Information about the display properties of a column. (+11 more)
...
Cohesion: 0.05
Nodes (21): MultiCellRange, ColRange, from_string(), PrintArea, PrintTitles, Contains at least either a range of rows or columns, Represent a range of at least one column, Represent a range of at least one row (+13 more)
...
Cohesion: 0.1
Nodes (36): InvoiceListItem, InvoiceReadingDetail, formatDateLong(), formatPhpCurrency(), buildFaceToFacePreviewInvoice(), buildSelectivePreviewInvoice(), CheckoutPage(), Field() (+28 more)

### Community 47 - "Community 47"
Cohesion: 0.07
Nodes (21): Return the full XML representation, etree_write_cell(), lxml_write_cell(), Set coordinate and datatype, _set_attributes(), Safely and consistently format numeric values, safe_string(), _explicit_none() (+13 more)
...
Cohesion: 0.07
Nodes (31): product(), build_workbook(), format_case_id(), resolve_output_path(), absolute_coordinate(), cols_from_range(), column_index_from_string(), coordinate_from_string() (+23 more)
...
Cohesion: 0.05
Nodes (17): column_letter(), comment(), coordinate(), get_time_format(), get_type(), is_date(), Given a value, infer the correct data type, value() (+9 more)

### Community 53 - "Community 53"
Cohesion: 0.16
Nodes (36): ICON_MAP, LandlordQuestBoard(), LandlordQuestBoardProps, addDays(), clampStepIndex(), completeLandlordProductTour(), createLandlordProductTourState(), ensureLandlordProductTourState() (+28 more)

### Community 54 - "Community 54"
Cohesion: 0.08
Nodes (10): Sequence, _assign_position(), Automatically assign positions if a list of colours is provided.      It is not, Stop, StopList, builtin_format_id(), Return the id of a standard style., apply_stylesheet() (+2 more)
...
Cohesion: 0.11
Nodes (28): SigningMode, SigningModeSelector(), SigningModeSelectorProps, BackgroundGlow(), Noise(), TOOL_ACCENTS, TOOL_GLOWS, ToolAccessBar() (+20 more)
...
Cohesion: 0.22
Nodes (17): AuditEvent, extractIpAddress(), extractUserAgent(), sendLeaseActivatedNotification(), sendTenantSignedNotification(), generateLeasePdf(), getAllowedTransitions(), getTransitionErrorMessage() (+9 more)
...
Cohesion: 0.14
Nodes (19): CommandCenter(), CommandCenterProps, NextMove, StatCard, urgencyStyles, INACTIVE_INVITE_STATUSES, LandlordDashboard(), OPEN_UNIT_STATUSES (+11 more)
...
Cohesion: 0.11
Nodes (11): sheetname(), quote_sheetname(), Add quotes around sheetnames if they contain spaces., DefinedName, create_named_range(), get_active_sheet(), Write the core workbook xml., Write the workbook relationships xml. (+3 more)

### Community 96 - "Community 96"
Cohesion: 0.16
Nodes (17): Bool, Descriptor, A sequence (list or tuple) that may only contain objects of the declared     typ, Sequence, NestedText, NestedDateTime, QualifiedDateTime, In certain situations Excel will complain if the additional type     attribute i (+9 more)
...
Cohesion: 0.12
Nodes (12): CellStyleList, ColorList, builtin_format_code(), is_timedelta_format(), NumberFormatList, Return one of the standard format codes by index., Merge named style names "cellStyles" with their associated styles         "cellS, Expand a named style reference element to a         named style object by bindin (+4 more)
...
Cohesion: 0.09
Nodes (9): DataValidationList, Need to skip validations that have no cell ranges, SheetFormatProperties, PrintOptions, Worksheet print options, InputCells, Scenario, ScenarioList (+1 more)
...
Cohesion: 0.23
Nodes (17): ADVANCE_TEMPLATE_KEYS, DEPOSIT_TEMPLATE_KEYS, hashPortalToken(), ApplicationInsert, expireInviteIfNeeded(), fetchPortalPayload(), GET(), InviteRecord (+9 more)
...
Cohesion: 0.21
Nodes (10): useAppToast(), DigitalSigner, LandlordLeaseSigningPage(), LandlordSigningContent(), LeaseDetails, LeaseSigningContent(), TenantLeaseSigningPage(), LeasePdfData (+2 more)

### Community 124 - "Community 124"
Cohesion: 0.18
Nodes (12): _BaseAxis, DateAxis, Scaling, NumFmt, NumberFormatDescriptor, Allow direct assignment of format code, From the specification: 21.2.2.216      This element specifies text formatting., The value can be either a cell reference or a text element     If both are prese (+4 more)
...
Cohesion: 0.18
Nodes (8): Override, ExcelReader, _find_workbook_part(), load_workbook(), Read an Excel package and dispatch the contents to the relevant modules, Open the given filename and return the workbook      :param filename: the path t, Does a first check whether filename is a string or a file-like     object. If it, _validate_archive()

### Community 133 - "Community 133"
Cohesion: 0.14
Nodes (10): Strict, from_str(), from_tree(), HeaderFooterItem, _HeaderFooterPart, Convert to Excel HeaderFooter miniformat minus position, Header or footer item, Split the combined (decoded) string into left, center and right parts      # See (+2 more)
...
Cohesion: 0.12
Nodes (13): code:typescript (it('returns ordered photos for album', async () => {), code:bash (git add src/lib/community/actions.ts), code:typescript (it('fetches posts for landlord properties with filters', asy), code:bash (git add src/lib/community/actions.ts), code:typescript (it('allows tenant to vote on poll (upsert)', async () => {), code:bash (npx vitest --run), code:bash (git add src/lib/community/actions.ts), code:bash (git add src/lib/community/actions.ts) (+5 more)
...
Cohesion: 0.14
Nodes (14): Alternative Flows, Alternative Flows, code:plantuml (@startuml), code:plantuml (@startuml), FEATURE 3: Digital Lease Signing Workflow, Main Flow, Main Flow, Objective (+6 more)
...
Cohesion: 0.17
Nodes (8): DummyCode, DateTime, cast_numeric(), cast_percentage(), cast_time(), Explicitly convert a string to a numeric value, Explicitly convert a string to numeric value and format as a     percentage, Explicitly convert a string to a number and format as datetime or     time

### Community 187 - "Community 187"
Cohesion: 0.19
Nodes (6): Cached, Caching metaclass     Child classes will only create new instances of themselves, Singleton metaclass     Based on Python Cookbook 3rd Edition Recipe 9.13     Onl, Singleton, AutoSlotProperties, type
...
Cohesion: 0.17
Nodes (7): defaultdict, Map fields to associated conditional formats by priority, Break names down into sheet locals and globals, collapse_cell_addresses(), expand_cell_ranges(), Collapse a collection of cell co-ordinates down into an optimal         range or, Expand cell ranges to a sequence of addresses.     Reverse of collapse_cell_addr
...
Cohesion: 0.24
Nodes (9): This module contains code to translate formulae across cells in a worksheet.  Th, Convert the formula into A1 notation, or as row and column coordinates, Raised when a formula can't be translated across cells.      This error arises w, Returns a list with the tokens comprising the formula., strip_ws_name(), translate_col(), translate_range(), translate_row() (+1 more)
...
Cohesion: 0.18
Nodes (12): code:block1 (docs/latest-documentations after major refactor/activity-dia), code:bash (java -jar plantuml.jar docs/latest-documentations\ after\ ma), code:block3 (https://www.plantuml.com/plantuml/uml/SyfFKj2rKt3CoKnELR1Io4), How to View the Diagrams, Option A: Online Renderer (Quickest), Option A: Open .drawio files in diagrams.net, Option B: Use PlantUML, Option B: VS Code Extension (+4 more)
...
Cohesion: 0.27
Nodes (3): MetaSerialisable, MetaStrict, Strict
...
Cohesion: 0.22
Nodes (6): escape(), r"""     Convert ASCII < 31 to OOXML: \n == _x + hex(ord(\n)) + _, r"""     Convert escaped strings to ASCIII: _x000a_ == \n, unescape(), Pack parts into a single string, from_tree()
...
## Knowledge Gaps
- **2528 isolated node(s):** `supabase`, `supabase`, `supabase`, `supabase`, `eslintConfig` (+2523 more)
...
- **Why does `Serialisable` connect `Community 4` to `Community 0`, `Community 3`, `Community 132`, `Community 133`, `Community 8`, `Community 12`, `Community 142`, `Community 16`, `Community 18`, `Community 21`, `Community 23`, `Community 24`, `Community 152`, `Community 26`, `Community 27`, `Community 30`, `Community 34`, `Community 35`, `Community 36`, `Community 37`, `Community 39`, `Community 43`, `Community 47`, `Community 54`, `Community 58`, `Community 76`, `Community 81`, `Community 218`, `Community 348`, `Community 93`, `Community 95`, `Community 96`, `Community 99`, `Community 102`, `Community 104`, `Community 235`, `Community 236`, `Community 237`, `Community 238`, `Community 111`, `Community 107`, `Community 124`, `Community 253`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 8` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 7`, `Community 11`, `Community 141`, `Community 17`, `Community 20`, `Community 157`, `Community 158`, `Community 33`, `Community 38`, `Community 167`, `Community 170`, `Community 44`, `Community 46`, `Community 53`, `Community 59`, `Community 65`, `Community 68`, `Community 73`, `Community 75`, `Community 214`, `Community 216`, `Community 101`, `Community 230`, `Community 108`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 5` to `Community 1`, `Community 6`, `Community 262`, `Community 9`, `Community 10`, `Community 11`, `Community 140`, `Community 13`, `Community 14`, `Community 15`, `Community 19`, `Community 147`, `Community 22`, `Community 28`, `Community 157`, `Community 31`, `Community 292`, `Community 169`, `Community 170`, `Community 46`, `Community 51`, `Community 181`, `Community 53`, `Community 183`, `Community 56`, `Community 313`, `Community 59`, `Community 60`, `Community 68`, `Community 75`, `Community 89`, `Community 90`, `Community 106`, `Community 119`, `Community 120`, `Community 121`, `Community 123`?**
