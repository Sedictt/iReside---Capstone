# Graph Report - iReside  (2026-05-18)

## Corpus Check
- 983 files · ~7,149,309 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9059 nodes · 20954 edges · 674 communities (475 shown, 199 thin omitted)
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 4458 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2dc686cb`
...
Cohesion: 0.03
Nodes (109): ExtensionList, HexBinary, Percentage, ColorChoiceDescriptor, Objects can choose from 7 different kinds of color system.     Assume RGBHex if, Connection, ConnectorLocking, ConnectorNonVisual (+101 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (94): _3DBase, _3DBase, Base class for 3D charts, Surface, View3D, AreaChart, AreaChart3D, _AreaChartBase (+86 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (97): Alias, Relation, MultiSequence, MultiSequencePart, NestedSequence, Allow a multisequence to be built up from parts      Excluded from the instance, Wrap a sequence in an containing object, Sequences can contain objects with different tags (+89 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (74): GET(), PUT(), RouteParams, GET(), POST(), GET(), getDashboardPathForRole(), PUT() (+66 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (103): ChatUser, ContactCard(), ContactCardProps, ContactsSidebar(), DEFAULT_CHAT_STATE, EMPTY_ARRAY, EMPTY_OBJECT, formatConversationTimestamp() (+95 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (76): AdminSidebar(), NAV_ITEMS, AdminLayout(), ThemeProvider(), AuthContext, AuthContextValue, AuthProvider(), AuthState (+68 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (78): TenantInviteManager(), AdminChatModerationPage(), BannedTerm, ModerationReportCard(), ReportRow, ReportStatus, STATUS_OPTIONS, BulkOrganizerPanel() (+70 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (70): CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, Property, PropertyContext, PropertyContextValue, PropertyProvider() (+62 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (57): VALUES, WHO_IT_SERVES, geistMono, geistSans, metadata, RootLayout(), HOW_IT_WORKS, IRIS_WORKFLOWS (+49 more)

### Community 9 - "Community 9"
Cohesion: 0.07
Nodes (53): ColorChoice, Objects can serialise to XML their attributes and child objects.     The followi, Serialisable, ColorChoice, HSLColor, RGBPercent, SchemeColor, SystemColor (+45 more)

### Community 10 - "Community 10"
Cohesion: 0.05
Nodes (65): Bool, PhoneticProperties, PhoneticText, RichText, Text, Set the categories / x-axis values, AxDataSource, Level (+57 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (57): Loading(), ConsultationDashboard(), Document, ConsultationTool(), ConsultationToolProps, DigitalSigner, ConsultationTool, SignPage() (+49 more)
...
Cohesion: 0.05
Nodes (51): ensureBucket(), POST(), sanitizeFileName(), generateTempPassword(), POST(), ensureBucket(), POST(), sanitizeFileName() (+43 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (53): NextPayment, OverduePayment, PaymentSummaryProps, LeaseInfo, TenantDashboardHeaderProps, UnitHistoryModalProps, buildInvoiceLabel(), buildOverdueLabel() (+45 more)
...
Cohesion: 0.04
Nodes (34): CellRange, Extension, ExtensionList, IgnoredError, IgnoredErrors, BlankFilter, ColorFilter, CustomFilter (+26 more)
...
Cohesion: 0.05
Nodes (67): GET(), openai, POST(), DELETE(), UpdateListingBody, formatContextForAI(), getTenantContext(), getActiveLease() (+59 more)
...
Cohesion: 0.04
Nodes (34): dict, MultiCellRange, DefinedNameDict, Utility class for storing defined names.     Allows access by name and separatio, Add names without worrying about key and name matching., DataValidationList, Need to skip validations that have no cell ranges, SheetFormatProperties (+26 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (19): from_ISO8601(), Convert from a timestamp string to a datetime object. According to     18.17.4 i, ArrayFormula, DataTableFormula, HyperlinkList, Break, ColBreak, RowBreak (+11 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (44): column_letter(), coordinate(), cols(), DummyWorksheet, Return and remove the first cell, Normalise cell range references, Reference, rows() (+36 more)

### Community 23 - "Community 23"
Cohesion: 0.08
Nodes (43): generateOTP(), GET(), POST(), ActionBody, ALLOWED_STATUSES, createLeaseRecord(), createPaymentRecords(), generateTempPassword() (+35 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (38): make_operand(), make_separator(), make_subexp(), This module contains a tokenizer for Excel formulae.  The tokenizer is based on, Consume all the text between square brackets [].          Returns the number of, Base class for all Tokenizer errors., Consume the text following a '#' as an error.          Looks for a match in self, Consume a string of consecutive spaces.          Returns the number of spaces fo (+30 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (21): CellRange, MultiCellRange, Check whether comparisons between ranges are possible.         Cannot compare ra, Shift the focus of the range according to the shift values (*col_shift*, *row_sh, Test whether the ranges are not equal.          :type other: openpyxl.worksheet., Represents a range in a sheet: title and coordinates.      This object is used t, Test whether the ranges are equal.          :type other: openpyxl.worksheet.cell, Test whether every cell in this range is also in *other*.          :type other: (+13 more)
...
Cohesion: 0.08
Nodes (12): MergeCell, MergeCells, create_temporary_file(), Return all rows, and any cells that they contain, As per discusion with the OOXML Working Group global sort state is not required., Comments & VBA controls use VML and require an additional element         that i, Write all elements after the rows         calc properties         protection, Close the context manager (+4 more)
...
Cohesion: 0.15
Nodes (37): ICON_MAP, LandlordQuestBoardProps, addDays(), clampStepIndex(), completeLandlordProductTour(), createLandlordProductTourState(), ensureLandlordProductTourState(), evaluateLandlordProductTourEligibility() (+29 more)
...
Cohesion: 0.17
Nodes (30): computeAmountTag(), DbClient, expireInPersonIntents(), getInPersonIntentExpiry(), getOrCreateDirectConversation(), insertPaymentAuditEvent(), MessageOptions, NotifyOptions (+22 more)

### Community 42 - "Community 42"
Cohesion: 0.06
Nodes (25): read_chart(), Max, Min, Values must be less than a `max` value, Values must be greater than a `min` value, Return a new range with cells common to this range and *other*          :type ot, Return the minimal superset of this range and *other*. This new range         wi, collapse_cell_addresses() (+17 more)
...
Cohesion: 0.13
Nodes (37): activeLeaseSnapshot(), addDays(), averageTenantDurationYears(), buildFinancialWindows(), buildSnapshotPoints(), ChangeType, clampTrend(), countRenewalsWithin() (+29 more)

### Community 45 - "Community 45"
Cohesion: 0.11
Nodes (25): array, Document, DocumentsPage(), LandlordProfile, VerificationInfo, LeaseDocument(), DEFAULT_OCCUPANCY, ENUM_TO_PROPERTY_TYPE (+17 more)
...
Cohesion: 0.1
Nodes (23): Float, CellIsRule(), ColorScale, ColorScaleRule(), DataBar, DataBarRule(), FormatObject, FormulaRule() (+15 more)
...
Cohesion: 0.16
Nodes (31): addDays(), clampStepIndex(), completeTenantProductTour(), createTenantProductTourState(), ensureTenantProductTourState(), getTenantProductTourRequiredStep(), getTenantProductTourSkipCooldownDays(), getTenantProductTourState() (+23 more)

### Community 51 - "Community 51"
Cohesion: 0.1
Nodes (15): ChildSheet, FileRecoveryProperties, PivotCache, Represents a reference to a worksheet or chartsheet in workbook.xml      It cont, Represent the workbook file in the archive, WorkbookPackage, CalcProperties, FileVersion (+7 more)

### Community 52 - "Community 52"
Cohesion: 0.07
Nodes (17): BoundDictionary, defaultdict, StyleableObject, BoundDictionary, A default dictionary where elements are tightly coupled.      The factory method, Break names down into sheet locals and globals, ColumnDimension, Dimension (+9 more)
...
Cohesion: 0.1
Nodes (19): Override, get_dependents(), get_rel(), get_rels_path(), Normalise dependency file paths to absolute ones      Relative paths are relativ, Get related object based on id or rel_type, Find relationships by content-type         NB. these content-types namespaced ob, Convert relative path to absolutes that can be loaded from a zip     archive. (+11 more)
...
Cohesion: 0.1
Nodes (15): Generate string representation of XML element.      All subelements are included, tostring(), ExtendedProperties, See 22.2      Most of this is irrelevant but Excel is very picky about the versi, InvalidFileException, Error for trying to open a non-ooxml file., Save the current workbook under the given `filename`.         Use this function, Write the workbook relationships xml. (+7 more)

### Community 65 - "Community 65"
Cohesion: 0.09
Nodes (21): WriteOnlyCell(), Exception, CellCoordinatesException, IllegalCharacterError, NamedRangeException, The data submitted which cannot be used directly in Excel files. It     must be, Error for badly formatted named ranges., Error for bad sheet names. (+13 more)
...
Cohesion: 0.08
Nodes (13): DocumentProperties, High-level properties of the document.     Defined in ECMA-376 Par2 Annex D, DifferentialStyleList, Dedupable container for differential styles., Check to see whether style already exists and append it if does not., Add a differential style and return its index, TableStyleList, Add an worksheet (at an optional index). (+5 more)
...
Cohesion: 0.15
Nodes (24): formatPhpCurrency(), ActionButton(), CreditCardIcon(), DiagnosisCard(), F2FActionCenter(), InvoiceDetail, InvoiceModal(), Metric() (+16 more)
...
Cohesion: 0.13
Nodes (4): _no_value(), apply_stylesheet(), from_tree(), Add styles to workbook if present
...
Cohesion: 0.14
Nodes (16): evaluateTenantProductTourEligibility(), isNextProductTourStepSubmission(), TenantProductTourState, INITIAL_TOUR_UI_STATE, isTourEnabledClient(), StepProgressPayload, TenantProductTourOverlay(), TourApiPayload (+8 more)

### Community 100 - "Community 100"
Cohesion: 0.17
Nodes (17): Descriptor, Strict, A sequence (list or tuple) that may only contain objects of the declared     typ, Use a set to keep values unique, Sequence, UniqueSequence, NestedText, NestedDateTime (+9 more)
...
Cohesion: 0.11
Nodes (8): ASCII, DateTime, Default, Length, When called returns an instance of the expected type.     Additional default val, Values must of a particular type, Tuple, Typed
...
Cohesion: 0.14
Nodes (8): ReadOnlyCell, Make sure a row contains always the same number of cells or values, Cells are returned by a generator which can be empty, Loop through all the cells to get the size of a worksheet.         Do this only, Remove worksheet dimensions if these are incorrect in the worksheet source., Parse xml source on demand, must close after use, The source worksheet file may have columns or rows missing.         Missing cell, ReadOnlyWorksheet
...
Cohesion: 0.15
Nodes (13): Base64Binary, Guid, UniversalMeasure, MatchPattern, hash_password(), Create a password hash from a given string for protecting a worksheet     only., FileSharing, from_tree() (+5 more)
...
Cohesion: 0.14
Nodes (10): Sequence, _assign_position(), Fill, GradientFill, PatternFill, Automatically assign positions if a list of colours is provided.      It is not, Fill areas with gradient      Two types of gradient fill are supported:, Area fill patterns for use in styles.     Caution: if you do not specify a fill_ (+2 more)

### Community 133 - "Community 133"
Cohesion: 0.11
Nodes (18): , **1.1.2 Project Context** {#1.1.2-project-context}, **1.1 Background of the Study** {#1.1-background-of-the-study}, **1.2.1 General Objectives** {#1.2.1-general-objectives}, **1.2.2 Specific Objectives** {#1.2.2-specific-objectives}, **1.2 Problem Statement** {#1.2-problem-statement}, **1.3.1 Significance of the Study** {#1.3.1-significance-of-the-study}, **1.3 Purpose and Description** {#1.3-purpose-and-description} (+10 more)
...
Cohesion: 0.12
Nodes (6): CustomChartsheetView, CustomChartsheetViews, PageMargins, PrintOptions, Worksheet print options, Information about page margins for view/print layouts.     Standard values (in i
...
Cohesion: 0.18
Nodes (6): copy(), Return a copy of the proxied object., Return a copy of the proxied object. Keyword args will be passed through, Copy an existing worksheet in the current workbook          .. warning::, Copy the values, styles, dimensions, merged cells, margins, and     print/page s, WorksheetCopy

### Community 156 - "Community 156"
Cohesion: 0.16
Nodes (4): _convert(), MatchPattern, Values must match a regex pattern, Check value is of or can be converted to expected type.
...
Cohesion: 0.21
Nodes (5): ExternalReference, get_active_sheet(), Write the core workbook xml., Return the index of the active sheet.     If the sheet set to active is hidden r, WorkbookWriter
...
Cohesion: 0.14
Nodes (15): **3.5.1 Proposed System Context Diagram** {#3.5.1-proposed-system-context-diagram}, **3.5.3 Activity Diagram for Functional Requirements** {#3.5.3-activity-diagram-for-functional-requirements}, **3.5.4 Use Case Diagram![][image12]** {#3.5.4-use-case-diagram}, **3.5.4 Use Case Diagram![][image8]** {#3.5.4-use-case-diagram}, **3.5.5 Use Case Scenario** {#3.5.5-use-case-scenario}, **3.5.6 Hierarchical Diagram or Entity Relationship Diagram** {#3.5.6-hierarchical-diagram-or-entity-relationship-diagram}, **3.5.7 Data Dictionary** {#3.5.7-data-dictionary}, **3.5.8 Wireframes/Prototypes/Screenshots** {#3.5.8-wireframes/prototypes/screenshots} (+7 more)
...
Cohesion: 0.29
Nodes (12): ADVANCE_TEMPLATE_KEYS, buildPaymentPreview(), DEPOSIT_TEMPLATE_KEYS, InviteApplicationType, InviteListItem, InviteMode, InviteRequirementKey, parseAmount() (+4 more)
...
Cohesion: 0.14
Nodes (6): DefinedName, DefinedNameList, destinations(), Check for whether DefinedName with the same name and scope already         exist, type(), create_named_range()
...
Cohesion: 0.15
Nodes (12): 13.1 What is iRis?, 13.2 What iRis Can Help With, 13.3 How to Use iRis, 13.4 Privacy, 13. The iRis Assistant, 18. Glossary, 3.1 Screen Layout, 3.2 Dark Mode (+4 more)
...
Cohesion: 0.21
Nodes (11): days_to_time(), from_excel(), Convert Excel serial to Python datetime, Convert a time value to fractions of day, Convert a timedelta value to fractions of a day, Convert from a datetime to a timestamp string., Convert Python datetime to Excel serial, time_to_days() (+3 more)
...
Cohesion: 0.24
Nodes (4): Extension, Size in hundredths of points.     In theory other units of measurement can be us, TextPoint, MinMax
...
Cohesion: 0.22
Nodes (4): DummyCode, DateTime, QualifiedDateTime, In certain situations Excel will complain if the additional type     attribute i

### Community 235 - "Community 235"
Cohesion: 0.24
Nodes (4): _CustomDocumentProperty, _CustomDocumentPropertyList, Parses and seriliases property lists but is not used directly, Low-level representation of a Custom Document Property.     Not used directly

### Community 236 - "Community 236"
Cohesion: 0.2
Nodes (3): CustomPropertyList, from_tree(), Delete a propery by name
...
Cohesion: 0.25
Nodes (4): read_external_link(), Find all sheets in the workbook and return the link to the source file., Bind defined names and other definitions to worksheets or the workbook, WorkbookParser
...
Cohesion: 0.25
Nodes (7): 10.1 Description and Priority, 10.2.1 Positive Flow, 10.2.2 Negative Flow, 10.2 Stimulus / Response, 10.3 Functional Requirements, 10. Administration and Governance, iReside Functional Requirements (Updated)
...
## Knowledge Gaps
- **2758 isolated node(s):** `supabase`, `supabase`, `supabase`, `supabase`, `eslintConfig` (+2753 more)
...
- **Why does `Serialisable` connect `Community 9` to `Community 0`, `Community 1`, `Community 2`, `Community 132`, `Community 10`, `Community 399`, `Community 144`, `Community 16`, `Community 20`, `Community 21`, `Community 22`, `Community 25`, `Community 158`, `Community 34`, `Community 35`, `Community 42`, `Community 174`, `Community 47`, `Community 48`, `Community 51`, `Community 52`, `Community 54`, `Community 63`, `Community 64`, `Community 194`, `Community 68`, `Community 69`, `Community 197`, `Community 72`, `Community 73`, `Community 74`, `Community 218`, `Community 96`, `Community 100`, `Community 103`, `Community 234`, `Community 107`, `Community 235`, `Community 236`, `Community 364`, `Community 115`, `Community 249`, `Community 123`?**
  _High betweenness centrality (0.133) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 2` to `Community 0`, `Community 3`, `Community 4`, `Community 9`, `Community 13`, `Community 15`, `Community 17`, `Community 18`, `Community 19`, `Community 28`, `Community 32`, `Community 37`, `Community 166`, `Community 41`, `Community 170`, `Community 171`, `Community 44`, `Community 50`, `Community 62`, `Community 67`, `Community 81`, `Community 215`, `Community 217`, `Community 231`, `Community 122`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 6` to `Community 258`, `Community 131`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 11`, `Community 12`, `Community 141`, `Community 14`, `Community 142`, `Community 17`, `Community 19`, `Community 23`, `Community 27`, `Community 37`, `Community 38`, `Community 168`, `Community 40`, `Community 169`, `Community 171`, `Community 170`, `Community 45`, `Community 46`, `Community 50`, `Community 181`, `Community 53`, `Community 59`, `Community 317`, `Community 61`, `Community 190`, `Community 81`, `Community 92`, `Community 105`, `Community 106`, `Community 119`, `Community 120`?**
