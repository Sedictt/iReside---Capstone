...
## Corpus Check
- 987 files · ~7,160,716 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9204 nodes · 21113 edges · 683 communities (480 shown, 203 thin omitted)
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 4458 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0577b03f`
...
## Communities (683 total, 203 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (81): AuthorList, CommentRecord, CommentSheet, from_comments(), Properties, DocumentProperties, High-level properties of the document.     Defined in ECMA-376 Par2 Annex D, Sequence (+73 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (77): CellRange, NestedSequence, A sequence of primitive types that are stored as a single attribute.     "val" i, Wrap a sequence in an containing object, ValueSequence, Objects can serialise to XML their attributes and child objects.     The followi, Serialisable, ExternalBook (+69 more)
...
Cohesion: 0.05
Nodes (106): ChatUser, ContactCard(), ContactCardProps, DEFAULT_CHAT_STATE, EMPTY_ARRAY, EMPTY_OBJECT, formatConversationTimestamp(), formatMiniTimestamp() (+98 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (58): PUT(), RouteParams, GET(), getDashboardPathForRole(), PUT(), PUT(), RouteParams, GET() (+50 more)
...
Cohesion: 0.04
Nodes (70): ExtensionList, Percentage, Connection, ConnectorLocking, ConnectorNonVisual, ConnectorShape, NonVisualConnectorProperties, ShapeMeta (+62 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (76): AdminSidebar(), NAV_ITEMS, AdminLayout(), geistMono, geistSans, metadata, RootLayout(), ThemeProvider() (+68 more)
...
Cohesion: 0.05
Nodes (59): generateOTP(), GET(), POST(), ensureBucket(), POST(), sanitizeFileName(), ensureBucket(), POST() (+51 more)

### Community 10 - "Community 10"
Cohesion: 0.09
Nodes (62): _3DBase, AreaChart, AreaChart3D, _AreaChartBase, _BaseAxis, ChartLines, DateAxis, DisplayUnitsLabel (+54 more)
...
Cohesion: 0.04
Nodes (64): CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, Property, PropertyContext, PropertyContextValue, useProperty() (+56 more)
...
Cohesion: 0.05
Nodes (56): ConsultationDashboard(), Document, ConsultationTool(), ConsultationToolProps, DigitalSigner, useAuth(), ConsultationTool, SignPage() (+48 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (43): Base64Binary, Extension, Guid, Size in hundredths of points.     In theory other units of measurement can be us, TextPoint, UniversalMeasure, MatchPattern, MinMax (+35 more)
...
Cohesion: 0.05
Nodes (43): NumFmt, Trendline, TrendlineLabel, Descriptor, ASCII, Bool, _convert(), Convertible (+35 more)
...
Cohesion: 0.06
Nodes (32): Shape, anchor(), Drawing, a drawing object - eg container for shapes or charts         we assume user spec, PresetGeometry2D, GraphicFrame, GroupShape, Image (+24 more)

### Community 21 - "Community 21"
Cohesion: 0.06
Nodes (58): GET(), openai, POST(), DELETE(), UpdateListingBody, formatContextForAI(), getTenantContext(), getLandlordProperties() (+50 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (48): BillingWorkspace, NextPayment, OverduePayment, PaymentSummaryProps, LeaseInfo, TenantDashboardHeaderProps, UnitHistoryModalProps, buildInvoiceLabel() (+40 more)
...
Cohesion: 0.07
Nodes (36): VALUES, WHO_IT_SERVES, HOW_IT_WORKS, IRIS_WORKFLOWS, OUTCOMES, ScrollyTellingLandingPage(), SHOWCASE_MODULES, ApplyPage() (+28 more)
...
Cohesion: 0.05
Nodes (41): column_letter(), coordinate(), Return and remove the first cell, product(), build_workbook(), format_case_id(), resolve_output_path(), cols_from_range() (+33 more)

### Community 28 - "Community 28"
Cohesion: 0.07
Nodes (31): Bool, Level, NumberValueDescriptor, NumData, NumVal, Data should be numerical but isn't always :-/, DateTime, NestedText (+23 more)
...
Cohesion: 0.08
Nodes (33): GET(), GET(), POST(), GET(), POST(), generateSchema, GET(), POST() (+25 more)
...
Cohesion: 0.09
Nodes (26): Document, DocumentsPage(), LandlordProfile, VerificationInfo, LeaseDocument(), DEFAULT_OCCUPANCY, ENUM_TO_PROPERTY_TYPE, NewAssetContent() (+18 more)
...
Cohesion: 0.08
Nodes (21): AxId, PlotArea(), ChartContainer, ChartSpace, ExternalData, Protection, MultiLevelStrData, MultiLevelStrRef (+13 more)
...
Cohesion: 0.06
Nodes (15): Cell, coordinate(), get_time_format(), get_type(), is_date(), Check string coding, length, and line break character, Tries to convert Error" else N/A, Given a value, infer the correct data type (+7 more)

### Community 53 - "Community 53"
Cohesion: 0.09
Nodes (24): CellIsRule(), ColorScale, ColorScaleRule(), DataBar, DataBarRule(), FormatObject, FormulaRule(), IconSet (+16 more)
...
Cohesion: 0.12
Nodes (26): InvoiceListItem, InvoiceReadingDetail, formatPhpCurrency(), buildFaceToFacePreviewInvoice(), buildSelectivePreviewInvoice(), CheckoutPage(), Field(), InvoiceDetail (+18 more)
...
Cohesion: 0.11
Nodes (17): SignaturePad(), SignaturePadProps, DigitalSigner(), DigitalSignerProps, PdfPage, Signature, workerUrl, SOUND_PATHS (+9 more)
...
Cohesion: 0.09
Nodes (16): Set the categories / x-axis values, Add a range of data in a single pass.         The default is to treat each colum, Append a data series to the chart, Combine the chart with another one, AxDataSource, NumDataSource, StrRef, ErrorBars (+8 more)
...
Cohesion: 0.11
Nodes (23): FloorSelector(), FloorSelectorProps, FloorTab, VisualCanvasProps, VisualBuilderStateProps, DEFAULT_FLOOR_LAYOUTS, EMPTY_FLOOR_LAYOUT, INITIAL_UNITS (+15 more)
...
Cohesion: 0.11
Nodes (13): ConsentSettings, CookieConsent(), SettingToggle(), DocsPage(), Section, DocDetailPage(), DOCS_CONTENT, cardHover (+5 more)
...
Cohesion: 0.23
Nodes (17): AuditEvent, extractIpAddress(), extractUserAgent(), sendLeaseActivatedNotification(), sendTenantSignedNotification(), getAllowedTransitions(), getTransitionErrorMessage(), isValidLeaseStatusTransition() (+9 more)
...
Cohesion: 0.11
Nodes (12): ExcelReader, _find_workbook_part(), load_workbook(), Read an Excel package and dispatch the contents to the relevant modules, Open the given filename and return the workbook      :param filename: the path t, Does a first check whether filename is a string or a file-like     object. If it, _validate_archive(), Find all sheets in the workbook and return the link to the source file. (+4 more)
...
Cohesion: 0.23
Nodes (16): ActionBody, ALLOWED_STATUSES, createLeaseRecord(), createPaymentRecords(), generateTempPassword(), getStateForAction(), InquiryAction, isAllowedStatus() (+8 more)
...
Cohesion: 0.24
Nodes (13): sendLandlordCredentialsCopy(), sendLandlordRegistrationApproved(), sendProspectPaymentRequestEmail(), sendRegistrationOTP(), sendTenantCredentials(), sendTenantOnboardingReminder(), transporter, createLeaseRecord() (+5 more)
...
Cohesion: 0.12
Nodes (12): code:typescript (it('returns poll results with aggregated vote counts', async), code:bash (npx vitest --run), code:typescript (it('fetches comments with nested replies (max depth 2)', asy), code:bash (git add src/lib/community/actions.ts), code:bash (git add src/lib/community/actions.ts), code:typescript (it('allows tenant to report a post', async () => {), code:bash (git add src/lib/community/actions.ts), Phase 2: Server Actions & Data Layer (+4 more)
...
Cohesion: 0.19
Nodes (6): Add to zipfile and update manifest, Write the relevant child objects and add links, Map fields to associated conditional formats by priority, Return a dictionary of format objects keyed by (field id and format property)., Group formats by field index and priority.         Sorted to match sorting and g, TableDefinition
...
Cohesion: 0.21
Nodes (11): DbUnit, QuickActionGuardResult, QuickActionType, dbUnitToCanvasUnit(), formatFloorWatermark(), getFloorDisplayLabel(), parseFloorNumber(), QUICK_ACTION_META (+3 more)
...
Cohesion: 0.2
Nodes (10): code:block1 (docs/latest-documentations after major refactor/activity-dia), Consistency Notes, Diagram Inventory, How to View the Diagrams, iReside UML Activity Diagrams — Complete Documentation, Option A: Online Renderer (Quickest), Option A: Open .drawio files in diagrams.net, Option B: Use PlantUML (+2 more)
...
- **Why does `Serialisable` connect `Community 1` to `Community 0`, `Community 5`, `Community 6`, `Community 10`, `Community 141`, `Community 14`, `Community 16`, `Community 18`, `Community 20`, `Community 281`, `Community 28`, `Community 29`, `Community 31`, `Community 32`, `Community 168`, `Community 42`, `Community 48`, `Community 308`, `Community 53`, `Community 54`, `Community 56`, `Community 188`, `Community 64`, `Community 71`, `Community 72`, `Community 78`, `Community 79`, `Community 210`, `Community 91`, `Community 97`, `Community 354`, `Community 353`, `Community 109`, `Community 113`, `Community 241`, `Community 117`, `Community 251`?**
  _High betweenness centrality (0.135) - this node is a cross-community bridge._
- **Why does `Boolean` connect `Community 14` to `Community 1`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 11`, `Community 13`, `Community 152`, `Community 25`, `Community 39`, `Community 40`, `Community 46`, `Community 175`, `Community 47`, `Community 69`, `Community 106`, `Community 240`, `Community 112`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 14` to `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 13`, `Community 17`, `Community 19`, `Community 21`, `Community 152`, `Community 25`, `Community 160`, `Community 161`, `Community 39`, `Community 40`, `Community 47`, `Community 51`, `Community 67`, `Community 69`, `Community 70`, `Community 207`, `Community 208`, `Community 224`?**
