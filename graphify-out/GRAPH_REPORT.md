...
## Corpus Check
- 924 files · ~6,902,691 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7647 nodes · 19101 edges · 561 communities (375 shown, 186 thin omitted)
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 4452 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `70035c63`
...
## Communities (561 total, 186 thin omitted)
...
Cohesion: 0.02
Nodes (86): Chartsheet, ChartsheetProperties, ChartsheetProtection, WebPublishItem, WebPublishItems, DrawingHF, SheetBackgroundPicture, ChartsheetView (+78 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (69): PUT(), RouteParams, GET(), getDashboardPathForRole(), PUT(), PUT(), RouteParams, GET() (+61 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (79): Relation, Shape, anchor(), GroupTransform2D, Point2D, PositiveSize2D, PresetGeometry2D, Transform2D (+71 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (91): ActionBody, ALLOWED_STATUSES, createLeaseRecord(), createPaymentRecords(), generateTempPassword(), getStateForAction(), InquiryAction, isAllowedStatus() (+83 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (80): ThemeToggle(), InvoiceModal(), CashPaymentInterface(), CashPaymentInterfaceProps, ChatHeader(), ChatHeaderProps, buildListFetchErrorMessage(), buildPaymentHistoryErrorMessage() (+72 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (66): PhoneticProperties, PhoneticText, RichText, Text, Level, MultiLevelStrData, MultiLevelStrRef, NumberValueDescriptor (+58 more)

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (51): Alias, Alias, Aliases can be used when either the desired attribute name is not allowed     or, MultiSequence, MultiSequencePart, NestedSequence, Allow a multisequence to be built up from parts      Excluded from the instance, Wrap a sequence in an containing object (+43 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (63): AnalyticsPage(), DEFAULT_EXTENDED_KPIS, DEFAULT_FINANCIAL_CHART, DEFAULT_OPERATIONAL_SNAPSHOT, DEFAULT_PRIMARY_KPIS, ExportAuditItem, formatIsoDate(), getDateLabels() (+55 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (80): advancePaymentSchema, POST(), ActiveLeaseWorkspaceRow, AppSupabaseClient, BillingLeaseRow, buildInvoiceListItem(), createAdvancePayment(), createMultiMonthAdvancePayment() (+72 more)

### Community 10 - "Community 10"
Cohesion: 0.09
Nodes (52): ColorChoice, Percentage, Size in hundredths of points.     In theory other units of measurement can be us, TextPoint, ColorChoice, ColorMapping, HSLColor, RGBPercent (+44 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (54): Loading(), ConsultationDashboard(), Document, ConsultationTool(), ConsultationToolProps, DigitalSigner, ConsultationTool, SignPage() (+46 more)
...
Cohesion: 0.05
Nodes (43): ensureBucket(), POST(), sanitizeFileName(), ensureBucket(), POST(), sanitizeFileName(), fileSchema, landlordRegistrationSchema (+35 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (65): GET(), openai, POST(), assertAdmin(), DELETE(), MUTABLE_STATUSES, PATCH(), RegistrationRecord (+57 more)

### Community 15 - "Community 15"
Cohesion: 0.07
Nodes (41): AdminSidebar(), NAV_ITEMS, AdminLayout(), ThemeProvider(), AuthContext, AuthContextValue, AuthProvider(), AuthState (+33 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (67): array, useOptionalProperty(), UnitMapFeatureSection(), FeaturesPage(), metadata, TenantUnitMapData, TenantUnitMapPage(), VisualPlannerPage() (+59 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (24): ChildSheet, FileRecoveryProperties, PivotCache, Represents a reference to a worksheet or chartsheet in workbook.xml      It cont, Represent the workbook file in the archive, WorkbookPackage, DefinedNameList, Check for whether DefinedName with the same name and scope already         exist (+16 more)
...
Cohesion: 0.09
Nodes (45): ActorProfile, ApplicationResponse, ApplicationRow, AuditRow, buildComplianceChecklist(), ComplianceChecklist, DEFAULT_COMPLIANCE_CHECKLIST, extractMissingColumn() (+37 more)

### Community 21 - "Community 21"
Cohesion: 0.07
Nodes (29): HOW_IT_WORKS, IRIS_WORKFLOWS, OUTCOMES, ScrollyTellingLandingPage(), SHOWCASE_MODULES, ThemeToggleProps, DocsHeader(), DocsHeaderProps (+21 more)
...
Cohesion: 0.05
Nodes (22): BoundDictionary, StyleableObject, BoundDictionary, A default dictionary where elements are tightly coupled.      The factory method, ColumnDimension, Dimension, DimensionHolder, Information about the display properties of a column. (+14 more)

### Community 25 - "Community 25"
Cohesion: 0.08
Nodes (43): PAYMENT_METHODS, PaymentRecordForm(), PaymentRecordFormProps, SigningMode, SigningModeSelector(), SigningModeSelectorProps, BackgroundGlow(), Noise() (+35 more)

### Community 26 - "Community 26"
Cohesion: 0.07
Nodes (32): buildInvoiceLabel(), buildOverdueLabel(), DashboardData, formatCurrency(), formatCurrencyParts(), formatDueDate(), TenantDashboard(), LeaseHubContent() (+24 more)

### Community 27 - "Community 27"
Cohesion: 0.1
Nodes (33): ChatUser, ContactCard(), ContactCardProps, ContactsSidebar(), DEFAULT_CHAT_STATE, formatConversationTimestamp(), formatMiniTimestamp(), MiniChatMessage (+25 more)
...
Cohesion: 0.06
Nodes (15): AuthorList, CommentRecord, CommentSheet, from_comments(), Properties, Create the VML for comments, Comment, Create a detached copy of this comment. (+7 more)
...
Cohesion: 0.15
Nodes (31): computeAmountTag(), DbClient, expireInPersonIntents(), getInPersonIntentExpiry(), getOrCreateDirectConversation(), insertPaymentAuditEvent(), MessageOptions, NotifyOptions (+23 more)
...
Cohesion: 0.06
Nodes (19): escape(), r"""     Convert ASCII < 31 to OOXML: \n == _x + hex(ord(\n)) + _, r"""     Convert escaped strings to ASCIII: _x000a_ == \n, unescape(), Add sort condition for cpecified range of cells.          :param ref: range of t, SortState, Pack parts into a single string, from_tree() (+11 more)
...
Cohesion: 0.12
Nodes (38): activeLeaseSnapshot(), addDays(), averageTenantDurationYears(), buildFinancialWindows(), buildSnapshotPoints(), ChangeType, clampTrend(), countRenewalsWithin() (+30 more)

### Community 43 - "Community 43"
Cohesion: 0.07
Nodes (20): A sequence of primitive types that are stored as a single attribute.     "val" i, ValueSequence, BlankFilter, ColorFilter, CustomFilter, CustomFilters, DateGroupItem, DynamicFilter (+12 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (23): read_chart(), Max, Min, Values must be less than a `max` value, Values must be greater than a `min` value, Return a new range with cells common to this range and *other*          :type ot, collapse_cell_addresses(), DataValidation (+15 more)
...
Cohesion: 0.13
Nodes (21): CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, Property, PropertyContext, PropertyContextValue, useProperty() (+13 more)

### Community 48 - "Community 48"
Cohesion: 0.1
Nodes (29): parseIncome(), WalkInApplicationModal(), ActionItem, ActionRequired(), ActionSummary, formatDateLabel(), getDaysUntil(), MaintenanceRequestItem (+21 more)
...
Cohesion: 0.07
Nodes (18): dict, DocumentProperties, High-level properties of the document.     Defined in ECMA-376 Par2 Annex D, Find all sheets in the workbook and return the link to the source file., Bind defined names and other definitions to worksheets or the workbook, WorkbookParser, DefinedNameDict, Utility class for storing defined names.     Allows access by name and separatio (+10 more)
...
Cohesion: 0.17
Nodes (32): addDays(), clampStepIndex(), completeTenantProductTour(), createTenantProductTourState(), ensureTenantProductTourState(), evaluateTenantProductTourEligibility(), getTenantProductTourRequiredStep(), getTenantProductTourSkipCooldownDays() (+24 more)
...
Cohesion: 0.07
Nodes (15): Strict, avoid_duplicate_name(), Naive check to see whether name already exists.     If name does exist suggest a, title(), _WorkbookChild, from_str(), from_tree(), HeaderFooter (+7 more)
...
Cohesion: 0.06
Nodes (10): DefinedName, destinations(), type(), active(), create_named_range(), get_index(), Move a sheet or sheetname, Remove `worksheet` from this workbook. (+2 more)
...
Cohesion: 0.12
Nodes (19): Document, DocumentsPage(), LandlordProfile, VerificationInfo, LeaseDocument(), GET(), DEFAULT_OCCUPANCY, ENUM_TO_PROPERTY_TYPE (+11 more)
...
Cohesion: 0.09
Nodes (18): Base64Binary, CellRange, Guid, UniversalMeasure, MatchPattern, hash_password(), Create a password hash from a given string for protecting a worksheet     only., FileSharing (+10 more)
...
Cohesion: 0.08
Nodes (9): PrintPageSetup, Worksheet print page setup, Break, ColBreak, RowBreak, Outline, PageSetupProperties, WorksheetProperties (+1 more)

### Community 75 - "Community 75"
Cohesion: 0.11
Nodes (17): VALUES, WHO_IT_SERVES, geistMono, geistSans, metadata, RootLayout(), GlobalLoadingContext, GlobalLoadingContextType (+9 more)
...
Cohesion: 0.09
Nodes (15): Border, Border positioning for use in styles., Fill, GradientFill, PatternFill, Fill areas with gradient      Two types of gradient fill are supported:, Area fill patterns for use in styles.     Caution: if you do not specify a fill_, _NamedCellStyle (+7 more)
...
Cohesion: 0.14
Nodes (12): Generate string representation of XML element.      All subelements are included, tostring(), get_rels_path(), Convert relative path to absolutes that can be loaded from a zip     archive., Write the workbook relationships xml., ExcelWriter, Write links to external workbooks, Write data into the archive. (+4 more)
...
Cohesion: 0.09
Nodes (12): Alignment, Alignment options for use in styles., ArrayDescriptor, CellStyle, Convert to StyleArray, Extract protection and alignments, convert to style array, NamedStyleList, Named styles are editable and can be applied to multiple objects      As only th (+4 more)
...
Cohesion: 0.19
Nodes (14): AddAmenityModal(), AddAmenityModalProps, AMENITY_TYPES, ICONS, AmenityInsert, deleteAmenity(), getAmenities(), getAmenityBookings() (+6 more)
...
Cohesion: 0.12
Nodes (12): code:typescript (it('allows landlord to approve resident discussion post', as), code:bash (git add src/lib/community/actions.ts), code:typescript (it('fetches posts for landlord properties with filters', asy), code:bash (git add src/lib/community/actions.ts), code:bash (git add src/lib/community/actions.ts), code:typescript (it('allows tenant to report a post', async () => {), code:bash (git add src/lib/community/actions.ts), Phase 2: Server Actions & Data Layer (+4 more)
...
Cohesion: 0.13
Nodes (5): Drawing, a drawing object - eg container for shapes or charts         we assume user spec, Map fields to associated conditional formats by priority, Return a dictionary of format objects keyed by (field id and format property)., Group formats by field index and priority.         Sorted to match sorting and g
...
Cohesion: 0.17
Nodes (8): String, builtin_format_code(), builtin_format_id(), is_timedelta_format(), NumberFormatDescriptor, Return one of the standard format codes by index., Return the id of a standard style., Rebase custom numFmtIds with a floor of 164 when reading stylesheet         And
...
Cohesion: 0.29
Nodes (8): TenantProductTourState, isTourEnabledClient(), StepProgressPayload, TenantProductTourOverlay(), TourApiPayload, reasonLabel, TenantTourPage(), TourResponse
...
Cohesion: 0.33
Nodes (9): ExpenseItem, HeroStat(), InputField(), InvoicesPage(), LedgerMetric(), SelectField(), StudioLineItem(), StudioStep (+1 more)
...
Cohesion: 0.42
Nodes (7): DbUnit, FloorConfig, floorDisplayName(), FloorLane(), MapSetupWizard(), MapSetupWizardProps, SortableUnit()
...
Cohesion: 0.42
Nodes (5): generateOTP(), GET(), POST(), sendRegistrationOTP(), POST()

### Community 208 - "Community 208"
Cohesion: 0.5
Nodes (7): auth(), getCurrentUser(), getDashboardPathForRole(), getSession(), signIn(), signOut(), signUp()
...
## Knowledge Gaps
- **1903 isolated node(s):** `supabase`, `supabase`, `supabase`, `supabase`, `fs` (+1898 more)
...
- **Why does `Serialisable` connect `Community 1` to `Community 0`, `Community 3`, `Community 6`, `Community 7`, `Community 10`, `Community 17`, `Community 18`, `Community 22`, `Community 24`, `Community 153`, `Community 29`, `Community 31`, `Community 162`, `Community 39`, `Community 43`, `Community 44`, `Community 45`, `Community 175`, `Community 52`, `Community 309`, `Community 53`, `Community 57`, `Community 62`, `Community 66`, `Community 67`, `Community 69`, `Community 70`, `Community 72`, `Community 74`, `Community 79`, `Community 87`, `Community 88`, `Community 90`, `Community 99`, `Community 100`, `Community 102`, `Community 103`, `Community 107`, `Community 108`, `Community 109`, `Community 123`?**
  _High betweenness centrality (0.148) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 7` to `Community 1`, `Community 2`, `Community 131`, `Community 133`, `Community 6`, `Community 5`, `Community 9`, `Community 140`, `Community 13`, `Community 14`, `Community 20`, `Community 151`, `Community 30`, `Community 33`, `Community 36`, `Community 38`, `Community 42`, `Community 173`, `Community 48`, `Community 49`, `Community 54`, `Community 55`, `Community 185`, `Community 187`?**
  _High betweenness centrality (0.111) - this node is a cross-community bridge._
- **Why does `Boolean` connect `Community 7` to `Community 1`, `Community 33`, `Community 4`, `Community 36`, `Community 6`, `Community 38`, `Community 133`, `Community 5`, `Community 12`, `Community 13`, `Community 206`, `Community 205`, `Community 113`, `Community 20`, `Community 55`, `Community 30`, `Community 27`, `Community 158`?**
