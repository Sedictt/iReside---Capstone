...
## Corpus Check
- 983 files · ~7,146,906 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9057 nodes · 20952 edges · 674 communities (473 shown, 201 thin omitted)
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 4458 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c24b73d9`
...
## Communities (674 total, 201 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (150): CustomChartsheetViews, WebPublishItems, DrawingHF, CommentRecord, Properties, Base64Binary, CellRange, Extension (+142 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (116): _3DBase, Bool, _3DBase, Base class for 3D charts, Surface, View3D, AreaChart, AreaChart3D (+108 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (103): ApplyPage(), AdminChatModerationPage(), BannedTerm, ModerationReportCard(), ReportRow, ReportStatus, STATUS_OPTIONS, BulkOrganizerPanel() (+95 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (62): PUT(), RouteParams, GET(), getDashboardPathForRole(), PUT(), PUT(), RouteParams, GET() (+54 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (103): ChatUser, ContactCard(), ContactCardProps, DEFAULT_CHAT_STATE, EMPTY_ARRAY, EMPTY_OBJECT, formatConversationTimestamp(), formatMiniTimestamp() (+95 more)

### Community 5 - "Community 5"
Cohesion: 0.07
Nodes (79): title_maker(), ColorChoice, Convertible, HexBinary, Percentage, EmptyTag, NestedValue, Boolean if a tag exists or not. (+71 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (61): Shape, anchor(), AdjPoint2D, AdjustHandleList, Backdrop, Bevel, Camera, ConnectionSite (+53 more)
...
Cohesion: 0.05
Nodes (60): CommunityPropertyGate(), LandlordCommunityHubPage(), PropertySelectorHub(), PropertySelectorHubProps, Property, PropertyContext, PropertyContextValue, useOptionalProperty() (+52 more)
...
Cohesion: 0.06
Nodes (52): AdminSidebar(), AdminLayout(), geistMono, geistSans, metadata, RootLayout(), ConsentSettings, CookieConsent() (+44 more)

### Community 14 - "Community 14"
Cohesion: 0.06
Nodes (48): ConsultationDashboard(), Document, ConsultationTool(), ConsultationToolProps, DigitalSigner, ConsultationTool, SignPage(), BusinessPermitCard() (+40 more)
...
Cohesion: 0.06
Nodes (44): PhoneticProperties, PhoneticText, RichText, Text, Level, MultiLevelStrData, MultiLevelStrRef, NumberValueDescriptor (+36 more)

### Community 20 - "Community 20"
Cohesion: 0.08
Nodes (35): VALUES, WHO_IT_SERVES, NAV_ITEMS, HOW_IT_WORKS, IRIS_WORKFLOWS, OUTCOMES, ScrollyTellingLandingPage(), SHOWCASE_MODULES (+27 more)
...
Cohesion: 0.06
Nodes (14): Border, Border positioning for use in styles., MergeCell, MergeCells, Related, create_temporary_file(), Return all rows, and any cells that they contain, As per discusion with the OOXML Working Group global sort state is not required. (+6 more)

### Community 27 - "Community 27"
Cohesion: 0.12
Nodes (36): upsertPaymentReceipt(), computeAmountTag(), DbClient, expireInPersonIntents(), getInPersonIntentExpiry(), getOrCreateDirectConversation(), insertPaymentAuditEvent(), MessageOptions (+28 more)

### Community 28 - "Community 28"
Cohesion: 0.09
Nodes (37): GET(), getBillingWorkspace(), recordUtilityReading(), BILLING_BUCKETS, DEFAULT_LIMITS, ensureBucket(), removeBillingFile(), uploadBillingFile() (+29 more)
...
Cohesion: 0.06
Nodes (19): Cell, MergedCell, Tries to convert Error" else N/A, Returns a cell location relative to this cell.          :param row: number of ro, Describes the properties of a cell in a merged cell and helps to     display the, Describes cell associated properties.      Properties of interest include style,, CellRange, ArrayFormula (+11 more)
...
Cohesion: 0.05
Nodes (27): defaultdict, Max, Min, Values must be less than a `max` value, Values must be greater than a `min` value, Break names down into sheet locals and globals, Return a new range with cells common to this range and *other*          :type ot, Return the minimal superset of this range and *other*. This new range         wi (+19 more)
...
Cohesion: 0.07
Nodes (11): HyperlinkList, Break, ColBreak, RowBreak, read_dimension(), _cast_number(), parse_richtext_string(), Get worksheet dimensions if they are provided. (+3 more)
...
Cohesion: 0.06
Nodes (14): CustomChartsheetView, MultiCellRange, PageMargins, PrintOptions, PrintPageSetup, Worksheet print options, Worksheet print page setup, Information about page margins for view/print layouts.     Standard values (in i (+6 more)
...
Cohesion: 0.09
Nodes (19): read_chart(), get_dependents(), get_rel(), Normalise dependency file paths to absolute ones      Relative paths are relativ, Get related object based on id or rel_type, Find relationships by content-type         NB. these content-types namespaced ob, find_images(), Given the path to a drawing file extract charts and images      Ignore errors du (+11 more)
...
Cohesion: 0.07
Nodes (11): comment(), coordinate(), get_time_format(), get_type(), is_date(), Given a value, infer the correct data type, value(), EmptyCell (+3 more)
...
Cohesion: 0.09
Nodes (18): Check string coding, length, and line break character, WriteOnlyCell(), Exception, CellCoordinatesException, IllegalCharacterError, NamedRangeException, The data submitted which cannot be used directly in Excel files. It     must be, Error for badly formatted named ranges. (+10 more)

### Community 77 - "Community 77"
Cohesion: 0.12
Nodes (13): Generate string representation of XML element.      All subelements are included, tostring(), get_rels_path(), Convert relative path to absolutes that can be loaded from a zip     archive., Add to zipfile and update manifest, Write the relevant child objects and add links, ExcelWriter, Write links to external workbooks (+5 more)
...
Cohesion: 0.22
Nodes (16): AddAmenityModal(), AddAmenityModalProps, AMENITY_TYPES, ICONS, ModernSelect(), AmenityInsert, deleteAmenity(), getAmenities() (+8 more)
...
Cohesion: 0.18
Nodes (16): AdminRegistrationsPage(), IncomingStatus, initialBusinessName(), isIncomingStatus(), KpiCard(), LiveVerificationResult, persistedRows(), RegistrationRow (+8 more)
...
Cohesion: 0.12
Nodes (12): code:typescript (it('returns ordered photos for album', async () => {), code:bash (git add src/lib/community/actions.ts), code:typescript (it('toggles reaction on post', async () => {), code:bash (git add src/lib/community/actions.ts), code:typescript (it('adds top-level comment', async () => {), code:bash (git add src/lib/community/actions.ts), code:bash (git add src/lib/community/actions.ts), Phase 2: Server Actions & Data Layer (+4 more)
...
- **Why does `Serialisable` connect `Community 0` to `Community 1`, `Community 5`, `Community 6`, `Community 392`, `Community 9`, `Community 393`, `Community 141`, `Community 17`, `Community 19`, `Community 23`, `Community 26`, `Community 29`, `Community 32`, `Community 36`, `Community 38`, `Community 43`, `Community 45`, `Community 47`, `Community 177`, `Community 51`, `Community 54`, `Community 187`, `Community 62`, `Community 65`, `Community 69`, `Community 453`, `Community 73`, `Community 93`, `Community 94`, `Community 98`, `Community 109`, `Community 238`, `Community 115`, `Community 116`?**
  _High betweenness centrality (0.140) - this node is a cross-community bridge._
- **Why does `Boolean` connect `Community 9` to `Community 0`, `Community 4`, `Community 5`, `Community 7`, `Community 12`, `Community 15`, `Community 16`, `Community 20`, `Community 27`, `Community 157`, `Community 35`, `Community 41`, `Community 172`, `Community 49`, `Community 92`, `Community 97`, `Community 107`, `Community 236`, `Community 237`, `Community 252`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `Number` connect `Community 9` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 8`, `Community 10`, `Community 139`, `Community 12`, `Community 15`, `Community 16`, `Community 24`, `Community 27`, `Community 28`, `Community 157`, `Community 156`, `Community 35`, `Community 41`, `Community 173`, `Community 55`, `Community 183`, `Community 206`, `Community 207`, `Community 92`, `Community 221`, `Community 127`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
