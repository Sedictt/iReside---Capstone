<!-- converted from iReside_Section_4_User_Manual_and_Installation_Guide_FINAL.docx -->
...
- Groq Cloud API Key (gsk_... via https://console.groq.com) or OpenAI API Key (sk-...).
...
2. Log into Vercel → click Add New... → Project.
