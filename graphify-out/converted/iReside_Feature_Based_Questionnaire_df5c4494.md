<!-- converted from iReside_Feature_Based_Questionnaire.docx -->

3.6.4.2 Feature-based Questionnaire
...
AGREE (4) |
| --- | --- | --- | --- | --- |
| 1. The private QR code and invite link onboarding process makes it easy and convenient for tenants to join their assigned unit and access lease information.
...
| 2. The digital lease review and electronic signing feature provides a clear and user-friendly way for tenants to execute their lease agreements.
...
| 3. The lease overview clearly displays all relevant information including monthly rental terms, start and end dates, renewal eligibility, and contractual status.
...
| 4. The document viewer provides convenient access to download and review signed lease agreements and official property records.
...
| 5. The maintenance reporting and tracking features make it easy for tenants to submit repair requests with photos, specify urgency, and monitor progress until completion.
...
| 6. The direct real-time messaging platform enables effective and transparent communication with the landlord regarding property concerns.
...
| 7. The iRis assistant provides helpful, quick guidance on building policies, amenities, payment procedures, and general resident inquiries.
...
| 8. The financial billing ledger and payment history clearly present itemized breakdowns of monthly base rent, sub-metered water, electricity, and remaining balances.
...
| 9. The GCash and digital payment submission feature provides a fast, convenient, and secure way to upload payment receipts and reference numbers.
...
| 10. The advance payment option allows tenants to conveniently submit payments credited toward future billing periods.
...
| 11. The interactive unit map provides an intuitive visual layout of the building floors and unit orientation.
...
| 12. The lease renewal request feature allows tenants to easily express their intent to extend their tenancy before contract expiration.
...
| 13. The community bulletin board provides an organized channel to view official landlord announcements and building updates.
...
| 14. The notification system effectively delivers timely in-app and email alerts regarding billing statements, payment verifications, and urgent maintenance updates.
...
| 15. The first-launch onboarding tour clearly introduces new residents to essential portal tools and navigation upon initial login.
...
AGREE (4) |
| --- | --- | --- | --- | --- |
| 1. The workspace personalization and settings hub allows landlords to easily customize branding, brand theme colors, monogram logos, and business contact details.
...
| 2. The unified settings save system with unsaved changes exit protection ensures modifications across all tabs are safely stored without accidental data loss.
...
| 3. The Property and Unit Management interface makes it straightforward to organize buildings, update rental rates, record deposits, and manage amenities.
...
| 4. The interactive Unit Map provides a clear visual bird's-eye view of unit statuses, occupied spaces, and vacancies across the property.
...
| 5. The Tenant Intake and Private Invite QR Code generator provides a secure and seamless way to onboard verified residents into specific units.
...
| 6. The Lobby Flyer Studio allows landlords to design professional physical posters with custom photos and export high-resolution print-ready PNG images.
...
| 7. The Digital Lease drafting and electronic signature workflow enables landlords to generate enforceable contracts and finalize agreements digitally.
...
| 8. The Sub-meter Utility Reading module simplifies the entry of monthly electricity and water consumption and accurately computes utility bills.
...
| 9. The Invoice Management module enables batch generation of itemized rent and utility billing statements with automated overdue reminder alerts.
...
| 10. The Financial Ledger and Payment Verification feature provides a transparent way to review uploaded tenant receipts and approve payments directly into the accounting records.
...
| 11. The Maintenance Management dashboard simplifies reviewing repair requests, assigning third-party service contractors, and recording final resolution costs into property expenses.
...
| 12. The Landlord-Tenant Messaging module and Community Announcement publisher facilitate organized, real-time communication and building-wide notices.
...
| 13. The iRis Assistant provides valuable portfolio analytics, occupancy summaries, and context-aware smart response drafting to assist daily operations.
...
| 14. The Lease Renewal and Move-Out termination workflow provides a structured process to approve contract extensions or release vacant units with inspection records.
...
| 15. The integrated Documentation Hub and 1-Click Handover Kit provide comprehensive user manuals and technical guides to operate the system independently without dedicated IT support.
