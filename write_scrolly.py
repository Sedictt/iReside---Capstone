                ...
                <div className="max-w-6xl mx-auto">
                    {FEATURES.map((feature, index) => (
                        ...
                        >
                            ...
                            <div className={`flex-1 w-full aspect-square md:aspect-video lg:aspect-square rounded-[3rem] bg-gradient-to-br from-white/[0.03] to-transparent border border-white/10 ${index % 2 !== 0 ? 'lg:order-1' : ''} flex items-center justify-center p-8 md:p-16 relative overflow-hidden group`}>
