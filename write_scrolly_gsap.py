...
export default function ScrollyTellingLandingPage() {
    ...
    useGSAP(() => {
        const totalWidth = scrollWrapperRef.current?.scrollWidth || 0;
    ...
    return (
        <div className="min-h-screen bg-[#0A0A0B] text-white selection:bg-emerald-500/30 font-sans overflow-x-hidden">
            ...
            <section ref={containerRef} className="relative h-screen bg-[#0A0A0B] z-20 overflow-hidden">
                <div ref={scrollWrapperRef} className="flex h-screen items-center w-max px-[5vw] pt-24">
                    
                    <div className="w-[90vw] md:w-[60vw] shrink-0 flex flex-col justify-center px-12 md:px-20">
                        <h2 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter mb-8 text-white leading-tight">
                            Drop the spread<br className="hidden md:block"/>sheets.
                        </h2>
                        <p className="text-2xl text-zinc-400 font-medium leading-relaxed max-w-xl">
            ...
            <section className="relative min-h-screen py-32 md:py-52 px-6 border-t border-white/10 bg-[#0A0A0B] overflow-hidden z-20 flex flex-col justify-center">
...
print("page.tsx recreated via GSAP python script")