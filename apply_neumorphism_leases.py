...
directories = [
    r"c:\Users\JV\Documents\GitHub\iReside\src\app\landlord\leases",
    r"c:\Users\JV\Documents\GitHub\iReside\src\components\landlord\leases",
]
...
def process_file(file_path):
    ...
    # Check if there are other card patterns like border border-white/5 neu-section which might already be there or similar
...
print("Applied Neumorphism to leases successfully!")
